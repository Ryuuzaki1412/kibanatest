...
var _globalClient = /*#__PURE__*/new WeakMap();
/*
...
class CoreUiSettingsRouteHandlerContext {
  constructor(uiSettingsStart, savedObjectsRouterHandlerContext) {
    ...
    _classPrivateFieldInitSpec(this, _globalClient, {
      writable: true,
      value: void 0
    });
  ...
  get globalClient() {
    if ((0, _classPrivateFieldGet2.default)(this, _globalClient) == null) {
      (0, _classPrivateFieldSet2.default)(this, _globalClient, this.uiSettingsStart.globalAsScopedToClient(this.savedObjectsRouterHandlerContext.client));
    }
    return (0, _classPrivateFieldGet2.default)(this, _globalClient);
  }
}
