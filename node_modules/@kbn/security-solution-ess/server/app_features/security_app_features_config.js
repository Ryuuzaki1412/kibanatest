...
var _privileges = require("@kbn/security-solution-features/privileges");
/*
...
const getSecurityAppFeaturesConfigurator = enabledAppFeatureKeys => () => {
...
const securityAppFeaturesConfig = {
  ...
  [_keys.AppFeatureSecurityKey.endpointExceptions]: {
    privileges: _privileges.AppFeaturesPrivileges[_privileges.AppFeaturesPrivilegeId.endpointExceptions]
  }
};