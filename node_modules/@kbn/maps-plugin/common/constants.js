...
const MAP_EMBEDDABLE_NAME = _i18n.i18n.translate('xpack.maps.embeddableDisplayName', {
  defaultMessage: 'map'
});
exports.MAP_EMBEDDABLE_NAME = MAP_EMBEDDABLE_NAME;
...
const INDEX_SETTINGS_API_PATH = `/${GIS_INTERNAL_PATH}/indexSettings`;
exports.INDEX_SETTINGS_API_PATH = INDEX_SETTINGS_API_PATH;
const FONTS_API_PATH = `/${GIS_INTERNAL_PATH}/fonts`;
exports.FONTS_API_PATH = FONTS_API_PATH;
const INDEX_SOURCE_API_PATH = `/${GIS_INTERNAL_PATH}/docSource`;
exports.INDEX_SOURCE_API_PATH = INDEX_SOURCE_API_PATH;
const INDEX_FEATURE_PATH = `/${GIS_INTERNAL_PATH}/feature`;
exports.INDEX_FEATURE_PATH = INDEX_FEATURE_PATH;
const GET_MATCHING_INDEXES_PATH = `/${GIS_INTERNAL_PATH}/getMatchingIndexes`;
exports.GET_MATCHING_INDEXES_PATH = GET_MATCHING_INDEXES_PATH;
const CHECK_IS_DRAWING_INDEX = `/${GIS_INTERNAL_PATH}/checkIsDrawingIndex`;
exports.CHECK_IS_DRAWING_INDEX = CHECK_IS_DRAWING_INDEX;
const MVT_GETTILE_API_PATH = `/${GIS_INTERNAL_PATH}/mvt/getTile`;
exports.MVT_GETTILE_API_PATH = MVT_GETTILE_API_PATH;
const MVT_GETGRIDTILE_API_PATH = `/${GIS_INTERNAL_PATH}/mvt/getGridTile`;
...
exports.GEOJSON_FEATURE_ID_PROPERTY_NAME = GEOJSON_FEATURE_ID_PROPERTY_NAME;
...
let MASK_OPERATOR; // Maplibre does not provide any feedback when rendering is complete.
// Workaround is hard-coded timeout period.
exports.MASK_OPERATOR = MASK_OPERATOR;
(function (MASK_OPERATOR) {
  MASK_OPERATOR["ABOVE"] = "ABOVE";
  MASK_OPERATOR["BELOW"] = "BELOW";
})(MASK_OPERATOR || (exports.MASK_OPERATOR = MASK_OPERATOR = {}));
const RENDER_TIMEOUT = 1000;
exports.RENDER_TIMEOUT = RENDER_TIMEOUT;
const MIDDLE_TRUNCATION_PROPS = {
  truncation: 'middle'
};
exports.MIDDLE_TRUNCATION_PROPS = MIDDLE_TRUNCATION_PROPS;
const SINGLE_SELECTION_AS_TEXT_PROPS = {
  asPlainText: true
};
exports.SINGLE_SELECTION_AS_TEXT_PROPS = SINGLE_SELECTION_AS_TEXT_PROPS;