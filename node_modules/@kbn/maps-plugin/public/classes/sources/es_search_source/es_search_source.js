...
const sourceTitle = _i18n.i18n.translate('xpack.maps.source.esSearchTitle', {
...
class ESSearchSource extends _es_source.AbstractESSource {
  ...
  async _getNewFeatureFields() {
    var _getSecurityService;
    if (!(await this._isDrawingIndex())) {
      return {};
    }
    const user = await ((_getSecurityService = (0, _kibana_services.getSecurityService)()) === null || _getSecurityService === void 0 ? void 0 : _getSecurityService.authc.getCurrentUser());
