...
const clustersTitle = _i18n.i18n.translate('xpack.maps.source.esGridClustersTitle', {
  defaultMessage: 'Clusters'
});
exports.clustersTitle = clustersTitle;
const heatmapTitle = _i18n.i18n.translate('xpack.maps.source.esGridHeatmapTitle', {
  defaultMessage: 'Heat map'
});
exports.heatmapTitle = heatmapTitle;
class ESGeoGridSource extends _es_agg_source.AbstractESAggSource {
  ...
  async getTileUrl(requestMeta, refreshToken, hasLabels, buffer) {
    ...
    const tileUrlParams = (0, _mapsVectorTileUtils.getTileUrlParams)({
      ...
      hasLabels,
      buffer,
      requestBody: _lodash.default.pick(searchSource.getSearchRequestBody(), ['aggs', 'fields', 'query', 'runtime_mappings']),
      renderAs: this._descriptor.requestType,
      token: refreshToken,
