...
const INCOMPLETE_RESULTS_WARNING = _i18n.i18n.translate('xpack.maps.layer.incompleteResultsWarning', {
  defaultMessage: `Layer had issues returning data and results might be incomplete.`
});
exports.INCOMPLETE_RESULTS_WARNING = INCOMPLETE_RESULTS_WARNING;
class AbstractLayer {
  ...
  getGeoFieldNames() {
    ...
    return source.isESSource() ? [source.getGeoFieldName()] : [];
  }
