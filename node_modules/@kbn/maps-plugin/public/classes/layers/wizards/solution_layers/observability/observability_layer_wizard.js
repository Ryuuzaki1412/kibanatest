...
const ObservabilityLayerWizardConfig = {
  ...
  getIsDisabled: async () => {
    try {
      await (0, _kibana_services.getIndexPatternService)().get(_create_layer_descriptor.APM_INDEX_PATTERN_ID);
      return false;
    } catch (e) {
      return true;
    }
...
exports.ObservabilityLayerWizardConfig = ObservabilityLayerWizardConfig;