...
const FIXED_LABEL = _i18n.i18n.translate('xpack.maps.styles.staticDynamicSelect.staticLabel', {
  defaultMessage: 'Fixed'
});
exports.FIXED_LABEL = FIXED_LABEL;
const BY_VALUE_LABEL = _i18n.i18n.translate('xpack.maps.styles.staticDynamicSelect.dynamicLabel', {
  defaultMessage: 'By value'
});
exports.BY_VALUE_LABEL = BY_VALUE_LABEL;
class StylePropEditor extends _react.Component {
  ...
  render() {
    ...
    const stylePropertyForm = this.props.disabled && this.props.disabledBy ? /*#__PURE__*/_react.default.createElement(_eui.EuiToolTip, {
      ...
      compressed: true,
      disabled: true
    })))) : /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.cloneElement(this.props.children, {
      staticDynamicSelect
