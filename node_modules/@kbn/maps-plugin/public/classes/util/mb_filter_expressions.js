...
const EXCLUDE_CENTROID_FEATURES = ['!=', ['get', _constants.KBN_IS_CENTROID_FEATURE], true];
exports.EXCLUDE_CENTROID_FEATURES = EXCLUDE_CENTROID_FEATURES;
...
function getPointFilterExpression(isSourceGeoJson, isESSource, joinFilter, timesliceMaskConfig) {
  const filters = [];
  if (isSourceGeoJson) {
...
function getLabelFilterExpression(isSourceGeoJson, isESSource, joinFilter, timesliceMaskConfig) {
  const filters = [];
  if (isSourceGeoJson) {
