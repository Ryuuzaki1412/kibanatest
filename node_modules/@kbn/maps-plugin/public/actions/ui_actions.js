...
const SET_IS_LAYER_TOC_OPEN = 'SET_IS_LAYER_TOC_OPEN';
exports.SET_IS_LAYER_TOC_OPEN = SET_IS_LAYER_TOC_OPEN;
const SET_IS_TIME_SLIDER_OPEN = 'SET_IS_TIME_SLIDER_OPEN';
exports.SET_IS_TIME_SLIDER_OPEN = SET_IS_TIME_SLIDER_OPEN;
const SET_FULL_SCREEN = 'SET_FULL_SCREEN';
exports.SET_FULL_SCREEN = SET_FULL_SCREEN;
const SET_READ_ONLY = 'SET_READ_ONLY';
exports.SET_READ_ONLY = SET_READ_ONLY;
const SET_OPEN_TOC_DETAILS = 'SET_OPEN_TOC_DETAILS';
exports.SET_OPEN_TOC_DETAILS = SET_OPEN_TOC_DETAILS;
const SHOW_TOC_DETAILS = 'SHOW_TOC_DETAILS';
exports.SHOW_TOC_DETAILS = SHOW_TOC_DETAILS;
const HIDE_TOC_DETAILS = 'HIDE_TOC_DETAILS';
exports.HIDE_TOC_DETAILS = HIDE_TOC_DETAILS;
const SET_DRAW_MODE = 'SET_DRAW_MODE';
exports.SET_DRAW_MODE = SET_DRAW_MODE;
const SET_AUTO_OPEN_WIZARD_ID = 'SET_AUTO_OPEN_WIZARD_ID';
exports.SET_AUTO_OPEN_WIZARD_ID = SET_AUTO_OPEN_WIZARD_ID;
const PUSH_DELETED_FEATURE_ID = 'PUSH_DELETED_FEATURE_ID';
exports.PUSH_DELETED_FEATURE_ID = PUSH_DELETED_FEATURE_ID;
const CLEAR_DELETED_FEATURE_IDS = 'CLEAR_DELETED_FEATURE_IDS';
exports.CLEAR_DELETED_FEATURE_IDS = CLEAR_DELETED_FEATURE_IDS;
