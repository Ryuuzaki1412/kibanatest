...
class Timeslider extends _react.Component {
  constructor(...args) {
    ...
    (0, _defineProperty2.default)(this, "_onLoadComplete", controlGroup => {
      ...
      this._subscriptions.add(controlGroup.getOutput$().pipe((0, _operators.distinctUntilChanged)(({
        ...
        this.props.waitForTimesliceToLoad$.pipe((0, _operators.first)()).subscribe(() => {
