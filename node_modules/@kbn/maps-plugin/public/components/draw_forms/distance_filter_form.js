...
class DistanceFilterForm extends _react.Component {
  constructor(...args) {
    super(...args);
    ...
    (0, _defineProperty2.default)(this, "_onFilterLabelChange", e => {
      this.setState({
  ...
  render() {
    ...
    })), /*#__PURE__*/_react.default.createElement(_action_select.ActionSelect, {
