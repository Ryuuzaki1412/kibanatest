...
const getLazyComponent = () => {
  return /*#__PURE__*/(0, _react.lazy)(() => Promise.resolve().then(() => _interopRequireWildcard(require('./region_map_visualization'))));
};
const regionMapRenderer = {
...
exports.regionMapRenderer = regionMapRenderer;