...
class painless_lexer extends _Lexer.Lexer {
  ...
  constructor(input) {
    super(input);
    this._interp = new _LexerATNSimulator.LexerATNSimulator(painless_lexer._ATN, this);
  }
