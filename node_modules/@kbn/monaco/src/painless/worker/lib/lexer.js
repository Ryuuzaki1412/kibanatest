...
var _painless_lexer = require("../../antlr/painless_lexer");
/*
 ...
 */
class PainlessLexerEnhanced extends _painless_lexer.painless_lexer {
  constructor(...args) {
    super(...args);
  ...
  isSlashRegex() {
    ...
    switch ((_this$lastToken = this.lastToken) === null || _this$lastToken === void 0 ? void 0 : _this$lastToken.type) {
      case _painless_lexer.painless_lexer.RBRACE:
      case _painless_lexer.painless_lexer.RP:
      case _painless_lexer.painless_lexer.OCTAL:
      case _painless_lexer.painless_lexer.HEX:
      case _painless_lexer.painless_lexer.INTEGER:
      case _painless_lexer.painless_lexer.DECIMAL:
      case _painless_lexer.painless_lexer.ID:
      case _painless_lexer.painless_lexer.DOTINTEGER:
      case _painless_lexer.painless_lexer.DOTID:
        return false;
      default:
        return true;
    }
