...
const MONITOR_NOT_FOUND_ROUTE = '/monitor-not-found/:monitorId';
exports.MONITOR_NOT_FOUND_ROUTE = MONITOR_NOT_FOUND_ROUTE;
...
const PRIVATE_LOCATIOSN_ROUTE = '/settings/private-locations';
exports.PRIVATE_LOCATIOSN_ROUTE = PRIVATE_LOCATIOSN_ROUTE;
...
const SYNTHETICS_STEP_DETAIL_ROUTE = '/monitor/:monitorId/test-run/:checkGroupId/step/:stepIndex';
exports.SYNTHETICS_STEP_DETAIL_ROUTE = SYNTHETICS_STEP_DETAIL_ROUTE;
...
const ERROR_DETAILS_ROUTE = '/monitor/:monitorId/errors/:errorStateId';
...
const LICENSE_NOT_ACTIVE_ERROR = 'License not active';
exports.LICENSE_NOT_ACTIVE_ERROR = LICENSE_NOT_ACTIVE_ERROR;
const LICENSE_MISSING_ERROR = 'Missing license information';
exports.LICENSE_MISSING_ERROR = LICENSE_MISSING_ERROR;
const LICENSE_NOT_SUPPORTED_ERROR = 'License not supported';
exports.LICENSE_NOT_SUPPORTED_ERROR = LICENSE_NOT_SUPPORTED_ERROR;
const INITIAL_REST_VERSION = '2023-10-31';
exports.INITIAL_REST_VERSION = INITIAL_REST_VERSION;