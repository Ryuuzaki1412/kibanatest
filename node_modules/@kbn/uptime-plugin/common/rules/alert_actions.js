...
const SLACK_WEBHOOK_ACTION_ID = '.slack';
exports.SLACK_WEBHOOK_ACTION_ID = SLACK_WEBHOOK_ACTION_ID;
const PAGER_DUTY_ACTION_ID = '.pagerduty';
exports.PAGER_DUTY_ACTION_ID = PAGER_DUTY_ACTION_ID;
const SERVER_LOG_ACTION_ID = '.server-log';
exports.SERVER_LOG_ACTION_ID = SERVER_LOG_ACTION_ID;
const INDEX_ACTION_ID = '.index';
exports.INDEX_ACTION_ID = INDEX_ACTION_ID;
const TEAMS_ACTION_ID = '.teams';
exports.TEAMS_ACTION_ID = TEAMS_ACTION_ID;
const SERVICE_NOW_ACTION_ID = '.servicenow';
exports.SERVICE_NOW_ACTION_ID = SERVICE_NOW_ACTION_ID;
const JIRA_ACTION_ID = '.jira';
exports.JIRA_ACTION_ID = JIRA_ACTION_ID;
const WEBHOOK_ACTION_ID = '.webhook';
exports.WEBHOOK_ACTION_ID = WEBHOOK_ACTION_ID;
const EMAIL_ACTION_ID = '.email';
exports.EMAIL_ACTION_ID = EMAIL_ACTION_ID;
