...
const simpleAlertEnabled = (defaultActions, theme$, rule) => {
  ...
  return {
    ...
    text: (0, _public.toMountPoint)( /*#__PURE__*/_react.default.createElement(_sharedUxLinkRedirectApp.RedirectAppLinks, {
      coreStart: {
