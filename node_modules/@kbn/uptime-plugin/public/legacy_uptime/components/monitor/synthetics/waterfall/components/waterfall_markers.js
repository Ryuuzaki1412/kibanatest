  ...
  return /*#__PURE__*/_react.default.createElement(Wrapper, null, annotations.map(({
    ...
    return /*#__PURE__*/_react.default.createElement(_charts.LineAnnotation, {
      ...
      dataValues: [{
        dataValue: offset,
        details: label,
        header: _i18n.i18n.translate('xpack.uptime.synthetics.waterfall.offsetUnit', {
...
`;
const FCP_LABEL = _i18n.i18n.translate('xpack.uptime.synthetics.waterfall.fcpLabel', {
  defaultMessage: 'First contentful paint'
});
exports.FCP_LABEL = FCP_LABEL;
const LCP_LABEL = _i18n.i18n.translate('xpack.uptime.synthetics.waterfall.lcpLabel', {
  defaultMessage: 'Largest contentful paint'
});
exports.LCP_LABEL = LCP_LABEL;
const LAYOUT_SHIFT_LABEL = _i18n.i18n.translate('xpack.uptime.synthetics.waterfall.layoutShiftLabel', {
  defaultMessage: 'Layout shift'
});
exports.LAYOUT_SHIFT_LABEL = LAYOUT_SHIFT_LABEL;
const LOAD_EVENT_LABEL = _i18n.i18n.translate('xpack.uptime.synthetics.waterfall.loadEventLabel', {
  defaultMessage: 'Load event'
});
exports.LOAD_EVENT_LABEL = LOAD_EVENT_LABEL;
const DOCUMENT_CONTENT_LOADED_LABEL = _i18n.i18n.translate('xpack.uptime.synthetics.waterfall.domContentLabel', {
