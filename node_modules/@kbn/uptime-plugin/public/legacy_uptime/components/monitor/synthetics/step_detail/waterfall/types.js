...
exports.FriendlyTimingLabels = FriendlyTimingLabels;
const FriendlyFlyoutLabels = {
...
exports.FriendlyFlyoutLabels = FriendlyFlyoutLabels;
const TIMING_ORDER = [Timings.Blocked, Timings.Dns, Timings.Connect, Timings.Ssl, Timings.Send, Timings.Wait, Timings.Receive];
exports.TIMING_ORDER = TIMING_ORDER;
const META_DATA_ORDER_FLYOUT = [Metadata.MimeType, Timings.Dns, Timings.Connect, Timings.Ssl, Timings.Wait, Timings.Receive];
exports.META_DATA_ORDER_FLYOUT = META_DATA_ORDER_FLYOUT;
let MimeType;
...
exports.FriendlyMimetypeLabels = FriendlyMimetypeLabels;
const MimeTypesMap = {
...
exports.MimeTypesMap = MimeTypesMap;