...
const UptimeThemeContext = /*#__PURE__*/(0, _react.createContext)(defaultContext);
exports.UptimeThemeContext = UptimeThemeContext;
const UptimeThemeContextProvider = ({
  darkMode,
  children
}) => {
  let colors;
  ...
  return /*#__PURE__*/_react.default.createElement(UptimeThemeContext.Provider, {
    value: value,
    children: children
  });
};
