...
const getMonitorSummary = (monitorInfo, statusMessage) => {
  var _monitorInfo$monitor$, _monitorInfo$monitor, _monitorInfo$monitor2, _monitorInfo$observer, _monitorInfo$observer2, _monitorInfo$observer3, _monitorInfo$Timesta, _monitorInfo$url, _monitorInfo$monitor3, _monitorInfo$monitor$2, _monitorInfo$monitor4, _monitorInfo$monitor5, _monitorInfo$monitor6, _monitorInfo$error, _monitorInfo$observer4, _monitorInfo$observer5, _monitorInfo$observer6, _monitorInfo$agent, _monitorInfo$Timesta2;
  ...
  async executor({
    ...
    if (isAutoGenerated) {
      for await (const monitorLoc of downMonitorsByLocation) {
        ...
        alert.scheduleActions(_uptime_alerts.MONITOR_STATUS.id, {
