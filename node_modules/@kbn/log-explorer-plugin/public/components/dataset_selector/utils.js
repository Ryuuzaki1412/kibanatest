...
exports.getPopoverButtonStyles = exports.createUncategorizedStatusItem = exports.createIntegrationStatusItem = exports.createDataViewsStatusItem = exports.createAllLogDatasetsItem = exports.buildIntegrationsTree = void 0;
...
const getPopoverButtonStyles = ({
  ...
  maxWidth: fullWidth ? undefined : _constants.DATA_VIEW_POPOVER_CONTENT_WIDTH
});
...
const createAllLogDatasetsItem = () => {
  const allLogDataset = _datasets.Dataset.createAllLogsDataset();
  return {
...
exports.createAllLogDatasetsItem = createAllLogDatasetsItem;
