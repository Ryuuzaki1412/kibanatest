...
var _raw_connector_schema = require("./raw_connector_schema");
...
class ActionTypeRegistry {
  ...
  isActionExecutable(actionId, actionTypeId, options = {
    ...
    return actionTypeEnabled || !actionTypeEnabled && (inMemoryConnector === null || inMemoryConnector === void 0 ? void 0 : inMemoryConnector.isPreconfigured) === true;
  }
  /**
  ...
  register(actionType) {
    ...
    this.taskManager.registerTaskDefinitions({
      [`actions:${actionType.id}`]: {
        ...
        indirectParamsSchema: _raw_connector_schema.rawConnectorSchema
      }
    });
  ...
  list(featureId) {
    ...
    .filter(([actionTypeId]) => featureId ? actionTypeId !== '.sentinelone' : true).map(([actionTypeId, actionType]) => ({
      id: actionTypeId,
