...
exports.getTokenCountFromInvokeStream = getTokenCountFromInvokeStream;
 ...
 */
async function getTokenCountFromInvokeStream({
  actionTypeId,
  responseStream,
  body,
  logger
...
const parseBedrockStream = async (responseStream, logger) => {
...
const parseOpenAIStream = async (responseStream, logger) => {
  let responseBody = '';
  responseStream.on('data', chunk => {
 ...
 */
const parseBedrockBuffer = chunks => {
