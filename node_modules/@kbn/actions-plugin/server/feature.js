...
exports.CONNECTORS_BASIC_EXECUTE_PRIVILEGE_API_TAG = exports.CONNECTORS_ADVANCED_EXECUTE_PRIVILEGE_API_TAG = exports.ACTIONS_FEATURE = void 0;
...
const CONNECTORS_ADVANCED_EXECUTE_PRIVILEGE_API_TAG = 'actions:execute-advanced-connectors';
exports.CONNECTORS_ADVANCED_EXECUTE_PRIVILEGE_API_TAG = CONNECTORS_ADVANCED_EXECUTE_PRIVILEGE_API_TAG;
const CONNECTORS_BASIC_EXECUTE_PRIVILEGE_API_TAG = 'actions:execute-basic-connectors';

/**
 * The order of appearance in the feature privilege page
 * under the management section.
 */
exports.CONNECTORS_BASIC_EXECUTE_PRIVILEGE_API_TAG = CONNECTORS_BASIC_EXECUTE_PRIVILEGE_API_TAG;
...
const ACTIONS_FEATURE = {
  ...
  privileges: {
    all: {
      app: [],
      api: [CONNECTORS_ADVANCED_EXECUTE_PRIVILEGE_API_TAG, CONNECTORS_BASIC_EXECUTE_PRIVILEGE_API_TAG],
      catalogue: [],
      management: {
        insightsAndAlerting: ['triggersActions', 'triggersActionsConnectors']
      },
