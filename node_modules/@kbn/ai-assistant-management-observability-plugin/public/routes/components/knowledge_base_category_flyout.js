...
const CATEGORY_MAP = {
  lens: {
    description: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiText, {
      size: "m"
    }, _i18n.i18n.translate('aiAssistantManagementObservability.knowledgeBaseCategoryFlyout.categoryMap.lensCategoryDescriptionLabel', {
...
function KnowledgeBaseCategoryFlyout({
  ...
  const columns = [{
    field: '@timestamp',
    name: _i18n.i18n.translate('aiAssistantManagementObservability.knowledgeBaseCategoryFlyout.actions.dateCreated', {
    ...
    field: 'id',
    name: _i18n.i18n.translate('aiAssistantManagementObservability.knowledgeBaseCategoryFlyout.actions.name', {
      defaultMessage: 'Name'
    }),
    sortable: true,
    width: '340px'
    ...
    name: 'Actions',
    actions: [{
      name: _i18n.i18n.translate('aiAssistantManagementObservability.knowledgeBaseCategoryFlyout.actions.delete', {
        defaultMessage: 'Delete'
      }),
      description: _i18n.i18n.translate('aiAssistantManagementObservability.knowledgeBaseCategoryFlyout.actions.deleteDescription', {
