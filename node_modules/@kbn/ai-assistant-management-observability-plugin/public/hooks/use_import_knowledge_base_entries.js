...
function useImportKnowledgeBaseEntries() {
  ...
  return (0, _reactQuery.useMutation)([_constants.REACT_QUERY_KEYS.IMPORT_KB_ENTRIES], ({
    ...
    return observabilityAIAssistantApi === null || observabilityAIAssistantApi === void 0 ? void 0 : observabilityAIAssistantApi('POST /internal/observability_ai_assistant/kb/entries/import', {
      signal: null,
      params: {
        body: {
          entries
    ...
    onSuccess: (_data, {
      ...
      toasts.addSuccess(_i18n.i18n.translate('aiAssistantManagementObservability.kb.importEntries.successNotification', {
    ...
    onError: error => {
      ...
      toasts.addError(new Error((_error$body$message = (_error$body = error.body) === null || _error$body === void 0 ? void 0 : _error$body.message) !== null && _error$body$message !== void 0 ? _error$body$message : error.message), {
        title: _i18n.i18n.translate('aiAssistantManagementObservability.kb.importEntries.errorNotification', {
