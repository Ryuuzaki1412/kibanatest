...
var _server = require("@kbn/telemetry-plugin/server");
  ...
  return clustersLocalStats.map(localStats => {
    ...
    if (xpack) {
      return {
        ...
        stack_stats: {
          ...localStatsWithLicense.stack_stats,
          xpack
        }
      };
    }
    ...
    var _stats$stack_stats$ki, _stats$stack_stats$ki2, _stats$stack_stats$ki3;
