    ...
    (0, _defineProperty2.default)(this, "getUpdatedAtColumn", () => {
      const renderUpdatedAt = dateTime => {
        ...
        if (updatedAt.diff((0, _moment.default)(), 'days') > -7) {
          return /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedRelative, {
            value: new Date(dateTime).getTime()
          }, formattedDate => /*#__PURE__*/_react.default.createElement(_eui.EuiToolTip, {
            content: updatedAt.format('LL LT')
          }, /*#__PURE__*/_react.default.createElement("span", null, formattedDate)));
        }
        return /*#__PURE__*/_react.default.createElement(_eui.EuiToolTip, {
          content: updatedAt.format('LL LT')
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, activeActionContents, /*#__PURE__*/_react.default.createElement(_eui.EuiSearchBar, {
      ...
      toolsRight: [/*#__PURE__*/_react.default.createElement(_eui.EuiButton, {
        ...
        color: "danger",
        onClick: onDelete,
        isDisabled: selectedSavedObjects.length === 0 || !capabilities.savedObjectsManagement.delete,
