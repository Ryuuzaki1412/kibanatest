...
exports.BeatsInstancesPage = void 0;
...
var _listing = require("../../../components/beats/listing");
...
const BeatsInstancesPage = ({
  ...
  } = (0, _use_table.useTable)('beats.instances');
  ...
  const title = _i18n.i18n.translate('xpack.monitoring.beats.routeTitle', {
    defaultMessage: 'Beats'
  });
  const pageTitle = _i18n.i18n.translate('xpack.monitoring.beats.listing.pageTitle', {
  ...
  const getPageData = (0, _react.useCallback)(async () => {
    ...
    setData(response);
    updateTotalItemCount(response === null || response === void 0 ? void 0 : response.stats.total);
  ...
  return /*#__PURE__*/_react.default.createElement(_beats_template.BeatsTemplate, {
    ...
    "data-test-subj": "monitoringBeatsInstancesApp"
    ...
    }, flyoutComponent, /*#__PURE__*/_react.default.createElement(_listing.Listing, (0, _extends2.default)({
      stats: data.stats,
      data: data.listing,
      setupMode: setupMode
...
exports.BeatsInstancesPage = BeatsInstancesPage;