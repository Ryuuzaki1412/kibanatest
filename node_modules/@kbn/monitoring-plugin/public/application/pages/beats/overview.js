...
exports.BeatsOverviewPage = void 0;
...
var _overview = require("../../../components/beats/overview");
...
const BeatsOverviewPage = ({
  ...
  const title = _i18n.i18n.translate('xpack.monitoring.beats.overview.routeTitle', {
    defaultMessage: 'Beats - Overview'
  });
  const pageTitle = _i18n.i18n.translate('xpack.monitoring.beats.overview.pageTitle', {
    defaultMessage: 'Beats overview'
  });
  (0, _react.useEffect)(() => {
    if (cluster) {
  ...
  const renderOverview = overviewData => {
    ...
    return /*#__PURE__*/_react.default.createElement(_overview.BeatsOverview, (0, _extends2.default)({}, overviewData, {
      onBrush: onBrush,
      zoomInfo: zoomInfo
    }));
  };
  ...
  }, /*#__PURE__*/_react.default.createElement("div", null, renderOverview(data)));
};
exports.BeatsOverviewPage = BeatsOverviewPage;