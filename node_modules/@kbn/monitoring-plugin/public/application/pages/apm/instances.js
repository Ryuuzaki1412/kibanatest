...
exports.ApmInstancesPage = void 0;
...
var _instances = require("../../../components/apm/instances");
...
const ApmInstancesPage = ({
  ...
  } = (0, _use_table.useTable)('apm.instances');
  ...
  const title = _i18n.i18n.translate('xpack.monitoring.apm.instances.routeTitle', {
    defaultMessage: '{apm} - Instances',
    values: {
      apm: 'APM server'
    }
  });
  const pageTitle = _i18n.i18n.translate('xpack.monitoring.apm.instances.pageTitle', {
  ...
  return /*#__PURE__*/_react.default.createElement(_apm_template.ApmTemplate, {
    ...
    }, flyoutComponent, /*#__PURE__*/_react.default.createElement(_instances.ApmServerInstances, {
      setupMode: setupMode,
      apms: {
        pagination,
        sorting,
...
exports.ApmInstancesPage = ApmInstancesPage;