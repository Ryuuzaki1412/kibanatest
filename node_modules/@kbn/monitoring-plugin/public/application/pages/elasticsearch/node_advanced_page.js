...
exports.ElasticsearchNodeAdvancedPage = void 0;
...
var _advanced = require("../../../components/elasticsearch/node/advanced");
...
const ElasticsearchNodeAdvancedPage = ({
  clusters
}) => {
  ...
  const title = _i18n.i18n.translate('xpack.monitoring.elasticsearch.node.advanced.title', {
  ...
  const pageTitle = _i18n.i18n.translate('xpack.monitoring.elasticsearch.node.advanced.pageTitle', {
    defaultMessage: 'Elasticsearch node: {nodeName}',
    values: {
      nodeName: data === null || data === void 0 ? void 0 : (_data$nodeSummary4 = data.nodeSummary) === null || _data$nodeSummary4 === void 0 ? void 0 : _data$nodeSummary4.name
    }
  });
  ...
  }, [ccs, clusterUuid, (_services$data2 = services.data) === null || _services$data2 === void 0 ? void 0 : _services$data2.query.timefilter.timefilter, services.http, node]);
  return /*#__PURE__*/_react.default.createElement(_item_template.ItemTemplate, {
    ...
    id: node,
    pageType: "nodes"
  }, /*#__PURE__*/_react.default.createElement(_advanced.AdvancedNode, {
...
exports.ElasticsearchNodeAdvancedPage = ElasticsearchNodeAdvancedPage;