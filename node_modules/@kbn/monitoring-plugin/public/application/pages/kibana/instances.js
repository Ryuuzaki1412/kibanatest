...
exports.KibanaInstancesPage = void 0;
...
var _instances = require("../../../components/kibana/instances");
...
const KibanaInstancesPage = ({
  ...
  const {
    ...
    ccs
  } = (0, _react.useContext)(_global_state_context.GlobalStateContext);
  const {
    services
  } = (0, _public.useKibana)();
  const {
  ...
  } = (0, _use_table.useTable)('kibana.instances');
  const cluster = (0, _lodash.find)(clusters, {
    cluster_uuid: clusterUuid
  });
  const [data, setData] = (0, _react.useState)({});
  const [alerts, setAlerts] = (0, _react.useState)({});
  const title = _i18n.i18n.translate('xpack.monitoring.kibana.instances.routeTitle', {
    defaultMessage: 'Kibana - Instances'
  });
  const pageTitle = _i18n.i18n.translate('xpack.monitoring.kibana.instances.pageTitle', {
    defaultMessage: 'Kibana instances'
  });
  (0, _react.useEffect)(() => {
    if (cluster) {
  ...
  }, [ccs, clusterUuid, (_services$data2 = services.data) === null || _services$data2 === void 0 ? void 0 : _services$data2.query.timefilter.timefilter, services.http, updateTotalItemCount]);
  return /*#__PURE__*/_react.default.createElement(_kibana_template.KibanaTemplate, {
    title: title,
    pageTitle: pageTitle,
    getPageData: getPageData
  }, /*#__PURE__*/_react.default.createElement("div", {
    "data-test-subj": "monitoringKibanaInstancesApp"
    ...
    }, flyoutComponent, /*#__PURE__*/_react.default.createElement(_instances.KibanaInstances, (0, _extends2.default)({
      alerts: alerts,
...
exports.KibanaInstancesPage = KibanaInstancesPage;