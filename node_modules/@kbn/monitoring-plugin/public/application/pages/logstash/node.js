...
exports.LogStashNodePage = void 0;
...
const LogStashNodePage = ({
  ...
  const title = _i18n.i18n.translate('xpack.monitoring.logstash.node.routeTitle', {
    defaultMessage: 'Logstash - {nodeName}',
    values: {
      nodeName: data.nodeSummary ? data.nodeSummary.name : ''
    }
  });
  const pageTitle = _i18n.i18n.translate('xpack.monitoring.logstash.node.pageTitle', {
  ...
  }, [ccs, clusterUuid, (_services$data2 = services.data) === null || _services$data2 === void 0 ? void 0 : _services$data2.query.timefilter.timefilter, services.http, match.params]);
  const metricsToShow = (0, _react.useMemo)(() => {
    if (!data.metrics) return [];
    return [data.metrics.logstash_events_input_rate, data.metrics.logstash_jvm_usage, data.metrics.logstash_events_output_rate, data.metrics.logstash_node_cpu_metric, data.metrics.logstash_events_latency, data.metrics.logstash_os_load];
  }, [data.metrics]);
...
exports.LogStashNodePage = LogStashNodePage;