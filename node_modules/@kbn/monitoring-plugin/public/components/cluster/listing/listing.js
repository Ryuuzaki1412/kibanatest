...
const handleClickIncompatibleLicense = (scope, theme$, clusterName) => {
  licenseWarning(scope, {
    ...
    text: (0, _public.toMountPoint)( /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
...
const Listing = ({
  ...
  const _handleClickIncompatibleLicense = (0, _lodash.partial)(handleClickIncompatibleLicense, scope, services.theme.theme$);
  const _handleClickInvalidLicense = (0, _lodash.partial)(handleClickInvalidLicense, scope, services.theme.theme$);
