...
exports.ExplainPluginEnabled = ExplainPluginEnabled;
...
function ExplainPluginEnabled({
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_blurbs.ChangesNeeded, null), /*#__PURE__*/_react.default.createElement(_eui.EuiHorizontalRule, {
    ...
    defaultMessage: "We checked the {context} settings and found that {property} is set to {data} set, which disables monitoring. Removing the {monitoringEnableFalse} setting from your configuration will put the default into effect and enable Monitoring.",
    values: {
      context,
      ...
      monitoringEnableFalse: /*#__PURE__*/_react.default.createElement(_eui.EuiCode, null, "xpack.monitoring.enabled: false")
    }
  }))));
}
