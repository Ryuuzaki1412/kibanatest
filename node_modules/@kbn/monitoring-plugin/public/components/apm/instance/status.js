...
function Status({
  ...
  const metrics = [{
    label: _i18n.i18n.translate('xpack.monitoring.apm.instance.status.nameLabel', {
      defaultMessage: 'Name'
    }),
    value: name,
    'data-test-subj': 'name'
  }, {
    label: _i18n.i18n.translate('xpack.monitoring.apm.instance.status.outputLabel', {
      defaultMessage: 'Output'
    }),
    value: output,
    'data-test-subj': 'output'
  }, {
    label: _i18n.i18n.translate('xpack.monitoring.apm.instance.status.versionLabel', {
      defaultMessage: 'Version'
    }),
    value: version,
    'data-test-subj': 'version'
  }, {
    label: _i18n.i18n.translate('xpack.monitoring.apm.instance.status.uptimeLabel', {
      defaultMessage: 'Uptime'
    }),
    value: (0, _format_number.formatMetric)(uptime, 'time_since'),
    'data-test-subj': 'uptime'
  }, {
    label: _i18n.i18n.translate('xpack.monitoring.apm.instance.status.lastEventLabel', {
      defaultMessage: 'Last Event'
    }),
    value: _i18n.i18n.translate('xpack.monitoring.apm.instance.status.lastEventDescription', {
