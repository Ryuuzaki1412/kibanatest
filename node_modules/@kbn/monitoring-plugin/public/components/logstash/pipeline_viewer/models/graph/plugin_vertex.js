...
exports.TIME_CONSUMING_PROCESSOR_THRESHOLD_COEFFICIENT = exports.SLOWNESS_STANDARD_DEVIATIONS_ABOVE_THE_MEAN = exports.PluginVertex = void 0;
...
const TIME_CONSUMING_PROCESSOR_THRESHOLD_COEFFICIENT = 2;
exports.TIME_CONSUMING_PROCESSOR_THRESHOLD_COEFFICIENT = TIME_CONSUMING_PROCESSOR_THRESHOLD_COEFFICIENT;
const SLOWNESS_STANDARD_DEVIATIONS_ABOVE_THE_MEAN = 2;
exports.SLOWNESS_STANDARD_DEVIATIONS_ABOVE_THE_MEAN = SLOWNESS_STANDARD_DEVIATIONS_ABOVE_THE_MEAN;
class PluginVertex extends _vertex.Vertex {
  get typeString() {
    return 'plugin';
  }
  get name() {
  ...
  get eventsPerSecond() {
    ...
    const eps = {
      ...this.eventsPerMillisecond
    }; // Clone the object so we don't modify the original one
...
exports.PluginVertex = PluginVertex;