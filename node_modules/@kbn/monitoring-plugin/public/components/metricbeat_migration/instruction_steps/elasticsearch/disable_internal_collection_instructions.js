...
exports.getElasticsearchInstructionsForDisablingInternalCollection = getElasticsearchInstructionsForDisablingInternalCollection;
...
function getElasticsearchInstructionsForDisablingInternalCollection(product, meta) {
  const disableInternalCollectionStep = {
    title: _i18n.i18n.translate('xpack.monitoring.metricbeatMigration.elasticsearchInstructions.disableInternalCollectionTitle', {
    ...
    children: /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiText, null, /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
      ...
      defaultMessage: "Disable self monitoring of Elasticsearch monitoring metrics. Set {monospace} to false on each server in the production cluster.",
      values: {
        monospace: /*#__PURE__*/_react.default.createElement(_monospace.Monospace, null, "xpack.monitoring.elasticsearch.collection.enabled")
      }
