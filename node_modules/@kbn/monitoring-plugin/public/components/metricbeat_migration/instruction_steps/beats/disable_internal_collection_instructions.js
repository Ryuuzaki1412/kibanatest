...
exports.getBeatsInstructionsForDisablingInternalCollection = getBeatsInstructionsForDisablingInternalCollection;
...
function getBeatsInstructionsForDisablingInternalCollection(product, meta) {
  const beatType = product.beatType;
  const disableInternalCollectionStep = {
    title: _i18n.i18n.translate('xpack.monitoring.metricbeatMigration.beatsInstructions.disableInternalCollection.title', {
    ...
    children: /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiText, null, /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
      ...
      values: {
        beatType: beatType || _common_beats_instructions.UNDETECTED_BEAT_TYPE,
        file: /*#__PURE__*/_react.default.createElement(_monospace.Monospace, null, beatType, ".yml")
      }
      ...
      isCopyable: true,
      language: "bash"
    }, "monitoring.enabled: false"), /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, {
      size: "s"
