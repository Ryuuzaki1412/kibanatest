...
const INDEX_TIMEOUT_IN_MINUTES_CNVM = 240;
exports.INDEX_TIMEOUT_IN_MINUTES_CNVM = INDEX_TIMEOUT_IN_MINUTES_CNVM;
...
const statusQueryParamsSchema = _configSchema.schema.object({
  /**
...
exports.statusQueryParamsSchema = statusQueryParamsSchema;
