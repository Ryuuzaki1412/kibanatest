...
const BenchmarksSection = ({
  ...
  const navToFindingsByBenchmarkAndEvaluation = (benchmark, evaluation) => {
    navToFindings({
  ...
  const navToFailedFindingsByBenchmarkAndSection = (benchmark, ruleSection) => {
    navToFindings({
      ...(0, _summary_section.getPolicyTemplateQuery)(dashboardType),
      ...getBenchmarkIdQuery(benchmark),
  ...
  const navToFailedFindingsByBenchmark = benchmark => {
    navToFindingsByBenchmarkAndEvaluation(benchmark, _constants.RULE_FAILED);
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiPanel, {
    ...
    maxItems: 3,
    onCellClick: resourceTypeName => navToFailedFindingsByBenchmarkAndSection(benchmark, resourceTypeName),
