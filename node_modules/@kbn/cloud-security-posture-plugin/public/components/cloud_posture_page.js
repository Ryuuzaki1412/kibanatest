...
const LOADING_STATE_TEST_SUBJECT = 'cloud_posture_page_loading';
exports.LOADING_STATE_TEST_SUBJECT = LOADING_STATE_TEST_SUBJECT;
const ERROR_STATE_TEST_SUBJECT = 'cloud_posture_page_error';
exports.ERROR_STATE_TEST_SUBJECT = ERROR_STATE_TEST_SUBJECT;
const PACKAGE_NOT_INSTALLED_TEST_SUBJECT = 'cloud_posture_page_package_not_installed';
exports.PACKAGE_NOT_INSTALLED_TEST_SUBJECT = PACKAGE_NOT_INSTALLED_TEST_SUBJECT;
const CSPM_INTEGRATION_NOT_INSTALLED_TEST_SUBJECT = 'cloud_posture_page_cspm_not_installed';
exports.CSPM_INTEGRATION_NOT_INSTALLED_TEST_SUBJECT = CSPM_INTEGRATION_NOT_INSTALLED_TEST_SUBJECT;
const KSPM_INTEGRATION_NOT_INSTALLED_TEST_SUBJECT = 'cloud_posture_page_kspm_not_installed';
exports.KSPM_INTEGRATION_NOT_INSTALLED_TEST_SUBJECT = KSPM_INTEGRATION_NOT_INSTALLED_TEST_SUBJECT;
const DEFAULT_NO_DATA_TEST_SUBJECT = 'cloud_posture_page_no_data';
exports.DEFAULT_NO_DATA_TEST_SUBJECT = DEFAULT_NO_DATA_TEST_SUBJECT;
const SUBSCRIPTION_NOT_ALLOWED_TEST_SUBJECT = 'cloud_posture_page_subscription_not_allowed';
exports.SUBSCRIPTION_NOT_ALLOWED_TEST_SUBJECT = SUBSCRIPTION_NOT_ALLOWED_TEST_SUBJECT;
...
const subscriptionNotAllowedRenderer = licenseManagementLocator => /*#__PURE__*/_react.default.createElement(_full_size_centered_page.FullSizeCenteredPage, {
...
const CloudPosturePage = ({
  ...
  const getLicenseManagementLocator = (0, _use_license_management_locator_api.useLicenseManagementLocatorApi)();
  const render = () => {
