...
exports.AWS_SINGLE_ACCOUNT = AWS_SINGLE_ACCOUNT;
const AWS_ORGANIZATION_ACCOUNT = 'organization-account';
exports.AWS_ORGANIZATION_ACCOUNT = AWS_ORGANIZATION_ACCOUNT;
const GCP_SINGLE_ACCOUNT = 'single-account';
exports.GCP_SINGLE_ACCOUNT = GCP_SINGLE_ACCOUNT;
const GCP_ORGANIZATION_ACCOUNT = 'organization-account';
exports.GCP_ORGANIZATION_ACCOUNT = GCP_ORGANIZATION_ACCOUNT;
const AZURE_SINGLE_ACCOUNT = 'single-account';
exports.AZURE_SINGLE_ACCOUNT = AZURE_SINGLE_ACCOUNT;
const AZURE_ORGANIZATION_ACCOUNT = 'organization-account';
exports.AZURE_ORGANIZATION_ACCOUNT = AZURE_ORGANIZATION_ACCOUNT;
    ...
    if (!getAzureAccountType(input)) {
      updatePolicy((0, _utils.getPosturePolicy)(newPolicy, input.type, {
        ...
        'azure.credentials.type': {
          value: _azure_credentials_form.AZURE_ARM_TEMPLATE_CREDENTIAL_TYPE,
          type: 'text'
        }
      }));
    }
