...
const useAzureCredentialsForm = ({
  ...
  const azureCredentialsType = getAzureCredentialsType(input) || _azure_credentials_form.AZURE_ARM_TEMPLATE_CREDENTIAL_TYPE;
  ...
  (0, _react.useEffect)(() => {
    const isInvalid = setupFormat === _azure_credentials_form.AZURE_ARM_TEMPLATE_CREDENTIAL_TYPE && !hasArmTemplateUrl;
  ...
  const onSetupFormatChange = newSetupFormat => {
    if (newSetupFormat === _azure_credentials_form.AZURE_ARM_TEMPLATE_CREDENTIAL_TYPE) {
