...
class CloudChatPlugin {
  ...
  start(core, {
    ...
    function ConnectedChat(props) {
      return /*#__PURE__*/_react.default.createElement(CloudChatContextProvider, null, /*#__PURE__*/_react.default.createElement(_reactKibanaContextRender.KibanaRenderContextProvider, {
        theme: core.theme,
        i18n: core.i18n
      }, /*#__PURE__*/_react.default.createElement(_chat_experiment_switcher.ChatExperimentSwitcher, {
