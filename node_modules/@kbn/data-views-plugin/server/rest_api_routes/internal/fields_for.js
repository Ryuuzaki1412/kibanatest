...
exports.registerFieldForWildcard = exports.parseFields = void 0;
...
const parseFields = fields => {
  ...
  try {
    ...
    throw new Error('metaFields should be an array of field names, a JSON-stringified array of field names, or a single field name');
  }
};
...
const handler = isRollupsEnabled => async (context, request, response) => {
  ...
  const indexPatterns = new _fetcher.IndexPatternsFetcher(asCurrentUser, undefined, isRollupsEnabled());
  const {
    pattern,
  ...
  try {
    ...
    parsedFields = parseFields((_request$query$fields = request.query.fields) !== null && _request$query$fields !== void 0 ? _request$query$fields : []);
  } catch (error) {
...
const registerFieldForWildcard = async (router, getStartServices, isRollupsEnabled) => {
