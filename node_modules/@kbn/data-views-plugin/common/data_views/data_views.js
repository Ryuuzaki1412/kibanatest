...
class DataViewsService {
  ...
  constructor(deps) {
    ...
    (0, _defineProperty2.default)(this, "getFieldsForWildcard", async options => {
      const metaFields = await this.config.get(_2.META_FIELDS);
      const {
        fields
    ...
    (0, _defineProperty2.default)(this, "getFieldsForIndexPattern", async (indexPattern, options) => {
      ...
      return this.getFieldsForWildcard({
        ...
        allowHidden: indexPattern.allowHidden || (indexPattern === null || indexPattern === void 0 ? void 0 : indexPattern.getAllowHidden())
      });
    });
    ...
    (0, _defineProperty2.default)(this, "initFromSavedObjectLoadFields", async ({
      ...
      const {
        ...
        pattern: title,
        metaFields: await this.config.get(_2.META_FIELDS),
        type,
    ...
    (0, _defineProperty2.default)(this, "get", async (id, displayErrors = true, refreshFields = false) => {
      ...
      const indexPatternPromise = dataViewFromCache || this.dataViewCache.set(id, this.getSavedObjectAndInit(id, displayErrors));
    ...
    this.dataViewCache = (0, _.createDataViewCache)();
  ...
  async createAndSave(spec, overwrite = false, skipFetchFields = false, displayErrors = true) {
    ...
    const createdIndexPattern = await this.createSavedObject(indexPattern, overwrite, displayErrors);
  ...
  async createSavedObject(dataView, overwrite = false, displayErrors = true) {
  ...
  async updateSavedObject(indexPattern, saveAttempts = 0, ignoreErrors = false, displayErrors = true) {
    ...
    return this.savedObjectsClient.update(indexPattern.id, body, {
