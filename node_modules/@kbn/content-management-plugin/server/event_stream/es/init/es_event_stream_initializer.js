...
class EsEventStreamInitializer {
  ...
  async initialize() {
    const createdIndexTemplate = await (0, _classPrivateFieldGet2.default)(this, _retry).call(this, this.createIndexTemplateIfNotExists, 'createIndexTemplateIfNotExists');
    if (createdIndexTemplate) {
      await (0, _classPrivateFieldGet2.default)(this, _retry).call(this, this.createDataStream, 'createDataStream');
    }
  }
