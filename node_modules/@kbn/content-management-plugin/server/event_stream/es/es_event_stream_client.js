...
class EsEventStreamClient {
  constructor(deps) {
    ...
    this.deps = deps;
    (0, _classPrivateFieldSet2.default)(this, _names, new _es_event_stream_names.EsEventStreamNames(deps.baseName));
  }
  async initialize() {
    const initializer = new _es_event_stream_initializer.EsEventStreamInitializer({
      names: (0, _classPrivateFieldGet2.default)(this, _names),
  ...
  async writeEvents(events) {
    ...
    const {
      ...
      index: (0, _classPrivateFieldGet2.default)(this, _names).dataStream,
      operations
    }, {
      maxRetries: 0
    });
