...
var _services_transforms_factory = require("../services_transforms_factory");
  ...
  router.post({
    ...
    try {
      const context = {
        ...
        getTransformsFactory: _services_transforms_factory.getServiceObjectTransformFactory,
