...
const symbolsIndices = ['profiling-symbols-global', 'profiling-symbols-private', 'profiling-executables', 'profiling-stackframes', 'profiling-returnpads-private'];
exports.symbolsIndices = symbolsIndices;
const stacktracesIndices = ['profiling-events-*', 'profiling-metrics', 'profiling-stacktraces', 'profiling-executables', 'profiling-stackframes'];
exports.stacktracesIndices = stacktracesIndices;
const allIndices = ['profiling-events-*', 'profiling-metrics', 'profiling-stacktraces', 'profiling-sq-executables', 'profiling-sq-leafframes', 'profiling-hosts', 'profiling-symbols-global', 'profiling-symbols-private', 'profiling-executables', 'profiling-stackframes', 'profiling-returnpads-private'];
