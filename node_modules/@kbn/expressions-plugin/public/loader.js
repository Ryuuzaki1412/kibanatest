...
class ExpressionLoader {
  constructor(element, _expression, _params) {
    ...
    (0, _defineProperty2.default)(this, "loadData", (expression, params) => {
      ...
      .pipe((0, _operators.delay)(0)).subscribe(value => this.dataSubject.next(value));
    });
    ...
    this.loading$ = this.loadingSubject.asObservable().pipe((0, _operators.shareReplay)(1), (0, _operators.filter)(_ => _ === true), (0, _operators.map)(() => void 0));
