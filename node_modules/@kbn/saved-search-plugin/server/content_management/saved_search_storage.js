...
class SavedSearchStorage extends _contentManagementUtils.SOContentStorage {
  constructor({
    ...
    super({
      ...
      enableMSearch: true,
      allowedSavedObjectAttributes: ['title', 'sort', 'columns', 'description', 'grid', 'hideChart', 'isTextBasedQuery', 'usesAdHocDataView', 'kibanaSavedObjectMeta', 'viewMode', 'hideAggregatedPreview', 'rowHeight', 'timeRestore', 'timeRange', 'refreshInterval', 'rowsPerPage', 'breakdownField', 'sampleSize'],
      logger,
      throwOnResultValidationError
    });
  }
