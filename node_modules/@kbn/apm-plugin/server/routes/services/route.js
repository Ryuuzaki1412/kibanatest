...
var _server = require("@kbn/ml-plugin/server");
...
var _get_services_items = require("./get_services/get_services_items");
var _get_service_alerts = require("./get_services/get_service_alerts");
var _get_service_transaction_detailed_statistics = require("./get_services_detailed_statistics/get_service_transaction_detailed_statistics");
...
const servicesRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  params: t.type({
    ...
    }), t.intersection([_default_api_types.probabilityRt, t.intersection([_default_api_types.serviceTransactionDataSourceRt, t.type({
  ...
  async handler(resources) {
    ...
    const [mlClient, apmEventClient, apmAlertsClient, serviceGroup, randomSampler] = await Promise.all([(0, _get_ml_client.getMlClient)(resources), (0, _get_apm_event_client.getApmEventClient)(resources), (0, _get_apm_alerts_client.getApmAlertsClient)(resources), serviceGroupId ? (0, _get_service_group.getServiceGroup)({
      savedObjectsClient,
      serviceGroupId
...
const servicesDetailedStatisticsRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  params: t.type({
    query: t.intersection([_default_api_types.environmentRt, _default_api_types.kueryRt, _default_api_types.rangeRt, t.intersection([_comparison_rt.offsetRt, _default_api_types.probabilityRt, _default_api_types.serviceTransactionDataSourceRt]), t.type({
  ...
  handler: async resources => {
    ...
    return (0, _get_service_transaction_detailed_statistics.getServiceTransactionDetailedStatsPeriods)({
      environment,
      kuery,
      apmEventClient,
      documentType,
...
const serviceMetadataDetailsRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  params: t.type({
    ...
    query: t.intersection([_default_api_types.rangeRt, _default_api_types.environmentRt])
  }),
  options: {
    tags: ['access:apm']
  },
...
const serviceTransactionTypesRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  params: t.type({
    ...
    query: t.intersection([_default_api_types.rangeRt, _default_api_types.serviceTransactionDataSourceRt])
  }),
  options: {
    tags: ['access:apm']
  },
...
const serviceNodeMetadataRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  params: t.type({
    ...
    query: t.intersection([_default_api_types.kueryRt, _default_api_types.rangeRt, _default_api_types.environmentRt, _default_api_types.serviceTransactionDataSourceRt])
  }),
  options: {
    tags: ['access:apm']
  },
...
const serviceDependenciesRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  async handler(resources) {
    ...
    return {
      serviceDependencies: await (0, _get_service_dependencies.getServiceDependencies)({
        apmEventClient,
        start,
        end,
        serviceName,
...
const serviceAlertsRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  handler: async resources => {
    ...
    const servicesAlerts = await (0, _get_service_alerts.getServicesAlerts)({
      serviceName,
      apmAlertsClient,
      environment,
      start,
    ...
    return servicesAlerts.length > 0 ? servicesAlerts[0] : {
      serviceName,
      alertsCount: 0
    };
  }
