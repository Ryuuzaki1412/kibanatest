...
async function createStaticDataView({
  ...
  const dataViewId = (0, _data_view_constants.getDataViewId)(spaceId);
  ...
  return (0, _with_apm_span.withApmSpan)('create_static_data_view', async () => {
    ...
    try {
      await dataViewService.delete(_data_view_constants.DO_NOT_USE_LEGACY_APM_STATIC_DATA_VIEW_ID);
    } catch (e) {
