...
exports.getTransactionThroughput = getTransactionThroughput;
...
async function getTransactionThroughput({
  ...
  return (await (0, _fetch_timeseries.fetchSeries)({
    ...
    intervalString,
    filter: filter.concat(...(0, _server.termQuery)(_apm.TRANSACTION_TYPE, transactionType)),
    ...
    return {
      ...fetchedSerie,
      value: fetchedSerie.value !== null ? fetchedSerie.value * bucketSizeInMinutes / rangeInMinutes : null,
