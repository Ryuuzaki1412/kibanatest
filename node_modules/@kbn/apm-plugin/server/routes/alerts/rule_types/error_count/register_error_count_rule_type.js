...
const errorCountActionVariables = [_action_variables.apmActionVariables.alertDetailsUrl, _action_variables.apmActionVariables.environment, _action_variables.apmActionVariables.errorGroupingKey, _action_variables.apmActionVariables.errorGroupingName, _action_variables.apmActionVariables.interval, _action_variables.apmActionVariables.reason, _action_variables.apmActionVariables.serviceName, _action_variables.apmActionVariables.threshold, _action_variables.apmActionVariables.transactionName, _action_variables.apmActionVariables.triggerValue, _action_variables.apmActionVariables.viewInAppUrl];
exports.errorCountActionVariables = errorCountActionVariables;
function registerErrorCountRuleType({
  ...
  alerting.registerType(createLifecycleRuleType({
    ...
    executor: async ({
      ...
      var _ruleParams$searchCon, _ruleParams$searchCon2, _ruleParams$searchCon3, _ruleParams$searchCon4, _response$aggregation, _response$aggregation2;
