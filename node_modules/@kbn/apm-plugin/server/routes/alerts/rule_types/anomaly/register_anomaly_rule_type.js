  ...
  alerting.registerType(createLifecycleRuleType({
    ...
    executor: async ({
        ...
        body: {
          ...
          query: {
            bool: {
              ...
              }, ...(0, _server2.termQuery)('partition_field_value', ruleParams.serviceName, {
                queryEmptyString: false
              }), ...(0, _server2.termQuery)('by_field_value', ruleParams.transactionType, {
                queryEmptyString: false
              }), ...(0, _server2.termQuery)('detector_index', (0, _apm_ml_detectors.getApmMlDetectorIndex)(_apm_ml_detectors.ApmMlDetectorType.txLatency))]
            }
          },
          aggs: {
            anomaly_groups: {
      ...
      await (0, _std.asyncForEach)((0, _lodash.compact)(anomalies), async anomaly => {
        ...
        const alertId = [_ruleDataUtils.ApmRuleType.Anomaly, serviceName, environment, transactionType].filter(name => name).join('_');
