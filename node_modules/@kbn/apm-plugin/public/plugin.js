...
class ApmPlugin {
  ...
  setup(core, plugins) {
    ...
    core.application.register({
      ...
      deepLinks: [{
        ...
        title: servicesTitle,
        path: '/services',
        navLinkStatus: config.serverless.enabled ? _public.AppNavLinkStatus.visible : _public.AppNavLinkStatus.default
      }, {
        id: 'traces',
        title: tracesTitle,
        path: '/traces',
  ...
  start(core, plugins) {
    ...
    plugins.observabilityAIAssistant.service.register(async ({
