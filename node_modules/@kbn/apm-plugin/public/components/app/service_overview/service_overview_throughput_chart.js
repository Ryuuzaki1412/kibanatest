...
function ServiceOverviewThroughputChart({
  ...
  var _data$currentPeriod, _data$previousPeriod;
  const {
    query: {
      rangeFrom,
      rangeTo,
  ...
  const preferredAnomalyTimeseries = (0, _use_preferred_service_anomaly_timeseries.usePreferredServiceAnomalyTimeseries)(_apm_ml_detectors.ApmMlDetectorType.txThroughput);
  const {
    start,
    end
