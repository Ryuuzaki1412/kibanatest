...
function ServiceDashboards() {
  ...
  (0, _react.useEffect)(() => {
    ...
    const filteredServiceDashbords = ((_data$serviceDashboar = data === null || data === void 0 ? void 0 : data.serviceDashboards) !== null && _data$serviceDashboar !== void 0 ? _data$serviceDashboar : []).reduce((result, serviceDashboard) => {
  ...
  }, [allAvailableDashboards, data === null || data === void 0 ? void 0 : data.serviceDashboards]);
