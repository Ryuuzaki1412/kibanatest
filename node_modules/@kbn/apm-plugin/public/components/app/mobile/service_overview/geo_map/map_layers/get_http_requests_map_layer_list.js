...
async function getHttpRequestsLayerList(maps, dataViewId) {
  var _maps$createLayerDesc;
  const whereQuery = {
    language: 'kuery',
  ...
  const basemapLayerDescriptor = await (maps === null || maps === void 0 ? void 0 : (_maps$createLayerDesc = maps.createLayerDescriptors) === null || _maps$createLayerDesc === void 0 ? void 0 : _maps$createLayerDesc.createBasemapLayerDescriptor());
  const httpRequestsByCountryLayer = {
    ...
    style: (0, _get_map_layer_style.getLayerStyle)(HTTP_REQUEST_PER_COUNTRY, _get_map_layer_style.PalleteColors.BluetoRed),
    id: (0, _uuid.v4)(),
  ...
  const httpRequestsByRegionLayer = {
    ...
    style: (0, _get_map_layer_style.getLayerStyle)(HTTP_REQUESTS_PER_REGION, _get_map_layer_style.PalleteColors.YellowtoRed),
    id: (0, _uuid.v4)(),
  ...
  return [...(basemapLayerDescriptor ? [basemapLayerDescriptor] : []), httpRequestsByRegionLayer, httpRequestsByCountryLayer];
}