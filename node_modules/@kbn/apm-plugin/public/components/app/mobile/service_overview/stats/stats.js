...
function MobileStats({
  ...
  const metrics = [{
    ...
    extra: getComparisonValueFormatter(data === null || data === void 0 ? void 0 : (_data$previousPeriod$2 = data.previousPeriod.launchTimes) === null || _data$previousPeriod$2 === void 0 ? void 0 : (_data$previousPeriod$3 = _data$previousPeriod$2.value) === null || _data$previousPeriod$3 === void 0 ? void 0 : _data$previousPeriod$3.toFixed(1)),
    trendShape: _charts.MetricTrendShape.Area
  }, {
    color: euiTheme.eui.euiColorLightestShade,
    ...
    extra: getComparisonValueFormatter(data === null || data === void 0 ? void 0 : (_data$previousPeriod$4 = data.previousPeriod.sessions) === null || _data$previousPeriod$4 === void 0 ? void 0 : _data$previousPeriod$4.value),
    trendShape: _charts.MetricTrendShape.Area
  }, {
    color: euiTheme.eui.euiColorLightestShade,
    ...
    extra: getComparisonValueFormatter(data === null || data === void 0 ? void 0 : (_data$previousPeriod$5 = data.previousPeriod.requests) === null || _data$previousPeriod$5 === void 0 ? void 0 : _data$previousPeriod$5.value),
