...
async function getSessionMapLayerList(maps, dataViewId) {
  ...
  return [...(basemapLayerDescriptor ? [basemapLayerDescriptor] : []), sessionsByRegionLayer, sessionsByCountryLayer];
}