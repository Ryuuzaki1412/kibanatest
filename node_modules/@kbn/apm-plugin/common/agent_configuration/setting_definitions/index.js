...
const settingDefinitions = (0, _lodash.sortBy)([..._general_settings.generalSettings, ..._java_settings.javaSettings, ..._mobile_settings.mobileSettings].map(getSettingDefaults), 'key');
