 ...
 * @internal
 */
function createPluginPrebootSetupContext({
  deps,
  plugin
}) {
  return {
...
function createPluginSetupContext({
  ...
  return {
    ...
    http: {
      ...
      basePath: deps.http.basePath,
      staticAssets: {
        getPluginAssetHref: assetPath => deps.http.staticAssets.getPluginAssetHref(plugin.name, assetPath)
      },
      csp: deps.http.csp,
      getServerInfo: deps.http.getServerInfo
    },
 ...
 * @internal
 */ //
function createPluginStartContext({
  plugin,
  deps,
  runtimeResolver
}) {
