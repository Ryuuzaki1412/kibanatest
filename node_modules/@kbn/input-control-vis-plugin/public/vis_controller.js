...
const createInputControlVisController = (deps, handlers, el) => {
  let I18nContext;
  let isLoaded = false;
  return new class InputControlVisController {
    constructor() {
      ...
      (0, _defineProperty2.default)(this, "drawVis", () => {
        ...
        (0, _reactDom.render)( /*#__PURE__*/_react.default.createElement(I18nContext, null, /*#__PURE__*/_react.default.createElement(_public.VisualizationContainer, {
          handlers: handlers
