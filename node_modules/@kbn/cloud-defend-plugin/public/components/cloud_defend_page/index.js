...
const LOADING_STATE_TEST_SUBJECT = 'cloud_defend_page_loading';
exports.LOADING_STATE_TEST_SUBJECT = LOADING_STATE_TEST_SUBJECT;
const ERROR_STATE_TEST_SUBJECT = 'cloud_defend_page_error';
exports.ERROR_STATE_TEST_SUBJECT = ERROR_STATE_TEST_SUBJECT;
const PACKAGE_NOT_INSTALLED_TEST_SUBJECT = 'cloud_defend_page_package_not_installed';
exports.PACKAGE_NOT_INSTALLED_TEST_SUBJECT = PACKAGE_NOT_INSTALLED_TEST_SUBJECT;
const DEFAULT_NO_DATA_TEST_SUBJECT = 'cloud_defend_page_no_data';
exports.DEFAULT_NO_DATA_TEST_SUBJECT = DEFAULT_NO_DATA_TEST_SUBJECT;
const SUBSCRIPTION_NOT_ALLOWED_TEST_SUBJECT = 'cloud_defend_page_subscription_not_allowed';
