...
exports.policiesQueryParamsSchema = void 0;
...
const policiesQueryParamsSchema = _configSchema.schema.object({
  /**
  ...
  per_page: _configSchema.schema.number({
    defaultValue: _constants.DEFAULT_POLICIES_PER_PAGE,
    min: 0
  }),
  /**
   ...
   * Policy filter
   */
  policy_name: _configSchema.schema.maybe(_configSchema.schema.string())
});
exports.policiesQueryParamsSchema = policiesQueryParamsSchema;