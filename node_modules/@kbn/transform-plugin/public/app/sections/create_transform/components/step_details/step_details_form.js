...
const StepDetailsForm = /*#__PURE__*/_react.default.memo(({
  overrides = {},
  onChange,
  searchItems,
  stepDefineState
  ...
  const isContinuousModeDelayValid = (0, _validators.continuousModeDelayValidator)(continuousModeDelay);
  ...
  const isRetentionPolicyMaxAgeValid = (0, _validators.retentionPolicyMaxAgeValidator)(retentionPolicyMaxAge);
  (0, _react.useEffect)(() => {
  ...
  const isTransformFrequencyValid = (0, _validators.transformFrequencyValidator)(transformFrequency);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    error: !retentionPolicyMaxAgeEmpty && !isRetentionPolicyMaxAgeValid && [_validation_messages.retentionPolicyMaxAgeInvalidErrorMessage],
