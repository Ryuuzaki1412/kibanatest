...
const CreateTransformWizardContext = /*#__PURE__*/(0, _react.createContext)({
  dataView: null,
  runtimeMappings: undefined
});
exports.CreateTransformWizardContext = CreateTransformWizardContext;
const Wizard = /*#__PURE__*/_react.default.memo(({
  cloneConfig,
  searchItems
}) => {
  const {
