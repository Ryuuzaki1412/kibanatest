...
const useColumns = (expandedRowItemIds, setExpandedRowItemIds, transformNodes, transformSelection, transformsStatsLoading) => {
  ...
  const columns = [{
    ...
    sortable: item => {
      var _item$stats2;
      return (_item$stats2 = item.stats) === null || _item$stats2 === void 0 ? void 0 : _item$stats2.health.status;
    },
    truncateText: true,
    render(item) {
      return item.stats ? /*#__PURE__*/_react.default.createElement(_transform_health_colored_dot.TransformHealthColoredDot, {
