 ...
 * 2.0.
 */
let PIVOT_SUPPORTED_GROUP_BY_AGGS;
...
const pivotGroupByFieldSupport = {
...
const histogramIntervalFormatRegex = /^([1-9][0-9]*((\.)([0-9]+))?|([0](\.)([0-9]+)))$/;
...
const dateHistogramIntervalFormatRegex = /^[1-9][0-9]*(ms|s|m|h|d|w|M|q|y)$/;
