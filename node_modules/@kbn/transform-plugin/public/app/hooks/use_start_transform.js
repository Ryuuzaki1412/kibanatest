...
const useStartTransforms = () => {
  ...
  const mutation = (0, _reactQuery.useMutation)({
    mutationFn: reqBody => http.post((0, _constants.addInternalBasePath)('start_transforms'), {
      body: JSON.stringify(reqBody),
      version: '1'
    }),
    onError: error => toastNotifications.addDanger({
      title: _i18n.i18n.translate('xpack.transform.stepCreateForm.startTransformResponseSchemaErrorMessage', {
        ...
        if (results.hasOwnProperty(transformId)) {
          ...
          if (!result.success) {
            toastNotifications.addError(new Error(JSON.stringify(result.error.caused_by, null, 2)), {
              title: _i18n.i18n.translate('xpack.transform.transformList.startTransformErrorMessage', {
