...
exports.getDataViewIdByTitle = getDataViewIdByTitle;
exports.loadDataViews = loadDataViews;
exports.refreshDataViews = void 0;
...
let dataViewCache = [];
let refreshDataViews;
exports.refreshDataViews = refreshDataViews;
async function loadDataViews(dataViewsContract) {
  dataViewCache = await dataViewsContract.find('*', 10000);
  return dataViewCache;
}
function getDataViewIdByTitle(dataViewTitle) {
  var _dataViewCache$find;
  return (_dataViewCache$find = dataViewCache.find(({
    title
  }) => title === dataViewTitle)) === null || _dataViewCache$find === void 0 ? void 0 : _dataViewCache$find.id;
}
