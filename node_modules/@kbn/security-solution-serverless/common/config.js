...
const productLine = _configSchema.schema.oneOf([_configSchema.schema.literal(_product.ProductLine.security), _configSchema.schema.literal(_product.ProductLine.endpoint), _configSchema.schema.literal(_product.ProductLine.cloud)]);
exports.productLine = productLine;
const productTier = _configSchema.schema.oneOf([_configSchema.schema.literal(_product.ProductTier.essentials), _configSchema.schema.literal(_product.ProductTier.complete)]);
