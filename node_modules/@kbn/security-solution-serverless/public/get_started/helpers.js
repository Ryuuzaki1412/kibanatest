...
exports.updateActiveSections = exports.setupActiveSections = exports.isStepActive = exports.isDefaultFinishedCardStep = exports.getTotalStepsLeftAndActiveSteps = exports.getStepsByActiveProduct = exports.getCardTimeInMinutes = exports.getCardStepsLeft = exports.getCard = exports.getActiveSteps = exports.findCardSectionByStepId = exports.defaultFinishedSteps = exports.CONTENT_WIDTH = void 0;
...
const defaultFinishedSteps = {
  [_types.QuickStartSectionCardsId.createFirstProject]: [_types.CreateProjectSteps.createFirstProject]
};
exports.defaultFinishedSteps = defaultFinishedSteps;
const isDefaultFinishedCardStep = (cardId, stepId) => {
  var _defaultFinishedSteps;
  return !!((_defaultFinishedSteps = defaultFinishedSteps[cardId]) !== null && _defaultFinishedSteps !== void 0 && _defaultFinishedSteps.includes(stepId));
};
...
const getCardStepsLeft = (activeSteps, stepsDone) => {
  ...
  return ((_activeSteps$length = activeSteps === null || activeSteps === void 0 ? void 0 : activeSteps.length) !== null && _activeSteps$length !== void 0 ? _activeSteps$length : 0) - ((_stepsDone$size = stepsDone.size) !== null && _stepsDone$size !== void 0 ? _stepsDone$size : 0);
};
...
const getActiveSteps = (steps, activeProducts) => steps === null || steps === void 0 ? void 0 : steps.filter(step => isStepActive(step, activeProducts));
...
const getStepsByActiveProduct = ({
  ...
  const steps = getActiveSteps(card === null || card === void 0 ? void 0 : card.steps, activeProducts);
  return steps;
};
exports.getStepsByActiveProduct = getStepsByActiveProduct;
const setupActiveSections = (finishedSteps, activeProducts) => activeProducts.size > 0 ? (0, _sections.getSections)().reduce((acc, section) => {
