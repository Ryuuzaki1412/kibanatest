...
exports.DashboardButton = void 0;
...
const DashboardButtonComponent = () => {
  ...
  const onClick = (0, _react.useCallback)(() => {
    toggleTaskCompleteStatus({
      stepId: _types.ViewDashboardSteps.analyzeData,
      cardId: _types.AddAndValidateYourDataCardsId.viewDashboards,
      sectionId: _types.SectionId.addAndValidateYourData,
      undo: false
    });
  }, [toggleTaskCompleteStatus]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, !isIntegrationsStepComplete && /*#__PURE__*/_react.default.createElement(_add_integration_callout.AddIntegrationCallout, {
    stepName: _translations.VIEW_DASHBOARDS_CALLOUT_TITLE
    ...
    onClick: onClick
  }, _translations.GO_TO_DASHBOARDS));
};
const DashboardButton = /*#__PURE__*/_react.default.memo(DashboardButtonComponent);
