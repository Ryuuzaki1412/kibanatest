...
exports.getCasesAppFeaturesConfigurator = void 0;
...
const getCasesAppFeaturesConfigurator = enabledAppFeatureKeys => () => {
  return (0, _config.createEnabledAppFeaturesConfigMap)(casesAppFeaturesConfig, enabledAppFeatureKeys);
};
 ...
 */
exports.getCasesAppFeaturesConfigurator = getCasesAppFeaturesConfigurator;
const casesAppFeaturesConfig = {
  ...(0, _config.getCasesDefaultAppFeaturesConfig)({
    apiTags: {
