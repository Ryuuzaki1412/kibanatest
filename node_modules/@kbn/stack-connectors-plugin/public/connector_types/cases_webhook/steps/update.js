...
const UpdateStep = ({
  ...
  size: "m"
}), /*#__PURE__*/_react.default.createElement(_eui.EuiText, null, /*#__PURE__*/_react.default.createElement("h3", null, i18n.STEP_4B), /*#__PURE__*/_react.default.createElement("small", null, /*#__PURE__*/_react.default.createElement("p", null, i18n.STEP_4B_DESCRIPTION))), /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, {
  size: "s"
}), /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
  justifyContent: "spaceBetween"
}, /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, {
  ...
  config: {
    ...
    validations: [{
      validator: (0, _validator.isUrlButCanBeEmpty)(i18n.CREATE_COMMENT_URL_REQUIRED)
    }],
  ...
  config: {
    ...
    validations: [{
      validator: (0, _validator.containsCommentsOrEmpty)(i18n.CREATE_COMMENT_MESSAGE)
    }]
  },
  component: _public.JsonFieldWrapper,
  componentProps: {
