...
const getDashboardTitle = title => `${title} Token Usage`;
const getDashboard = (genAIProvider, dashboardId) => {
  const attributes = genAIProvider === 'OpenAI' ? {
    provider: _constants.OPENAI_TITLE,
    dashboardTitle: getDashboardTitle(_constants.OPENAI_TITLE),
    actionTypeId: _constants.OPENAI_CONNECTOR_ID
  } : {
    provider: _constants2.BEDROCK_TITLE,
    dashboardTitle: getDashboardTitle(_constants2.BEDROCK_TITLE),
    actionTypeId: _constants2.BEDROCK_CONNECTOR_ID
  };
  const ids = {
    genAiSavedObjectId: dashboardId,
    tokens: (0, _uuid.v4)(),
    totalTokens: (0, _uuid.v4)(),
    tag: (0, _uuid.v4)()
  };
  return {
    attributes: {
            ...
            state: {
              visualization: {
                ...
                layers: [{
                  ...
                  accessors: ['0f9814ec-0964-4efa-93a3-c7f173df2483', 'b0e390e4-d754-4eb4-9fcc-4347dadda394'],
                  position: 'top',
                ...
                formBased: {
                  layers: {
                    '475e8ca0-e78e-454a-8597-a5492f70dce3': {
                      ...
                      columnOrder: ['5352fcb2-7b8e-4b5a-bce9-73a7f3b2b519', '0f9814ec-0964-4efa-93a3-c7f173df2483', 'b0e390e4-d754-4eb4-9fcc-4347dadda394'],
                      sampling: 1,
                      incompleteColumns: {}
                    }
                  }
                ...
                formBased: {
                  layers: {
                    '475e8ca0-e78e-454a-8597-a5492f70dce3': {
                      ...
                      columnOrder: ['5352fcb2-7b8e-4b5a-bce9-73a7f3b2b519', 'b0e390e4-d754-4eb4-9fcc-4347dadda394'],
                      sampling: 1,
                      incompleteColumns: {}
                    }
                  }
