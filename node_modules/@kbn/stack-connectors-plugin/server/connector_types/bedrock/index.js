...
const getConnectorType = () => ({
  ...
  name: _constants.BEDROCK_TITLE,
  getService: params => new _bedrock.BedrockConnector(params),
  schema: {
  ...
  supportedFeatureIds: [_common.GenerativeAIConnectorFeatureId],
...
const configValidator = (configObject, validatorServices) => {
  try {
    ...
    throw new Error(_i18n.i18n.translate('xpack.stackConnectors.bedrock.configurationErrorApiProvider', {
