...
function healthRoute(params) {
  ...
  (0, _operators.map)(stats => withServiceStatus(getHealthStatus(stats))), (0, _operators.filter)(([monitoredHealth]) => monitoredHealth.status !== _monitoring.HealthStatus.Uninitialized)).subscribe(([monitoredHealth, serviceStatus]) => {
