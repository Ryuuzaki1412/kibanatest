...
const DEFAULT_MONITORING_STATS_RUNNING_AVERAGE_WINDOW = 50;
exports.DEFAULT_MONITORING_STATS_RUNNING_AVERAGE_WINDOW = DEFAULT_MONITORING_STATS_RUNNING_AVERAGE_WINDOW;
...
const DEFAULT_METRICS_RESET_INTERVAL = 30 * 1000; // 30 seconds

// At the default poll interval of 3sec, this averages over the last 15sec.
exports.DEFAULT_METRICS_RESET_INTERVAL = DEFAULT_METRICS_RESET_INTERVAL;
const DEFAULT_WORKER_UTILIZATION_RUNNING_AVERAGE_WINDOW = 5;
exports.DEFAULT_WORKER_UTILIZATION_RUNNING_AVERAGE_WINDOW = DEFAULT_WORKER_UTILIZATION_RUNNING_AVERAGE_WINDOW;
const CLAIM_STRATEGY_DEFAULT = 'default';
exports.CLAIM_STRATEGY_DEFAULT = CLAIM_STRATEGY_DEFAULT;
...
const requeueInvalidTasksConfig = _configSchema.schema.object({
...
const configSchema = _configSchema.schema.object({
  ...
  validate: config => {
    ...
    try {
      (0, _task_claimers.getTaskClaimer)(config.claim_strategy);
    } catch (err) {
