...
var TaskOverdueMetricKeys;
(function (TaskOverdueMetricKeys) {
  TaskOverdueMetricKeys["OVERALL"] = "overall";
  TaskOverdueMetricKeys["BY_TYPE"] = "by_type";
})(TaskOverdueMetricKeys || (TaskOverdueMetricKeys = {}));
class TaskOverdueMetricsAggregator {
  ...
  collect() {
    ...
    return (0, _lib.unflattenObject)((0, _lodash.mapValues)(this.histograms, hist => hist.serialize()));
  }
  reset() {
