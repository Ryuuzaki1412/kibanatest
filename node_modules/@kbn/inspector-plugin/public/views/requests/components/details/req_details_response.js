...
class RequestDetailsResponse extends _react.Component {
  render() {
...
(0, _defineProperty2.default)(RequestDetailsResponse, "shouldShow", request => Boolean(RequestDetailsResponse.getResponseJson(request)));
(0, _defineProperty2.default)(RequestDetailsResponse, "getResponseJson", request => request.response ? request.response.json : null);