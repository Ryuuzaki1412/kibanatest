...
function startTrackingEventLoopDelaysUsage(internalRepository, instanceUuid, stopMonitoringEventLoop$, eventLoopDelaysMonitor, configs = {}) {
  ...
  (0, _rxjs.timer)(collectionStartDelay, collectionInterval).pipe((0, _operators.map)(i => (i + 1) % resetOnCount === 0), (0, _operators.takeUntil)(stopMonitoringEventLoop$), (0, _operators.finalize)(() => eventLoopDelaysMonitor.stop()), (0, _rxjs.switchMap)(async shouldReset => {
