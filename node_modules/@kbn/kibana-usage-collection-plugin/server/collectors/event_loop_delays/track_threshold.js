...
function startTrackingEventLoopDelaysThreshold(eventLoopCounter, logger, stopMonitoringEventLoop$, eventLoopDelaysMonitor, configs = {}) {
  ...
  (0, _rxjs.timer)(collectionStartDelay, collectionInterval).pipe((0, _operators.takeUntil)(stopMonitoringEventLoop$), (0, _operators.finalize)(() => eventLoopDelaysMonitor.stop())).subscribe(() => {
    const {
      mean: meanMS
