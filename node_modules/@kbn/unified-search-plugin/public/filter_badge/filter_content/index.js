...
exports.FilterContentLazy = exports.FilterContent = void 0;
 ...
 */
const FilterContentLazy = /*#__PURE__*/_react.default.lazy(() => Promise.resolve().then(() => _interopRequireWildcard(require('./filter_content'))));
 ...
 */
exports.FilterContentLazy = FilterContentLazy;
const FilterContent = (0, _sharedUxUtility.withSuspense)(FilterContentLazy);
