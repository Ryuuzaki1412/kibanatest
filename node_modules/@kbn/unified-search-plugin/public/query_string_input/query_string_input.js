...
class QueryStringInputUI extends _react.PureComponent {
  constructor(...args) {
      ...
      if (subTypeNested && subTypeNested.nested && !this.props.deps.storage.get('kibana.KQLNestedQuerySyntaxInfoOptOut')) {
        ...
        if (notifications && docLinks) {
          const toast = notifications.toasts.add({
            ...
            text: (0, _public2.toMountPoint)( /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
    ...
    (0, _defineProperty2.default)(this, "onMouseEnterSuggestion", (suggestion, index) => {
      this.setState({
        index
      });
    });
