...
var _adjust_threshold_based_on_format = require("../../helpers/adjust_threshold_based_on_format");
  ...
  const handleAddNewRow = (0, _react.useCallback)(() => {
    setCustomMetrics(previous => {
      ...
      debouncedOnChange({
        ...
        metrics: nextMetrics,
        equation,
        threshold: (0, _adjust_threshold_based_on_format.adjustThresholdBasedOnFormat)(previous, nextMetrics, expression.threshold)
      });
      return nextMetrics;
    });
