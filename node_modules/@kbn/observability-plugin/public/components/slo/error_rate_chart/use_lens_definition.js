...
function useLensDefinition(slo) {
  var _slo$instanceId;
  const {
    euiTheme
  } = (0, _eui.useEuiTheme)();
  const interval = _sloSchema.timeslicesBudgetingMethodSchema.is(slo.budgetingMethod) ? slo.objective.timesliceWindow : '60s';
  return {
    ...
    state: {
      visualization: {
        ...
        layers: [{
          ...
          accessors: ['0a42b72b-cd5a-4d59-81ec-847d97c268e6', '76d3bcc9-7d45-4b08-b2b1-8d3866ca0762', 'c531a6b1-70dd-4918-bdd0-a21535a7af05', '61f9e663-10eb-41f7-b584-1f0f95418489'],
          yConfig: [{
        ...
        formBased: {
          layers: {
            ...
            '34298f84-681e-4fa3-8107-d6facb32ed92': {
              ...
              columnOrder: ['0a42b72b-cd5a-4d59-81ec-847d97c268e6', '0a42b72b-cd5a-4d59-81ec-847d97c268e6X0', '76d3bcc9-7d45-4b08-b2b1-8d3866ca0762X0', '76d3bcc9-7d45-4b08-b2b1-8d3866ca0762', 'c531a6b1-70dd-4918-bdd0-a21535a7af05X0', 'c531a6b1-70dd-4918-bdd0-a21535a7af05', '61f9e663-10eb-41f7-b584-1f0f95418489X0', '61f9e663-10eb-41f7-b584-1f0f95418489'],
              sampling: 1,
      ...
      adHocDataViews: {
        '32ca1ad4-81c0-4daf-b9d1-07118044bdc5': {
          id: '32ca1ad4-81c0-4daf-b9d1-07118044bdc5',
          title: _constants.SLO_DESTINATION_INDEX_PATTERN,
