...
function RuleDetailsPage() {
  ...
  const [activeTabId, setActiveTabId] = (0, _react.useState)(() => {
    ...
    return urlTabId && [_constants2.RULE_DETAILS_EXECUTION_TAB, _constants2.RULE_DETAILS_ALERTS_TAB].includes(urlTabId) ? urlTabId : _constants2.RULE_DETAILS_EXECUTION_TAB;
  });
  ...
  const featureIds = (rule === null || rule === void 0 ? void 0 : rule.consumer) === _common.ALERTS_FEATURE_ID && ruleType !== null && ruleType !== void 0 && ruleType.producer ? [ruleType.producer] : rule ? [rule.consumer] : [];
