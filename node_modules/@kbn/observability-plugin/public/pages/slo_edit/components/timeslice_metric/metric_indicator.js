...
const NEW_TIMESLICE_METRIC = {
  name: 'A',
  aggregation: 'avg',
  field: ''
};
exports.NEW_TIMESLICE_METRIC = NEW_TIMESLICE_METRIC;
...
const equationLabel = _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.equationLabel', {
  defaultMessage: 'Equation'
});
const equationTooltip = /*#__PURE__*/_react.default.createElement(_eui.EuiIconTip, {
  content: _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.totalEquation.tooltip', {
    defaultMessage: 'This supports basic math (A + B / C) and boolean logic (A < B ? A : B).'
  }),
  position: "top"
});
const thresholdLabel = _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.thresholdLabel', {
  defaultMessage: 'Threshold'
});
const thresholdTooltip = /*#__PURE__*/_react.default.createElement(_eui.EuiIconTip, {
  content: _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.threshold.tooltip', {
...
function MetricIndicator({
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, null, fields === null || fields === void 0 ? void 0 : fields.map((metric, index) => /*#__PURE__*/_react.default.createElement(_react.default.Fragment, {
    key: metric.id
    ...
    title: _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.deleteLabel', {
      defaultMessage: 'Delete metric'
    }),
    "aria-label": _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.deleteLabel', {
      defaultMessage: 'Delete metric'
    })
    ...
    "aria-label": _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.addMetricAriaLabel', {
    ...
    render: ({
      ...
      error: [_i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.equation.invalidCharacters', {
    ...
    render: ({
      ...
      fullWidth: true,
      isInvalid: fieldState.invalid,
      label: _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.comparatorLabel', {
    ...
    size: "xs",
    color: "subdued"
  }, /*#__PURE__*/_react.default.createElement("p", null, _i18n.i18n.translate('xpack.observability.slo.sloEdit.sliType.timesliceMetric.equationHelpText', {
