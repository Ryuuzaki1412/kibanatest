...
const SLO_REQUIRED = _i18n.i18n.translate('xpack.observability.sloEmbeddable.config.errors.sloRequired', {
...
function SloSelector({
  ...
  const mapSlosToOptions = slos => {
    ...
    return (_slos$map = slos === null || slos === void 0 ? void 0 : slos.map(slo => ({
      label: slo.instanceId !== _sloSchema.ALL_VALUE ? `${slo.name} (${slo.groupBy}: ${slo.instanceId})` : slo.name,
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiFormRow, {
    ...
    "aria-label": _i18n.i18n.translate('xpack.observability.sloEmbeddable.config.sloSelector.ariaLabel', {
      defaultMessage: 'SLO'
    }),
    placeholder: _i18n.i18n.translate('xpack.observability.sloEmbeddable.config.sloSelector.placeholder', {
