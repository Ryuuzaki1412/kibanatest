...
const uiSettings = {
  ...
  [_ui_settings_keys.profilingDatacenterPUE]: {
    ...
    description: _i18n.i18n.translate('xpack.observability.profilingDatacenterPUEUiSettingDescription', {
      ...
      `,
      values: {
        uptimeLink: '<a href="https://ela.st/uptimeinstitute" target="_blank" rel="noopener noreferrer">' + _i18n.i18n.translate('xpack.observability.profilingDatacenterPUEUiSettingDescription.uptimeLink', {
  ...
  [_ui_settings_keys.profilingUseLegacyCo2Calculation]: {
    category: [_common.observabilityFeatureId],
    name: _i18n.i18n.translate('xpack.observability.profilingUseLegacyCo2Calculation', {
