...
var _panel_actions = require("./embeddable_panel/panel_actions");
/*
...
class EmbeddablePublicPlugin {
  ...
  start(core, deps) {
    ...
    const editPanel = new _panel_actions.EditPanelAction(this.getEmbeddableFactory, core.application, this.stateTransferService);
    const timeRangeBadge = new _panel_actions.CustomTimeRangeBadge(overlays, theme, editPanel, commonlyUsedRanges, dateFormat);
