  ...
  return class VislibVisController {
    ...
    async render(esResponse, visParams, handlers, renderComplete) {
      ...
      if (this.showLegend(visParams)) {
        (0, _jquery.default)(this.container).attr('class', (i, cls) => {
    ...
    mountLegend(visData, visParams, fireEvent, uiState) {
      const {
        legendPosition
      } = visParams;
      this.unmountLegend = (0, _public.toMountPoint)( /*#__PURE__*/_react.default.createElement(_legend.VisLegend, {
        ref: this.legendRef,
