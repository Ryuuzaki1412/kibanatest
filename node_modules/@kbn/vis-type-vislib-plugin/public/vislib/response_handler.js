...
exports.vislibSeriesResponseHandler = void 0;
...
function tableResponseHandler(table, dimensions) {
  ...
  if (split) {
    ...
    const splitColumnFormatter = (0, _services.getFormatService)().deserialize(split[0].format);
...
const vislibSeriesResponseHandler = handlerFunction(_helpers.buildPointSeriesData);
exports.vislibSeriesResponseHandler = vislibSeriesResponseHandler;