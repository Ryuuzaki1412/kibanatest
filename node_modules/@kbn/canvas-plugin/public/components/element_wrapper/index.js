...
const ElementWrapper = (0, _recompose.compose)((0, _reactRedux.connectAdvanced)(selectorFactory), (0, _recompose.withPropsOnChange)((props, nextProps) => !(0, _reactFastCompare.default)(props.element, nextProps.element), props => {
  const {
    element,
    createHandlers
  } = props;
