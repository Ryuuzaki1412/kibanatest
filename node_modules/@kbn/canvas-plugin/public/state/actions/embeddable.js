...
const UpdateEmbeddableExpressionActionType = 'updateEmbeddableExpression';
exports.UpdateEmbeddableExpressionActionType = UpdateEmbeddableExpressionActionType;
const updateEmbeddableExpression = (0, _reduxActions.createAction)(UpdateEmbeddableExpressionActionType);
exports.updateEmbeddableExpression = updateEmbeddableExpression;
const fetchEmbeddableRenderable = (0, _create_thunk.createThunk)('fetchEmbeddableRenderable', ({
  dispatch,
  getState
}, elementId) => {
