...
const help = {
  help: _i18n.i18n.translate('xpack.canvas.functions.filtersHelpText', {
    defaultMessage: 'Aggregates element filters from the workpad for use elsewhere, usually a data source. {FILTER_FN} is deprecated and will be removed in a future release. Use {REPLACEMENT} instead.',
    values: {
      FILTER_FN: '`filters`',
