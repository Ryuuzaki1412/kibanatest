...
const INTERNAL_API_ROUTE = '/internal/canvas';
exports.INTERNAL_API_ROUTE = INTERNAL_API_ROUTE;
const API_ROUTE_WORKPAD = `${INTERNAL_API_ROUTE}/workpad`;
...
const API_ROUTE_WORKPAD_ASSETS = `${INTERNAL_API_ROUTE}/workpad-assets`;
exports.API_ROUTE_WORKPAD_ASSETS = API_ROUTE_WORKPAD_ASSETS;
const API_ROUTE_WORKPAD_STRUCTURES = `${INTERNAL_API_ROUTE}/workpad-structures`;
exports.API_ROUTE_WORKPAD_STRUCTURES = API_ROUTE_WORKPAD_STRUCTURES;
const API_ROUTE_CUSTOM_ELEMENT = `${INTERNAL_API_ROUTE}/custom-element`;
exports.API_ROUTE_CUSTOM_ELEMENT = API_ROUTE_CUSTOM_ELEMENT;
const API_ROUTE_TEMPLATES = `${INTERNAL_API_ROUTE}/templates`;
...
const API_ROUTE_FUNCTIONS = `${INTERNAL_API_ROUTE}/fns`;
