...
class LegacyAlertsClient {
  ...
  processAlerts({
    ...
    const alerts = (0, _lib.getAlertsForNotification)(flappingSettings, notifyOnActionGroupChange, this.options.ruleType.defaultActionGroupId, processedAlertsNew, processedAlertsActive, trimmedAlertsRecovered, processedAlertsRecoveredCurrent);
