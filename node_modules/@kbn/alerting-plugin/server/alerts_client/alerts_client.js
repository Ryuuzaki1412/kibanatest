...
class AlertsClient {
  ...
  async persistAlerts() {
    ...
    if (!((_this$ruleType$alerts2 = this.ruleType.alerts) !== null && _this$ruleType$alerts2 !== void 0 && _this$ruleType$alerts2.shouldWrite)) {
      ...
      this.options.logger.debug(`Resources registered and installed for ${(_this$ruleType$alerts3 = this.ruleType.alerts) === null || _this$ruleType$alerts3 === void 0 ? void 0 : _this$ruleType$alerts3.context} context but "shouldWrite" is set to false.`);
      return;
    }
    ...
    for (const id of (0, _lodash.keys)(recoveredAlertsToReturn)) {
      ...
      if (this.fetchedAlerts.data.hasOwnProperty(id)) {
        ...
        this.options.logger.debug(`Could not find alert document to update for recovered alert with id ${id} and uuid ${recoveredAlerts[id].getUuid()}`);
      }
    }
  ...
  async getSummarizedAlerts({
    ...
    var _this$ruleType$alerts4, _this$ruleType$autoRe;
    if (!ruleId || !spaceId) {
    ...
    const formatAlert = (_this$ruleType$alerts4 = this.ruleType.alerts) === null || _this$ruleType$alerts4 === void 0 ? void 0 : _this$ruleType$alerts4.formatAlert;
  ...
  async updateAlertsMaintenanceWindowIdByScopedQuery({
    ruleId,
    spaceId,
    executionUuid,
    maintenanceWindows
