...
var _clone = require("./methods/clone");
...
var _bulk_enable = require("./methods/bulk_enable");
...
const fieldsToExcludeFromRevisionUpdates = new Set(['activeSnoozes', 'alertTypeId', 'apiKey', 'apiKeyOwner', 'apiKeyCreatedByUser', 'consumer', 'createdAt', 'createdBy', 'enabled', 'executionStatus', 'id', 'isSnoozedUntil', 'lastRun', 'monitoring', 'muteAll', 'mutedInstanceIds', 'nextRun', 'revision', 'running', 'snoozeSchedule', 'updatedBy', 'updatedAt']);
exports.fieldsToExcludeFromRevisionUpdates = fieldsToExcludeFromRevisionUpdates;
class RulesClient {
  constructor(context) {
    (0, _defineProperty2.default)(this, "context", void 0);
    (0, _defineProperty2.default)(this, "aggregate", params => (0, _aggregate.aggregateRules)(this.context, params));
    (0, _defineProperty2.default)(this, "clone", (...args) => (0, _clone.clone)(this.context, ...args));
    ...
    (0, _defineProperty2.default)(this, "find", params => (0, _find.find)(this.context, params));
    ...
    (0, _defineProperty2.default)(this, "bulkEnableRules", options => (0, _bulk_enable.bulkEnableRules)(this.context, options));
