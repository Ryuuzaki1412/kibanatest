...
exports.RunningHandler = void 0;
var _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty"));
var _partially_update_alert = require("../saved_objects/partially_update_alert");
/*
...
class RunningHandler {
  ...
  setRunning(ruleId, namespace) {
    ...
    this.runningPromise = (0, _partially_update_alert.partiallyUpdateAlert)(this.client, ruleId, {
      running: true
    }, {
      ignore404: true,
      namespace,
...
exports.RunningHandler = RunningHandler;