...
var _raw_rule = require("./saved_objects/schemas/raw_rule");
/*
...
class RuleTypeRegistry {
  constructor({
    ...
    (0, _defineProperty2.default)(this, "latestRuleVersion", void 0);
    this.config = config;
    this.logger = logger;
  ...
  register(ruleType) {
    ...
    this.taskManager.registerTaskDefinitions({
      [`alerting:${ruleType.id}`]: {
        ...
        indirectParamsSchema: _raw_rule.rawRuleSchemaV1
      }
    });
