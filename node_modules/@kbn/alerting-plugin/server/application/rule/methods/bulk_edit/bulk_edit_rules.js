...
async function updateRuleAttributesAndParamsInMemory({
  ...
  try {
    ...
    const {
      ...
      // TODO (http-versioning) Remove this cast once we fix injectReferencesIntoActions
      ruleType
    });
    ...
    const ruleAttributes = (0, _transforms.transformRuleDomainToRuleAttributes)(updatedRule, {
    ...
    const {
      updatedAttributes
    } = updateAttributes(context, ruleAttributes, apiKeyAttributes, updatedParams, rawAlertActions, username);
    rules.push({
      ...rule,
      references,
      ...
      case 'actions':
        {
          ...
          try {
            ...
            updatedRule = await attemptToMigrateLegacyFrequency(context, updatedOperation, updatedRule, ruleType);
          }
          const {
            modifiedAttributes,
            isAttributeModified
...
async function attemptToMigrateLegacyFrequency(context, operation, rule, ruleType) {
