...
const bulkEditRuleSnoozeScheduleSchema = _configSchema.schema.object({
  id: _configSchema.schema.maybe(_configSchema.schema.string()),
  duration: _configSchema.schema.number(),
  rRule: _schemas.rRuleRequestSchema
});
exports.bulkEditRuleSnoozeScheduleSchema = bulkEditRuleSnoozeScheduleSchema;
...
const bulkEditActionSchema = _configSchema.schema.object({
  ...
  frequency: _configSchema.schema.maybe(_configSchema.schema.object({
    ...
    notifyWhen: _schemas2.notifyWhenSchema
  }))
});
...
const bulkEditActionsSchema = _configSchema.schema.object({
  ...
  value: _configSchema.schema.arrayOf(bulkEditActionSchema)
});
...
const bulkEditOperationSchema = _configSchema.schema.oneOf([bulkEditTagSchema, bulkEditActionsSchema, bulkEditScheduleSchema, bulkEditThrottleSchema, bulkEditNotifyWhenSchema, bulkEditSnoozeSchema, bulkEditUnsnoozeSchema, bulkEditApiKeySchema]);
exports.bulkEditOperationSchema = bulkEditOperationSchema;
const bulkEditOperationsSchema = _configSchema.schema.arrayOf(bulkEditOperationSchema, {
  minSize: 1
});
