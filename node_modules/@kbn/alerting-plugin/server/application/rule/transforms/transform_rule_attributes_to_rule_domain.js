...
const transformRuleAttributesToRuleDomain = (esRule, transformParams) => {
  ...
  let actions = esRule.actions ? (0, _common.injectReferencesIntoActions)(id, esRule.actions, references || []) : [];
  if (omitGeneratedValues) {
    actions = actions.map(ruleAction => (0, _lodash.omit)(ruleAction, 'alertsFilter.query.dsl'));
  }
