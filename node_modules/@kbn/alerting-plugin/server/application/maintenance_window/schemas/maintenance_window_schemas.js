...
const maintenanceWindowCategoryIdsSchema = _configSchema.schema.maybe(_configSchema.schema.nullable(_configSchema.schema.arrayOf(_configSchema.schema.oneOf([_configSchema.schema.literal(_constants.maintenanceWindowCategoryIdTypes.OBSERVABILITY), _configSchema.schema.literal(_constants.maintenanceWindowCategoryIdTypes.SECURITY_SOLUTION), _configSchema.schema.literal(_constants.maintenanceWindowCategoryIdTypes.MANAGEMENT)]))));
exports.maintenanceWindowCategoryIdsSchema = maintenanceWindowCategoryIdsSchema;
const maintenanceWindowSchema = _configSchema.schema.object({
...
exports.maintenanceWindowSchema = maintenanceWindowSchema;