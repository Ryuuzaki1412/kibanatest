...
const createMaintenanceWindowParamsSchema = _configSchema.schema.object({
  data: _configSchema.schema.object({
    title: _configSchema.schema.string(),
    duration: _configSchema.schema.number(),
    rRule: _schemas2.rRuleRequestSchema,
...
exports.createMaintenanceWindowParamsSchema = createMaintenanceWindowParamsSchema;