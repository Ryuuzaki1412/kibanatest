...
exports.scheduleIdsSchema = exports.ruleSnoozeScheduleSchema = exports.ruleResponseSchema = exports.ruleParamsSchema = exports.ruleLastRunSchema = exports.ruleExecutionStatusSchema = exports.notifyWhenSchema = exports.monitoringSchema = exports.mappedParamsSchema = exports.actionParamsSchema = void 0;
...
const ruleParamsSchema = _configSchema.schema.recordOf(_configSchema.schema.string(), _configSchema.schema.maybe(_configSchema.schema.any()));
exports.ruleParamsSchema = ruleParamsSchema;
const actionParamsSchema = _configSchema.schema.recordOf(_configSchema.schema.string(), _configSchema.schema.maybe(_configSchema.schema.any()));
exports.actionParamsSchema = actionParamsSchema;
const mappedParamsSchema = _configSchema.schema.recordOf(_configSchema.schema.string(), _configSchema.schema.maybe(_configSchema.schema.any()));
exports.mappedParamsSchema = mappedParamsSchema;
const notifyWhenSchema = _configSchema.schema.oneOf([_configSchema.schema.literal(_v.ruleNotifyWhen.CHANGE), _configSchema.schema.literal(_v.ruleNotifyWhen.ACTIVE), _configSchema.schema.literal(_v.ruleNotifyWhen.THROTTLE)], {
  validate: _validation.validateNotifyWhenV1
});
exports.notifyWhenSchema = notifyWhenSchema;
...
const ruleExecutionStatusSchema = _configSchema.schema.object({
...
exports.ruleExecutionStatusSchema = ruleExecutionStatusSchema;
const ruleLastRunSchema = _configSchema.schema.object({
...
exports.ruleLastRunSchema = ruleLastRunSchema;
const monitoringSchema = _configSchema.schema.object({
...
exports.monitoringSchema = monitoringSchema;
...
const ruleResponseSchema = _configSchema.schema.object({
  id: _configSchema.schema.string(),
...
exports.ruleResponseSchema = ruleResponseSchema;
