...
const maintenanceWindowEventSchema = _configSchema.schema.object({
  gte: _configSchema.schema.string(),
  lte: _configSchema.schema.string()
});
exports.maintenanceWindowEventSchema = maintenanceWindowEventSchema;
const maintenanceWindowResponseSchema = _configSchema.schema.object({
  ...
  status: _configSchema.schema.oneOf([_configSchema.schema.literal(_.maintenanceWindowStatusV1.RUNNING), _configSchema.schema.literal(_.maintenanceWindowStatusV1.UPCOMING), _configSchema.schema.literal(_.maintenanceWindowStatusV1.FINISHED), _configSchema.schema.literal(_.maintenanceWindowStatusV1.ARCHIVED)]),
...
exports.maintenanceWindowResponseSchema = maintenanceWindowResponseSchema;