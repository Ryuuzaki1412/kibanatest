...
var _elasticsearch_fieldnames = require("../components/shared/exploratory_view/configurations/constants/elasticsearch_fieldnames");
/*
...
const getIncludeClause = (sourceField, query) => {
  ...
  let includeClause = '';
  if (sourceField === _elasticsearch_fieldnames.TRANSACTION_URL) {
