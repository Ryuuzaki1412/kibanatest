...
exports.ExpViewActionMenu = ExpViewActionMenu;
...
function ExpViewActionMenu(props) {
  const {
    setHeaderActionMenu,
    theme$
  ...
  return /*#__PURE__*/_react.default.createElement(_public.HeaderMenuPortal, {
    ...
    theme$: theme$
  }, /*#__PURE__*/_react.default.createElement(_action_menu.ExpViewActionMenuContent, props));
}