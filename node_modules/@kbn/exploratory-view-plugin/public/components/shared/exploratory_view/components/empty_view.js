...
const FlexGroup = (0, _styledComponents.default)(_eui.EuiFlexGroup)`
  height: 100%;
`;
const EMPTY_LABEL = _i18n.i18n.translate('xpack.exploratoryView.expView.seriesBuilder.emptyview', {
  defaultMessage: 'Nothing to display.'
});
exports.EMPTY_LABEL = EMPTY_LABEL;
const CHOOSE_REPORT_DEFINITION = _i18n.i18n.translate('xpack.exploratoryView.expView.seriesBuilder.emptyReportDefinition', {
  defaultMessage: 'Select a report definition to create a visualization.'
});
exports.CHOOSE_REPORT_DEFINITION = CHOOSE_REPORT_DEFINITION;
const SELECT_REPORT_TYPE_BELOW = _i18n.i18n.translate('xpack.exploratoryView.expView.seriesBuilder.selectReportType.empty', {
  defaultMessage: 'Select a report type to create a visualization.'
});
exports.SELECT_REPORT_TYPE_BELOW = SELECT_REPORT_TYPE_BELOW;
