...
const TableActions = ({
  ...
  }, /*#__PURE__*/_react.default.createElement(_table_row_btn_filter_add.DocViewTableRowBtnFilterAdd, {
    disabled: !fieldMapping || !fieldMapping.filterable || ignoredValue || !onFilter,
    onClick: () => onFilter(fieldMapping, flattenedField, '+')
  }), /*#__PURE__*/_react.default.createElement(_table_row_btn_filter_remove.DocViewTableRowBtnFilterRemove, {
    disabled: !fieldMapping || !fieldMapping.filterable || ignoredValue || !onFilter,
    onClick: () => onFilter(fieldMapping, flattenedField, '-')
  }), /*#__PURE__*/_react.default.createElement(_table_row_btn_toggle_column.DocViewTableRowBtnToggleColumn, {
    active: isActive,
    fieldname: field,
    onClick: () => onToggleColumn(field)
  }), /*#__PURE__*/_react.default.createElement(_table_row_btn_filter_exists.DocViewTableRowBtnFilterExists, {
