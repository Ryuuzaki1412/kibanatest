...
function getTypicalAndActualValues(source) {
  ...
  if ((0, _mlAnomalyUtils.showActualForFunction)(functionDescription)) {
  ...
  if ((0, _mlAnomalyUtils.showTypicalForFunction)(functionDescription)) {
...
function resultsServiceProvider(mlClient, client) {
  ...
  async function getCategoryStoppedPartitions(jobIds, fieldToBucket = _mlAnomalyUtils.ML_PARTITION_FIELD_VALUE) {
    let finalResults = {
      jobs: {}
    };
        ...
        jobs: {
          ...
          aggs: {
            unique_stopped_partitions: {
              terms: {
                field: _mlAnomalyUtils.ML_PARTITION_FIELD_VALUE
              }
            }
          }
        }
    ...
    if (jobIdsWithStopOnWarnSet.length > 0) {
      ...
      } else if (fieldToBucket === _mlAnomalyUtils.ML_PARTITION_FIELD_VALUE) {
