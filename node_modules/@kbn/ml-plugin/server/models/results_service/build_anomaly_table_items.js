...
function buildAnomalyTableItems(anomalyRecords, aggregationInterval, dateFormatTz) {
  ...
  return displayRecords.map((record, index) => {
    ...
    const entityName = (0, _mlAnomalyUtils.getEntityFieldName)(source);
    if (entityName !== undefined) {
      record.entityName = entityName;
      record.entityValue = (0, _mlAnomalyUtils.getEntityFieldValue)(source);
    }
    ...
    if ((0, _mlAnomalyUtils.showActualForFunction)(functionDescription) === true) {
    ...
    if ((0, _mlAnomalyUtils.showTypicalForFunction)(functionDescription) === true) {
...
function aggregateAnomalies(anomalyRecords, interval, dateFormatTz) {
  ...
  anomalyRecords.forEach(record => {
    ...
    let entity = (0, _mlAnomalyUtils.getEntityFieldValue)(record);
    if (entity === undefined) {
      entity = '';
    }
