...
const categorizationFieldValidationSchema = {
...
exports.categorizationFieldValidationSchema = categorizationFieldValidationSchema;
...
const deleteJobsSchema = _configSchema.schema.object({
  /** List of job IDs. */
  jobIds: _configSchema.schema.arrayOf(_configSchema.schema.string()),
  deleteUserAnnotations: _configSchema.schema.maybe(_configSchema.schema.boolean())
});
exports.deleteJobsSchema = deleteJobsSchema;
