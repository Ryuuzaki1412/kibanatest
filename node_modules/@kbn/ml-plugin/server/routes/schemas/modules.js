...
exports.setupModuleBodySchema = exports.recognizeModulesSchema = exports.optionalModuleIdParamSchema = exports.moduleIdParamSchema = exports.moduleFilterSchema = void 0;
...
const recognizeModulesSchema = _configSchema.schema.object({
  /**
...
exports.recognizeModulesSchema = recognizeModulesSchema;
const moduleFilterSchema = _configSchema.schema.object({
  filter: _configSchema.schema.maybe(_configSchema.schema.string())
});
exports.moduleFilterSchema = moduleFilterSchema;