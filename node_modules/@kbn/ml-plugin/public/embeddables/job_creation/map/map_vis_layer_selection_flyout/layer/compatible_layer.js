...
const CompatibleLayer = ({
  ...
  const quickJobCreator = (0, _react.useMemo)(() => new _job_from_map.QuickGeoJobCreator(uiSettings, data.query.timefilter.timefilter, dashboardService, mlApiServices),
