...
exports.GeoJobFlyout = void 0;
var _react = _interopRequireWildcard(require("react"));
var _i18nReact = require("@kbn/i18n-react");
var _eui = require("@elastic/eui");
var _layer = require("./map_vis_layer_selection_flyout/layer");
...
const GeoJobFlyout = ({
  ...
  (0, _react.useEffect)(() => {
    const visExtractor = new _job_from_map.VisualizationExtractor();
    visExtractor.getResultLayersFromEmbeddable(embeddable).then(setLayerResults).catch(error => {
...
exports.GeoJobFlyout = GeoJobFlyout;