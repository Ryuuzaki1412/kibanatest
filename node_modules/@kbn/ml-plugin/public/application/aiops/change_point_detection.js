...
const ChangePointDetectionPage = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_page_header.MlPageHeader, null, /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
    ...
    appDependencies: {
      ...(0, _lodash.pick)(services, ['application', 'cases', 'charts', 'data', 'embeddable', 'executionContext', 'fieldFormats', 'http', 'i18n', 'lens', 'notifications', 'presentationUtil', 'share', 'storage', 'theme', 'uiActions', 'uiSettings', 'unifiedSearch', 'usageCollection']),
      fieldStats: {
