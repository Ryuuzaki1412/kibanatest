...
exports.ForecastingModalUI = exports.ForecastingModal = exports.FORECAST_DURATION_MAX_DAYS = void 0;
...
const FORECAST_DURATION_MAX_DAYS = 3650; // Max forecast duration allowed by analytics.
exports.FORECAST_DURATION_MAX_DAYS = FORECAST_DURATION_MAX_DAYS;
...
class ForecastingModalUI extends _react.Component {
  constructor(props) {
    super(props);
    ...
    (0, _defineProperty2.default)(this, "runForecast", closeJobAfterRunning => {
      ...
      _forecast_service.mlForecastService.runForecast(this.props.job.job_id, `${durationInSeconds}s`).then(resp => {
    ...
    (0, _defineProperty2.default)(this, "waitForForecastResults", (forecastId, closeJobAfterRunning) => {
      ...
      this.forecastChecker = setInterval(() => {
        _forecast_service.mlForecastService.getForecastRequestStats(this.props.job, forecastId).then(resp => {
    ...
    (0, _defineProperty2.default)(this, "openModal", () => {
      ...
      if (typeof job === 'object') {
        ...
        const {
          timefilter
        } = this.props.kibana.services.data.query.timefilter;
        ...
        _forecast_service.mlForecastService.getForecastsSummary(job, statusFinishedQuery, bounds.min.valueOf(), FORECASTS_VIEW_MAX).then(resp => {
          this.setState({
...
exports.ForecastingModalUI = ForecastingModalUI;
(0, _defineProperty2.default)(ForecastingModalUI, "propTypes", {
...
const ForecastingModal = (0, _public.withKibana)(ForecastingModalUI);
