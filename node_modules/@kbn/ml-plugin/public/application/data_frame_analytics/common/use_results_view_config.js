      ...
      try {
        ...
        if (Array.isArray(analyticsConfigs.data_frame_analytics) && analyticsConfigs.data_frame_analytics.length > 0) {
          ...
          try {
            ...
            const destDataViewId = (_await$getDataViewIdF = await (0, _index_utils.getDataViewIdFromName)(destIndex)) !== null && _await$getDataViewIdF !== void 0 ? _await$getDataViewIdF : destIndex;
            let fetchedDataView;
            try {
            ...
            if (fetchedDataView === undefined) {
              ...
              const sourceDataViewId = (_await$getDataViewIdF2 = await (0, _index_utils.getDataViewIdFromName)(sourceIndex)) !== null && _await$getDataViewIdF2 !== void 0 ? _await$getDataViewIdF2 : sourceIndex;
              try {
