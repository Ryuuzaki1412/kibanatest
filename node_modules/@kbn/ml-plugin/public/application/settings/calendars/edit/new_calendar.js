...
class NewCalendarUI extends _react.Component {
  constructor(props) {
    ...
    (0, _defineProperty2.default)(this, "onCreate", async () => {
      ...
      if (this.isDuplicateId()) {
        ...
        try {
          ...
          toasts.addDanger(_i18n.i18n.translate('xpack.ml.calendarsEdit.errorWithCreatingCalendarErrorMessage', {
    ...
    (0, _defineProperty2.default)(this, "onEdit", async () => {
      ...
      try {
        ...
        toasts.addDanger(_i18n.i18n.translate('xpack.ml.calendarsEdit.errorWithUpdatingCalendarErrorMessage', {
  ...
  async formSetup() {
    try {
      ...
      toasts.addDanger(_i18n.i18n.translate('xpack.ml.calendarsEdit.errorWithLoadingCalendarFromDataErrorMessage', {
...
const NewCalendar = (0, _public.withKibana)(NewCalendarUI);
