  ...
  constructor(props) {
    ...
    (0, _defineProperty2.default)(this, "loadFilterList", filterId => {
      _ml_api_service.ml.filters.filters({
        ...
        toasts.addDanger(_i18n.i18n.translate('xpack.ml.settings.filterLists.editFilterList.loadingDetailsOfFilterErrorMessage', {
    ...
    (0, _defineProperty2.default)(this, "save", () => {
      ...
      (0, _utils.saveFilterList)(filterId, description, items, loadedFilter).then(savedFilter => {
        ...
        toasts.addDanger(_i18n.i18n.translate('xpack.ml.settings.filterLists.editFilterList.savingFilterErrorMessage', {
...
const EditFilterList = (0, _public.withKibana)(EditFilterListUI);
exports.EditFilterList = EditFilterList;