...
class MlCapabilitiesService {
  ...
  constructor(mlApiServices) {
    ...
    (0, _defineProperty2.default)(this, "capabilities$", this._capabilities$.pipe((0, _operators.distinctUntilChanged)(_lodash.isEqual)));
    (0, _defineProperty2.default)(this, "_subscription", void 0);
    this.mlApiServices = mlApiServices;
    this.init();
  }
  init() {
    this._subscription = (0, _rxjs.combineLatest)([this._updateRequested$, (0, _rxjs.timer)(0, CAPABILITIES_REFRESH_INTERVAL)]).pipe((0, _operators.tap)(() => {
      this._isLoading$.next(true);
    }), (0, _operators.switchMap)(() => (0, _rxjs.from)(this.mlApiServices.checkMlCapabilities())), (0, _operators.retry)({
...
function checkGetManagementMlJobsResolver({
  ...
  return new Promise(async (resolve, reject) => {
    try {
      const capabilities = await (0, _rxjs.firstValueFrom)(mlCapabilities.getCapabilities$().pipe((0, _operators.filter)(c => !!c)));
