...
exports.isMapEmbeddable = isMapEmbeddable;
...
function isLensEmbeddable(arg) {
  return arg.hasOwnProperty('type') && arg.type === 'lens';
}
function isMapEmbeddable(arg) {
...
class QuickJobCreatorBase {
  constructor(kibanaConfig, timeFilter, dashboardService, mlApiServices) {
  ...
  async createDashboardLink(dashboard, datafeedConfig) {
    var _this$dashboardServic;
    const dashboardTitle = dashboard === null || dashboard === void 0 ? void 0 : dashboard.getTitle();
