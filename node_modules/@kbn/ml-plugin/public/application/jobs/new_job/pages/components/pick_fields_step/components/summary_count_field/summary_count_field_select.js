...
const SummaryCountFieldSelect = ({
  ...
  const options = [...(0, _general.createDocCountFieldOption)(jobCreator.aggregationFields.length > 0), ...(0, _general.createFieldOptions)(fields, jobCreator.additionalFields)].map(o => ({
    ...o,
    css: optionCss
  }));
  const selection = [];
