...
exports.ForecastsTableUI = exports.ForecastsTable = void 0;
 ...
 */
class ForecastsTableUI extends _react.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    ...
    if (dataCounts.processed_record_count > 0) {
      ...
      _forecast_service.mlForecastService.getForecastsSummary(this.props.job, null, dataCounts.earliest_record_timestamp, MAX_FORECASTS).then(resp => {
        this.setState({
          isLoading: false,
...
exports.ForecastsTableUI = ForecastsTableUI;
ForecastsTableUI.propTypes = {
  job: _propTypes.default.object.isRequired
};
const ForecastsTable = (0, _public.withKibana)(ForecastsTableUI);
