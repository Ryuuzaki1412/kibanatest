...
exports.fromLensRouteFactory = void 0;
...
var _job_from_lens = require("../../../jobs/new_job/job_from_lens");
/*
...
const fromLensRouteFactory = () => ({
  path: (0, _router.createPath)(_locator.ML_PAGES.ANOMALY_DETECTION_CREATE_JOB_FROM_LENS),
  render: (props, deps) => /*#__PURE__*/_react.default.createElement(PageWrapper, (0, _extends2.default)({}, props, {
    deps: deps
  })),
  breadcrumbs: []
});
exports.fromLensRouteFactory = fromLensRouteFactory;
const PageWrapper = ({
  location
}) => {
  const {
  ...
  const {
    ...
    redirect: () => (0, _job_from_lens.resolver)({
      lens,
      mlApiServices,
      timeFilter,
      kibanaConfig,
      dashboardService
    }, vis, from, to, query, filters, layerIndex)
  });
