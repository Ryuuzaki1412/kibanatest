...
*/
const annotation$ = new _rxjs.BehaviorSubject(null);
...
const annotationsRefresh$ = new _rxjs.BehaviorSubject(Date.now());
...
class AnnotationUpdatesService {
  ...
  isAnnotationInitialized$() {
    return this._annotation$.asObservable().pipe((0, _operators.distinctUntilChanged)((prev, curr) => {
