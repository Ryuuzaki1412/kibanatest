...
var _job_map = require("../data_frame_analytics/pages/job_map");
...
const ExpandedRow = ({
  ...
  const tabs = (0, _react.useMemo)(() => {
    return [{
      ...
      }), (0, _mlIsPopulatedObject.isPopulatedObject)(pipelines) ? /*#__PURE__*/_react.default.createElement(_eui.EuiNotificationBadge, null, Object.keys(pipelines).length) : null),
      content: /*#__PURE__*/_react.default.createElement("div", {
      ...
      }, /*#__PURE__*/_react.default.createElement(_job_map.JobMap, {
  ...
  }, [analyticsConfig, deploymentStatItems, details, formatToListItems, inferenceConfig, inferenceStats, pipelines, restMetaData, stats, item.model_id, hideColumns]);
