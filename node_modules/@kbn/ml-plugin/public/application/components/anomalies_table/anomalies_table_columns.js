...
function getColumns(items, jobIds, examplesByJobId, isAggregatedData, interval, bounds, showViewSeriesLink, showRuleEditorFlyout, itemIdToExpandedRowMap, toggleRow, filter, influencerFilter, sourceIndicesWithGeoFields) {
  const columns = [{
    ...
    }, /*#__PURE__*/_react.default.createElement("span", null, _i18n.i18n.translate('xpack.ml.anomaliesTable.severityColumnName', {
  ...
  if (items.some(item => item.actual !== undefined)) {
    columns.push({
      ...
      }, /*#__PURE__*/_react.default.createElement("span", null, _i18n.i18n.translate('xpack.ml.anomaliesTable.actualSortColumnName', {
      ...
      render: (actual, item) => {
        const fieldFormat = _field_format_service.mlFieldFormatService.getFieldFormat(item.jobId, item.source.detector_index);
  ...
  if (items.some(item => item.typical !== undefined)) {
    columns.push({
      ...
      }, /*#__PURE__*/_react.default.createElement("span", null, _i18n.i18n.translate('xpack.ml.anomaliesTable.typicalSortColumnName', {
