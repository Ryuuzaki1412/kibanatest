...
var _add_inference_pipeline_footer = require("./components/add_inference_pipeline_footer");
var _add_inference_pipeline_horizontal_steps = require("./components/add_inference_pipeline_horizontal_steps");
...
var _on_failure_configuration = require("./components/on_failure_configuration");
var _test_pipeline = require("./components/test_pipeline");
var _review_and_create_pipeline = require("./components/review_and_create_pipeline");
...
const AddInferencePipelineFlyout = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiFlyout, {
  ...
  })))), /*#__PURE__*/_react.default.createElement(_eui.EuiFlyoutBody, null, /*#__PURE__*/_react.default.createElement(_add_inference_pipeline_horizontal_steps.AddInferencePipelineHorizontalSteps, {
    step: step,
    setStep: setStep,
    ...
    tag: formState.tag
  }), step === _constants.ADD_INFERENCE_PIPELINE_STEPS.ON_FAILURE && /*#__PURE__*/_react.default.createElement(_on_failure_configuration.OnFailureConfiguration, {
  ...
  }), step === _constants.ADD_INFERENCE_PIPELINE_STEPS.CREATE && /*#__PURE__*/_react.default.createElement(_review_and_create_pipeline.ReviewAndCreatePipeline, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_add_inference_pipeline_footer.AddInferencePipelineFooter, {
    onClose: onClose,
