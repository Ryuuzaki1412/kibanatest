...
exports.MlEmbeddedMapComponent = MlEmbeddedMapComponent;
...
function MlEmbeddedMapComponent({
  layerList,
  mapEmbeddableInput,
  ...
  const factory = embeddablePlugin ? embeddablePlugin.getEmbeddableFactory(_common.MAP_SAVED_OBJECT_TYPE) : undefined;

  // Update the layer list  with updated geo points upon refresh
  (0, _react.useEffect)(() => {
    async function updateIndexPatternSearchLayer() {
      if (embeddable && !(0, _public.isErrorEmbeddable)(embeddable) && Array.isArray(layerList) && Array.isArray(baseLayers.current)) {
  ...
  (0, _react.useEffect)(() => {
    if (embeddable && !(0, _public.isErrorEmbeddable)(embeddable) && mapEmbeddableInput !== undefined) {
      embeddable.updateInput(mapEmbeddableInput);
    }
  }, [embeddable, mapEmbeddableInput]);
  (0, _react.useEffect)(() => {
    if (embeddable && !(0, _public.isErrorEmbeddable)(embeddable) && renderTooltipContent !== undefined) {
