...
exports.OUTLIER_SCORE_FIELD = OUTLIER_SCORE_FIELD;
const SCATTERPLOT_SIZE = 125;
const USER_SELECTION = 'user_selection';
exports.USER_SELECTION = USER_SELECTION;
const SINGLE_POINT_CLICK = 'single_point_click';
exports.SINGLE_POINT_CLICK = SINGLE_POINT_CLICK;
const COLOR_BLUR = '#bbb';
exports.COLOR_BLUR = COLOR_BLUR;
const COLOR_OUTLIER = (0, _eui.euiPaletteNegative)(2)[1];
exports.COLOR_OUTLIER = COLOR_OUTLIER;
const COLOR_SELECTION = (0, _eui.euiPaletteColorBlind)()[2];
exports.COLOR_SELECTION = COLOR_SELECTION;
const COLOR_RANGE_OUTLIER = [(0, _eui.euiPaletteColorBlind)()[1], (0, _eui.euiPaletteColorBlind)()[2]];
exports.COLOR_RANGE_OUTLIER = COLOR_RANGE_OUTLIER;
const COLOR_RANGE_NOMINAL = (0, _eui.euiPaletteColorBlind)({
  rotations: 2
});
exports.COLOR_RANGE_NOMINAL = COLOR_RANGE_NOMINAL;
const COLOR_RANGE_QUANTITATIVE = (0, _eui.euiPalettePositive)(5);
exports.COLOR_RANGE_QUANTITATIVE = COLOR_RANGE_QUANTITATIVE;
