...
exports.MlNodeAvailableWarningShared = void 0;
...
const MlNodeAvailableWarningShared = ({
  ...
  const {
    ...
    deploymentId,
    isCloudTrial
  } = (0, _hooks.useMlNodeAvailableCheck)();
  (0, _react.useEffect)(function callCallback() {
...
exports.MlNodeAvailableWarningShared = MlNodeAvailableWarningShared;