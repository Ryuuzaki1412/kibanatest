...
exports.explorerService = exports.explorerAction$ = void 0;
...
const explorerAction$ = new _rxjs.Subject();
...
(0, _operators.flatMap)(action => (0, _rxjs.isObservable)(action) ? action : (0, _rxjs.from)([action])), (0, _operators.distinctUntilChanged)(_lodash.isEqual));

// applies action and returns state
const explorerState$ = explorerFilteredAction$.pipe((0, _operators.scan)(_reducers.explorerReducer, (0, _reducers.getExplorerDefaultState)()),
