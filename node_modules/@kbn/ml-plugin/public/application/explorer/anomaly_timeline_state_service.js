...
class AnomalyTimelineStateService extends _state_service.StateService {
  ...
  constructor(anomalyExplorerUrlStateService, anomalyExplorerCommonStateService, anomalyTimelineService, timefilter) {
    ...
    (0, _defineProperty2.default)(this, "timeDomain$", this._overallSwimLaneData$.pipe((0, _operators.map)(data => {
      if (!data) return null;
      return {
    ...
    this._timeBounds$ = this.timefilter.getTimeUpdate$().pipe((0, _operators.startWith)(null), (0, _operators.map)(() => this.timefilter.getBounds()));
    this._refreshSubject$ = _mlDatePicker.mlTimefilterRefresh$.pipe((0, _operators.startWith)({
      lastRefresh: 0
    }));
  ...
  _initSubscriptions() {
    ...
    subscription.add(this.anomalyExplorerUrlStateService.getPageUrlState$().pipe((0, _operators.map)(v => v === null || v === void 0 ? void 0 : v.mlExplorerSwimlane), (0, _operators.distinctUntilChanged)(_lodash.isEqual)).subscribe(this._swimLaneUrlState$));
    subscription.add(this._initViewByData());
    subscription.add(this._swimLaneUrlState$.pipe((0, _operators.map)(v => {
      var _v$severity;
      return (_v$severity = v === null || v === void 0 ? void 0 : v.severity) !== null && _v$severity !== void 0 ? _v$severity : 0;
    }), (0, _operators.distinctUntilChanged)()).subscribe(this._swimLaneSeverity$));
  ...
  _initViewByData() {
    return (0, _rxjs.combineLatest)([this._swimLaneUrlState$.pipe((0, _operators.map)(v => v === null || v === void 0 ? void 0 : v.viewByFieldName), (0, _operators.distinctUntilChanged)()), this.anomalyExplorerCommonStateService.getSelectedJobs$(), this.anomalyExplorerCommonStateService.getFilterSettings$(), this._selectedCells$]).subscribe(([currentlySelected, selectedJobs, filterSettings, selectedCells]) => {
      const {
  ...
  _initSwimLanePagination() {
    return (0, _rxjs.combineLatest)([this._swimLaneUrlState$.pipe((0, _operators.map)(v => {
    ...
    }), (0, _operators.distinctUntilChanged)(_lodash.isEqual)), this.anomalyExplorerCommonStateService.getInfluencerFilterQuery$(), this._timeBounds$]).subscribe(([pagination, influencersFilerQuery]) => {
  ...
  _initOverallSwimLaneData() {
    return (0, _rxjs.combineLatest)([this.anomalyExplorerCommonStateService.getSelectedJobs$(), this._swimLaneSeverity$, this.getSwimLaneBucketInterval$(), this._timeBounds$, this._refreshSubject$]).pipe((0, _operators.tap)(() => {
      this._isOverallSwimLaneLoading$.next(true);
    }), (0, _operators.switchMap)(([selectedJobs, severity, bucketInterval]) => {
  ...
  _initTopFieldValues() {
    return (0, _rxjs.combineLatest)([this.anomalyExplorerCommonStateService.getSelectedJobs$(), this.anomalyExplorerCommonStateService.getInfluencerFilterQuery$(), this.getViewBySwimlaneFieldName$(), this.getSwimLanePagination$(), this.getSwimLaneCardinality$(), this.getSelectedCells$(), this.getSwimLaneBucketInterval$(), this._timeBounds$, this._refreshSubject$]).pipe((0, _operators.switchMap)(([selectedJobs, influencersFilterQuery, viewBySwimlaneFieldName, swimLanePagination, swimLaneCardinality, selectedCells, swimLaneBucketInterval]) => {
  ...
  _initViewBySwimLaneData() {
    return (0, _rxjs.combineLatest)([this._overallSwimLaneData$.pipe((0, _operators.skipWhile)(v => !v)), this.anomalyExplorerCommonStateService.getSelectedJobs$(), this.anomalyExplorerCommonStateService.getInfluencerFilterQuery$(), this._swimLaneSeverity$, this.getSwimLaneBucketInterval$(), this.getViewBySwimlaneFieldName$(), this.getSwimLanePagination$(), this._topFieldValues$.pipe((0, _operators.distinctUntilChanged)(_lodash.isEqual)), this._timeBounds$, this._refreshSubject$]).pipe((0, _operators.tap)(() => {
      this._isViewBySwimLaneLoading$.next(true);
    }), (0, _operators.switchMap)(([overallSwimLaneData, selectedJobs, influencersFilterQuery, severity, bucketInterval, viewBySwimlaneFieldName, swimLanePagination, topFieldValues]) => {
  ...
  _initSelectedCells() {
    return (0, _rxjs.combineLatest)([this._viewBySwimlaneFieldName$, this._swimLaneUrlState$, this.getSwimLaneBucketInterval$(), this._timeBounds$]).pipe((0, _operators.map)(([viewByFieldName, swimLaneUrlState, swimLaneBucketInterval]) => {
    ...
    }), (0, _operators.distinctUntilChanged)(_lodash.isEqual)).subscribe(this._selectedCells$);
  }
  ...
  getContainerWidth$() {
    return this._containerWidth$.pipe((0, _operators.debounceTime)(500), (0, _operators.distinctUntilChanged)((prev, curr) => {
  ...
  getSwimLaneCardinality$() {
    return this._swimLaneCardinality$.pipe((0, _operators.distinctUntilChanged)());
  }
  getViewBySwimlaneFieldName$() {
    return this._viewBySwimlaneFieldName$.pipe((0, _operators.distinctUntilChanged)());
  }
   ...
   */
  getSwimLaneJobs$() {
    return (0, _rxjs.combineLatest)([this.anomalyExplorerCommonStateService.getSelectedJobs$(), this.getViewBySwimlaneFieldName$(), this._viewBySwimLaneData$, this._selectedCells$]).pipe((0, _operators.map)(([selectedJobs, swimLaneFieldName, viewBySwimLaneData, selectedCells]) => {
  ...
  getSwimLaneBucketInterval$() {
    return this._swimLaneBucketInterval$.pipe((0, _operators.filter)(v => !!v), (0, _operators.distinctUntilChanged)((prev, curr) => {
