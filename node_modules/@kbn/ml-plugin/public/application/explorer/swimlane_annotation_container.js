...
exports.Y_AXIS_LABEL_WIDTH = exports.Y_AXIS_LABEL_PADDING = exports.SwimlaneAnnotationContainer = void 0;
...
const SwimlaneAnnotationContainer = ({
  ...
  (0, _react.useEffect)(() => {
    if (canvasRef.current !== null && Array.isArray(annotationsData)) {
      ...
      })).attr('x', Y_AXIS_LABEL_WIDTH - Y_AXIS_LABEL_PADDING).attr('y', ANNOTATION_CONTAINER_HEIGHT / 2).attr('dominant-baseline', 'middle').style('fill', euiTheme.euiTextSubduedColor).style('font-size', euiTheme.euiFontSizeXS);
