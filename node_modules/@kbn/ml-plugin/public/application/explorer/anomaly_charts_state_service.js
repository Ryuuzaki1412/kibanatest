...
class AnomalyChartsStateService extends _state_service.StateService {
  ...
  _initSubscriptions() {
    ...
    subscription.add(this._anomalyExplorerUrlStateService.getPageUrlState$().pipe((0, _operators.map)(urlState => {
