...
class AnomalyDetectionAlertsStateService extends _state_service.StateService {
  ...
  constructor(_anomalyTimelineStateServices, data, timefilter) {
    ...
    (0, _defineProperty2.default)(this, "countByStatus$", this._aadAlerts$.pipe((0, _operators.map)(alerts => {
      return this.countAlertsByStatus(alerts);
    })));
    this._anomalyTimelineStateServices = _anomalyTimelineStateServices;
    this.data = data;
    this.timefilter = timefilter;
    this.selectedAlerts$ = (0, _rxjs.combineLatest)([this._aadAlerts$, this._anomalyTimelineStateServices.getSelectedCells$().pipe((0, _operators.map)(cells => cells === null || cells === void 0 ? void 0 : cells.times))]).pipe((0, _operators.map)(([alerts, selectedTimes]) => {
    ...
    const timeUpdates$ = this.timefilter.getTimeUpdate$().pipe((0, _operators.startWith)(null), (0, _operators.map)(() => this.timefilter.getTime()));
    ...
    (0, _operators.map)(([selectedJobs, timeRange]) => {
      return {
        bool: {
          filter: [{
            term: {
  ...
  _initSubscriptions() {
    ...
    subscription.add(this.alertsQuery$.pipe((0, _operators.tap)(() => {
      this._isLoading$.next(true);
    }), (0, _operators.debounceTime)(300), (0, _operators.switchMap)(query => {
