...
function AlertActions(props) {
  var _alert$ALERT_RULE_UUI, _alert$ALERT_RULE_UUI2, _alert$ALERT_UUID$, _alert$ALERT_UUID;
  const {
    alert,
    refresh
  } = props;
  ...
  const actionsMenuItems = [...(CASES_ACTIONS_ENABLED && casesPrivileges !== null && casesPrivileges !== void 0 && casesPrivileges.create && casesPrivileges.read ? [/*#__PURE__*/_react.default.createElement(_eui.EuiContextMenuItem, {
