...
const featureMlCapabilities = {
  isADEnabled: true,
  isDFAEnabled: true,
  isNLPEnabled: true
};
exports.featureMlCapabilities = featureMlCapabilities;
...
const basicLicenseMlCapabilities = ['canFindFileStructure', 'canGetFieldInfo', 'canGetMlInfo'];
...
const featureCapabilities = {
  ...
  nlp: ['canGetTrainedModels', 'canTestTrainedModels', 'canCreateTrainedModels', 'canDeleteTrainedModels', 'canStartStopTrainedModels']
};
exports.featureCapabilities = featureCapabilities;