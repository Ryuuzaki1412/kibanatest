...
const ALERT_ANOMALY_TIMESTAMP = `${ML_ALERT_NAMESPACE}.anomaly_timestamp`;
exports.ALERT_ANOMALY_TIMESTAMP = ALERT_ANOMALY_TIMESTAMP;
const ALERT_ANOMALY_DETECTION_JOB_ID = `${ML_ALERT_NAMESPACE}.job_id`;
exports.ALERT_ANOMALY_DETECTION_JOB_ID = ALERT_ANOMALY_DETECTION_JOB_ID;
const ALERT_ANOMALY_SCORE = `${ML_ALERT_NAMESPACE}.anomaly_score`;
exports.ALERT_ANOMALY_SCORE = ALERT_ANOMALY_SCORE;
const ALERT_ANOMALY_IS_INTERIM = `${ML_ALERT_NAMESPACE}.is_interim`;
exports.ALERT_ANOMALY_IS_INTERIM = ALERT_ANOMALY_IS_INTERIM;
const ALERT_TOP_RECORDS = `${ML_ALERT_NAMESPACE}.top_records`;
exports.ALERT_TOP_RECORDS = ALERT_TOP_RECORDS;
const ALERT_TOP_INFLUENCERS = `${ML_ALERT_NAMESPACE}.top_influencers`;
exports.ALERT_TOP_INFLUENCERS = ALERT_TOP_INFLUENCERS;
const alertFieldNameMap = Object.freeze({
...
exports.alertFieldNameMap = alertFieldNameMap;