...
const useInventoryViews = () => {
  ...
  const {
    ...
    queryFn: ({
      queryKey: [, id]
    }) => inventoryViews.client.getInventoryView(id),
    onError: error => {
  ...
  const {
    ...
    mutationFn: id => updateSourceConfiguration({
  ...
  const {
    ...
    mutationFn: ({
      id,
      attributes
    }) => inventoryViews.client.updateInventoryView(id, attributes),
    onError: error => {
  ...
  const {
    ...
    mutationFn: id => inventoryViews.client.deleteInventoryView(id),
    /**
     * To provide a quick feedback, we perform an optimistic update on the list
