...
const subscribeToQuerySearchBarChanges = ({
  queryStringService
}) => context => queryStringService.getUpdates$().pipe((0, _operators.map)(() => queryStringService.getQuery()), (0, _operators.map)(query => {
  return {
...
}) => context => filterManagerService.getUpdates$().pipe((0, _operators.map)(() => filterManagerService.getFilters()), (0, _operators.map)(filters => {
  return {
