...
const ThresholdAnnotations = ({
  ...
  const isAbove = [_metrics.Comparator.GT, _metrics.Comparator.GT_OR_EQ].includes(comparator);
  const isBelow = [_metrics.Comparator.LT, _metrics.Comparator.LT_OR_EQ].includes(comparator);
  ...
  }), sortedThresholds.length === 2 && comparator === _metrics.Comparator.BETWEEN ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_charts.RectAnnotation, {
  ...
  })) : null, sortedThresholds.length === 2 && comparator === _metrics.Comparator.OUTSIDE_RANGE ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_charts.RectAnnotation, {
    id: `${id}-lower-threshold`,
