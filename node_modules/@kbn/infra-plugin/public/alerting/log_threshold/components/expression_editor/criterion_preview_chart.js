...
const CriterionPreview = ({
  ...
  return /*#__PURE__*/_react.default.createElement(CriterionPreviewChart, {
    buckets: !chartAlertParams.groupBy || chartAlertParams.groupBy.length === 0 ? _criterion_preview_chart.NUM_BUCKETS : _criterion_preview_chart.NUM_BUCKETS / 4 // Display less data for groups due to space limitations
    ,
