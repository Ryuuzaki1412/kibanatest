...
var _log_rate_analysis_type = require("@kbn/aiops-utils/log_rate_analysis_type");
...
const LogRateAnalysis = ({
  ...
  const messages = (0, _react.useMemo)(() => {
    ...
    return [{
      ...
      message: {
        content,
        role: _public2.MessageRole.User
      }
    }];
  }, [logRateAnalysisParams]);
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiPanel, {
    ...
    appDependencies: (0, _lodash.pick)(services, ['application', 'data', 'executionContext', 'charts', 'fieldFormats', 'http', 'notifications', 'share', 'storage', 'uiSettings', 'unifiedSearch', 'theme', 'lens', 'i18n'])
  }))), /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
    direction: "column",
    gutterSize: "m"
