...
const useMetricsExplorerChartData = (expression, derivedIndexPattern, source, filterQuery, groupBy, timeRange = DEFAULT_TIME_RANGE) => {
  const {
    timeSize,
    timeUnit
  } = expression || {
  ...
  }, [expression.aggType, expression.equation, expression.metric, expression.customMetrics, filterQuery, groupBy]);
  ...
  return (0, _use_metrics_explorer_data.useMetricsExplorerData)(options, source === null || source === void 0 ? void 0 : source.configuration, derivedIndexPattern, timestamps);
};
