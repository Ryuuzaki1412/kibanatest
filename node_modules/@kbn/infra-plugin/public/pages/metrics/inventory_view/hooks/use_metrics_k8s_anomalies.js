...
const useMetricsK8sAnomaliesResults = ({
  ...
  const isLoadingMetricsK8sAnomalies = (0, _react.useMemo)(() => getMetricsK8sAnomaliesRequest.state === 'pending', [getMetricsK8sAnomaliesRequest.state]);
  const hasFailedLoadingMetricsK8sAnomalies = (0, _react.useMemo)(() => getMetricsK8sAnomaliesRequest.state === 'rejected', [getMetricsK8sAnomaliesRequest.state]);
  return {
    metricsK8sAnomalies,
