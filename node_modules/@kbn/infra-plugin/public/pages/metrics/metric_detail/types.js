...
const SeriesOverridesObjectRT = _ioTs.default.intersection([_ioTs.default.type({
...
const SeriesOverridesRT = _ioTs.default.record(_ioTs.default.string, _ioTs.default.union([_ioTs.default.undefined, SeriesOverridesObjectRT]));
exports.SeriesOverridesRT = SeriesOverridesRT;
const VisSectionPropsRT = _ioTs.default.partial({
  type: ChartTypesRT,
