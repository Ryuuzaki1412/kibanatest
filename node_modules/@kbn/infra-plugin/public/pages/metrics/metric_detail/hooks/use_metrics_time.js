...
const MetricsTimeInputRT = rt.type({
  from: rt.union([rt.string, rt.number]),
  to: rt.union([rt.string, rt.number]),
  interval: rt.string
});
exports.MetricsTimeInputRT = MetricsTimeInputRT;
const MetricsTimeUrlStateRT = rt.partial({
  time: MetricsTimeInputRT,
  autoReload: rt.boolean,
  refreshInterval: rt.number
});
exports.MetricsTimeUrlStateRT = MetricsTimeUrlStateRT;
...
const MetricsTimeContainer = (0, _constate.default)(useMetricsTime);
