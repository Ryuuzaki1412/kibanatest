...
exports.metricsExplorerMetricToTSVBMetric = exports.createTSVBLink = exports.createFilterFromOptions = void 0;
...
const createTSVBLink = (source, options, series, timeRange, chartOptions) => {
  const tsvbIndexPattern = createTSVBIndexPattern(source && source.metricAlias || TSVB_WORKAROUND_INDEX_PATTERN);
  const appState = {
    filters: [],
    linked: false,
    query: {
