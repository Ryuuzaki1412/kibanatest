...
var _use_profiling_functions_data = require("../../hooks/use_profiling_functions_data");
...
function Functions() {
  ...
  const profilingLinkLabel = _i18n.i18n.translate('xpack.infra.flamegraph.profilingAppTopFunctionsLink', {
  ...
  const {
    ...
    loading,
    response
  } = (0, _use_profiling_functions_data.useProfilingFunctionsData)({
  ...
  if (!loading && (response === null || response === void 0 ? void 0 : response.TotalCount) === 0) {
