...
const Page = ({
  ...
  const heightWithOffset = (0, _react2.useMemo)(() => `calc(100vh - var(--euiFixedHeadersOffset, 0) - ${actionMenuHeight}px)`, [actionMenuHeight]);
  return loading ? /*#__PURE__*/_react2.default.createElement(_eui.EuiFlexGroup, {
    direction: "column",
    css: (0, _react.css)`
  ...
  })) : /*#__PURE__*/_react2.default.createElement(_eui.EuiPageTemplate, {
    panelled: true,
    contentBorder: false,
    offset: 0,
    restrictWidth: false,
