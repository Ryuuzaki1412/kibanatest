...
const CUSTOM_EQUATION_I18N = _i18n.i18n.translate('xpack.infra.metrics.alerting.threshold.customEquation', {
...
const groupByKeysActionVariableDescription = _i18n.i18n.translate('xpack.infra.metrics.alerting.groupByKeysActionVariableDescription', {
...
const originalAlertStateActionVariableDescription = _i18n.i18n.translate('xpack.infra.metrics.alerting.originalAlertStateActionVariableDescription', {
  defaultMessage: 'The state of the alert before it recovered. This is only available in the recovery context'
});
exports.originalAlertStateActionVariableDescription = originalAlertStateActionVariableDescription;
const originalAlertStateWasActionVariableDescription = _i18n.i18n.translate('xpack.infra.metrics.alerting.originalAlertStateWasWARNINGActionVariableDescription', {
...
exports.originalAlertStateWasActionVariableDescription = originalAlertStateWasActionVariableDescription;