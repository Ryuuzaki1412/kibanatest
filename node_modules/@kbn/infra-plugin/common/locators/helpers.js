...
exports.getLocationToDiscover = exports.createSearchString = exports.createNodeLogsQuery = void 0;
...
const createNodeLogsQuery = params => {
  ...
  const nodeFilter = `${(0, _common2.findInventoryFields)(nodeType).id}: ${nodeId}`;
