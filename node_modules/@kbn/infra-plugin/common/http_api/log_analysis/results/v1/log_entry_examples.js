...
const getLogEntryExamplesSuccessResponsePayloadRT = rt.intersection([rt.type({
  data: rt.type({
...
exports.getLogEntryExamplesSuccessResponsePayloadRT = getLogEntryExamplesSuccessResponsePayloadRT;
const getLogEntryExamplesResponsePayloadRT = rt.union([getLogEntryExamplesSuccessResponsePayloadRT, _shared.badRequestErrorRT, _shared.forbiddenErrorRT]);
