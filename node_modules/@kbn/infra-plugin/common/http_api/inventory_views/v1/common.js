...
const INVENTORY_VIEW_URL = '/api/infra/inventory_views';
exports.INVENTORY_VIEW_URL = INVENTORY_VIEW_URL;
const INVENTORY_VIEW_URL_ENTITY = `${INVENTORY_VIEW_URL}/{inventoryViewId}`;
exports.INVENTORY_VIEW_URL_ENTITY = INVENTORY_VIEW_URL_ENTITY;
...
const inventoryViewRequestParamsRT = rt.type({
  inventoryViewId: inventoryViewIdRT
});
exports.inventoryViewRequestParamsRT = inventoryViewRequestParamsRT;
const inventoryViewRequestQueryRT = rt.partial({
  sourceId: rt.string
});
exports.inventoryViewRequestQueryRT = inventoryViewRequestQueryRT;
const inventoryViewResponsePayloadRT = rt.type({
  data: _inventory_views.inventoryViewRT
});
exports.inventoryViewResponsePayloadRT = inventoryViewResponsePayloadRT;