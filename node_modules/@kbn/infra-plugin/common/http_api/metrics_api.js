...
exports.MetricsAPITimerangeRT = exports.MetricsAPISeriesRT = exports.MetricsAPIRowRT = exports.MetricsAPIResponseSeriesRT = exports.MetricsAPIResponseRT = exports.MetricsAPIRequestRT = exports.MetricsAPIPageInfoRT = exports.MetricsAPIMetricRT = exports.MetricsAPIColumnTypeRT = exports.MetricsAPIColumnRT = void 0;
...
const MetricsAPITimerangeRT = rt.intersection([rt.type({
  from: rt.number,
  to: rt.number,
  interval: rt.string
}), rt.partial({
...
const MetricsAPIMetricRT = rt.type({
  id: rt.string,
  aggregations: _common.MetricsUIAggregationRT
});
...
const MetricsAPIPageInfoRT = rt.intersection([rt.type({
...
const MetricsAPIResponseSeriesRT = rt.intersection([MetricsAPISeriesRT, rt.partial({
  metricsets: rt.array(rt.string)
})]);
exports.MetricsAPIResponseSeriesRT = MetricsAPIResponseSeriesRT;
