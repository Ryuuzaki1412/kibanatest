...
function _default(directory) {
  ...
  const files = _lodash.default.map(_globby.default.sync((0, _normalizePath.default)(_path.default.resolve(__dirname, '../' + directory + '/*.js'))).filter(filename => !filename.includes('.test')), function (file) {
  ...
  const directories = _lodash.default.chain(_globby.default.sync((0, _normalizePath.default)(_path.default.resolve(__dirname, '../' + directory + '/*/index.js')))).map(function (file) {
