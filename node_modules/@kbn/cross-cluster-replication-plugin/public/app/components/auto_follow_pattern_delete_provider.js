...
class AutoFollowPatternDeleteProviderUi extends _react.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, children(this.deleteAutoFollowPattern), isModalOpen && this.renderModal());
  }
}
const mapDispatchToProps = dispatch => ({
  deleteAutoFollowPattern: id => dispatch((0, _actions.deleteAutoFollowPattern)(id))
});
const AutoFollowPatternDeleteProvider = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(AutoFollowPatternDeleteProviderUi);
exports.AutoFollowPatternDeleteProvider = AutoFollowPatternDeleteProvider;