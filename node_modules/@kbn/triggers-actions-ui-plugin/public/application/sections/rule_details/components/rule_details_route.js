...
const RuleDetailsRoute = ({
  ...
  return rule && ruleType && actionTypes ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, getLegacyUrlConflictCallout(), /*#__PURE__*/_react.default.createElement(_rule_details.RuleDetailsWithApi, {
    rule: rule,
    ruleType: ruleType,
...
const RuleDetailsRouteWithApi = (0, _with_actions_api_operations.withActionOperations)((0, _with_bulk_rule_api_operations.withBulkRuleOperations)(RuleDetailsRoute));
// eslint-disable-next-line import/no-default-export
exports.default = RuleDetailsRouteWithApi;