...
const ALERT_STATUS_OK = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleStatusOk', {
  defaultMessage: 'Ok'
});
exports.ALERT_STATUS_OK = ALERT_STATUS_OK;
const ALERT_STATUS_ACTIVE = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleStatusActive', {
  defaultMessage: 'Active'
});
exports.ALERT_STATUS_ACTIVE = ALERT_STATUS_ACTIVE;
const ALERT_STATUS_ERROR = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleStatusError', {
  defaultMessage: 'Error'
});
exports.ALERT_STATUS_ERROR = ALERT_STATUS_ERROR;
const ALERT_STATUS_LICENSE_ERROR = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleStatusLicenseError', {
  defaultMessage: 'License Error'
});
exports.ALERT_STATUS_LICENSE_ERROR = ALERT_STATUS_LICENSE_ERROR;
const ALERT_STATUS_PENDING = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleStatusPending', {
  defaultMessage: 'Pending'
});
exports.ALERT_STATUS_PENDING = ALERT_STATUS_PENDING;
const ALERT_STATUS_UNKNOWN = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleStatusUnknown', {
  defaultMessage: 'Unknown'
});
exports.ALERT_STATUS_UNKNOWN = ALERT_STATUS_UNKNOWN;
const ALERT_STATUS_WARNING = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleStatusWarning', {
  defaultMessage: 'Warning'
});
exports.ALERT_STATUS_WARNING = ALERT_STATUS_WARNING;
const RULE_LAST_RUN_OUTCOME_SUCCEEDED = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleLastRunOutcomeSucceeded', {
  defaultMessage: 'Succeeded'
});
exports.RULE_LAST_RUN_OUTCOME_SUCCEEDED = RULE_LAST_RUN_OUTCOME_SUCCEEDED;
const RULE_LAST_RUN_OUTCOME_WARNING = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleLastRunOutcomeWarning', {
  defaultMessage: 'Warning'
});
exports.RULE_LAST_RUN_OUTCOME_WARNING = RULE_LAST_RUN_OUTCOME_WARNING;
const RULE_LAST_RUN_OUTCOME_FAILED = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleLastRunOutcomeFailed', {
  defaultMessage: 'Failed'
});
exports.RULE_LAST_RUN_OUTCOME_FAILED = RULE_LAST_RUN_OUTCOME_FAILED;
...
const rulesLastRunOutcomeTranslationMapping = {
  succeeded: RULE_LAST_RUN_OUTCOME_SUCCEEDED,
  warning: RULE_LAST_RUN_OUTCOME_WARNING,
  failed: RULE_LAST_RUN_OUTCOME_FAILED
};
exports.rulesLastRunOutcomeTranslationMapping = rulesLastRunOutcomeTranslationMapping;
const ALERT_ERROR_UNKNOWN_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonUnknown', {
  defaultMessage: 'An error occurred for unknown reasons.'
});
exports.ALERT_ERROR_UNKNOWN_REASON = ALERT_ERROR_UNKNOWN_REASON;
const ALERT_ERROR_READING_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonReading', {
  defaultMessage: 'An error occurred when reading the rule.'
});
exports.ALERT_ERROR_READING_REASON = ALERT_ERROR_READING_REASON;
const ALERT_ERROR_DECRYPTING_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonDecrypting', {
  defaultMessage: 'An error occurred when decrypting the rule.'
});
exports.ALERT_ERROR_DECRYPTING_REASON = ALERT_ERROR_DECRYPTING_REASON;
const ALERT_ERROR_EXECUTION_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonRunning', {
  defaultMessage: 'An error occurred when running the rule.'
});
exports.ALERT_ERROR_EXECUTION_REASON = ALERT_ERROR_EXECUTION_REASON;
const ALERT_ERROR_LICENSE_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonLicense', {
  defaultMessage: 'Cannot run rule'
});
exports.ALERT_ERROR_LICENSE_REASON = ALERT_ERROR_LICENSE_REASON;
const ALERT_ERROR_TIMEOUT_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonTimeout', {
  defaultMessage: 'Rule execution cancelled due to timeout.'
});
exports.ALERT_ERROR_TIMEOUT_REASON = ALERT_ERROR_TIMEOUT_REASON;
const ALERT_ERROR_DISABLED_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonDisabled', {
  defaultMessage: 'Rule failed to execute because rule ran after it was disabled.'
});
exports.ALERT_ERROR_DISABLED_REASON = ALERT_ERROR_DISABLED_REASON;
const ALERT_ERROR_VALIDATE_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleErrorReasonValidate', {
  defaultMessage: 'An error occurred when validating the rule parameters.'
});
exports.ALERT_ERROR_VALIDATE_REASON = ALERT_ERROR_VALIDATE_REASON;
const ALERT_WARNING_MAX_EXECUTABLE_ACTIONS_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleWarningReasonMaxExecutableActions', {
  defaultMessage: 'Action limit exceeded'
});
exports.ALERT_WARNING_MAX_EXECUTABLE_ACTIONS_REASON = ALERT_WARNING_MAX_EXECUTABLE_ACTIONS_REASON;
const ALERT_WARNING_MAX_QUEUED_ACTIONS_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleWarningReasonMaxQueuedActions', {
  defaultMessage: 'Queued action limit exceeded.'
});
exports.ALERT_WARNING_MAX_QUEUED_ACTIONS_REASON = ALERT_WARNING_MAX_QUEUED_ACTIONS_REASON;
const ALERT_WARNING_MAX_ALERTS_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleWarningReasonMaxAlerts', {
  defaultMessage: 'Alert limit exceeded'
});
exports.ALERT_WARNING_MAX_ALERTS_REASON = ALERT_WARNING_MAX_ALERTS_REASON;
const ALERT_WARNING_UNKNOWN_REASON = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.ruleWarningReasonUnknown', {
  defaultMessage: 'Unknown reason'
});
exports.ALERT_WARNING_UNKNOWN_REASON = ALERT_WARNING_UNKNOWN_REASON;
const rulesErrorReasonTranslationsMapping = {
...
exports.rulesErrorReasonTranslationsMapping = rulesErrorReasonTranslationsMapping;
const rulesWarningReasonTranslationsMapping = {
...
exports.rulesWarningReasonTranslationsMapping = rulesWarningReasonTranslationsMapping;
const SELECT_ALL_ARIA_LABEL = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.rulesListTable.columns.selectAllAriaLabel', {
  defaultMessage: 'Toggle select all rules'
});
exports.SELECT_ALL_ARIA_LABEL = SELECT_ALL_ARIA_LABEL;
const SELECT_SHOW_BULK_ACTIONS_ARIA_LABEL = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.rulesListTable.columns.selectShowBulkActionsAriaLabel', {
  defaultMessage: 'Show bulk actions'
});
exports.SELECT_SHOW_BULK_ACTIONS_ARIA_LABEL = SELECT_SHOW_BULK_ACTIONS_ARIA_LABEL;
...
const CLEAR_SELECTION = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.clearAllSelectionButton', {
...
const SINGLE_RULE_TITLE = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.singleTitle', {
  defaultMessage: 'rule'
});
exports.SINGLE_RULE_TITLE = SINGLE_RULE_TITLE;
const MULTIPLE_RULE_TITLE = _i18n.i18n.translate('xpack.triggersActionsUI.sections.rulesList.multipleTitle', {
  defaultMessage: 'rules'
});
exports.MULTIPLE_RULE_TITLE = MULTIPLE_RULE_TITLE;
const CANCEL_BUTTON_TEXT = _i18n.i18n.translate('xpack.triggersActionsUI.deleteSelectedIdsConfirmModal.cancelButtonLabel', {
