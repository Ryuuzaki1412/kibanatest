...
const RulesList = ({
  ...
  const onDisableRule = (0, _react.useCallback)(rule => {
  ...
  const onEnable = async () => {
    ...
    if (circuitBreakerError) {
      ...
      toasts.addDanger({
        ...
        text: (0, _public.toMountPoint)( /*#__PURE__*/_react.default.createElement(_toast_with_circuit_breaker_content.ToastWithCircuitBreakerContent, null, parsedError.details))
      });
    } else {
      showToast({
        action: 'ENABLE',
