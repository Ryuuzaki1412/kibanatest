...
const useAlertMutedState = alert => {
  ...
  const alertInstanceId = (_alert$ALERT_INSTANCE = alert[_ruleDataUtils.ALERT_INSTANCE_ID]) === null || _alert$ALERT_INSTANCE === void 0 ? void 0 : _alert$ALERT_INSTANCE[0];
  const ruleId = (_alert$ALERT_RULE_UUI = alert[_ruleDataUtils.ALERT_RULE_UUID]) === null || _alert$ALERT_RULE_UUI === void 0 ? void 0 : _alert$ALERT_RULE_UUI[0];
