...
var _health_api = require("../../common/lib/health_api");
...
const HealthCheck = ({
  ...
  _react.default.useEffect(() => {
    (async function () {
      ...
      const triggersActionsUiHealthStatus = await (0, _health_api.triggersActionsUiHealth)({
        http
      });
      const healthStatus = {
...
async function getAlertingFrameworkHealth(http) {
  try {
    return (0, _Option.some)(await (0, _health.alertingFrameworkHealth)({
      http
    }));
  } catch (err) {
    return _Option.none;
