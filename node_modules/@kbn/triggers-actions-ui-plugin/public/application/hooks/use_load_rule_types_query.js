...
const useLoadRuleTypesQuery = ({
  ...
  const authorizedToReadAnyRules = authorizedToCreateAnyRules || authorizedRuleTypes.some(ruleType => {
    ...
    return (_ruleType$authorizedC2 = ruleType.authorizedConsumers[_common.ALERTS_FEATURE_ID]) === null || _ruleType$authorizedC2 === void 0 ? void 0 : _ruleType$authorizedC2.read;
  });
  return {
    ruleTypesState: {
