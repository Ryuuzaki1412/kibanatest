...
exports.getStylesheetPaths = exports.getSettingValue = exports.getBundlesHref = void 0;
...
const getBundlesHref = (baseHref, buildNr) => `${baseHref}/${buildNr}/bundles`;
...
const getStylesheetPaths = ({
  ...
  return [...(darkMode ? [`${bundlesHref}/kbn-ui-shared-deps-npm/${_uiSharedDepsNpm.default.darkCssDistFilename(themeVersion)}`, `${bundlesHref}/kbn-ui-shared-deps-src/${UiSharedDepsSrc.cssDistFilename}`, `${baseHref}/ui/legacy_dark_theme.min.css`] : [`${bundlesHref}/kbn-ui-shared-deps-npm/${_uiSharedDepsNpm.default.lightCssDistFilename(themeVersion)}`, `${bundlesHref}/kbn-ui-shared-deps-src/${UiSharedDepsSrc.cssDistFilename}`, `${baseHref}/ui/legacy_light_theme.min.css`])];
};
