...
class TagsCache {
  constructor({
    ...
    this.public$ = this.internal$.pipe((0, _operators.takeUntil)(this.stop$));
  ...
  getState$({
    ...
    return waitForInitialization ? this.isInitialized$.pipe((0, _operators.first)(isInitialized => isInitialized), (0, _operators.mergeMap)(() => this.public$)) : this.public$;
  }
  onDelete(id) {
