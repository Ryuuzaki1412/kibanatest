...
const partitionVisWrapperStyle = (0, _react.css)({
  display: 'flex',
  flex: '1 1 auto',
  minHeight: 0,
  minWidth: 0,
...
exports.partitionVisWrapperStyle = partitionVisWrapperStyle;
const partitionVisContainerStyle = (0, _react.css)`
  min-height: 0;
  min-width: 0;
  margin-left: auto;
  margin-right: auto;
  ...
  height: 100%;
`;
exports.partitionVisContainerStyle = partitionVisContainerStyle;
