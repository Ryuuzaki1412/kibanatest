...
const PartitionVisComponent = props => {
  var _visParams$labels$per, _visParams$legendPosi, _visParams$distinctCo, _window$_echDebugStat, _visParams$legendSize, _visParams$maxLegendL;
  const {
  ...
  const themeOverrides = (0, _react.useMemo)(() => (0, _utils3.getPartitionTheme)(visType, visParams, chartTheme, containerDimensions, rescaleFactor, hasOpenedOnAggBasedEditor), [visType, visParams, chartTheme, containerDimensions, rescaleFactor, hasOpenedOnAggBasedEditor]);
...
var _default = /*#__PURE__*/(0, _react.memo)(PartitionVisComponent);
