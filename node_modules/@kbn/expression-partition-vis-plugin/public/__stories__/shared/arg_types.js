...
exports.pieDonutArgTypes = pieDonutArgTypes;
const treemapArgTypes = {
  visType: {
    name: `visType`,
    description: 'Type of the chart',
    type: {
...
exports.treemapArgTypes = treemapArgTypes;
const mosaicArgTypes = {
  visType: {
    name: `visType`,
    description: 'Type of the chart',
    type: {
...
exports.mosaicArgTypes = mosaicArgTypes;
const waffleArgTypes = {
  visType: {
    name: `visType`,
    description: 'Type of the chart',
    type: {
...
exports.waffleArgTypes = waffleArgTypes;