...
const renderApp = async (element, theme$, coreStart, history) => {
  const {
    featureCatalogue,
    chrome,
  ...
  const navLinksSubscription = chrome.navLinks.getNavLinks$().subscribe(navLinks => {
    ...
    (0, _reactDom.render)( /*#__PURE__*/_react.default.createElement(_sharedUxLinkRedirectApp.RedirectAppLinks, {
      coreStart: {
