...
class TutorialDirectoryUi extends _react.default.Component {
  constructor(props) {
    ...
    this.tabs = [{
      ...
      id,
      name,
      content: /*#__PURE__*/_react.default.createElement(Component, null)
    }))];
...
const TutorialDirectory = (0, _i18nReact.injectI18n)(TutorialDirectoryUi);
exports.TutorialDirectory = TutorialDirectory;