...
function getUiSettings(docLinks, enableValidations) {
  return {
    ...
    [_common.UI_SETTINGS.QUERY_ALLOW_LEADING_WILDCARDS]: {
      ...
      description: _i18n.i18n.translate('data.advancedSettings.query.allowWildcardsText', {
        defaultMessage: 'When set, * is allowed as the first character in a query clause. ' + 'To disallow leading wildcards in basic lucene queries, use {queryStringOptionsPattern}.',
        values: {
  ...
  "to": "now"
    ...
    [_common.UI_SETTINGS.TIMEPICKER_QUICK_RANGES]: {
      ...
      requiresPageReload: true,
      schema: enableValidations ? _configSchema.schema.arrayOf(_configSchema.schema.object({
        from: _configSchema.schema.string(),
        to: _configSchema.schema.string(),
    ...
    [_common.UI_SETTINGS.AUTOCOMPLETE_VALUE_SUGGESTION_METHOD]: {
      ...
      description: _i18n.i18n.translate('data.advancedSettings.autocompleteValueSuggestionMethodText', {
        defaultMessage: 'The method used for querying suggestions for values in KQL autocomplete. Select terms_enum to use the ' + 'Elasticsearch terms enum API for improved autocomplete suggestion performance. (Note that terms_enum is ' + 'incompatible with Document Level Security.) Select terms_agg to use an Elasticsearch terms aggregation. ' + '(Note that terms_agg is incompatible with IP-type fields.) {learnMoreLink}',
        values: {
