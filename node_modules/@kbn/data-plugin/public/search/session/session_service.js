...
class SessionService {
  ...
  constructor(initializerContext, getStartServices, sessionsClient, nowProvider, usageCollector, {
    ...
    this.disableSaveAfterSearchesExpire$ = (0, _rxjs.combineLatest)([this._disableSaveAfterSearchesExpire$, this.sessionMeta$.pipe((0, _operators.map)(meta => meta.isContinued))]).pipe((0, _operators.map)(([_disableSaveAfterSearchesExpire, isSessionContinued]) => _disableSaveAfterSearchesExpire || isSessionContinued), (0, _operators.distinctUntilChanged)());
    ...
    this.subscription.add(this.state$.pipe((0, _operators.switchMap)(_state => _state === _search_session_state.SearchSessionState.Completed ? (0, _rxjs.merge)((0, _rxjs.of)(false), (0, _rxjs.timer)(notTouchedTimeout).pipe((0, _operators.mapTo)(true))) : (0, _rxjs.of)(false)), (0, _operators.distinctUntilChanged)(), (0, _operators.tap)(value => {
    ...
    this.subscription.add(sessionMeta$.pipe((0, _operators.map)(meta => meta.startTime), (0, _operators.distinctUntilChanged)()).subscribe(startTime => {
    ...
    this.subscription.add(this.getSession$().pipe((0, _operators.switchMap)(sessionId => {
      ...
      const schedulePollSearches = () => {
        return (0, _rxjs.timer)(KEEP_ALIVE_COMPLETED_SEARCHES_INTERVAL).pipe((0, _operators.mergeMap)(() => {
        ...
        }), (0, _operators.repeat)(), (0, _operators.takeUntil)(this.disableSaveAfterSearchesExpire$.pipe((0, _operators.filter)(disable => disable))));
      };
   ...
   */
  getSession$() {
    return this.state.state$.pipe((0, _operators.startWith)(this.state.get()), (0, _operators.map)(s => s.sessionId), (0, _operators.distinctUntilChanged)());
  }
