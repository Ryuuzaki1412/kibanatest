...
const TOUR_TAKING_TOO_LONG_STEP_KEY = `data.searchSession.tour.takingTooLong`;
exports.TOUR_TAKING_TOO_LONG_STEP_KEY = TOUR_TAKING_TOO_LONG_STEP_KEY;
const TOUR_RESTORE_STEP_KEY = `data.searchSession.tour.restore`;
exports.TOUR_RESTORE_STEP_KEY = TOUR_RESTORE_STEP_KEY;
