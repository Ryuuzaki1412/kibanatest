...
const createConnectedSearchSessionIndicator = ({
  ...
  const debouncedSessionServiceState$ = sessionService.state$.pipe((0, _operators.debounce)(_state => (0, _rxjs.timer)(_state === _search_session_state.SearchSessionState.None ? 50 : 300)) // switch to None faster to quickly remove indicator when navigating away
  );
