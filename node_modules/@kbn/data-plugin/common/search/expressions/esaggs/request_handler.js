...
const handleRequest = ({
  ...
  return (0, _rxjs.defer)(async () => {
    ...
    inspector: {
      ...
      title: title !== null && title !== void 0 ? title : _i18n.i18n.translate('data.functions.esaggs.inspector.dataRequest.title', {
        defaultMessage: 'Data'
      }),
      description: description !== null && description !== void 0 ? description : _i18n.i18n.translate('data.functions.esaggs.inspector.dataRequest.description', {
