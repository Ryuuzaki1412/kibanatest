  ...
  setParams(from) {
    ...
    this.getAggParams().forEach(aggParam => {
      ...
      if (aggParam.deserialize) {
        var _aggParam$getValueTyp;
        const valueType = (_aggParam$getValueTyp = aggParam.getValueType) === null || _aggParam$getValueTyp === void 0 ? void 0 : _aggParam$getValueTyp.call(aggParam, this);
        const isTyped = _lodash.default.isFunction(valueType);
