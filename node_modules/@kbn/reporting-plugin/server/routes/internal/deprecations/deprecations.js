...
const registerDeprecationsRoutes = (reporting, logger) => {
  ...
  const getStatusPath = _constants.INTERNAL_ROUTES.MIGRATE.GET_ILM_POLICY_STATUS;
  router.get({
    path: getStatusPath,
    validate: false,
    options: {
  ...
  const migrateApiPath = _constants.INTERNAL_ROUTES.MIGRATE.MIGRATE_ILM_POLICY;
  router.put({
    path: migrateApiPath,
    validate: false,
    options: {
