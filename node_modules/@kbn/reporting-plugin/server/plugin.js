...
class ReportingPlugin {
  ...
  setup(core, plugins) {
    ...
    const reportingCore = new _.ReportingCore(core, this.logger, this.initContext);
    ...
    http.registerRouteHandlerContext(_reportingCommon.PLUGIN_ID, () => {
    ...
    const usageCounter = (_plugins$usageCollect = plugins.usageCollection) === null || _plugins$usageCollect === void 0 ? void 0 : _plugins$usageCollect.createUsageCounter(_reportingCommon.PLUGIN_ID);
  ...
  start(core, plugins) {
    ...
    (0, _reportingServer.setFieldFormats)(plugins.fieldFormats);
