...
const STACK_AAD_INDEX_NAME = 'stack';
exports.STACK_AAD_INDEX_NAME = STACK_AAD_INDEX_NAME;
const ALERT_TITLE = `${_ruleDataUtils.ALERT_NAMESPACE}.title`;
...
const ALERT_EVALUATION_CONDITIONS = `${_ruleDataUtils.ALERT_NAMESPACE}.evaluation.conditions`;
exports.ALERT_EVALUATION_CONDITIONS = ALERT_EVALUATION_CONDITIONS;
const STACK_ALERTS_AAD_CONFIG = {
...
exports.STACK_ALERTS_AAD_CONFIG = STACK_ALERTS_AAD_CONFIG;