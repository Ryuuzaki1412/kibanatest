...
const SearchSourceExpressionForm = props => {
  ...
  const [ruleConfiguration, dispatch] = (0, _react.useReducer)((currentState, action) => {
    ...
    size: (_ruleParams$size = ruleParams.size) !== null && _ruleParams$size !== void 0 ? _ruleParams$size : _constants.DEFAULT_VALUES.SIZE,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiTitle, {
    ...
    errors: errors,
    hasValidationErrors: (0, _validation.hasExpressionValidationErrors)(props.ruleParams),
