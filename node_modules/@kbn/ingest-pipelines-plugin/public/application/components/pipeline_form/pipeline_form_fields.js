...
const PipelineFormFields = ({
  ...
  const [isVersionVisible, setIsVersionVisible] = (0, _react.useState)(hasVersion);
  const [isMetaVisible, setIsMetaVisible] = (0, _react.useState)(hasMeta);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(FormRow, {
  ...
  }), isVersionVisible && /*#__PURE__*/_react.default.createElement(UseField, {
    path: "version",
    componentProps: {
    ...
    title: /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
      id: "xpack.ingestPipelines.form.metaTitle",
