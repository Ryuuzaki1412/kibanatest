...
exports.getCasesDefaultAppFeaturesConfig = void 0;
 ...
 */
const getCasesDefaultAppFeaturesConfig = ({
  apiTags,
  uiCapabilities
}) => ({
  [_app_features_keys.AppFeatureCasesKey.casesConnectors]: {
    privileges: {
      all: {
...
exports.getCasesDefaultAppFeaturesConfig = getCasesDefaultAppFeaturesConfig;