...
exports.assistantDefaultAppFeaturesConfig = void 0;
 ...
 */
const assistantDefaultAppFeaturesConfig = {
  [_app_features_keys.AppFeatureAssistantKey.assistant]: {
    privileges: {
      all: {
        ui: ['ai-assistant']
      }
...
exports.assistantDefaultAppFeaturesConfig = assistantDefaultAppFeaturesConfig;