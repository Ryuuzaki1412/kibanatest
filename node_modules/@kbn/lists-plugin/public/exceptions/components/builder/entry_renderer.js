...
const BuilderEntryItem = ({
  ...
  }, [indexPattern, entry, isDisabled, handleFieldChange, allowCustomOptions, sPaddingSize, extendedField]);
  ...
  const getEventFilterWildcardWarningInfo = precedingWarning => {
    ...
    switch (type) {
      ...
      case _securitysolutionIoTsListTypes.ListOperatorTypeEnum.WILDCARD:
        ...
        if (listType !== 'detection' && listType !== 'rule_default') {
          ...
          actualWarning = warning === _securitysolutionUtils.WILDCARD_WARNING && listType === 'endpoint_events' ? getEventFilterWildcardWarningInfo(warning) : warning;
        }
