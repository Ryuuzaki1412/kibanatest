...
const deleteListRoute = router => {
  router.versioned.delete({
    ...
    validate: {
      request: {
        query: (0, _utils.buildRouteValidation)(_api.deleteListRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (deleted == null) {
        ...
        const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(deleted, _api.deleteListResponse);
        if (errors != null) {
          return siemResponse.error({
            body: errors,
            statusCode: 500
