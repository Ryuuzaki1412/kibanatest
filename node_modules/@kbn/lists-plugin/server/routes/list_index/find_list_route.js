...
const findListRoute = router => {
  router.versioned.get({
    ...
    validate: {
      request: {
        query: (0, _utils2.buildRouteValidation)(_api.findListRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (!isValid) {
        ...
        const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionList, _api.findListResponse);
        if (errors != null) {
          return siemResponse.error({
            body: errors,
            statusCode: 500
