...
const patchListItemRoute = router => {
  router.versioned.patch({
    ...
    validate: {
      request: {
        body: (0, _utils.buildRouteValidation)(_api.patchListItemRequest)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (listItem == null) {
        ...
        const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(listItem, _api.patchListItemResponse);
        if (errors != null) {
          return siemResponse.error({
            body: errors,
            statusCode: 500
