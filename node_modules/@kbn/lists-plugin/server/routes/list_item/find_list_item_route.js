...
const findListItemRoute = router => {
  router.versioned.get({
    ...
    validate: {
      request: {
        query: (0, _utils2.buildRouteValidation)(_api.findListItemRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (!isValid) {
        ...
        if (exceptionList == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(exceptionList, _api.findListItemResponse);
          if (errors != null) {
            return siemResponse.error({
              body: errors,
              statusCode: 500
