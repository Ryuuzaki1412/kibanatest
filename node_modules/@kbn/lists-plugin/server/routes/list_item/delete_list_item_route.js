...
const deleteListItemRoute = router => {
  router.versioned.delete({
    ...
    validate: {
      request: {
        query: (0, _utils.buildRouteValidation)(_api.deleteListItemRequestQuery)
      }
    },
    version: '2023-10-31'
    ...
    try {
      ...
      if (id != null) {
        ...
        if (deleted == null) {
          ...
          const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(deleted, _api.deleteListItemResponse);
          if (errors != null) {
            return siemResponse.error({
              body: errors,
              statusCode: 500
        ...
        if (list == null) {
          ...
          if (deleted == null || deleted.length === 0) {
            ...
            const [validated, errors] = (0, _securitysolutionIoTsUtils.validate)(deleted, _api.deleteListItemArrayResponse);
            if (errors != null) {
              return siemResponse.error({
                body: errors,
                statusCode: 500
