...
exports.mockDataProviders = exports.mockDataProviderNames = exports.getEventCount = void 0;
...
const mockDataProviderNames = () => Object.keys(mockSourceNameToEventCount);

/** Returns a count of the events for a mock data provider */
exports.mockDataProviderNames = mockDataProviderNames;
const getEventCount = dataProviderName => mockSourceNameToEventCount[dataProviderName] || 0;
...
const mockDataProviders = Object.keys(mockSourceNameToEventCount).map(name => ({
  id: `id-${name}`,
  name,
  enabled: true,
  excluded: false,
