...
const MAIN_TYPES = ['alias', 'binary', 'boolean', 'completion', 'constant_keyword', 'date', 'date_nanos', 'dense_vector', 'flattened', 'geo_point', 'geo_shape', 'ip', 'join', 'keyword', 'nested', 'numeric', 'match_only_text', 'object', 'percolator', 'range', 'rank_feature', 'rank_features', 'search_as_you_type', 'shape', 'sparse_vector', 'text', 'token_count', 'histogram', 'wildcard', 'point', 'version', 'other'];
exports.MAIN_TYPES = MAIN_TYPES;
const MAIN_DATA_TYPE_DEFINITION = MAIN_TYPES.reduce((acc, type) => ({
  ...acc,
...
const SUB_TYPE_MAP_TO_MAIN = Object.entries(MAIN_DATA_TYPE_DEFINITION).reduce((acc, [type, definition]) => {
...
const ALL_DATA_TYPES = [...Object.keys(MAIN_DATA_TYPE_DEFINITION), ...Object.keys(SUB_TYPE_MAP_TO_MAIN)];
