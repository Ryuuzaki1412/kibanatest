...
const EditField = /*#__PURE__*/_react.default.memo(({
  form,
  field,
  allFields,
  exitEdit,
  ...
  return /*#__PURE__*/_react.default.createElement(_shared_imports.Form, {
    ...
    const typeDefinition = _constants.TYPE_DEFINITION[type[0].value];
    const subTypeDefinition = _constants.TYPE_DEFINITION[subType === null || subType === void 0 ? void 0 : subType[0].value];
    ...
    const ParametersForm = (0, _field_types.getParametersFormForType)(type === null || type === void 0 ? void 0 : type[0].value, subType === null || subType === void 0 ? void 0 : subType[0].value);
    if (!ParametersForm) {
      return null;
    }
