...
const SectionError = ({
  ...
  const {
    ...
    statusText,
    attributes: {
      cause: causeAttributes
    } = {}
  } = error;
  const cause = causeAttributes !== null && causeAttributes !== void 0 ? causeAttributes : causeRoot;
  return /*#__PURE__*/_react.default.createElement(_eui.EuiCallOut, (0, _extends2.default)({
    title: title,
    color: "danger",
    iconType: "warning"
  }, rest), /*#__PURE__*/_react.default.createElement("div", null, message || statusText), cause && /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, {
    size: "m"
