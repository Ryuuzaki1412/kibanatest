...
const mapDispatchToProps = dispatch => {
  return {
    ...
    reloadIndices: (indexNames, options) => {
      dispatch((0, _actions.reloadIndices)(indexNames, options));
    }
  };
};
const IndexTable = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_index_table.IndexTable));
