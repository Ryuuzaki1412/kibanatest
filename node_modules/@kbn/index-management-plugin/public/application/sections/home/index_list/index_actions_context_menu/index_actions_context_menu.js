  ...
  panels() {
    ...
    if (isOnListView && selectedIndexCount === 1) {
      items.push({
        ...
        onClick: () => {
          history.push((0, _routing.getIndexDetailsLink)(indexNames[0], _constants.IndexDetailsSection.Overview));
        }
      });
      items.push({
        ...
        onClick: () => {
          history.push((0, _routing.getIndexDetailsLink)(indexNames[0], _constants.IndexDetailsSection.Settings));
        }
      });
      items.push({
        ...
        onClick: () => {
          history.push((0, _routing.getIndexDetailsLink)(indexNames[0], _constants.IndexDetailsSection.Mappings));
        }
      });
      if (allOpen && enableIndexActions) {
        items.push({
          ...
          onClick: () => {
            history.push((0, _routing.getIndexDetailsLink)(indexNames[0], _constants.IndexDetailsSection.Stats));
          }
        });
      }
    }
