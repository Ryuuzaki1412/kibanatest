...
exports.getTemplateListLink = exports.getTemplateEditLink = exports.getTemplateDetailsLink = exports.getTemplateCloneLink = exports.getIndexListUri = exports.getIndexDetailsLink = exports.getDataStreamDetailsLink = void 0;
...
const getIndexListUri = (filter, includeHiddenIndices) => {
  ...
  if (filter) {
    ...
    return encodeURI(`/indices?includeHiddenIndices=${hiddenIndicesParam}&filter=${encodeURIComponent(filter)}`);
  }
...
const getIndexDetailsLink = (indexName, tab) => {
