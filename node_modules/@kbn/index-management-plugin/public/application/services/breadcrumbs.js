 ...
 * 2.0.
 */
let IndexManagementBreadcrumb;
exports.IndexManagementBreadcrumb = IndexManagementBreadcrumb;
(function (IndexManagementBreadcrumb) {
  IndexManagementBreadcrumb["home"] = "home";
  IndexManagementBreadcrumb["indices"] = "indices";
  IndexManagementBreadcrumb["indexDetailsOverview"] = "indexDetailsOverview";
  IndexManagementBreadcrumb["indexDetailsMappings"] = "indexDetailsMappings";
  IndexManagementBreadcrumb["indexDetailsSettings"] = "indexDetailsSettings";
  IndexManagementBreadcrumb["indexDetailsStats"] = "indexDetailsStats";
...
})(IndexManagementBreadcrumb || (exports.IndexManagementBreadcrumb = IndexManagementBreadcrumb = {}));
class BreadcrumbService {
  ...
  setup(setBreadcrumbsHandler) {
    ...
    this.breadcrumbs.indexDetailsOverview = [...this.breadcrumbs.indices, indexDetailsBreadcrumb, {
      text: _i18n.i18n.translate('xpack.idxMgmt.breadcrumb.indexDetailsOverviewLabel', {
        defaultMessage: 'Overview'
      })
    }];
    this.breadcrumbs.indexDetailsMappings = [...this.breadcrumbs.indices, indexDetailsBreadcrumb, {
      text: _i18n.i18n.translate('xpack.idxMgmt.breadcrumb.indexDetailsMappingsLabel', {
        defaultMessage: 'Mappings'
      })
    }];
    this.breadcrumbs.indexDetailsSettings = [...this.breadcrumbs.indices, indexDetailsBreadcrumb, {
      text: _i18n.i18n.translate('xpack.idxMgmt.breadcrumb.indexDetailsSettingsLabel', {
        defaultMessage: 'Settings'
      })
    }];
    this.breadcrumbs.indexDetailsStats = [...this.breadcrumbs.indices, indexDetailsBreadcrumb, {
      text: _i18n.i18n.translate('xpack.idxMgmt.breadcrumb.indexDetailsStatsLabel', {
