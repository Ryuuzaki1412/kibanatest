...
const templateSchema = _configSchema.schema.object({
  ...
  allowAutoCreate: _configSchema.schema.maybe(_configSchema.schema.boolean()),
  template: _configSchema.schema.maybe(_configSchema.schema.object({
    ...
    lifecycle: _configSchema.schema.maybe(_configSchema.schema.object({
      enabled: _configSchema.schema.boolean(),
      data_retention: _configSchema.schema.maybe(_configSchema.schema.string())
    }))
  })),
