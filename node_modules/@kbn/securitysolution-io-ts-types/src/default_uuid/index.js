 ...
 */
const DefaultUuid = new t.Type('DefaultUuid', t.string.is, (input, context) => input == null ? t.success((0, _uuid.v4)()) : _non_empty_string.NonEmptyString.validate(input, context), t.identity);
