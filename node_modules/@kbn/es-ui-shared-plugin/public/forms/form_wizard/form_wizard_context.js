...
const FormWizardProvider = (0, _multi_content.WithMultiContent)(function FormWizardProvider({
  children,
  defaultActiveStep = 0,
  isEditing,
  onSave,
...
exports.FormWizardProvider = FormWizardProvider;
const FormWizardConsumer = formWizardContext.Consumer;
exports.FormWizardConsumer = FormWizardConsumer;
