...
const useDashboardMenuItems = ({
  ...
  }, [quickSaveDashboard, isSaveInProgress, hasRunMigrations, hasUnsavedChanges, dashboardBackup, saveDashboardAs, setIsLabsShown, disableTopNav, resetChanges, isLabsShown, lastSavedId, showShare, dashboard, clone]);
  ...
  const viewModeTopNavConfig = (0, _react.useMemo)(() => {
    ...
    return [...labsMenuItem, menuItems.fullScreen, ...shareMenuItem, ...cloneMenuItem, ...mayberesetChangesMenuItem, ...editMenuItem];
  ...
  }, [isLabsEnabled, menuItems.labs, menuItems.share, menuItems.settings, menuItems.saveAs, menuItems.switchToViewMode, menuItems.quickSave, share, lastSavedId, showResetChange, resetChangesMenuItem]);
  return {
