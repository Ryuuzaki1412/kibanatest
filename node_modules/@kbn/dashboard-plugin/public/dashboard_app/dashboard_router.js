...
exports.dashboardUrlParams = dashboardUrlParams;
async function mountApp({
  ...
  const getUrlStateStorage = history => (0, _public3.createKbnUrlStateStorage)({
    history,
    useHash: uiSettings.get('state:storeInSessionStorage'),
    ...(0, _public3.withNotifyOnErrors)(notifications.toasts)
  });
  ...
  const app = /*#__PURE__*/_react.default.createElement(_i18nReact.I18nProvider, null, /*#__PURE__*/_react.default.createElement(_dashboard_mount_context.DashboardMountContext.Provider, {
    value: mountContext
