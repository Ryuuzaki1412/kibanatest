...
function getStats({
  ...
  const stats = {
    ...(kibanaRequest.query ? {
      kibanaApiQueryParameters: {
        label: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.kibanaApiQueryParametersLabel', {
          defaultMessage: 'Kibana API query parameters'
        }),
        description: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.kibanaApiQueryParametersDescription', {
    ...
    kibanaApiRoute: {
      label: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.kibanaApiRouteLabel', {
        defaultMessage: 'Kibana API route'
      }),
      description: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.kibanaApiRouteDescription', {
    ...
    indexPattern: {
      label: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.dataViewLabel', {
        defaultMessage: 'Data view'
      }),
      value: esRequestParams.index,
      description: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.dataViewDescription', {
  ...
  if (esResponse !== null && esResponse !== void 0 && (_esResponse$hits = esResponse.hits) !== null && _esResponse$hits !== void 0 && _esResponse$hits.hits) {
    stats.hits = {
      label: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.hitsLabel', {
        defaultMessage: 'Hits'
      }),
      value: `${esResponse.hits.hits.length}`,
      description: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.hitsDescription', {
  ...
  if (esResponse !== null && esResponse !== void 0 && esResponse.took) {
    stats.queryTime = {
      label: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.queryTimeLabel', {
        defaultMessage: 'Query time'
      }),
      value: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.queryTimeValue', {
        defaultMessage: '{queryTime}ms',
        values: {
          queryTime: esResponse.took
        }
      }),
      description: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.queryTimeDescription', {
  ...
  if ((esResponse === null || esResponse === void 0 ? void 0 : (_esResponse$hits2 = esResponse.hits) === null || _esResponse$hits2 === void 0 ? void 0 : _esResponse$hits2.total) !== undefined) {
    ...
    stats.hitsTotal = {
      label: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.hitsTotalLabel', {
        defaultMessage: 'Hits (total)'
      }),
      value: hitsTotalValue,
      description: _i18n.i18n.translate('xpack.observabilityShared.inspector.stats.hitsTotalDescription', {
