...
const performGet = async ({
  ...
  return encryptionHelper.optionallyDecryptAndRedactSingleResult(migrated, authorizationResult === null || authorizationResult === void 0 ? void 0 : authorizationResult.typeMap);
};
