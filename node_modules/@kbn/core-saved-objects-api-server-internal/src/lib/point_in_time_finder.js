...
class PointInTimeFinder {
  constructor(findOptions, {
    ...
    _classPrivateFieldInitSpec(this, _internalOptions, {
      writable: true,
      value: void 0
    });
    ...
    (0, _classPrivateFieldSet2.default)(this, _internalOptions, internalOptions);
  ...
  async *find() {
    ...
    do {
      ...
      if (lastResultsCount > 0 || (0, _classPrivateFieldGet2.default)(this, _findOptions).aggs) {
        yield results;
      }
  ...
  async close() {
    try {
      if ((0, _classPrivateFieldGet2.default)(this, _pitId)) {
        ...
        await (0, _classPrivateFieldGet2.default)(this, _client).closePointInTime((0, _classPrivateFieldGet2.default)(this, _pitId), undefined, (0, _classPrivateFieldGet2.default)(this, _internalOptions));
  ...
  async open() {
    try {
      ...
      }, (0, _classPrivateFieldGet2.default)(this, _internalOptions));
