...
const initMetricExplorerRoute = framework => {
  framework.registerRoute({
    ...
    const options = (0, _pipeable.pipe)(_metrics_explorer.metricsExplorerRequestBodyRT.decode(request.body), (0, _Either.fold)((0, _runtime_types.throwErrors)(_boom.default.badRequest), _function.identity));
