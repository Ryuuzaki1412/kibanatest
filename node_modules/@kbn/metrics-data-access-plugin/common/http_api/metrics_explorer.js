...
const OMITTED_AGGREGATIONS_FOR_CUSTOM_METRICS = ['custom', 'rate', 'p95', 'p99'];
exports.OMITTED_AGGREGATIONS_FOR_CUSTOM_METRICS = OMITTED_AGGREGATIONS_FOR_CUSTOM_METRICS;
...
const metricsExplorerCustomMetricAggregationRT = rt.keyof(metricsExplorerCustomMetricAggregationKeys);
exports.metricsExplorerCustomMetricAggregationRT = metricsExplorerCustomMetricAggregationRT;
...
const metricsExplorerCustomMetricRT = rt.intersection([rt.type({
  name: rt.string,
...
exports.metricsExplorerCustomMetricRT = metricsExplorerCustomMetricRT;
...
const timeRangeRT = rt.intersection([rt.type({
  from: rt.number,
  to: rt.number,
  interval: rt.string
}), rt.partial({
