...
const DISCOVER_APP_TARGET = 'discover';
exports.DISCOVER_APP_TARGET = DISCOVER_APP_TARGET;
const LOGS_APP_TARGET = 'logs-ui';
exports.LOGS_APP_TARGET = LOGS_APP_TARGET;
const O11Y_AAD_FIELDS = ['cloud.*', 'host.*', 'orchestrator.*', 'container.*', 'labels.*', 'tags'];
exports.O11Y_AAD_FIELDS = O11Y_AAD_FIELDS;