  ...
  start(core, {
    ...
    licensing.license$.subscribe(license => {
      ...
      this.appUpdater$.next(() => ({
        navLinkStatus: licenseInformation.showAppLink ? licenseInformation.enableAppLink ? _public.AppNavLinkStatus.visible : _public.AppNavLinkStatus.disabled : _public.AppNavLinkStatus.hidden,
