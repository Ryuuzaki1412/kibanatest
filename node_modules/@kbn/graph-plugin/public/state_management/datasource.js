 ...
 */
const setDatasource = actionCreator('SET_DATASOURCE');
...
const requestDatasource = actionCreator('SET_DATASOURCE_REQUEST');

/**
 * Datasource loading finished successfully.
 */
exports.requestDatasource = requestDatasource;
const datasourceLoaded = actionCreator('SET_DATASOURCE_SUCCESS');
...
const datasourceReducer = (0, _dist.reducerWithInitialState)(initialDatasource).case(_global.reset, () => initialDatasource).case(setDatasource, (_oldDatasource, newDatasource) => ({
...
const hasDatasourceSelector = (0, _reselect.createSelector)(datasourceSelector, datasource => datasource.current.type !== 'none');
