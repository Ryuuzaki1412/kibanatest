...
const loadFields = actionCreator('LOAD_FIELDS');
exports.loadFields = loadFields;
const updateFieldProperties = actionCreator('UPDATE_FIELD_PROPERTIES');
exports.updateFieldProperties = updateFieldProperties;
const selectField = actionCreator('SELECT_FIELD');
exports.selectField = selectField;
const deselectField = actionCreator('DESELECT_FIELD');
exports.deselectField = deselectField;
const initialFields = {};
const fieldsReducer = (0, _dist.reducerWithInitialState)(initialFields).case(_global.reset, () => initialFields).case(_datasource.setDatasource, () => initialFields).case(loadFields, (_currentFields, newFields) => {
  const newFieldMap = {};
...
const fieldsSelector = (0, _reselect.createSelector)(fieldMapSelector, fields => Object.values(fields));
exports.fieldsSelector = fieldsSelector;
const selectedFieldsSelector = (0, _reselect.createSelector)(fieldsSelector, fields => fields.filter(field => field.selected));
exports.selectedFieldsSelector = selectedFieldsSelector;
const liveResponseFieldsSelector = (0, _reselect.createSelector)(selectedFieldsSelector, fields => fields.filter(field => field.hopSize && field.hopSize > 0));
exports.liveResponseFieldsSelector = liveResponseFieldsSelector;
const hasFieldsSelector = (0, _reselect.createSelector)(selectedFieldsSelector, fields => fields.length > 0);
