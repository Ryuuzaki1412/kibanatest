...
const initializeWorkspace = actionCreator('INITIALIZE_WORKSPACE');
exports.initializeWorkspace = initializeWorkspace;
const submitSearch = actionCreator('SUBMIT_SEARCH');
exports.submitSearch = submitSearch;
const workspaceReducer = (0, _typescriptFsaReducers.reducerWithInitialState)(initialWorkspaceState).case(_global.reset, () => ({
  isInitialized: false
...
const workspaceInitializedSelector = (0, _reselect.createSelector)(workspaceSelector, workspace => workspace.isInitialized);
 ...
 */
exports.workspaceInitializedSelector = workspaceInitializedSelector;
