...
const getTotalItems = (0, _reselect.createSelector)(getFilteredJobs, filteredJobs => {
...
const getPageOfJobs = (0, _reselect.createSelector)(getFilteredJobs, getTableState, getPager, (filteredJobs, tableState, pager) => {
...
exports.getPageOfJobs = getPageOfJobs;
const getHasNextPage = (0, _reselect.createSelector)(getPager, pager => {
  return pager.hasNextPage;
});
exports.getHasNextPage = getHasNextPage;
const getHasPreviousPage = (0, _reselect.createSelector)(getPager, pager => {
  return pager.hasPreviousPage;
});
exports.getHasPreviousPage = getHasPreviousPage;
const getCurrentPage = (0, _reselect.createSelector)(getPager, pager => {
