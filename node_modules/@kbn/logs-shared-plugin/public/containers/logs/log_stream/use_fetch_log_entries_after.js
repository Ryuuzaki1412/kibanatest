...
const parseLogEntriesAfterSearchResponses = (0, _data_search.normalizeDataSearchResponses)(null, (0, _runtime_types.decodeOrThrow)(_log_entries.logEntriesSearchResponsePayloadRT));
exports.parseLogEntriesAfterSearchResponses = parseLogEntriesAfterSearchResponses;
const flattenLogEntriesAfterSearchResponse = (0, _operators.exhaustMap)(_data_search.flattenDataSearchResponseDescriptor);