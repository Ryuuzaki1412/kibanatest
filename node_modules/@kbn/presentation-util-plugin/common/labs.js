...
exports.solutionNames = exports.projects = exports.projectIDs = exports.isProjectEnabledByStatus = exports.getProjectIDs = exports.environmentNames = exports.LABS_PROJECT_PREFIX = exports.DEFER_BELOW_FOLD = exports.DASHBOARD_LINKS_PANEL = exports.BY_VALUE_EMBEDDABLE = void 0;
...
const DASHBOARD_LINKS_PANEL = `${LABS_PROJECT_PREFIX}dashboard:linksPanel`;
exports.DASHBOARD_LINKS_PANEL = DASHBOARD_LINKS_PANEL;
const BY_VALUE_EMBEDDABLE = `${LABS_PROJECT_PREFIX}canvas:byValueEmbeddable`;
exports.BY_VALUE_EMBEDDABLE = BY_VALUE_EMBEDDABLE;
const projectIDs = [DEFER_BELOW_FOLD, BY_VALUE_EMBEDDABLE, DASHBOARD_LINKS_PANEL];
...
const technicalPreviewLabel = _i18n.i18n.translate('presentationUtil.advancedSettings.technicalPreviewLabel', {
...
const projects = {
  ...
  [DASHBOARD_LINKS_PANEL]: {
    ...
    isDisplayed: true,
    environments: ['kibana', 'browser', 'session'],
    name: _i18n.i18n.translate('presentationUtil.labs.enableLinksPanelProjectName', {
      defaultMessage: 'Enable links panel'
    }),
    description: _i18n.i18n.translate('presentationUtil.labs.enableLinksPanelProjectDescription', {
      defaultMessage: '{technicalPreviewLabel} Enables the links panel for dashboard, which allows dashboard authors to easily link dashboards together.',
      values: {
