...
const getUiSettings = (docLinks, enableValidations) => ({
  [_discoverUtils.DEFAULT_COLUMNS_SETTING]: {
    ...
    category: ['discover'],
    schema: enableValidations ? _configSchema.schema.arrayOf(_configSchema.schema.string(), {
      maxSize: 50
    }) : _configSchema.schema.arrayOf(_configSchema.schema.string())
  },
  [_discoverUtils.MAX_DOC_FIELDS_DISPLAYED]: {
  ...
  [_discoverUtils.SAMPLE_SIZE_SETTING]: {
  ...
  [_discoverUtils.SAMPLE_ROWS_PER_PAGE_SETTING]: {
  ...
  [_discoverUtils.SORT_DEFAULT_ORDER_SETTING]: {
  ...
  [_discoverUtils.SEARCH_ON_PAGE_LOAD_SETTING]: {
  ...
  [_discoverUtils.DOC_HIDE_TIME_COLUMN_SETTING]: {
  ...
  [_discoverUtils.FIELDS_LIMIT_SETTING]: {
  ...
  [_discoverUtils.CONTEXT_DEFAULT_SIZE_SETTING]: {
  ...
  [_discoverUtils.CONTEXT_STEP_SETTING]: {
  ...
  [_discoverUtils.CONTEXT_TIE_BREAKER_FIELDS_SETTING]: {
  ...
  [_discoverUtils.DOC_TABLE_LEGACY]: {
  ...
  [_discoverUtils.MODIFY_COLUMNS_ON_SWITCH]: {
  ...
  [_discoverUtils.SEARCH_FIELDS_FROM_SOURCE]: {
  ...
  [_discoverUtils.SHOW_FIELD_STATISTICS]: {
  ...
  [_discoverUtils.SHOW_MULTIFIELDS]: {
  ...
  [_discoverUtils.ROW_HEIGHT_OPTION]: {
  ...
  [_discoverUtils.TRUNCATE_MAX_HEIGHT]: {
  ...
  [_discoverUtils.ENABLE_ESQL]: {
    name: _i18n.i18n.translate('discover.advancedSettings.enableESQLTitle', {
      defaultMessage: 'Enable ES|QL'
    }),
    value: true,
    description: _i18n.i18n.translate('discover.advancedSettings.enableESQLDescription', {
      defaultMessage: '{technicalPreviewLabel} This tech preview feature is highly experimental--do not rely on this for production saved searches, visualizations or dashboards. This setting enables ES|QL in Discover. If you have feedback on this experience please reach out to us on {link}',
      values: {
        link: `<a href="https://discuss.elastic.co/c/elastic-stack/kibana" target="_blank" rel="noopener">` + _i18n.i18n.translate('discover.advancedSettings.enableESQL.discussLinkText', {
