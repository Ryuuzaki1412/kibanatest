...
var _discover_app_state_container = require("../application/main/services/discover_app_state_container");
 ...
 */
async function getSharingData(currentSearchSource, state, services, isPlainRecord) {
  const {
    uiSettings,
    data
  } = services;
