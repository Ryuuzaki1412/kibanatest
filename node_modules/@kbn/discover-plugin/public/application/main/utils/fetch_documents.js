...
const fetchDocuments = (searchSource, {
  ...
  if (((_searchSource$getFiel = searchSource.getField('index')) === null || _searchSource$getFiel === void 0 ? void 0 : _searchSource$getFiel.type) === 'rollup') {
  ...
  }).pipe((0, _operators.filter)(res => !(0, _public.isRunningResponse)(res)), (0, _operators.map)(res => {
    return (0, _discoverUtils.buildDataTableRecordList)(res.rawResponse.hits.hits, dataView);
  }));
