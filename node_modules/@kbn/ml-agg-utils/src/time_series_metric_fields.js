 ...
 */
let TIME_SERIES_METRIC_TYPES;
/**
 * Check if DataViewField is a 'counter' time series metric field
 * @param field optional DataViewField
 * @returns a boolean
 */
exports.TIME_SERIES_METRIC_TYPES = TIME_SERIES_METRIC_TYPES;
(function (TIME_SERIES_METRIC_TYPES) {
...
})(TIME_SERIES_METRIC_TYPES || (exports.TIME_SERIES_METRIC_TYPES = TIME_SERIES_METRIC_TYPES = {}));
