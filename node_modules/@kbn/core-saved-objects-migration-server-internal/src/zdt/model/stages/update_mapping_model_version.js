...
exports.updateMappingModelVersion = void 0;
...
const updateMappingModelVersion = (state, res, context) => {
  ...
  return {
    ...
    currentIndexMeta: (0, _utils.setMetaMappingMigrationComplete)({
      meta: state.currentIndexMeta,
      versions: context.typeVirtualVersions
    })
  };
};
exports.updateMappingModelVersion = updateMappingModelVersion;