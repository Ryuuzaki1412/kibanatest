...
const getConfiguration = (layers, series, vis) => {
  var _vis$uiState$get, _vis$params$valueAxes4, _vis$params$valueAxes5, _vis$params$categoryA, _yLeftAxis$show, _yRightAxis$show, _vis$params$fittingFu, _vis$params$addLegend, _vis$params$legendPos, _vis$params$legendSiz, _vis$params$truncateL, _vis$params$maxLegend, _vis$params$fillOpaci, _vis$params$grid$cate, _vis$type$visConfig$d, _vis$params$grid$valu, _vis$type$visConfig$d2, _vis$params$grid$valu2, _vis$type$visConfig$d3, _xAxis$labels$show, _yLeftAxis$labels$sho, _yRightAxis$labels$sh, _getYScaleType, _getYScaleType2, _vis$params$labels$sh, _vis$type$visConfig$d4, _vis$params$labels$sh2, _vis$type$visConfig$d5, _vis$params$addTimeMa, _series$, _series$2;
  ...
  return {
    ...
    gridlinesVisibilitySettings: {
      x: (_vis$params$grid$cate = vis.params.grid.categoryLines) !== null && _vis$params$grid$cate !== void 0 ? _vis$params$grid$cate : (_vis$type$visConfig$d = vis.type.visConfig.defaults.grid) === null || _vis$type$visConfig$d === void 0 ? void 0 : _vis$type$visConfig$d.categoryLines,
      yLeft: ((_vis$params$grid$valu = vis.params.grid.valueAxis) !== null && _vis$params$grid$valu !== void 0 ? _vis$params$grid$valu : (_vis$type$visConfig$d2 = vis.type.visConfig.defaults.grid) === null || _vis$type$visConfig$d2 === void 0 ? void 0 : _vis$type$visConfig$d2.valueAxis) === (yLeftAxis === null || yLeftAxis === void 0 ? void 0 : yLeftAxis.id),
      yRight: ((_vis$params$grid$valu2 = vis.params.grid.valueAxis) !== null && _vis$params$grid$valu2 !== void 0 ? _vis$params$grid$valu2 : (_vis$type$visConfig$d3 = vis.type.visConfig.defaults.grid) === null || _vis$type$visConfig$d3 === void 0 ? void 0 : _vis$type$visConfig$d3.valueAxis) === (yRightAxis === null || yRightAxis === void 0 ? void 0 : yRightAxis.id)
    },
    ...
    valueLabels: ((_vis$params$labels$sh = vis.params.labels.show) !== null && _vis$params$labels$sh !== void 0 ? _vis$params$labels$sh : (_vis$type$visConfig$d4 = vis.type.visConfig.defaults.labels) === null || _vis$type$visConfig$d4 === void 0 ? void 0 : _vis$type$visConfig$d4.show) ? 'show' : 'hide',
    valuesInLegend: Boolean((_vis$params$labels$sh2 = vis.params.labels.show) !== null && _vis$params$labels$sh2 !== void 0 ? _vis$params$labels$sh2 : (_vis$type$visConfig$d5 = vis.type.visConfig.defaults.labels) === null || _vis$type$visConfig$d5 === void 0 ? void 0 : _vis$type$visConfig$d5.show),
