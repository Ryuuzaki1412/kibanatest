...
const WARNING_THRESHOLD_IN_DAYS = 25;
exports.WARNING_THRESHOLD_IN_DAYS = WARNING_THRESHOLD_IN_DAYS;
const licenseManagement = (0, _redux.combineReducers)({
...
exports.licenseManagement = licenseManagement;
...
const getLicenseState = (0, _reselect.createSelector)(getLicense, getExpirationDateFormatted, isExpired, (license, expirationDate, isExpired) => {
  const {
    isActive,
    type
  } = license;
...
exports.getLicenseState = getLicenseState;