...
const permissionsLoading = (0, _reduxActions.createAction)('LICENSE_MANAGEMENT_PERMISSIONS_LOADING');
exports.permissionsLoading = permissionsLoading;
const permissionsSuccess = (0, _reduxActions.createAction)('LICENSE_MANAGEMENT_PERMISSIONS_SUCCESS');
exports.permissionsSuccess = permissionsSuccess;
const permissionsError = (0, _reduxActions.createAction)('LICENSE_MANAGEMENT_PERMISSIONS_ERROR');
