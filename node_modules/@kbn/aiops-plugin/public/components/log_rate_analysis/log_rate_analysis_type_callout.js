...
const LogRateAnalysisTypeCallOut = ({
  ...
  let callOutTitle;
  let callOutText;
  if (!zeroDocsFallback && analysisType === _aiopsUtils.LOG_RATE_ANALYSIS_TYPE.SPIKE) {
  ...
  } else if (!zeroDocsFallback && analysisType === _aiopsUtils.LOG_RATE_ANALYSIS_TYPE.DIP) {
  ...
  } else if (zeroDocsFallback && analysisType === _aiopsUtils.LOG_RATE_ANALYSIS_TYPE.SPIKE) {
