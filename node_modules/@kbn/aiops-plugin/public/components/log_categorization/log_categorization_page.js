...
const LogCategorizationPage = ({
  ...
  const loadCategories = (0, _react.useCallback)(async () => {
    ...
    try {
      const [validationResult, categorizationResult] = await Promise.all([runValidateFieldRequest(index, selectedField, timeField, timeRange, searchQuery, {
  ...
  }), selectedField !== undefined && data !== null && data.categories.length > 0 ? /*#__PURE__*/_react.default.createElement(_category_table.CategoryTable, {
