...
async function showCategorizeFlyout(field, dataView, coreStart, plugins, originatingApp, additionalFilter) {
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      application.currentAppId$.pipe((0, _operators.skip)(1), (0, _operators.takeUntil)((0, _rxjs.from)(flyoutSession.onClose)), (0, _operators.distinctUntilChanged)()).subscribe(() => {
        flyoutSession.close();
      });
    } catch (error) {
      reject(error);
