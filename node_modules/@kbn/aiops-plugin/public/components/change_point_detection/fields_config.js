...
const FieldPanel = ({
  ...
  }, [canCreateCase, canEditDashboards, canUpdateCase, caseAttachmentButtonDisabled, dashboardAttachment.applyTimeRange, dashboardAttachment.maxSeriesToPlot, dataView.id, fieldConfig.fn, fieldConfig.metricField, fieldConfig.splitField, isDashboardFormValid, onRemove, openCasesModalCallback, removeDisabled, selectedPartitions, timeRange]);
  ...
  }, [embeddable, dataView.id, fieldConfig.metricField, fieldConfig.splitField, fieldConfig.fn, dashboardAttachment.applyTimeRange, dashboardAttachment.maxSeriesToPlot, timeRange, selectedChangePoints, panelIndex, selectedPartitions]);
