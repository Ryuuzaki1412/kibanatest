...
const useCommonChartProps = ({
  ...
  const chartTimeRange = (0, _react.useMemo)(() => {
    const absoluteTimeRange = (0, _common.getAbsoluteTimeRange)(timeRange);
    return {
      from: _moment.default.min((0, _moment.default)(absoluteTimeRange.from), (0, _moment.default)(annotation.timestamp)).toISOString(),
      to: _moment.default.max((0, _moment.default)(absoluteTimeRange.to), (0, _moment.default)(annotation.timestamp)).toISOString()
    };
