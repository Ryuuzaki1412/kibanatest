  ...
  return [{
    ...
    privileges: {
      all: {
        ...
        savedObject: {
          all: ['dashboard', 'query'],
          read: ['index-pattern', 'search', 'visualization', 'canvas-workpad', 'lens', 'links', 'map', 'tag']
        },
      ...
      read: {
        ...
        savedObject: {
          all: [],
          read: ['index-pattern', 'search', 'visualization', 'canvas-workpad', 'lens', 'links', 'map', 'dashboard', 'query', 'tag']
        },
        ui: ['show']
      }
    },
    ...
    id: 'filesManagement',
    name: _i18n.i18n.translate('xpack.features.filesManagementFeatureName', {
    ...
    id: 'filesSharedImage',
    name: _i18n.i18n.translate('xpack.features.filesSharedImagesFeatureName', {
    ...
    app: ['kibana'],
    catalogue: [],
    privilegesTooltip: _i18n.i18n.translate('xpack.features.filesSharedImagesPrivilegesTooltip', {
    ...
    name: _i18n.i18n.translate('xpack.features.savedQueryManagementFeatureName', {
    ...
    app: ['kibana'],
    catalogue: [],
    privilegesTooltip: _i18n.i18n.translate('xpack.features.savedQueryManagementTooltip', {
      defaultMessage: 'If set to "All", saved queries can be managed across Kibana in all applications that support them. If set to "None", saved query privileges will be determined independently by each application.'
    }),
    privileges: {
      all: {
        app: ['kibana'],
