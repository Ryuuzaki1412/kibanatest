...
const timeout = (0, _ioTsUtils.inRangeRt)(60, 60 * 15);
exports.timeout = timeout;
const timeoutOrUndefined = t.union([timeout, t.undefined]);
exports.timeoutOrUndefined = timeoutOrUndefined;
...
const queriesOrUndefined = t.union([arrayQueries, t.undefined]); // in the future we might need to support `objectQueries` so use `queries` instead of `arrayQueries` - now removing this because of strange type issue where query is a number
