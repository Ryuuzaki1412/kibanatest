...
exports.SpacesSavedObjectSchemas = void 0;
...
const SpacesSavedObjectSchemas = {
  '8.8.0': _configSchema.schema.object({
    ...
    disabledFeatures: _configSchema.schema.maybe(_configSchema.schema.arrayOf(_configSchema.schema.string())),
...
exports.SpacesSavedObjectSchemas = SpacesSavedObjectSchemas;