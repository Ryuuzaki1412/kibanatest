...
const SnapshotRestoreHome = ({
  ...
  const onSectionChange = newSection => {
    history.push(encodeURI(`${_constants.BASE_PATH}/${encodeURIComponent(newSection)}`));
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiPageHeader, {
    ...
    exact: true,
    path: `${_constants.BASE_PATH}/repositories/:repositoryName*`,
    component: _repository_list.RepositoryList
  }), /*#__PURE__*/_react.default.createElement(_sharedUxRouter.Route, {
    exact: true,
    path: `${_constants.BASE_PATH}/snapshots`,
    component: _snapshot_list.SnapshotList
  }), /*#__PURE__*/_react.default.createElement(_sharedUxRouter.Route, {
    exact: true,
    path: `${_constants.BASE_PATH}/snapshots/:repositoryName*/:snapshotId`,
    component: _snapshot_list.SnapshotList
  }), /*#__PURE__*/_react.default.createElement(_sharedUxRouter.Route, {
    exact: true,
    path: `${_constants.BASE_PATH}/restore_status`,
    component: _restore_list.RestoreList
  }), /*#__PURE__*/_react.default.createElement(_sharedUxRouter.Route, {
    exact: true,
    path: `${_constants.BASE_PATH}/policies/:policyName*`,
