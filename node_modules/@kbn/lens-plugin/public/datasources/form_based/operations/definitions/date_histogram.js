...
function getMultipleDateHistogramsErrorMessage(layer, columnId) {
  ...
  return _i18n.i18n.translate('xpack.lens.indexPattern.multipleDateHistogramsError', {
...
const dateHistogramOperation = {
  ...
  getErrorMessage: (layer, columnId, indexPattern) => [...((0, _helpers.getInvalidFieldMessage)(layer, columnId, indexPattern) || []), getMultipleDateHistogramsErrorMessage(layer, columnId) || ''].filter(Boolean),
