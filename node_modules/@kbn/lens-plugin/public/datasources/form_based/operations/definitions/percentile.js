...
const percentileOperation = {
  type: 'percentile',
  allowAsReference: true,
  displayName: _i18n.i18n.translate('xpack.lens.indexPattern.percentile', {
  ...
  buildColumn: ({
    ...
    const existingPercentileParam = previousColumn && (0, _helpers.isColumnOfType)('percentile', previousColumn) && previousColumn.params.percentile;
  ...
  documentation: {
    ...
    signature: _i18n.i18n.translate('xpack.lens.indexPattern.percentile.signature', {
      defaultMessage: 'field: string, [percentile]: number'
    }),
    description: _i18n.i18n.translate('xpack.lens.indexPattern.percentile.documentation.markdown', {
      defaultMessage: `
...
exports.percentileOperation = percentileOperation;