...
const percentileRanksOperation = {
  ...
  displayName: _i18n.i18n.translate('xpack.lens.indexPattern.percentileRank', {
  ...
  documentation: {
    ...
    signature: _i18n.i18n.translate('xpack.lens.indexPattern.percentileRanks.signature', {
      defaultMessage: 'field: string, [value]: number'
    }),
    description: _i18n.i18n.translate('xpack.lens.indexPattern.percentileRanks.documentation.markdown', {
      defaultMessage: `
...
exports.percentileRanksOperation = percentileRanksOperation;