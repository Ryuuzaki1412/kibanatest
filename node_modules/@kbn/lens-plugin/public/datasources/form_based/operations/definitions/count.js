...
const countOperation = {
  ...
  buildColumn({
    ...
    return {
      ...
      params: {
        ...
        emptyAsNull: previousColumn && (0, _helpers.isColumnOfType)('count', previousColumn) ? (_previousColumn$param = previousColumn.params) === null || _previousColumn$param === void 0 ? void 0 : _previousColumn$param.emptyAsNull : !(columnParams !== null && columnParams !== void 0 && columnParams.usedInMath)
      }
    };
  },
  getAdvancedOptions: ({
  ...
  documentation: {
    ...
    signature: _i18n.i18n.translate('xpack.lens.indexPattern.count.signature', {
      defaultMessage: '[field: string]'
    }),
    description: _i18n.i18n.translate('xpack.lens.indexPattern.count.documentation.markdown', {
      defaultMessage: `
