...
const termsOperation = {
  ...
  getErrorMessage: (layer, columnId, indexPattern) => {
    const messages = [...((0, _helpers.getInvalidFieldMessage)(layer, columnId, indexPattern) || []), (0, _helpers2.getDisallowedTermsMessage)(layer, columnId, indexPattern) || '', (0, _helpers2.getMultiTermsScriptedFieldErrorMessage)(layer, columnId, indexPattern) || ''].filter(Boolean);
  ...
  renderFieldInput: function FieldInput(props) {
    ...
    const showScriptedFieldError = Boolean((0, _helpers2.getMultiTermsScriptedFieldErrorMessage)(layer, columnId, indexPattern));
    const {
      invalidFields
