...
function getInvalidSortFieldMessage(sortField, columnId, indexPattern) {
  if (!indexPattern) {
    return;
  }
  ...
  if (field.type !== 'date') {
    return _i18n.i18n.translate('xpack.lens.indexPattern.lastValue.invalidTypeSortField', {
...
const lastValueOperation = {
  type: 'last_value',
  displayName: _i18n.i18n.translate('xpack.lens.indexPattern.lastValue', {
  ...
  getErrorMessage(layer, columnId, indexPattern) {
    ...
    const errorMessages = [];
    const invalidSourceFieldMessage = (0, _helpers.getInvalidFieldMessage)(layer, columnId, indexPattern);
    if (invalidSourceFieldMessage) {
      errorMessages.push(...invalidSourceFieldMessage);
    }
    const invalidSortFieldMessage = getInvalidSortFieldMessage(column.params.sortField, columnId, indexPattern);
    if (invalidSortFieldMessage) {
      errorMessages.push(invalidSortFieldMessage);
    }
    errorMessages.push(...((0, _reduced_time_range_utils.getColumnReducedTimeRangeError)(layer, columnId, indexPattern) || []));
  ...
  paramEditor: ({
    ...
    const isSortFieldInvalid = !!getInvalidSortFieldMessage(currentColumn.params.sortField, '', indexPattern);
  ...
  documentation: {
    ...
    signature: _i18n.i18n.translate('xpack.lens.indexPattern.lastValue.signature', {
      defaultMessage: 'field: string'
    }),
    description: _i18n.i18n.translate('xpack.lens.indexPattern.lastValue.documentation.markdown', {
      defaultMessage: `
...
exports.lastValueOperation = lastValueOperation;