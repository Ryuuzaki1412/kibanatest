...
const durationOutputOptions = _common.DURATION_OUTPUT_FORMATS.map(getNewHumanizeOutputLabel);
exports.durationOutputOptions = durationOutputOptions;
const durationInputOptions = _common.DURATION_INPUT_FORMATS.map(({
  text,
  kind
}) => ({
  label: text,
