...
exports.timeShiftOptions = timeShiftOptions;
const timeShiftOptionOrder = timeShiftOptions.reduce((optionMap, {
  value
}, index) => ({
  ...optionMap,
  [value]: index
}), {});
exports.timeShiftOptionOrder = timeShiftOptionOrder;
    ...
    timeShifts.forEach(timeShift => {
      ...
      if (timeShift < shiftInterval) {
        timeShiftMap[timeShift].forEach(columnId => {
          warningMessages.push( /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
            key: `small-${columnId}`,
