...
exports.reducedTimeRangeOptions = reducedTimeRangeOptions;
const reducedTimeRangeOptionOrder = reducedTimeRangeOptions.reduce((optionMap, {
  value
}, index) => ({
  ...optionMap,
  [value]: index
}), {});
exports.reducedTimeRangeOptionOrder = reducedTimeRangeOptionOrder;
function getColumnReducedTimeRangeError(layer, columnId, indexPattern) {
  ...
  const errors = [hasDateHistogram && _i18n.i18n.translate('xpack.lens.indexPattern.reducedTimeRangeWithDateHistogram', {
  ...
  }), !hasTimeField && _i18n.i18n.translate('xpack.lens.indexPattern.reducedTimeRangeWithoutTimefield', {
