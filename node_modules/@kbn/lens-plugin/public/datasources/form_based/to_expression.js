    ...
    esAggEntries.forEach(([colId, col], index) => {
      ...
      if (def.input !== 'fullReference' && def.input !== 'managedReference') {
        ...
        let aggAst = def.toEsAggsFn({
          ...col,
          timeShift: (0, _time_shift_utils.resolveTimeShift)(col.timeShift, dateRange, histogramBarsTarget, hasDateHistogram)
    ...
    */
    ...
    return {
      ...
      chain: [{
        ...
        probability: (0, _utils.getSamplingValue)(layer),
