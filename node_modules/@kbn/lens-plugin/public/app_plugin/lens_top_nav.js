...
function getLensTopNavConfig(options) {
  ...
  const enableSaveButton = savingToLibraryPermitted || allowByValue && savingToDashboardPermitted && !isByValueMode && !showSaveAndReturn;
...
const LensTopNavMenu = ({
  ...
  const topNavConfig = (0, _react.useMemo)(() => {
    ...
    const showSaveAndReturn = !(showReplaceInDashboard || showReplaceInCanvas) && (Boolean(isLinkedToOriginatingApp && (
    // Temporarily required until the 'by value' paradigm is default.
    dashboardFeatureFlag.allowByValueEmbeddables || Boolean(initialInput))) || Boolean(initialContextIsEmbedded));
      ...
      actions: {
        ...
        share: {
          ...
          execute: async anchorElement => {
            var _visualizationMap$vis, _visualizationMap$vis2, _visualizationMap$vis3;
            if (!share) {
              return;
            }
            ...
            const sharingData = {
              ...
              layout: {
                dimensions: (_visualizationMap$vis = (_visualizationMap$vis2 = (_visualizationMap$vis3 = visualizationMap[visualization.activeId]).getReportingLayout) === null || _visualizationMap$vis2 === void 0 ? void 0 : _visualizationMap$vis2.call(_visualizationMap$vis3, visualization.state)) !== null && _visualizationMap$vis !== void 0 ? _visualizationMap$vis : _share_action.DEFAULT_LENS_LAYOUT_DIMENSIONS
              }
            };
            share.toggleShareContextMenu({
              ...
              allowEmbed: false,
              allowShortUrl: false,
              // we'll manage this implicitly via the new service
              ...
              objectType: 'lens',
              objectTypeTitle: _i18n.i18n.translate('xpack.lens.app.share.panelTitle', {
