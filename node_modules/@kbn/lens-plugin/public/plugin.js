...
var _public5 = require("@kbn/ui-actions-plugin/public");
...
var _action = require("./trigger_actions/open_lens_config/action");
...
class LensPlugin {
  ...
  setup(core, {
    ...
    core.application.register({
      ...
      navLinkStatus: _public4.AppNavLinkStatus.hidden,
      mount: async params => {
        const {
          core: coreStart,
          plugins: deps
  ...
  start(core, startDependencies) {
    ...
    if (startDependencies.uiActions.hasAction(_public5.ACTION_VISUALIZE_FIELD)) {
      startDependencies.uiActions.unregisterAction(_public5.ACTION_VISUALIZE_FIELD);
    }
    startDependencies.uiActions.addTriggerAction(_public5.VISUALIZE_FIELD_TRIGGER, (0, _visualize_field_actions.visualizeFieldAction)(core.application));
    ...
    const editInLensAction = new _action.ConfigureInLensPanelAction(startDependencies, core.overlays, core.theme);
