...
const selectFramePublicAPI = (0, _toolkit.createSelector)([selectCurrentDatasourceStates, selectActiveData, selectInjectedDependencies, selectDataViews, selectExecutionContext], (datasourceStates, activeData, datasourceMap, dataViews, context) => {
  return {
