...
exports.getMessageIdsForDimension = getMessageIdsForDimension;
exports.getReferenceLayers = void 0;
exports.getVisualizationType = getVisualizationType;
exports.isReferenceLayer = exports.isPersistedLinkedByValueAnnotationsLayer = exports.isPersistedByValueAnnotationsLayer = exports.isPersistedByReferenceAnnotationsLayer = exports.isPersistedAnnotationsLayer = exports.isNumericMetric = exports.isNumericDynamicMetric = exports.isDataLayer = exports.isByReferenceAnnotationsLayer = exports.isBucketed = exports.isAnnotationsLayer = void 0;
...
const isPersistedAnnotationsLayer = layer => layer.layerType === _.layerTypes.ANNOTATIONS && !('indexPatternId' in layer);
...
function getVisualizationType(state) {
  ...
  const visualizationType = _types.visualizationTypes.find(t => t.id === (dataLayers === null || dataLayers === void 0 ? void 0 : dataLayers[0].seriesType));
...
const defaultIcon = _chartIcons.IconChartBarStacked;
exports.defaultIcon = defaultIcon;
const defaultSeriesType = 'bar_stacked';
exports.defaultSeriesType = defaultSeriesType;
const supportedDataLayer = {
...
exports.supportedDataLayer = supportedDataLayer;
...
function validateLayersForDimension(dimension, layers, missingCriteria) {
  ...
  const layerMissingAccessors = layers.reduce((missing, layer, i) => {
  ...
  return {
    valid: false,
    payload: getMessageIdsForDimension(dimension, layerMissingAccessors, (0, _state_helpers.isHorizontalChart)(layers))
  };
}
