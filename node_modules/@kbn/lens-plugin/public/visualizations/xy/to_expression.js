...
const buildXYExpression = (state, metadata, datasourceLayers, paletteService, datasourceExpressionsByLayers, eventAnnotationService) => {
  var _state$axisTitlesVisi, _state$axisTitlesVisi2, _state$tickLabelsVisi, _state$tickLabelsVisi2, _state$gridlinesVisib, _state$gridlinesVisib2, _state$labelsOrientat, _state$labelsOrientat2, _state$axisTitlesVisi3, _state$axisTitlesVisi4, _state$tickLabelsVisi3, _state$tickLabelsVisi4, _state$gridlinesVisib3, _state$gridlinesVisib4, _state$labelsOrientat3, _state$labelsOrientat4, _state$legend$shouldT, _state$axisTitlesVisi5, _state$axisTitlesVisi6, _state$tickLabelsVisi5, _state$tickLabelsVisi6, _state$gridlinesVisib5, _state$gridlinesVisib6, _state$labelsOrientat5, _state$labelsOrientat6, _state$xExtent, _state$fittingFunctio, _state$endValue, _state$emphasizeFitti, _state$minBarHeight, _state$fillOpacity, _state$valueLabels, _state$hideEndzones, _state$showCurrentTim, _state$valuesInLegend, _validDataLayers$, _metadata$validDataLa, _metadata$validDataLa2, _validDataLayers$2, _validDataLayers$3;
  ...
  const layeredXyVisFn = (0, _common.buildExpressionFunction)('layeredXyVis', {
    ...
    addTimeMarker: (_state$showCurrentTim = state.showCurrentTimeMarker) !== null && _state$showCurrentTim !== void 0 ? _state$showCurrentTim : false,
    valuesInLegend: (_state$valuesInLegend = state.valuesInLegend) !== null && _state$valuesInLegend !== void 0 ? _state$valuesInLegend : false,
