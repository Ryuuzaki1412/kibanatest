...
const DatatableComponent = props => {
  ...
  const headerRowHeight = (_props$args$headerRow = props.args.headerRowHeight) !== null && _props$args$headerRow !== void 0 ? _props$args$headerRow : 'single';
  const headerRowLines = (_props$args$headerRow2 = props.args.headerRowHeightLines) !== null && _props$args$headerRow2 !== void 0 ? _props$args$headerRow2 : 1;
  ...
  const sorting = (0, _react.useMemo)(() => (0, _table_actions.createGridSortingConfig)(sortBy, sortDirection, onEditAction), [onEditAction, sortBy, sortDirection]);
  ...
  return /*#__PURE__*/_react.default.createElement(_visualization_container.VisualizationContainer, {
    ...
    rowHeightsOptions: {
      defaultHeight: props.args.fitRowToContent ? 'auto' : props.args.rowHeightLines && props.args.rowHeightLines !== 1 ? {
