...
const getSuggestions = ({
  ...
  const shape = (state === null || state === void 0 ? void 0 : state.shape) === _common.GaugeShapes.VERTICAL_BULLET ? _common.GaugeShapes.VERTICAL_BULLET : _common.GaugeShapes.HORIZONTAL_BULLET;
  const baseSuggestion = {
    ...
    previewIcon: shape === _common.GaugeShapes.VERTICAL_BULLET ? _chartIcons.IconChartVerticalBullet : _chartIcons.IconChartHorizontalBullet,
    score: 0.5,
