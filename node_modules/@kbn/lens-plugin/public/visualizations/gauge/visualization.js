...
const CHART_NAMES = {
  horizontalBullet: {
    ...
    label: _i18n.i18n.translate('xpack.lens.gaugeHorizontal.gaugeLabel', {
  ...
  verticalBullet: {
    ...
    label: _i18n.i18n.translate('xpack.lens.gaugeVertical.gaugeLabel', {
...
const getGaugeVisualization = ({
  ...
  getDescription(state) {
    if (state.shape === _common2.GaugeShapes.HORIZONTAL_BULLET) {
  ...
  switchVisualizationType: (visualizationTypeId, state) => {
    return {
      ...state,
      shape: visualizationTypeId === _common2.GaugeShapes.HORIZONTAL_BULLET ? _common2.GaugeShapes.HORIZONTAL_BULLET : _common2.GaugeShapes.VERTICAL_BULLET
    };
  },
