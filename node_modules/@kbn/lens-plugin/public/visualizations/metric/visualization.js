...
const getDefaultColor = (state, isMetricNumeric) => {
  return showingBar(state) && isMetricNumeric ? _uiTheme.euiLightVars.euiColorPrimary : _uiTheme.euiThemeVars.euiColorLightestShade;
};
exports.getDefaultColor = getDefaultColor;
const supportedDataTypes = new Set(['string', 'boolean', 'number', 'ip', 'date']);
