...
class Embeddable extends _public4.Embeddable {
  logError(type) {
  ...
  constructor(deps, initialInput, parent) {
    ...
    (0, _defineProperty2.default)(this, "dataViews", []);
    ...
    (0, _defineProperty2.default)(this, "getUserMessages", (locationId, filters) => {
      var _this$savedVis, _mergedSearchContext$, _mergedSearchContext$2, _mergedSearchContext$3, _mergedSearchContext$4, _mergedSearchContext$5, _this$activeDatasourc, _this$activeDatasourc2, _this$activeVisualiza, _this$activeVisualiza2, _this$activeVisualiza3, _this$activeVisualiza4, _this$activeVisualiza5;
      const userMessages = [];
    ...
    (0, _defineProperty2.default)(this, "updateActiveData", (data, adapters) => {
      ...
      this.removeActiveDataWarningMessages = this.addUserMessages(searchWarningMessages.filter(_types.isMessageRemovable));
    ...
    (0, _defineProperty2.default)(this, "renderBadgeMessages", () => {
      ...
      if (this.badgeDomNode) {
        ...
        }, /*#__PURE__*/_react.default.createElement(EmbeddableMessagesPopover, {
    ...
    (0, _defineProperty2.default)(this, "hasCompatibleActions", async event => {
      if ((0, _types.isLensTableRowContextMenuClickEvent)(event) || (0, _types.isLensMultiFilterEvent)(event) || (0, _types.isLensFilterEvent)(event)) {
        ...
        const actions = await getTriggerCompatibleActions(_public3.VIS_EVENT_TO_TRIGGER[event.name], {
          data: event.data,
          embeddable: this
        });
    ...
    (0, _defineProperty2.default)(this, "getCompatibleCellValueActions", async data => {
      ...
      if (getTriggerCompatibleActions) {
        ...
        const actions = await getTriggerCompatibleActions(_public4.CELL_VALUE_TRIGGER, {
          data,
          embeddable
        });
        return actions.sort((a, b) => {
          ...
          iconType: action.getIconType({
            embeddable,
            data,
            trigger: _public4.cellValueTrigger
          }),
    ...
    (0, _defineProperty2.default)(this, "handleEvent", async event => {
      ...
      if ((0, _types.isLensFilterEvent)(event) || (0, _types.isLensMultiFilterEvent)(event) || (0, _types.isLensBrushEvent)(event)) {
        if (shouldExecuteDefaultTriggers) {
          this.deps.getTrigger(_public3.VIS_EVENT_TO_TRIGGER[event.name]).exec({
            data: {
              ...event.data,
    ...
    this.inputReloadSubscriptions.push(input$.pipe((0, _operators.map)(input => {
    ...
    }), (0, _operators.distinctUntilChanged)((a, b) => (0, _fastDeepEqual.default)(a, b)), (0, _operators.skip)(1)).subscribe(input => {
      this.reload();
    }));
    ...
    this.inputReloadSubscriptions.push(input$.pipe((0, _operators.map)(input => input.viewMode), (0, _operators.distinctUntilChanged)(), (0, _operators.skip)(1)).subscribe(input => {
    ...
    const withTrigger = trigger => (0, _operators.map)(input => ({
      trigger,
      input
    }));

    // Re-initialize the visualization if either the attributes or the saved object id changes
    const attributesOrSavedObjectId$ = input$.pipe((0, _operators.distinctUntilChanged)((a, b) => (0, _fastDeepEqual.default)(['attributes' in a && a.attributes, 'savedObjectId' in a && a.savedObjectId, 'overrides' in a && a.overrides, 'disableTriggers' in a && a.disableTriggers], ['attributes' in b && b.attributes, 'savedObjectId' in b && b.savedObjectId, 'overrides' in b && b.overrides, 'disableTriggers' in b && b.disableTriggers])), (0, _operators.skip)(1), withTrigger('attributesOrSavedObjectId'));

    // Update search context and reload on changes related to search
    const searchContext$ = (0, _public4.shouldFetch$)(input$, () => this.getInput()).pipe(withTrigger('searchContext'));

    // Merge and debounce the observables to avoid multiple reloads
    this.inputReloadSubscriptions.push((0, _rxjs.merge)(searchContext$, attributesOrSavedObjectId$).pipe((0, _operators.debounceTime)(0), (0, _rxjs.switchMap)(async ({
      trigger,
      input
    }) => {
  ...
  get activeDatasourceState() {
    var _this$savedVis3, _this$savedVis4, _this$savedVis5;
    if (!this.activeDatasourceId || !this.activeDatasource) return;
    const docDatasourceState = (_this$savedVis3 = this.savedVis) === null || _this$savedVis3 === void 0 ? void 0 : _this$savedVis3.state.datasourceStates[this.activeDatasourceId];
    return this.activeDatasource.initialize(docDatasourceState, [...(((_this$savedVis4 = this.savedVis) === null || _this$savedVis4 === void 0 ? void 0 : _this$savedVis4.references) || []), ...(((_this$savedVis5 = this.savedVis) === null || _this$savedVis5 === void 0 ? void 0 : _this$savedVis5.state.internalReferences) || [])], undefined, undefined, this.indexPatterns);
  }
  ...
  getTextBasedLanguage() {
    var _this$savedVis6, _this$savedVis7;
    if (!this.isTextBasedLanguage() || !((_this$savedVis6 = this.savedVis) !== null && _this$savedVis6 !== void 0 && _this$savedVis6.state.query)) {
      return;
    }
    const query = (_this$savedVis7 = this.savedVis) === null || _this$savedVis7 === void 0 ? void 0 : _this$savedVis7.state.query;
  ...
  async navigateToLensEditor() {
    ...
    const transfer = new _public4.EmbeddableStateTransfer(this.deps.coreStart.application.navigateToApp, this.deps.coreStart.application.currentAppId$);
    if (transfer) {
  ...
  async openConfingPanel(startDependencies) {
    ...
    if (attributes) {
      ...
      return /*#__PURE__*/_react.default.createElement(Component, {
        ...
        panelId: this.id,
        savedObjectId: (_this$savedVis8 = this.savedVis) === null || _this$savedVis8 === void 0 ? void 0 : _this$savedVis8.savedObjectId,
  ...
  getSearchWarningMessages(adapters) {
    ...
    const docDatasourceState = (_this$savedVis9 = this.savedVis) === null || _this$savedVis9 === void 0 ? void 0 : _this$savedVis9.state.datasourceStates[this.activeDatasourceId];
  ...
  render(domNode) {
    ...
    if (this.expression && !blockingErrors.length) {
      (0, _reactDom.render)( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_public2.KibanaThemeProvider, {
        theme$: this.deps.theme.theme$
      }, /*#__PURE__*/_react.default.createElement(_expression_wrapper.ExpressionWrapper, {
  ...
  renderUserMessages() {
    ...
    if (errors.length && this.domNode) {
      (0, _reactDom.render)( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_public2.KibanaThemeProvider, {
        theme$: this.deps.theme.theme$
      }, /*#__PURE__*/_react.default.createElement(_i18nReact.I18nProvider, null, /*#__PURE__*/_react.default.createElement(VisualizationErrorPanel, {
        errors: errors,
  ...
  get onEditAction() {
    ...
    const visType = (_this$savedVis10 = this.savedVis) === null || _this$savedVis10 === void 0 ? void 0 : _this$savedVis10.visualizationType;
    if (!visType) {
      return;
    }
  ...
  async initializeOutput() {
    var _this$savedVis11, _this$savedVis12, _input$title, _input$description;
    if (!this.savedVis) {
      return;
    }
    const {
      indexPatterns
    } = await (0, _utils.getIndexPatternsObjects)(((_this$savedVis11 = this.savedVis) === null || _this$savedVis11 === void 0 ? void 0 : _this$savedVis11.references.map(({
      id
    }) => id)) || [], this.deps.dataViews);
    (await Promise.all(Object.values(((_this$savedVis12 = this.savedVis) === null || _this$savedVis12 === void 0 ? void 0 : _this$savedVis12.state.adHocDataViews) || {}).map(spec => this.deps.dataViews.create(spec)))).forEach(dataView => indexPatterns.push(dataView));
    this.dataViews = (0, _lodash.uniqBy)(indexPatterns, 'id');
    ...
    if (input.timeRange == null && indexPatterns.some(indexPattern => indexPattern.isTimeBased())) {
      this.addUserMessages([{
   ...
   */
  async getFilters() {
    var _this$savedVis$state$, _this$savedVis13, _this$savedVis$refere, _this$savedVis14;
    return (0, _public.mapAndFlattenFilters)(this.deps.injectFilterReferences((_this$savedVis$state$ = (_this$savedVis13 = this.savedVis) === null || _this$savedVis13 === void 0 ? void 0 : _this$savedVis13.state.filters) !== null && _this$savedVis$state$ !== void 0 ? _this$savedVis$state$ : [], (_this$savedVis$refere = (_this$savedVis14 = this.savedVis) === null || _this$savedVis14 === void 0 ? void 0 : _this$savedVis14.references) !== null && _this$savedVis$refere !== void 0 ? _this$savedVis$refere : []));
  }
   ...
   */
  async getQuery() {
    var _this$savedVis15;
    return (_this$savedVis15 = this.savedVis) === null || _this$savedVis15 === void 0 ? void 0 : _this$savedVis15.state.query;
  }
  getSavedVis() {
  ...
  get visDisplayOptions() {
    var _this$savedVis16, _this$deps$visualizat5, _this$deps$visualizat6, _this$deps$visualizat7;
    if (!((_this$savedVis16 = this.savedVis) !== null && _this$savedVis16 !== void 0 && _this$savedVis16.visualizationType)) {
      return {};
    }
