...
exports.createPureOriginInterpreterStateMachine = exports.createOriginInterpreterStateMachine = void 0;
var _xstate = require("xstate");
var _constants = require("./constants");
var _defaults = require("./defaults");
var _location_state_service = require("./location_state_service");
...
exports.createPureOriginInterpreterStateMachine = createPureOriginInterpreterStateMachine;
const createOriginInterpreterStateMachine = ({
  initialContext = _defaults.DEFAULT_CONTEXT,
  history,
  toasts
}) => createPureOriginInterpreterStateMachine(initialContext).withConfig({
  actions: {
    requestFeedback: (0, _notifications.createRequestFeedbackNotifier)(toasts)
  },
  services: {
    initializeFromLocationState: (0, _location_state_service.initializeFromLocationState)({
      history
    })
  }
});
exports.createOriginInterpreterStateMachine = createOriginInterpreterStateMachine;