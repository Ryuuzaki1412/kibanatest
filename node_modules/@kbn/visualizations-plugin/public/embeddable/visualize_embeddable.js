...
class VisualizeEmbeddable extends _public3.Embeddable {
   ...
   */
  async getFilters() {
    var _input$savedVis$data$, _input$savedVis, _input$savedVis$data$2;
    let input = this.getInput();
    if (this.inputIsRefType(input)) {
      input = await this.getInputAsValueType();
    }
    const filters = (_input$savedVis$data$ = (_input$savedVis = input.savedVis) === null || _input$savedVis === void 0 ? void 0 : (_input$savedVis$data$2 = _input$savedVis.data.searchSource) === null || _input$savedVis$data$2 === void 0 ? void 0 : _input$savedVis$data$2.filter) !== null && _input$savedVis$data$ !== void 0 ? _input$savedVis$data$ : [];
   ...
   */
  async getQuery() {
    var _input$savedVis2, _input$savedVis2$data;
    let input = this.getInput();
    if (this.inputIsRefType(input)) {
      input = await this.getInputAsValueType();
    }
    return (_input$savedVis2 = input.savedVis) === null || _input$savedVis2 === void 0 ? void 0 : (_input$savedVis2$data = _input$savedVis2.data.searchSource) === null || _input$savedVis2$data === void 0 ? void 0 : _input$savedVis2$data.query;
  }
  /**
