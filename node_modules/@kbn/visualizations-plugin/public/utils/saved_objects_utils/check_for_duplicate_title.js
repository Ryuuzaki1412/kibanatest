 ...
 * @param services
 */
async function checkForDuplicateTitle(savedObject, copyOnSave, isTitleDuplicateConfirmed, onTitleDuplicate, services) {
  const {
    overlays
  } = services;
  ...
  const duplicate = await (0, _find_object_by_title.findObjectByTitle)(savedObject.title);
  ...
  return (0, _display_duplicate_title_confirm_modal.displayDuplicateTitleConfirmModal)(savedObject, overlays);
}