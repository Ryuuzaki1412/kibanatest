...
const CHARTS_WITHOUT_SMALL_MULTIPLES = {
  gauge: 'gauge'
};
exports.CHARTS_WITHOUT_SMALL_MULTIPLES = CHARTS_WITHOUT_SMALL_MULTIPLES;
const CHARTS_TO_BE_DEPRECATED = {
  pie: 'pie',
  controls: 'input_control_vis'
};
exports.CHARTS_TO_BE_DEPRECATED = CHARTS_TO_BE_DEPRECATED;
const CHARTS_CONFIG_TOKENS = {
  [CHARTS_WITHOUT_SMALL_MULTIPLES.gauge]: _constants.NEW_GAUGE_CHARTS_LIBRARY
};
exports.CHARTS_CONFIG_TOKENS = CHARTS_CONFIG_TOKENS;
