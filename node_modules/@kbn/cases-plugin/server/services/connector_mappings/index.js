...
class ConnectorMappingsService {
  ...
  async find({
    ...
    try {
      ...
      for (const mapping of connectorMappings.saved_objects) {
        const validatedMapping = (0, _api.decodeOrThrow)(_connector_mappings.ConnectorMappingsAttributesTransformedRt)(mapping.attributes);
  ...
  async post({
    ...
    try {
      ...
      const decodedAttributes = (0, _api.decodeOrThrow)(_connector_mappings.ConnectorMappingsAttributesTransformedRt)(attributes);
      ...
      const validatedAttributes = (0, _api.decodeOrThrow)(_connector_mappings.ConnectorMappingsAttributesTransformedRt)(connectorMappings.attributes);
      return Object.assign(connectorMappings, {
  ...
  async update({
    ...
    try {
      ...
      const decodedAttributes = (0, _api.decodeOrThrow)(_connector_mappings.ConnectorMappingsAttributesPartialRt)(attributes);
      ...
      const validatedAttributes = (0, _api.decodeOrThrow)(_connector_mappings.ConnectorMappingsAttributesPartialRt)(updatedMappings.attributes);
