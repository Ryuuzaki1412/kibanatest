...
const getCasesMetrics = async (params, casesClient, clientArgs) => {
  ...
  try {
    const queryParams = (0, _api.decodeWithExcessOrThrow)(_api2.CasesMetricsRequestRt)(params);
    ...
    return (0, _runtime_types.decodeOrThrow)(_api2.CasesMetricsResponseRt)(mergedResults);
  } catch (error) {
