...
const getCasesByAlertID = async ({
  ...
  try {
    const queryParams = (0, _api2.decodeWithExcessOrThrow)(_api.CasesByAlertIDRequestRt)(options);
    const {
...
async function getTags(params, clientArgs) {
  ...
  try {
    const queryParams = (0, _api2.decodeWithExcessOrThrow)(_api.AllTagsFindRequestRt)(params);
    const {
      filter: authorizationFilter
...
async function getReporters(params, clientArgs) {
  ...
  try {
    const queryParams = (0, _api2.decodeWithExcessOrThrow)(_api.AllReportersFindRequestRt)(params);
    const {
      filter: authorizationFilter
...
async function getCategories(params, clientArgs) {
  ...
  try {
    const queryParams = (0, _api2.decodeWithExcessOrThrow)(_api.AllCategoriesFindRequestRt)(params);
    const {
      filter: authorizationFilter
