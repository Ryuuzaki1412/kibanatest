...
var _api2 = require("../../../common/types/api");
...
const bulkCreate = async (data, clientArgs, casesClient) => {
  ...
  try {
    const decodedData = (0, _api.decodeWithExcessOrThrow)(_api2.BulkCreateCasesRequestRt)(data);
    ...
    const res = [];
    const [errors, casesSOs] = (0, _lodash.partition)(bulkCreateResponse.saved_objects, _utils.isSOError);
    if (errors.length > 0) {
      const firstError = errors[0];
      throw new _boom.default.Boom(firstError.error.error, {
    ...
    return (0, _runtime_types.decodeOrThrow)(_api2.BulkCreateCasesResponseRt)({
      cases: res
    });
  } catch (error) {
