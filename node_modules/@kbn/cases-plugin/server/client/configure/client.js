...
async function get(params = {}, clientArgs, casesClientInternal) {
  ...
  try {
    const queryParams = (0, _api2.decodeWithExcessOrThrow)(_api.GetConfigurationFindRequestRt)(params);
    const {
...
async function update(configurationId, req, clientArgs, casesClientInternal) {
  ...
  try {
    ...
    const request = (0, _api2.decodeWithExcessOrThrow)(_api.ConfigurationPatchRequestRt)(req);
...
async function create(configRequest, clientArgs, casesClientInternal) {
  ...
  try {
    ...
    const validatedConfigurationRequest = (0, _api2.decodeWithExcessOrThrow)(_api.ConfigurationRequestRt)(configRequest);
    (0, _validators.validateDuplicatedCustomFieldKeysInRequest)({
