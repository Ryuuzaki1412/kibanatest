...
const mockedTestProvidersOwner = [_constants.SECURITY_SOLUTION_OWNER];

/** A utility for wrapping children in the providers required to run most tests */
exports.mockedTestProvidersOwner = mockedTestProvidersOwner;
...
const testQueryClient = new _reactQuery.QueryClient({
  defaultOptions: {
    queries: {
      retry: false
    }
...
exports.testQueryClient = testQueryClient;
