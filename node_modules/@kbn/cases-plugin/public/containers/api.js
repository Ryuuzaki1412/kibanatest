...
const getFeatureIds = async ({
  ...
  return _kibana.KibanaServices.get().http.fetch(`${_constants.BASE_RAC_ALERTS_API_PATH}/_feature_ids`, {
    signal,
    query
  });
};
