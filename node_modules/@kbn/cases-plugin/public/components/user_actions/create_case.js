...
const getLabelTitle = userAction => `${i18n.CREATE_CASE.toLowerCase()} "${userAction.payload.title}"`;
const createCaseUserActionBuilder = ({
  userAction,
  userProfiles,
  handleOutlineComment
}) => ({
  build: () => {
    const createCaseUserAction = userAction;
