...
const useGetSeverity = ({
  ...
  return (0, _reactQuery.useQuery)(_constants.connectorsQueriesKeys.resilientGetSeverity((_connector$id = connector === null || connector === void 0 ? void 0 : connector.id) !== null && _connector$id !== void 0 ? _connector$id : ''), ({
    signal
  }) => {
    var _connector$id2;
    return (0, _api.getSeverity)({
      http,
      signal,
