...
const ConnectorUserActionPayloadWithoutConnectorIdRt = rt.strict({
  connector: _v.CaseUserActionConnectorRt
});
exports.ConnectorUserActionPayloadWithoutConnectorIdRt = ConnectorUserActionPayloadWithoutConnectorIdRt;
const ConnectorUserActionPayloadRt = rt.strict({
  connector: _v.CaseConnectorRt
});
exports.ConnectorUserActionPayloadRt = ConnectorUserActionPayloadRt;
const ConnectorUserActionWithoutConnectorIdRt = rt.strict({
  type: rt.literal(_v2.UserActionTypes.connector),
...
const ConnectorUserActionRt = rt.strict({
  type: rt.literal(_v2.UserActionTypes.connector),
