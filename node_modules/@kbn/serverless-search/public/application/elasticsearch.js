...
async function renderApp(element, core, services) {
  ...
  } = await Promise.resolve().then(() => _interopRequireWildcard(require('./components/overview')));
  ...
  }, /*#__PURE__*/_react.default.createElement(_sharedUxRouter.Routes, null, /*#__PURE__*/_react.default.createElement(_sharedUxRouter.Route, null, /*#__PURE__*/_react.default.createElement(ElasticsearchOverview, null)))))))), element);
