...
var _connectors_router = require("../connectors_router");
...
const ConnectorsTable = () => {
  ...
  const columns = [{
    ...
    render: (name, connector) => /*#__PURE__*/_react.default.createElement(_eui.EuiLink, {
      ...
      onClick: () => navigateToUrl((0, _reactRouterDom.generatePath)(_connectors_router.EDIT_CONNECTOR_PATH, {
        id: connector.id
      }))
    }, name || connector.id),
    truncateText: true
    ...
    name: typeLabel,
    render: serviceType => {
      const typeData = ((connectorTypes === null || connectorTypes === void 0 ? void 0 : connectorTypes.connectors) || []).find(connector => connector.serviceType === (serviceType !== null && serviceType !== void 0 ? serviceType : ''));
      if (!typeData) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
    ...
    values: {
      ...
      items: /*#__PURE__*/_react.default.createElement("strong", null, /*#__PURE__*/_react.default.createElement(_eui.EuiI18nNumber, {
        ...
        value: pageIndex * pageSize + 1 + items.length
      })),
