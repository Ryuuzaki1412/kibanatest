...
const EditServiceType = ({
  ...
  const options = (connectorTypes === null || connectorTypes === void 0 ? void 0 : connectorTypes.connectors.map(connectorType => ({
  ...
  const {
    ...
    onError: error => showErrorToast(error, _i18n.i18n.translate('xpack.serverlessSearch.connectors.config.connectorServiceTypeError', {
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiForm, null, /*#__PURE__*/_react.default.createElement(_eui.EuiFormLabel, null, _i18n.i18n.translate('xpack.serverlessSearch.connectors.serviceTypeLabel', {
