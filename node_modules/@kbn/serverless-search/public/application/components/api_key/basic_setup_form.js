...
const DEFAULT_EXPIRES_VALUE = '60';
exports.DEFAULT_EXPIRES_VALUE = DEFAULT_EXPIRES_VALUE;
const BasicSetupForm = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiForm, null, /*#__PURE__*/_react.default.createElement(_eui.EuiFormRow, {
    fullWidth: true,
    isInvalid: !name,
    helpText: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.nameFieldHelpText', {
      defaultMessage: 'A good name makes it clear what your API key does.'
    }),
    label: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.nameFieldLabel', {
      defaultMessage: 'Name'
    })
    ...
    fullWidth: true,
    helpText: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.userFieldHelpText', {
      defaultMessage: 'ID of the user creating the API key.'
    }),
    label: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.userFieldLabel', {
      defaultMessage: 'User'
    })
  }, /*#__PURE__*/_react.default.createElement(_eui.EuiFieldText, {
    ...
    labelAppend: /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
      ...
      color: "subdued",
      size: "xs"
    }, _i18n.i18n.translate('xpack.serverlessSearch.apiKey.expiresFieldHelpText', {
      defaultMessage: 'API keys should be rotated regularly.'
    })))),
    label: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.expiresFieldLabel', {
      defaultMessage: 'Expires'
    })
  }, /*#__PURE__*/_react.default.createElement(_eui.EuiRadioGroup, {
    options: [{
      id: 'never',
      label: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.expiresField.neverLabel', {
        defaultMessage: 'Never'
      }),
      'data-test-subj': 'create-api-key-expires-never-radio'
    }, {
      id: 'days',
      label: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.expiresField.daysLabel', {
    ...
    fullWidth: true,
    disabled: isLoading,
    append: _i18n.i18n.translate('xpack.serverlessSearch.apiKey.expiresFieldUnit', {
      defaultMessage: 'days'
    }),
    placeholder: "1",
