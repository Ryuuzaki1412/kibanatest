...
const DEFAULT_COLUMNS = [_indicator.RawIndicatorFieldId.TimeStamp, _indicator.RawIndicatorFieldId.Name, _indicator.RawIndicatorFieldId.Type, _indicator.RawIndicatorFieldId.Feed, _indicator.RawIndicatorFieldId.FirstSeen, _indicator.RawIndicatorFieldId.LastSeen].map(field => ({
  id: field,
