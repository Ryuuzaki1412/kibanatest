...
const MoreActions = ({
  ...
  const items = [/*#__PURE__*/_react.default.createElement(_add_to_existing_case.AddToExistingCase, {
    indicator: indicator,
    onClick: closePopover,
    "data-test-subj": _test_ids.ADD_TO_EXISTING_TEST_ID
  ...
  const button = /*#__PURE__*/_react.default.createElement(_eui.EuiToolTip, {
    ...
    "data-test-subj": _test_ids.MORE_ACTIONS_TEST_ID
  }));
