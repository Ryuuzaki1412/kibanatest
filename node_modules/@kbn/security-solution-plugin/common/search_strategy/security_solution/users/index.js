...
Object.defineProperty(exports, "UsersQueries", {
  enumerable: true,
  get: function () {
    return _search_strategy.UsersQueries;
  }
});
...
Object.keys(_observed_details).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _observed_details[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _observed_details[key];
    }
  });
});
