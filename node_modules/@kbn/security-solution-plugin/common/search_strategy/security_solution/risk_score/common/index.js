...
var _risk_engine = require("../../../../risk_engine");
...
const getHostRiskIndex = (spaceId, onlyLatest = true, isNewRiskScoreModuleInstalled) => {
  return isNewRiskScoreModuleInstalled ? (0, _risk_engine.getRiskScoreLatestIndex)(spaceId) : `${_constants.RISKY_HOSTS_INDEX_PREFIX}${onlyLatest ? 'latest_' : ''}${spaceId}`;
};
exports.getHostRiskIndex = getHostRiskIndex;
const getUserRiskIndex = (spaceId, onlyLatest = true, isNewRiskScoreModuleInstalled) => {
  return isNewRiskScoreModuleInstalled ? onlyLatest ? (0, _risk_engine.getRiskScoreLatestIndex)(spaceId) : (0, _risk_engine.getRiskScoreTimeSeriesIndex)(spaceId) : `${_constants.RISKY_USERS_INDEX_PREFIX}${onlyLatest ? 'latest_' : ''}${spaceId}`;
};
