...
const waitForMetadataTransformsReady = _usage_tracker.usageTracker.track('waitForMetadataTransformsReady', async (esClient, version) => {
...
const stopMetadataTransforms = _usage_tracker.usageTracker.track('stopMetadataTransforms', async (esClient, version) => {
...
const startMetadataTransforms = _usage_tracker.usageTracker.track('startMetadataTransforms', async (esClient, agentIds, version) => {
  const transformIds = await getMetadataTransformIds(esClient, version);
