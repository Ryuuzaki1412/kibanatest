...
class EndpointDocGenerator extends _base_data_generator.BaseDataGenerator {
  ...
  constructor(seed = Math.random().toString(), MetadataGenerator = _endpoint_metadata_generator.EndpointMetadataGenerator) {
    super(seed);
    (0, _defineProperty2.default)(this, "_commonInfo", void 0);
  ...
  get commonInfo() {
    return (0, _lodash.clone)(this._commonInfo);
  }
  set commonInfo(newInfo) {
  ...
  generateHostMetadata(ts = new Date().getTime(), metadataDataStream = metadataDefaultDataStream()) {
    return (0, _lodash.clone)(this.metadataGenerator.generate({
      '@timestamp': ts,
  ...
  generateEvent(options = {}) {
    var _options$ancestry$sli, _options$ancestry, _options$ancestryArra2, _options$eventsDataSt2, _options$eventCategor;
    ...
    return {
      ...
      event: {
        ...
        outcome: (_options$eventCategor = options.eventCategory) !== null && _options$eventCategor !== void 0 && _options$eventCategor.includes('authentication') ? this.randomChoice(['success', 'failure']) : '',
        kind: 'event',
