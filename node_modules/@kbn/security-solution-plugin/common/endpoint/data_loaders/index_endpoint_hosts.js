 ...
 */
const indexEndpointHostDocs = _usage_tracker.usageTracker.track('indexEndpointHostDocs', async ({
  numDocs,
  client,
  kbnClient,
  realPolicies,
  ...
  for (let j = 0; j < numDocs; j++) {
    ...
    if (enrollFleet) {
      ...
      if (!wasAgentEnrolled) {
        var _agents$0$agent$id, _agents$, _agents$$agent;
        ...
        agentId = (_agents$0$agent$id = (_agents$ = agents[0]) === null || _agents$ === void 0 ? void 0 : (_agents$$agent = _agents$.agent) === null || _agents$$agent === void 0 ? void 0 : _agents$$agent.id) !== null && _agents$0$agent$id !== void 0 ? _agents$0$agent$id : agentId;
