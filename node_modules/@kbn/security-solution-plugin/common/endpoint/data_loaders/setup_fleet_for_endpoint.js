 ...
 * @param logger
 */
const setupFleetForEndpoint = _usage_tracker.usageTracker.track('setupFleetForEndpoint', async (kbnClient, logger) => {
...
const installOrUpgradeEndpointFleetPackage = _usage_tracker.usageTracker.track('installOrUpgradeEndpointFleetPackage', async (kbnClient, logger) => {
