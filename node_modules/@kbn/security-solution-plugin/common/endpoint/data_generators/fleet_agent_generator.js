...
class FleetAgentGenerator extends _base_data_generator.BaseDataGenerator {
  ...
  generateEsHit(overrides = {}) {
    var _overrides$_source$ag, _overrides$_source, _overrides$_source$ag2;
    ...
    const agentId = (_overrides$_source$ag = overrides === null || overrides === void 0 ? void 0 : (_overrides$_source = overrides._source) === null || _overrides$_source === void 0 ? void 0 : (_overrides$_source$ag2 = _overrides$_source.agent) === null || _overrides$_source$ag2 === void 0 ? void 0 : _overrides$_source$ag2.id) !== null && _overrides$_source$ag !== void 0 ? _overrides$_source$ag : this.randomUUID();
    return (0, _lodash.merge)({
