...
const LogLevel = _zod.z.enum(['trace', 'debug', 'info', 'warn', 'error']);
exports.LogLevel = LogLevel;
const LogLevelEnum = LogLevel.enum;
...
const RuleExecutionEventType = _zod.z.enum(['message', 'status-change', 'execution-metrics']);
exports.RuleExecutionEventType = RuleExecutionEventType;
const RuleExecutionEventTypeEnum = RuleExecutionEventType.enum;
...
NOTE: This is a read model of rule execution events and it is pretty generic. It contains only a subset of their fields: only those fields that are common to all types of execution events.
  */
exports.RuleExecutionEventTypeEnum = RuleExecutionEventTypeEnum;
const RuleExecutionEvent = _zod.z.object({
