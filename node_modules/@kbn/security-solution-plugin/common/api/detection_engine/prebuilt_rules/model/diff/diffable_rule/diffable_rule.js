...
const DiffableEsqlFields = (0, _build_schema.buildSchema)({
  required: {
    type: t.literal('esql'),
...
exports.DiffableEsqlFields = DiffableEsqlFields;
...
const DiffableRule = t.intersection([DiffableCommonFields, t.union([DiffableCustomQueryFields, DiffableSavedQueryFields, DiffableEqlFields, DiffableEsqlFields, DiffableThreatMatchFields, DiffableThresholdFields, DiffableMachineLearningFields, DiffableNewTermsFields])]);
