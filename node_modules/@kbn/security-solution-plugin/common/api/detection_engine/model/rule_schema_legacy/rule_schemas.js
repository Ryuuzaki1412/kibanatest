...
const KqlQueryLanguage = t.keyof({
  kuery: null,
  lucene: null
});
exports.KqlQueryLanguage = KqlQueryLanguage;
const EqlQueryLanguage = t.literal('eql');
...
// -------------------------------------------------------------------------------------------------
// ES|QL rule schema
const EsqlQueryLanguage = t.literal('esql');
...
const TypeSpecificCreateProps = t.union([eqlSchema.create, esqlSchema.create, threatMatchSchema.create, querySchema.create, savedQuerySchema.create, thresholdSchema.create, machineLearningSchema.create, newTermsSchema.create]);
