...
exports.DeleteRuleResponse = exports.DeleteRuleRequestQuery = void 0;
...
const DeleteRuleRequestQuery = _zod.z.object({
  /**
   * The rule's `id` value.
   */
...
exports.DeleteRuleRequestQuery = DeleteRuleRequestQuery;
const DeleteRuleResponse = _rule_schemas.RuleResponse;
