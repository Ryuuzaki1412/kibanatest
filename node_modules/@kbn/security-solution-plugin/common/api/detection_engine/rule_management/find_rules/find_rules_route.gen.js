...
const FindRulesSortField = _zod.z.enum(['created_at', 'createdAt', 'enabled', 'execution_summary.last_execution.date', 'execution_summary.last_execution.metrics.execution_gap_duration_s', 'execution_summary.last_execution.metrics.total_indexing_duration_ms', 'execution_summary.last_execution.metrics.total_search_duration_ms', 'execution_summary.last_execution.status', 'name', 'risk_score', 'riskScore', 'severity', 'updated_at', 'updatedAt']);
exports.FindRulesSortField = FindRulesSortField;
const FindRulesSortFieldEnum = FindRulesSortField.enum;
exports.FindRulesSortFieldEnum = FindRulesSortFieldEnum;
const FindRulesRequestQuery = _zod.z.object({
