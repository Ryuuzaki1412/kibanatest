...
const firstLastSeenRequestOptionsSchema = _request_basic_options.requestBasicOptionsSchema.extend({
  order: _order.order,
  field: _zod.z.string(),
  value: _zod.z.string(),
  factoryQueryType: _zod.z.literal(_factory_query_type.FirstLastSeenQuery)
});
exports.firstLastSeenRequestOptionsSchema = firstLastSeenRequestOptionsSchema;
const firstLastSeenResponseSchema = _zod.z.object({
  firstSeen: _zod.z.string().nullable(),
  lastSeen: _zod.z.string().nullable(),
  inspect: _inspect.inspect
}).partial();
exports.firstLastSeenResponseSchema = firstLastSeenResponseSchema;