...
exports.networkTopNFlowSchema = void 0;
...
const networkTopNFlowSchema = _request_paginated_options.requestOptionsPaginatedSchema.extend({
  ip: _zod.z.string().ip().nullable().optional(),
  flowTarget: _flow_target.flowTarget,
  sort: _sort.sort,
  timerange: _timerange.timerange,
  factoryQueryType: _zod.z.literal(_factory_query_type.NetworkQueries.topNFlow)
});
exports.networkTopNFlowSchema = networkTopNFlowSchema;