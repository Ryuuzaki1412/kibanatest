...
const networkKpiUniquePrivateIps = _request_basic_options.requestBasicOptionsSchema.extend({
  timerange: _timerange.timerange,
  factoryQueryType: _zod.z.literal(_factory_query_type.NetworkKpiQueries.uniquePrivateIps)
});
