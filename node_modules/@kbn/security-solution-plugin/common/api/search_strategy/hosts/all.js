...
const allHostsSchema = _request_basic_options.requestBasicOptionsSchema.extend({
  sort: _sort.sort,
  pagination: _pagination.pagination,
  timerange: _timerange.timerange,
  isNewRiskScoreModuleInstalled: _zod.z.boolean().default(false),
  factoryQueryType: _zod.z.literal(_factory_query_type.HostsQueries.hosts)
});
exports.allHostsSchema = allHostsSchema;