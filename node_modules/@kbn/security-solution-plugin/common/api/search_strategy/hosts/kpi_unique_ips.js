...
exports.kpiUniqueIpsSchema = void 0;
...
const kpiUniqueIpsSchema = _request_basic_options.requestBasicOptionsSchema.extend({
  sort: _sort.sort,
  pagination: _pagination.pagination,
  timerange: _timerange.timerange,
  factoryQueryType: _zod.z.literal(_factory_query_type.HostsKpiQueries.kpiUniqueIps)
});
exports.kpiUniqueIpsSchema = kpiUniqueIpsSchema;