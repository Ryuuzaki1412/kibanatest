...
const hostUncommonProcessesSchema = _request_basic_options.requestBasicOptionsSchema.extend({
  sort: _sort.sort,
  pagination: _pagination.pagination,
  timerange: _timerange.timerange,
  factoryQueryType: _zod.z.literal(_factory_query_type.HostsQueries.uncommonProcesses)
});
exports.hostUncommonProcessesSchema = hostUncommonProcessesSchema;