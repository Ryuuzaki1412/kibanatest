...
exports.RULE_PREVIEW_INVOCATION_COUNT = exports.RULE_PREVIEW_INTERVAL = exports.RULE_PREVIEW_FROM = exports.PREBUILT_RULES_PACKAGE_NAME = exports.MINIMUM_LICENSE_FOR_SUPPRESSION = exports.ELASTIC_SECURITY_RULE_ID = exports.DEFAULT_SUPPRESSION_MISSING_FIELDS_STRATEGY = void 0;
/*
...
const PREBUILT_RULES_PACKAGE_NAME = 'security_detection_engine';

/**
 * Rule signature id (`rule.rule_id`) of the prebuilt "Endpoint Security" rule.
 */
exports.PREBUILT_RULES_PACKAGE_NAME = PREBUILT_RULES_PACKAGE_NAME;
const ELASTIC_SECURITY_RULE_ID = '9a1a2dae-0b5f-4c3d-8305-a268d404c306';
exports.ELASTIC_SECURITY_RULE_ID = ELASTIC_SECURITY_RULE_ID;
const DEFAULT_SUPPRESSION_MISSING_FIELDS_STRATEGY = 'suppress';
exports.DEFAULT_SUPPRESSION_MISSING_FIELDS_STRATEGY = DEFAULT_SUPPRESSION_MISSING_FIELDS_STRATEGY;
const MINIMUM_LICENSE_FOR_SUPPRESSION = 'platinum';
exports.MINIMUM_LICENSE_FOR_SUPPRESSION = MINIMUM_LICENSE_FOR_SUPPRESSION;