...
const KQL_FILTER_IMMUTABLE_RULES = `${_rule_fields.PARAMS_IMMUTABLE_FIELD}: true`;
exports.KQL_FILTER_IMMUTABLE_RULES = KQL_FILTER_IMMUTABLE_RULES;
const KQL_FILTER_MUTABLE_RULES = `${_rule_fields.PARAMS_IMMUTABLE_FIELD}: false`;
exports.KQL_FILTER_MUTABLE_RULES = KQL_FILTER_MUTABLE_RULES;
const KQL_FILTER_ENABLED_RULES = `${_rule_fields.ENABLED_FIELD}: true`;
exports.KQL_FILTER_ENABLED_RULES = KQL_FILTER_ENABLED_RULES;
const KQL_FILTER_DISABLED_RULES = `${_rule_fields.ENABLED_FIELD}: false`;
exports.KQL_FILTER_DISABLED_RULES = KQL_FILTER_DISABLED_RULES;
/**
