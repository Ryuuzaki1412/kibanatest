...
const createResolver = actionCreator('CREATE_RESOLVER');
exports.createResolver = createResolver;
const clearResolver = actionCreator('CLEAR_RESOLVER');
 ...
 */
exports.clearResolver = clearResolver;
const userRequestedRelatedEventData = actionCreator('REQUEST_RELATED_EVENT');
 ...
 */
exports.userRequestedRelatedEventData = userRequestedRelatedEventData;
const userFocusedOnResolverNode = actionCreator('FOCUS_ON_NODE');
 ...
 */
exports.userFocusedOnResolverNode = userFocusedOnResolverNode;
const userSelectedResolverNode = actionCreator('SELECT_RESOLVER_NODE');
 ...
 */
exports.userSelectedResolverNode = userSelectedResolverNode;
const appReceivedNewExternalProperties = actionCreator('APP_RECEIVED_NEW_EXTERNAL_PROPERTIES');
exports.appReceivedNewExternalProperties = appReceivedNewExternalProperties;