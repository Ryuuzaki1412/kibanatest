 ...
 */
const ariaActiveDescendant = (0, _reselect.createSelector)(uiState => uiState,
...
const selectedNode = (0, _reselect.createSelector)(uiState => uiState,
// eslint-disable-next-line @typescript-eslint/no-shadow
({
  selectedNode
}) => {
...
const panelViewAndParameters = (0, _reselect.createSelector)(state => state.locationSearch, state => state.resolverComponentInstanceID, (locationSearch, resolverComponentInstanceID) => {
...
const relativeHref = (0, _reselect.createSelector)(state => state.locationSearch, state => state.resolverComponentInstanceID, (locationSearch, resolverComponentInstanceID) => {
  return params => {
    /**
