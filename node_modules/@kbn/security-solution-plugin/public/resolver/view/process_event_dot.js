...
const UnstyledProcessEventDot = /*#__PURE__*/_react.default.memo(({
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    defaultMessage: "{isEventBeingAnalyzed, select, true {Analyzed Event \xB7 {descriptionText}} false {{descriptionText}}}",
    values: {
...
const ProcessEventDot = (0, _styledComponents.default)(UnstyledProcessEventDot)`
  position: absolute;
  text-align: left;
  font-size: 10px;
  user-select: none;
...
`;
exports.ProcessEventDot = ProcessEventDot;