...
const INIT_RISK_ENGINE_STATUS_KEY = ['POST', 'INIT_RISK_ENGINE'];
exports.INIT_RISK_ENGINE_STATUS_KEY = INIT_RISK_ENGINE_STATUS_KEY;
const useInitRiskEngineMutation = options => {
  ...
  return (0, _reactQuery.useMutation)(() => (0, _api.initRiskEngine)(), {
    ...options,
