...
const useBasicDataFromDetailsData = data => {
  ...
  const ruleId = (0, _react.useMemo)(() => isAlert ? (0, _helpers.getFieldValue)({
    category: 'kibana',
    field: 'kibana.alert.rule.uuid'
  }, data) : (0, _helpers.getFieldValue)({
    category: 'signal',
  ...
  const indexName = (0, _react.useMemo)(() => (0, _helpers.getFieldValue)({
    category: '_index',
    field: '_index'
  }, data), [data]);
  const alertUrl = (0, _react.useMemo)(() => (0, _helpers.getFieldValue)({
    category: 'kibana',
