...
// should be last.
const defaultRowRenderers = [_threat_match_row_renderer.threatMatchRowRenderer, ..._generic_row_renderer.auditdRowRenderers, ..._generic_row_renderer2.systemRowRenderers, _suricata_row_renderer.suricataRowRenderer, _zeek_row_renderer.zeekRowRenderer, _netflow_row_renderer.netflowRowRenderer];
exports.defaultRowRenderers = defaultRowRenderers;
const columnRenderers = [_reason_column_renderer.reasonColumnRenderer, _event_summary_column_renderer.eventSummaryColumnRenderer, _user_profile_renderer.userProfileColumnRenderer, _plain_column_renderer.plainColumnRenderer, _empty_column_renderer.emptyColumnRenderer, _unknown_column_renderer.unknownColumnRenderer];
