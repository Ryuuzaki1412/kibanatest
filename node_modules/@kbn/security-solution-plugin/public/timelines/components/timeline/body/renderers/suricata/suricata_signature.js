...
const SURICATA_SIGNATURE_FIELD_NAME = 'suricata.eve.alert.signature';
exports.SURICATA_SIGNATURE_FIELD_NAME = SURICATA_SIGNATURE_FIELD_NAME;
const SURICATA_SIGNATURE_ID_FIELD_NAME = 'suricata.eve.alert.signature_id';
...
const Tokens = /*#__PURE__*/_react.default.memo(({
  tokens
...
const DraggableSignatureId = /*#__PURE__*/_react.default.memo(({
  id,
  isDraggable,
  signatureId
}) => {
...
const SuricataSignature = /*#__PURE__*/_react.default.memo(({
  contextId,
  id,
  isDraggable,
  signature,
