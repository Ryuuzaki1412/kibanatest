...
exports.createGenericFileRowRenderer = exports.createGenericAuditRowRenderer = exports.auditdRowRenderers = void 0;
...
const createGenericAuditRowRenderer = ({
  actionName,
  text
}) => ({
  ...
  renderRow: ({
    ...
    isDraggable,
    scopeId
  }) => /*#__PURE__*/_react.default.createElement(_row_renderer.RowRendererContainer, null, /*#__PURE__*/_react.default.createElement(_generic_details.AuditdGenericDetails, {
    data: data,
...
const createGenericFileRowRenderer = ({
  ...
  renderRow: ({
    ...
    isDraggable,
    scopeId
  }) => /*#__PURE__*/_react.default.createElement(_row_renderer.RowRendererContainer, null, /*#__PURE__*/_react.default.createElement(_generic_file_details.AuditdGenericFileDetails, {
    contextId: `${actionName}-${scopeId}`,
    data: data,
    fileIcon: fileIcon,
    isDraggable: isDraggable,
