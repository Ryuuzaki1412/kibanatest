...
const FormattedFieldValueComponent = ({
  ...
  } else if (fieldName === _sentinelone_alert_check.SENTINEL_ONE_AGENT_ID_FIELD || (fieldFromBrowserField === null || fieldFromBrowserField === void 0 ? void 0 : fieldFromBrowserField.name) === _sentinelone_alert_check.SENTINEL_ONE_AGENT_ID_FIELD) {
    return /*#__PURE__*/_react.default.createElement(_sentinel_one_agent_status.SentinelOneAgentStatus, {
