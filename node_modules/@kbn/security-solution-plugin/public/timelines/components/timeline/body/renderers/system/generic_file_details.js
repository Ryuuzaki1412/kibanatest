...
const SystemGenericFileLine = /*#__PURE__*/_react.default.memo(({
  args,
  contextId,
  endgameExitCode,
  endgameFileName,
...
const SystemGenericFileDetails = /*#__PURE__*/_react.default.memo(({
  contextId,
  data,
  isDraggable,
  showMessage = true,
  ...
  return /*#__PURE__*/_react.default.createElement(_helpers2.Details, null, /*#__PURE__*/_react.default.createElement(SystemGenericFileLine, {
    id: id,
    contextId: contextId,
    text: text,
    hostName: hostName,
