...
const ColumnHeaderComponent = ({
  ...
  const handleResizeStop = (0, _react.useCallback)((e, direction, ref, delta) => {
    dispatch(_timeline2.timelineActions.applyDeltaToColumnWidth({
      columnId: header.id,
      delta: delta.width,
      id: timelineId
    }));
  ...
  const onColumnSort = (0, _react.useCallback)(sortDirection => {
    ...
    dispatch(_timeline2.timelineActions.updateSort({
      id: timelineId,
      sort: newSort
    }));
  ...
  const panels = (0, _react.useMemo)(() => [{
    ...
    items: [{
      ...
      onClick: () => {
        dispatch(_timeline2.timelineActions.removeColumn({
          id: timelineId,
          columnId: header.id
        }));
...
const ColumnHeader = /*#__PURE__*/_react.default.memo(ColumnHeaderComponent);
