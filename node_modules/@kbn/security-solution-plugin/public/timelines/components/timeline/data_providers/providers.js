...
const EMPTY_PROVIDERS_GROUP_CLASS_NAME = 'empty-providers-group';
exports.EMPTY_PROVIDERS_GROUP_CLASS_NAME = EMPTY_PROVIDERS_GROUP_CLASS_NAME;
/**
 ...
 */
const Providers = /*#__PURE__*/_react.default.memo(({
  browserFields,
  timelineId,
  dataProviders
}) => {
...
const DataProvidersGroupItem = /*#__PURE__*/_react.default.memo(({
  browserFields,
  group,
  groupIndex,
  dataProvider,
  ...
  const handleDeleteProvider = (0, _react.useCallback)(() => {
    ...
    dispatch(_timeline.timelineActions.removeProvider(payload));
  ...
  const handleToggleEnabledProvider = (0, _react.useCallback)(() => {
    ...
    dispatch(_timeline.timelineActions.updateDataProviderEnabled(payload));
  ...
  const handleToggleExcludedProvider = (0, _react.useCallback)(() => {
    ...
    dispatch(_timeline.timelineActions.updateDataProviderExcluded(payload));
  ...
  const handleToggleTypeProvider = (0, _react.useCallback)(() => {
    ...
    dispatch(_timeline.timelineActions.updateDataProviderType(payload));
  ...
  const handleDataProviderEdited = (0, _react.useCallback)(({
    ...
    providerId,
    value
  }) => dispatch(_timeline.timelineActions.dataProviderEdited({
    andProviderId,
    excluded,
    field,
    id: timelineId,
...
exports.DataProvidersGroupItem = DataProvidersGroupItem;
