...
const timelineReducer = (0, _typescriptFsaReducers.reducerWithInitialState)(initialTimelineState).case(_actions.addTimeline, (state, {
  id,
  timeline,
...
})).case(_actions.setIsDiscoverSavedSearchLoaded, (state, {
  id,
