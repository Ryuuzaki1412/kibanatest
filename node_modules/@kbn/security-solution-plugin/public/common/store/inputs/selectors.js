...
const timelineTimeRangeSelector = (0, _reselect.createSelector)(selectTimeline, timeline => timeline.timerange);

// TODO: remove ? when socTrendsEnabled feature flag removed
exports.timelineTimeRangeSelector = timelineTimeRangeSelector;
const socTrendsTimeRangeSelector = (0, _reselect.createSelector)(selectSocTrends, socTrends => socTrends === null || socTrends === void 0 ? void 0 : socTrends.timerange);
exports.socTrendsTimeRangeSelector = socTrendsTimeRangeSelector;
const globalFullScreenSelector = (0, _reselect.createSelector)(selectGlobal, global => global.fullScreen);
exports.globalFullScreenSelector = globalFullScreenSelector;
const timelineFullScreenSelector = (0, _reselect.createSelector)(selectTimeline, timeline => timeline.fullScreen);
exports.timelineFullScreenSelector = timelineFullScreenSelector;
const globalTimeRangeSelector = (0, _reselect.createSelector)(selectGlobal, global => global.timerange);
