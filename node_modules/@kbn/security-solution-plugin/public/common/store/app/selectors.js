...
const getNotes = (0, _memoizeOne.default)((notesById, noteIds) => (0, _fp.keys)(notesById).reduce((acc, noteId) => {
...
const selectNotesByIdSelector = (0, _reselect.createSelector)(selectNotesById, notesById => notesById);
