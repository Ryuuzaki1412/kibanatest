...
const initialGlobalUrlParam = {};
exports.initialGlobalUrlParam = initialGlobalUrlParam;
const globalUrlParamReducer = (0, _typescriptFsaReducers.reducerWithInitialState)(initialGlobalUrlParam).case(_actions.registerUrlParam, (state, {
  key,
  initialValue
}) => {
...
exports.globalUrlParamReducer = globalUrlParamReducer;