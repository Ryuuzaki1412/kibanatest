...
const sourcererReducer = (0, _typescriptFsaReducers.reducerWithInitialState)(_model.initialSourcererState).case(_actions.setSignalIndexName, (state, {
  signalIndexName
}) => ({
  ...state,
  signalIndexName
...
exports.sourcererReducer = sourcererReducer;