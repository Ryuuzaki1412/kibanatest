...
const useSignalHelpers = () => {
  ...
  const getSignalIndexNameSelector = (0, _react.useMemo)(() => _store.sourcererSelectors.signalIndexNameSelector(), []);
  const signalIndexNameSourcerer = (0, _use_selector.useDeepEqualSelector)(getSignalIndexNameSelector);
