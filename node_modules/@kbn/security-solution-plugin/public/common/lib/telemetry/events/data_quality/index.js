...
exports.dataQualityIndexCheckedEvent = exports.dataQualityCheckAllClickedEvent = void 0;
...
const dataQualityIndexCheckedEvent = {
  eventType: _constants.TelemetryEventTypes.DataQualityIndexChecked,
  schema: {
    batchId: {
      type: 'keyword',
      _meta: {
...
exports.dataQualityIndexCheckedEvent = dataQualityIndexCheckedEvent;
const dataQualityCheckAllClickedEvent = {
  eventType: _constants.TelemetryEventTypes.DataQualityCheckAllCompleted,
  schema: {
    batchId: {
      type: 'keyword',
      _meta: {
...
exports.dataQualityCheckAllClickedEvent = dataQualityCheckAllClickedEvent;