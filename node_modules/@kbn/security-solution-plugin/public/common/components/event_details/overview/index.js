...
var _helpers2 = require("../../../../timelines/store/timeline/helpers");
...
const NotGrowingFlexGroup = (0, _common.euiStyled)(_eui.EuiFlexGroup)`
  flex-grow: 0;
`;
exports.NotGrowingFlexGroup = NotGrowingFlexGroup;
const Overview = /*#__PURE__*/_react.default.memo(({
  browserFields,
  contextId,
  data,
  eventId,
  ...
  const cards = [signalCard, severityCard, riskScoreCard, ruleNameCard].filter(_helpers2.isNotNull);
