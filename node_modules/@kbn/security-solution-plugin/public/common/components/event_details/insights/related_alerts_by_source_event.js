...
exports.RelatedAlertsBySourceEvent = void 0;
 ...
 */
const RelatedAlertsBySourceEvent = /*#__PURE__*/_react.default.memo(({
  browserFields,
  data,
  eventId,
  scopeId
  ...
  const renderContent = (0, _react.useCallback)(() => {
    if (!alertIds || !(cellData !== null && cellData !== void 0 && cellData.dataProviders)) {
      ...
      return _translations2.SOURCE_EVENT_EMPTY;
    }
...
exports.RelatedAlertsBySourceEvent = RelatedAlertsBySourceEvent;
function getTextFromState(state, count) {
  switch (state) {
    case 'loading':
      return _translations2.SOURCE_EVENT_LOADING;
    case 'error':
      return _translations2.SOURCE_EVENT_ERROR;
    case 'success':
      return (0, _translations2.SOURCE_EVENT_COUNT)(count);
    default:
      return '';
  }
}
