...
const DragDropContextWrapperComponent = ({
  ...
  const onAddedToTimeline = (0, _react.useCallback)(fieldOrValue => {
    const message = timelineType === _timeline3.TimelineType.template ? (0, _translations.ADDED_TO_TIMELINE_TEMPLATE_MESSAGE)(fieldOrValue) : (0, _translations.ADDED_TO_TIMELINE_MESSAGE)(fieldOrValue);
