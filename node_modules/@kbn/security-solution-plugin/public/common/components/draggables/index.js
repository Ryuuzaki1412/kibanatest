...
const Content = /*#__PURE__*/_react.default.memo(({
  children,
  field,
  tooltipContent,
  tooltipPosition,
 ...
 */
const DefaultDraggable = /*#__PURE__*/_react.default.memo(({
  hideTopN = false,
  id,
  isDraggable = true,
  field,
...
const DraggableBadge = /*#__PURE__*/_react.default.memo(DraggableBadgeComponent);
