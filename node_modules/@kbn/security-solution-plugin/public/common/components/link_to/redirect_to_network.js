...
const getNetworkDetailsUrl = (detailName, flowTarget, search, tabName = _types.NetworkDetailsRouteType.flows) => `/ip/${detailName}/${flowTarget || _network.FlowTarget.source}/${tabName}${(0, _helpers.appendSearch)(search)}`;
