...
const PreferenceFormattedDate = /*#__PURE__*/_react.default.memo( /* eslint-disable-next-line react-hooks/rules-of-hooks */
({
  value,
...
const PreferenceFormattedP1DTDate = /*#__PURE__*/_react.default.memo(({
  value
}) => {
  /**
...
const FormattedDate = /*#__PURE__*/_react.default.memo(({
  value,
  fieldName,
  className = '',
  dateFormat
 ...
 * - the raw date value (e.g. 2019-03-22T00:47:46Z)
 */
const FormattedRelativePreferenceDate = /*#__PURE__*/_react.default.memo(({
  value,
  dateFormat,
  tooltipFieldName,
