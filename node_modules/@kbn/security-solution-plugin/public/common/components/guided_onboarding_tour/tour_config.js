...
exports.securityTourConfig = exports.sampleCase = exports.getTourAnchor = exports.SecurityStepId = exports.AlertsCasesTourSteps = void 0;
 ...
 */
let SecurityStepId;
exports.SecurityStepId = SecurityStepId;
(function (SecurityStepId) {
  SecurityStepId["rules"] = "rules";
  SecurityStepId["alertsCases"] = "alertsCases";
})(SecurityStepId || (exports.SecurityStepId = SecurityStepId = {}));
let AlertsCasesTourSteps;
exports.AlertsCasesTourSteps = AlertsCasesTourSteps;
(function (AlertsCasesTourSteps) {
...
})(AlertsCasesTourSteps || (exports.AlertsCasesTourSteps = AlertsCasesTourSteps = {}));
const defaultConfig = {
  minWidth: 360,
  maxWidth: 360,
  offset: 10,
...
exports.sampleCase = sampleCase;
const securityTourConfig = {
  /**
...
exports.securityTourConfig = securityTourConfig;