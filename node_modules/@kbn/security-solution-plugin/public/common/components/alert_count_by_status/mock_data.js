...
exports.parsedAlertCountByRuleResult = exports.mockQuery = exports.mockAlertCountByRuleResult = void 0;
...
const mockAlertCountByRuleResult = {
  aggregations: {
...
exports.mockAlertCountByRuleResult = mockAlertCountByRuleResult;
const parsedAlertCountByRuleResult = [{
  ruleName: 'Critical',
  count: 1,
  uuid: '100'
}, {
...
exports.parsedAlertCountByRuleResult = parsedAlertCountByRuleResult;
const mockQuery = () => ({
  query: (0, _use_alert_count_by_rule_by_status.buildRuleAlertsByEntityQuery)({
