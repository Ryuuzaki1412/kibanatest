...
const CLEAR_SELECTION = _i18n.i18n.translate('xpack.securitySolution.toolbar.bulkActions.clearSelectionTitle', {
...
const CLOSED_ALERT_FAILED_TOAST = _i18n.i18n.translate('xpack.securitySolution.bulkActions.closedAlertFailedToastMessage', {
  defaultMessage: 'Failed to close alert(s).'
});
exports.CLOSED_ALERT_FAILED_TOAST = CLOSED_ALERT_FAILED_TOAST;
const OPENED_ALERT_FAILED_TOAST = _i18n.i18n.translate('xpack.securitySolution.bulkActions.openedAlertFailedToastMessage', {
  defaultMessage: 'Failed to open alert(s)'
});
exports.OPENED_ALERT_FAILED_TOAST = OPENED_ALERT_FAILED_TOAST;
const ACKNOWLEDGED_ALERT_FAILED_TOAST = _i18n.i18n.translate('xpack.securitySolution.bulkActions.acknowledgedAlertFailedToastMessage', {
...
const BULK_ACTION_FAILED_SINGLE_ALERT = _i18n.i18n.translate('xpack.securitySolution.bulkActions.updateAlertStatusFailedSingleAlert', {
  defaultMessage: 'Failed to update alert because it was already being modified.'
});
exports.BULK_ACTION_FAILED_SINGLE_ALERT = BULK_ACTION_FAILED_SINGLE_ALERT;
const BULK_ACTION_OPEN_SELECTED = _i18n.i18n.translate('xpack.securitySolution.bulkActions.openSelectedTitle', {
  defaultMessage: 'Mark as open'
});
exports.BULK_ACTION_OPEN_SELECTED = BULK_ACTION_OPEN_SELECTED;
const BULK_ACTION_ACKNOWLEDGED_SELECTED = _i18n.i18n.translate('xpack.securitySolution.bulkActions.acknowledgedSelectedTitle', {
  defaultMessage: 'Mark as acknowledged'
});
exports.BULK_ACTION_ACKNOWLEDGED_SELECTED = BULK_ACTION_ACKNOWLEDGED_SELECTED;
const BULK_ACTION_CLOSE_SELECTED = _i18n.i18n.translate('xpack.securitySolution.bulkActions.closeSelectedTitle', {
...
const UPDATE_ALERT_TAGS_FAILURE = _i18n.i18n.translate('xpack.securitySolution.bulkActions.updateAlertTagsFailedToastMessage', {
  defaultMessage: 'Failed to update alert tags.'
});
exports.UPDATE_ALERT_TAGS_FAILURE = UPDATE_ALERT_TAGS_FAILURE;
const ALERT_TAGS_MENU_SEARCH_PLACEHOLDER = _i18n.i18n.translate('xpack.securitySolution.bulkActions.alertTagsMenuSearchPlaceholderMessage', {
  defaultMessage: 'Search tags'
});
exports.ALERT_TAGS_MENU_SEARCH_PLACEHOLDER = ALERT_TAGS_MENU_SEARCH_PLACEHOLDER;
const ALERT_TAGS_MENU_SEARCH_NO_TAGS_FOUND = _i18n.i18n.translate('xpack.securitySolution.bulkActions.alertTagsMenuSearchNoTagsFoundMessage', {
  defaultMessage: 'No tags match current search'
});
exports.ALERT_TAGS_MENU_SEARCH_NO_TAGS_FOUND = ALERT_TAGS_MENU_SEARCH_NO_TAGS_FOUND;
...
exports.ALERT_TAGS_MENU_EMPTY = ALERT_TAGS_MENU_EMPTY;
const ALERT_TAGS_APPLY_BUTTON_MESSAGE = _i18n.i18n.translate('xpack.securitySolution.bulkActions.alertTagsApplyButtonMessage', {
  defaultMessage: 'Apply tags'
});
exports.ALERT_TAGS_APPLY_BUTTON_MESSAGE = ALERT_TAGS_APPLY_BUTTON_MESSAGE;
...
exports.ALERT_TAGS_CONTEXT_MENU_ITEM_TITLE = ALERT_TAGS_CONTEXT_MENU_ITEM_TITLE;
const ALERT_TAGS_CONTEXT_MENU_ITEM_TOOLTIP_INFO = _i18n.i18n.translate('xpack.securitySolution.bulkActions.alertTagsContextMenuItemTooltip', {
  defaultMessage: 'Change alert tag options in Kibana Advanced Settings.'
});
exports.ALERT_TAGS_CONTEXT_MENU_ITEM_TOOLTIP_INFO = ALERT_TAGS_CONTEXT_MENU_ITEM_TOOLTIP_INFO;
...
const UPDATE_ALERT_ASSIGNEES_FAILURE = _i18n.i18n.translate('xpack.securitySolution.bulkActions.updateAlertAssigneesFailedToastMessage', {
  defaultMessage: 'Failed to update alert assignees.'
});
exports.UPDATE_ALERT_ASSIGNEES_FAILURE = UPDATE_ALERT_ASSIGNEES_FAILURE;
const ALERT_ASSIGNEES_CONTEXT_MENU_ITEM_TITLE = _i18n.i18n.translate('xpack.securitySolution.bulkActions.alertAssigneesContextMenuItemTitle', {
  defaultMessage: 'Assign alert'
});
exports.ALERT_ASSIGNEES_CONTEXT_MENU_ITEM_TITLE = ALERT_ASSIGNEES_CONTEXT_MENU_ITEM_TITLE;
const REMOVE_ALERT_ASSIGNEES_CONTEXT_MENU_TITLE = _i18n.i18n.translate('xpack.securitySolution.bulkActions.removeAlertAssignessContextMenuTitle', {
  defaultMessage: 'Unassign alert'
});
exports.REMOVE_ALERT_ASSIGNEES_CONTEXT_MENU_TITLE = REMOVE_ALERT_ASSIGNEES_CONTEXT_MENU_TITLE;