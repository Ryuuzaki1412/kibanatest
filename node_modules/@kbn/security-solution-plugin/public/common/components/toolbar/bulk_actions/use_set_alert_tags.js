...
exports.useSetAlertTags = void 0;
var _public = require("@kbn/kibana-react-plugin/public");
var _react = require("react");
var _use_app_toasts = require("../../../hooks/use_app_toasts");
var i18n = _interopRequireWildcard(require("./translations"));
var _api = require("../../../containers/alert_tags/api");
...
const useSetAlertTags = () => {
  ...
  const setAlertTagsRef = (0, _react.useRef)(null);
  const onUpdateSuccess = (0, _react.useCallback)((updated = 0) => addSuccess(i18n.UPDATE_ALERT_TAGS_SUCCESS_TOAST(updated)), [addSuccess]);
  const onUpdateFailure = (0, _react.useCallback)(error => {
    addError(error.message, {
      title: i18n.UPDATE_ALERT_TAGS_FAILURE
    });
  }, [addError]);
  (0, _react.useEffect)(() => {
    let ignore = false;
    const abortCtrl = new AbortController();
    const onSetAlertTags = async (tags, ids, onSuccess, setTableLoading) => {
      try {
        setTableLoading(true);
        const response = await (0, _api.setAlertTags)({
          tags,
          ids,
...
exports.useSetAlertTags = useSetAlertTags;