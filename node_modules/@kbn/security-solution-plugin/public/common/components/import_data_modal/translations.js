...
const CANCEL_BUTTON = _i18n.i18n.translate('xpack.securitySolution.detectionEngine.components.importRuleModal.cancelTitle', {
  defaultMessage: 'Cancel'
});
exports.CANCEL_BUTTON = CANCEL_BUTTON;
const OVERWRITE_EXCEPTIONS_LABEL = _i18n.i18n.translate('xpack.securitySolution.detectionEngine.components.importRuleModal.overwriteExceptionLabel', {
  defaultMessage: 'Overwrite existing exception lists with conflicting "list_id"'
});
exports.OVERWRITE_EXCEPTIONS_LABEL = OVERWRITE_EXCEPTIONS_LABEL;
const OVERWRITE_ACTION_CONNECTORS_LABEL = _i18n.i18n.translate('xpack.securitySolution.detectionEngine.components.importRuleModal.overwriteActionConnectorsLabel', {
  defaultMessage: 'Overwrite existing connectors with conflicting action "id"'
});
exports.OVERWRITE_ACTION_CONNECTORS_LABEL = OVERWRITE_ACTION_CONNECTORS_LABEL;
...
const ACTION_CONNECTORS_WARNING_BUTTON = _i18n.i18n.translate('xpack.securitySolution.detectionEngine.components.importRuleModal.actionConnectorsWarningButton', {
  defaultMessage: 'Go to connectors'
});
exports.ACTION_CONNECTORS_WARNING_BUTTON = ACTION_CONNECTORS_WARNING_BUTTON;
const ACTION_CONNECTORS_ADDITIONAL_PRIVILEGES = _i18n.i18n.translate('xpack.securitySolution.detectionEngine.components.importRuleModal.actionConnectorsAdditionalPrivilegesError', {
  defaultMessage: 'You need additional privileges to import rules with actions.'
});
exports.ACTION_CONNECTORS_ADDITIONAL_PRIVILEGES = ACTION_CONNECTORS_ADDITIONAL_PRIVILEGES;