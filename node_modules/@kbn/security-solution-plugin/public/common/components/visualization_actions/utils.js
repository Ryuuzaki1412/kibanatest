...
const VISUALIZATION_ACTIONS_BUTTON_CLASS = 'histogram-actions-trigger';
exports.VISUALIZATION_ACTIONS_BUTTON_CLASS = VISUALIZATION_ACTIONS_BUTTON_CLASS;
const FILTER_IN_LEGEND_ACTION = `filterIn`;
exports.FILTER_IN_LEGEND_ACTION = FILTER_IN_LEGEND_ACTION;
const FILTER_OUT_LEGEND_ACTION = `filterOut`;
exports.FILTER_OUT_LEGEND_ACTION = FILTER_OUT_LEGEND_ACTION;
...
exports.sourceOrDestinationIpExistsFilter = sourceOrDestinationIpExistsFilter;
