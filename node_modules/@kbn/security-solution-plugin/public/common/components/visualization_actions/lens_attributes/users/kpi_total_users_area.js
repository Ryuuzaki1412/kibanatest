...
exports.kpiTotalUsersAreaLensAttributes = void 0;
...
const kpiTotalUsersAreaLensAttributes = {
  description: '',
  state: {
    datasourceStates: {
      formBased: {
        layers: {
          '416b6fad-1923-4f6a-a2df-b223bb287e30': {
            columnOrder: ['5eea817b-67b7-4268-8ecb-7688d1094721', 'b00c65ea-32be-4163-bfc8-f795b1ef9d06'],
            columns: {
              ...
              'b00c65ea-32be-4163-bfc8-f795b1ef9d06': {
                ...
                dataType: 'number',
                isBucketed: false,
                label: (0, _translations.UNIQUE_COUNT)('user.name'),
...
exports.kpiTotalUsersAreaLensAttributes = kpiTotalUsersAreaLensAttributes;