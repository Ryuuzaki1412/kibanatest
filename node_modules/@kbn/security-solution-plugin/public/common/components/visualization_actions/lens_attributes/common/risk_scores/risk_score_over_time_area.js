...
exports.getRiskScoreOverTimeAreaAttributes = void 0;
...
const internalReferenceIdMapping = {
  host: (0, _uuid.v4)(),
  user: (0, _uuid.v4)()
};
const getRiskScoreOverTimeAreaAttributes = (stackByField = 'host', extraOptions = {
  spaceId: 'default'
}) => {
  const layerIds = [(0, _uuid.v4)(), (0, _uuid.v4)()];
  const layer2ColumnId = (0, _uuid.v4)();
        ...
        formBased: {
          layers: {
            [layerIds[0]]: {
              ...
              columnOrder: ['02a55c97-d7a4-440d-ac77-33b941c16189', '8886a925-4419-4d9a-8498-3bda4ecf1b0a'],
              sampling: 1,
              incompleteColumns: {}
            },
            [layerIds[1]]: {
...
exports.getRiskScoreOverTimeAreaAttributes = getRiskScoreOverTimeAreaAttributes;