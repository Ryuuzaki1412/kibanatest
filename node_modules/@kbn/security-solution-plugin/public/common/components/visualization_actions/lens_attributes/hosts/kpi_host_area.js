...
exports.kpiHostAreaLensAttributes = void 0;
...
const kpiHostAreaLensAttributes = {
  description: '',
  state: {
    datasourceStates: {
      formBased: {
          ...
          '416b6fad-1923-4f6a-a2df-b223bb287e30': {
            ...
            columns: {
              ...
              'b00c65ea-32be-4163-bfc8-f795b1ef9d06': {
                ...
                dataType: 'number',
                isBucketed: false,
                label: (0, _translations.UNIQUE_COUNT)('host.name'),
...
exports.kpiHostAreaLensAttributes = kpiHostAreaLensAttributes;