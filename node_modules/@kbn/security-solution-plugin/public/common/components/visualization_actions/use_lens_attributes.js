...
const useLensAttributes = ({
  ...
  const lensAttrsWithInjectedData = (0, _react.useMemo)(() => {
    ...
    return {
      ...
      state: {
        ...
        filters: [...attrs.state.filters, ...pageFilters, ...tabsFilters, ...indexFilters, ...(applyGlobalQueriesAndFilters ? filters : [])]
      },
  ...
  }, [applyGlobalQueriesAndFilters, attrs, dataViewId, filters, getLensAttributes, hasAdHocDataViews, lensAttributes, pageFilters, query, selectedPatterns, stackByField, tabsFilters, title]);
