...
exports.useReplaceUrlParams = exports.useGetInitialUrlParamValue = exports.isDetectionsPages = exports.getQueryStringFromLocation = exports.getParamFromQueryString = exports.encodeQueryString = exports.createHistoryEntry = void 0;
...
const useGetInitialUrlParamValue = urlParamKey => {
  ...
  const getInitialUrlParamValue = (0, _react.useCallback)(() => {
    const rawParamValue = getParamFromQueryString(getQueryStringFromLocation(window.location.search), urlParamKey);
    const paramValue = (0, _rison.safeDecode)(rawParamValue !== null && rawParamValue !== void 0 ? rawParamValue : '');
    return paramValue;
  }, [urlParamKey]);
