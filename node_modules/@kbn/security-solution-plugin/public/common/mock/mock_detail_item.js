...
exports.rawEventData = exports.mockDetailItemDataId = exports.mockDetailItemData = exports.generateMockDetailItemData = void 0;
/*
...
const mockDetailItemDataId = 'Y-6TfmcB0WOhS6qyMv3s';
exports.mockDetailItemDataId = mockDetailItemDataId;
const generateMockDetailItemData = () => [{
  field: '_id',
...
exports.generateMockDetailItemData = generateMockDetailItemData;
const mockDetailItemData = generateMockDetailItemData();
...
const rawEventData = {
  ...
  fields: {
    ...
    'user.id': ['0'],
    'host.os.type': ['linux'],
    'process.Ext.ancestry': ['MmFjOWU5YjMtZjZkNS00Y2U2LTkxNWQtOGYxZjhmNDEzNjI0LTIyMzY0LTEzMjc4NjA2NTAyLjA=', 'MmFjOWU5YjMtZjZkNS00Y2U2LTkxNWQtOGYxZjhmNDEzNjI0LTEtMTMyNzA3Njg2OTIuMA=='],
    'user.Ext.real.id': ['0'],
    ...
    'process.entity_id': ['MmFjOWU5YjMtZjZkNS00Y2U2LTkxNWQtOGYxZjhmNDEzNjI0LTIyNTM1LTEzMjc4NjA2NTI4LjA='],
    'host.ip': ['127.0.0.1', '::1', '10.1.2.3', '2001:0DB8:AC10:FE01::'],
    'process.executable.caseless': ['/opt/elastic/agent/data/elastic-agent-058c40/install/filebeat-8.0.0-snapshot-linux-x86_64/filebeat'],
    'event.sequence': [44872],
    'agent.type': ['endpoint'],
    'process.executable.text': ['/opt/Elastic/Agent/data/elastic-agent-058c40/install/filebeat-8.0.0-SNAPSHOT-linux-x86_64/filebeat'],
    ...
    'network.type': ['ipv4'],
    'process.executable': ['/opt/Elastic/Agent/data/elastic-agent-058c40/install/filebeat-8.0.0-SNAPSHOT-linux-x86_64/filebeat'],
...
exports.rawEventData = rawEventData;