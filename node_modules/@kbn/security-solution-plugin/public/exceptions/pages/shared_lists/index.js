...
const SharedLists = /*#__PURE__*/_react.default.memo(() => {
  const [{
  ...
  }), exceptionListsWithRuleRefs.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
    "data-test-subj": "exceptionsTable"
  }, exceptionListsWithRuleRefs.map(excList => /*#__PURE__*/_react.default.createElement(_components.ExceptionsListCard, {
    key: excList.list_id,
...
exports.SharedLists = SharedLists;
