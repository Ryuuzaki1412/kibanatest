...
exports.getRawData = exports.getPromptContextFromEventDetailsItem = exports.getPromptContextFromDetectionRules = exports.getMessageContentWithReplacements = exports.getFieldsAsCsv = exports.getAllFields = exports.augmentMessageCodeBlocks = exports.SECURITY_ASSISTANT_UI_SETTING_KEY = exports.LOCAL_STORAGE_KEY = void 0;
 ...
 * @param replacements
 */
const getMessageContentWithReplacements = ({
  messageContent,
  replacements
}) => replacements != null ? Object.keys(replacements).reduce((acc, replacement) => acc.replaceAll(replacement, replacements[replacement]), messageContent) : messageContent;
 ...
 */
exports.getMessageContentWithReplacements = getMessageContentWithReplacements;
const augmentMessageCodeBlocks = currentConversation => {
  const cbd = currentConversation.messages.map(({
    content
  }) => (0, _elasticAssistant.analyzeMarkdown)(getMessageContentWithReplacements({
