...
const ALERT_SUMMARIZATION_TITLE = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.alertSummarizationTitle', {
  defaultMessage: 'Alert summarization'
});
exports.ALERT_SUMMARIZATION_TITLE = ALERT_SUMMARIZATION_TITLE;
const ALERT_SUMMARIZATION_PROMPT = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.alertSummarizationPrompt', {
...
exports.ALERT_SUMMARIZATION_PROMPT = ALERT_SUMMARIZATION_PROMPT;
const ESQL_QUERY_GENERATION_TITLE = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.esqlQueryGenerationTitle', {
  defaultMessage: 'ES|QL Query Generation'
});
exports.ESQL_QUERY_GENERATION_TITLE = ESQL_QUERY_GENERATION_TITLE;
const ESQL_QUERY_GENERATION_PROMPT = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.esqlQueryGenerationPrompt', {
...
exports.ESQL_QUERY_GENERATION_PROMPT = ESQL_QUERY_GENERATION_PROMPT;
const RULE_CREATION_TITLE = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.ruleCreationTitle', {
  defaultMessage: 'Query generation'
});
exports.RULE_CREATION_TITLE = RULE_CREATION_TITLE;
const RULE_CREATION_PROMPT = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.ruleCreationPrompt', {
...
exports.RULE_CREATION_PROMPT = RULE_CREATION_PROMPT;
const WORKFLOW_ANALYSIS_TITLE = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.workflowAnalysisTitle', {
  defaultMessage: 'Workflow suggestions'
});
exports.WORKFLOW_ANALYSIS_TITLE = WORKFLOW_ANALYSIS_TITLE;
const WORKFLOW_ANALYSIS_PROMPT = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.workflowAnalysisPrompt', {
  defaultMessage: 'As an expert user of Elastic Security, please suggest a workflow, with step by step instructions on how to:'
});
exports.WORKFLOW_ANALYSIS_PROMPT = WORKFLOW_ANALYSIS_PROMPT;
const THREAT_INVESTIGATION_GUIDES_TITLE = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.threatInvestigationGuidesTitle', {
  defaultMessage: 'Custom data ingestion helper'
});
exports.THREAT_INVESTIGATION_GUIDES_TITLE = THREAT_INVESTIGATION_GUIDES_TITLE;
const THREAT_INVESTIGATION_GUIDES_PROMPT = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.threatInvestigationGuidesPrompt', {
...
exports.THREAT_INVESTIGATION_GUIDES_PROMPT = THREAT_INVESTIGATION_GUIDES_PROMPT;
const SPL_QUERY_CONVERSION_TITLE = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.splQueryConversionTitle', {
  defaultMessage: 'Query conversion'
});
exports.SPL_QUERY_CONVERSION_TITLE = SPL_QUERY_CONVERSION_TITLE;
const SPL_QUERY_CONVERSION_PROMPT = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.splQueryConversionPrompt', {
...
exports.SPL_QUERY_CONVERSION_PROMPT = SPL_QUERY_CONVERSION_PROMPT;
const AUTOMATION_TITLE = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.AutomationTitle', {
  defaultMessage: 'Agent integration advice'
});
exports.AUTOMATION_TITLE = AUTOMATION_TITLE;
const AUTOMATION_PROMPT = _i18n.i18n.translate('xpack.securitySolution.assistant.quickPrompts.AutomationPrompt', {
  defaultMessage: 'Which Fleet enabled Elastic Agent integration should I use to collect logs and events from:'
});
exports.AUTOMATION_PROMPT = AUTOMATION_PROMPT;