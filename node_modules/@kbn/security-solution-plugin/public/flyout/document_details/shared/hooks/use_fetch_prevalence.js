...
const FIELD_NAMES_AGG_KEY = 'fieldNames';
exports.FIELD_NAMES_AGG_KEY = FIELD_NAMES_AGG_KEY;
const EVENT_KIND_AGG_KEY = 'eventKind';
exports.EVENT_KIND_AGG_KEY = EVENT_KIND_AGG_KEY;
const HOST_NAME_AGG_KEY = 'hostName';
exports.HOST_NAME_AGG_KEY = HOST_NAME_AGG_KEY;
const USER_NAME_AGG_KEY = 'userName';
exports.USER_NAME_AGG_KEY = USER_NAME_AGG_KEY;
const HOSTS_AGG_KEY = 'hosts';
exports.HOSTS_AGG_KEY = HOSTS_AGG_KEY;
const USERS_AGG_KEY = 'users';

/**
 * Interface for a specific aggregation schema with nested aggregations, used in the prevalence components
 */
exports.USERS_AGG_KEY = USERS_AGG_KEY;
/**
