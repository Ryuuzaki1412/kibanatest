...
exports.RuleSourceFilter = void 0;
...
const RuleSourceFilterComponent = ({
  ...
  const options = (0, _helpers.populateSelected)(_constants.ruleSourceFilterDefaultOptions, selected);
  ...
  const renderOptionLabel = option => _constants.ruleSourceFilterLabelMap[option.label];
  ...
  }, i18n.CoverageOverviewRuleSourceFilterLabel), [isPopoverOpen, numActiveFilters, onButtonClick, isLoading]);
...
const RuleSourceFilter = /*#__PURE__*/_react.default.memo(RuleSourceFilterComponent);
exports.RuleSourceFilter = RuleSourceFilter;