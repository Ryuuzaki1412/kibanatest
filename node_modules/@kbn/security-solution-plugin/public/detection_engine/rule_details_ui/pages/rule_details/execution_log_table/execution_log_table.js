...
var _model2 = require("../../../../../common/store/sourcerer/model");
...
const ExecutionLogTableComponent = ({
  ...
  const {
    indexPattern
  } = (0, _sourcerer.useSourcererDataView)(_model2.SourcererScopeName.detections);
  const {
    addError,
    addSuccess,
    remove
  ...
  const onFilterByExecutionIdCallback = (0, _react.useCallback)((executionId, executionStart) => {
    if (uuidDataViewField != null) {
      ...
      successToastId.current = addSuccess({
        ...
        text: (0, _coreMountUtilsBrowserInternal.mountReactNode)( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("p", null, i18n.ACTIONS_SEARCH_FILTERS_HAVE_BEEN_UPDATED_DESCRIPTION), /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
  ...
  }, [addError, addSuccess, dispatch, filterManager, filters, indexPattern, query, resetGlobalQueryState, selectAlertsTab, timerange, uuidDataViewField]);
  ...
  const executionLogColumns = (0, _react.useMemo)(() => {
    ...
    if (showMetricColumns) {
      columns.push((0, _execution_log_columns.getMessageColumn)('20%'), ...(0, _execution_log_columns.getExecutionLogMetricsColumns)(docLinks));
    } else {
      columns.push((0, _execution_log_columns.getMessageColumn)('50%'));
    }
...
const ExecutionLogTable = /*#__PURE__*/_react.default.memo(ExecutionLogTableComponent);
exports.ExecutionLogTable = ExecutionLogTable;
