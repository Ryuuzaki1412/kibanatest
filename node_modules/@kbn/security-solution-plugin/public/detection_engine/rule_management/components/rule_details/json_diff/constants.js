...
exports.TABLE_CLASS_NAME = TABLE_CLASS_NAME;
const CODE_CLASS_NAME = 'rule-update-diff-code';
exports.CODE_CLASS_NAME = CODE_CLASS_NAME;
const GUTTER_CLASS_NAME = 'rule-update-diff-gutter';
exports.GUTTER_CLASS_NAME = GUTTER_CLASS_NAME;
const DARK_THEME_CLASS_NAME = 'rule-update-diff-dark-theme';
exports.DARK_THEME_CLASS_NAME = DARK_THEME_CLASS_NAME;
const COLORS = {
  light: {
    gutterBackground: {
