...
const PERFORM_SPECIFIC_RULES_INSTALLATION_KEY = ['POST', 'SPECIFIC_RULES', _urls.PERFORM_RULE_INSTALLATION_URL];
exports.PERFORM_SPECIFIC_RULES_INSTALLATION_KEY = PERFORM_SPECIFIC_RULES_INSTALLATION_KEY;
const usePerformSpecificRulesInstallMutation = options => {
  ...
  return (0, _reactQuery.useMutation)(rulesToInstall => {
    return (0, _api.performInstallSpecificRules)(rulesToInstall);
  }, {
    ...options,
