...
const PREBUILT_RULES_STATUS_QUERY_KEY = ['GET', _prebuilt_rules.GET_PREBUILT_RULES_STATUS_URL];
exports.PREBUILT_RULES_STATUS_QUERY_KEY = PREBUILT_RULES_STATUS_QUERY_KEY;
