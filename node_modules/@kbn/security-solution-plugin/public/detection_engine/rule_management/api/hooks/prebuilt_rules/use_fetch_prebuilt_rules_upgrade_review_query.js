...
const REVIEW_RULE_UPGRADE_QUERY_KEY = ['POST', _urls.REVIEW_RULE_UPGRADE_URL];
exports.REVIEW_RULE_UPGRADE_QUERY_KEY = REVIEW_RULE_UPGRADE_QUERY_KEY;
const useFetchPrebuiltRulesUpgradeReviewQuery = options => {
  return (0, _reactQuery.useQuery)(REVIEW_RULE_UPGRADE_QUERY_KEY, async ({
    signal
  }) => {
