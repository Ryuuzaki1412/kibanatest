...
exports.usePerformAllRulesInstallMutation = exports.PERFORM_ALL_RULES_INSTALLATION_KEY = void 0;
...
const PERFORM_ALL_RULES_INSTALLATION_KEY = ['POST', 'ALL_RULES', _urls.PERFORM_RULE_INSTALLATION_URL];
exports.PERFORM_ALL_RULES_INSTALLATION_KEY = PERFORM_ALL_RULES_INSTALLATION_KEY;
const usePerformAllRulesInstallMutation = options => {
  ...
  return (0, _reactQuery.useMutation)(() => (0, _api.performInstallAllRules)(), {
    ...options,
...
exports.usePerformAllRulesInstallMutation = usePerformAllRulesInstallMutation;