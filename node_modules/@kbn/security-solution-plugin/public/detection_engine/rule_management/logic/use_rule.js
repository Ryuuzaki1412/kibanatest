...
var _use_fetch_rule_by_id_query = require("../api/hooks/use_fetch_rule_by_id_query");
 ...
 *
 */
const useRule = (id, showToast = true) => {
  const {
    addError
  } = (0, _use_app_toasts.useAppToasts)();
  return (0, _use_fetch_rule_by_id_query.useFetchRuleByIdQuery)(id, showToast ? {
    onError: error => {
      addError(error, {
