...
const SHORT_EMPTY_TITLE = _i18n.i18n.translate('xpack.securitySolution.osquery.action.shortEmptyTitle', {
  defaultMessage: 'Osquery is not available'
});
exports.SHORT_EMPTY_TITLE = SHORT_EMPTY_TITLE;
const PERMISSION_DENIED = _i18n.i18n.translate('xpack.securitySolution.osquery.action.permissionDenied', {
  defaultMessage: 'Permission denied'
});
exports.PERMISSION_DENIED = PERMISSION_DENIED;
const NOT_AVAILABLE = _i18n.i18n.translate('xpack.securitySolution.osquery.action.unavailable', {
