...
const CANCEL = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addException.cancel', {
  defaultMessage: 'Cancel'
});
exports.CANCEL = CANCEL;
const CREATE_RULE_EXCEPTION = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addException.createRuleExceptionLabel', {
  defaultMessage: 'Add rule exception'
});
exports.CREATE_RULE_EXCEPTION = CREATE_RULE_EXCEPTION;
const ADD_ENDPOINT_EXCEPTION = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addException.addEndpointException', {
  defaultMessage: 'Add Endpoint Exception'
});
exports.ADD_ENDPOINT_EXCEPTION = ADD_ENDPOINT_EXCEPTION;
const SUBMIT_ERROR_TITLE = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addException.submitError.title', {
  defaultMessage: 'An error occured submitting exception'
});
exports.SUBMIT_ERROR_TITLE = SUBMIT_ERROR_TITLE;
const SUBMIT_ERROR_DISMISS_BUTTON = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addException.submitError.dismissButton', {
  defaultMessage: 'Dismiss'
});
exports.SUBMIT_ERROR_DISMISS_BUTTON = SUBMIT_ERROR_DISMISS_BUTTON;
const SUBMIT_ERROR_DISMISS_MESSAGE = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addException.submitError.message', {
  defaultMessage: 'View toast for error details.'
});
exports.SUBMIT_ERROR_DISMISS_MESSAGE = SUBMIT_ERROR_DISMISS_MESSAGE;
const ADD_EXCEPTION_SUCCESS = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addException.success', {
  defaultMessage: 'Rule exception added to shared exception list'
});
exports.ADD_EXCEPTION_SUCCESS = ADD_EXCEPTION_SUCCESS;
...
const ADD_RULE_EXCEPTION_SUCCESS_TITLE = _i18n.i18n.translate('xpack.securitySolution.ruleExceptions.addExceptionFlyout.addRuleExceptionToastSuccessTitle', {
  defaultMessage: 'Rule exception added'
});
exports.ADD_RULE_EXCEPTION_SUCCESS_TITLE = ADD_RULE_EXCEPTION_SUCCESS_TITLE;
