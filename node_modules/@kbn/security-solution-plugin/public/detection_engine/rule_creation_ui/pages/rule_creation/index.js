...
var _helpers3 = require("../../../../detections/components/rules/rule_preview/helpers");
var _use_start_ml_jobs = require("../../../rule_management/logic/use_start_ml_jobs");
var _next_step = require("../../../../detections/components/rules/next_step");
...
const CreateRulePageComponent = () => {
  ...
  }, [validateStep, defineStepForm, eqlOptionsSelected, aboutStepForm, scheduleStepForm, actionsStepForm, createRule, addSuccess, navigateToApp, ruleType, startMlJobs]);
