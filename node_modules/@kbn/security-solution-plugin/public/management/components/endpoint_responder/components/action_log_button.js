...
const ActionLogButton = /*#__PURE__*/(0, _react.memo)(props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiButton, {
    ...
    size: "m"
  }, /*#__PURE__*/_react.default.createElement("h1", null, _translations.UX_MESSAGES.flyoutTitle(props.meta.endpoint.host.hostname)))), /*#__PURE__*/_react.default.createElement(_eui.EuiFlyoutBody, null, /*#__PURE__*/_react.default.createElement(_response_actions_log.ResponseActionsLog, {
    agentIds: props.meta.endpoint.agent.id
  }))));
});
exports.ActionLogButton = ActionLogButton;
