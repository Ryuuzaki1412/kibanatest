...
const IsolateActionResult = /*#__PURE__*/(0, _react.memo)(({
  command,
  setStore,
  store,
  status,
  ...
  var _command$args$args2, _command$commandDefin3, _command$commandDefin4;
...
exports.IsolateActionResult = IsolateActionResult;
