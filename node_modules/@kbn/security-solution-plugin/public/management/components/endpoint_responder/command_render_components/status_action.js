...
const EndpointStatusActionResult = /*#__PURE__*/(0, _react.memo)(({
  command,
  status,
  setStatus,
  store,
  ...
  const getStatusDescriptionList = (0, _react.useCallback)(() => {
    ...
    const agentStatus = () => {
      ...
      return `${(0, _agent_status_text.getAgentStatusText)(endpointDetails.host_status)}${isolateStatus.length > 0 ? ` - ${isolateStatus}` : ''}`;
    };
    const statusData = [{
...
exports.EndpointStatusActionResult = EndpointStatusActionResult;
