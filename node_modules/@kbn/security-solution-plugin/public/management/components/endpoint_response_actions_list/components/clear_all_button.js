...
const StyledEuiButtonEmpty = (0, _common.euiStyled)(_eui.EuiButtonEmpty).attrs({
  iconType: 'cross',
  color: 'danger'
})`
  ...
  border-radius : 0;
`;
const ClearAllButton = /*#__PURE__*/(0, _react.memo)(({
  ...
  return /*#__PURE__*/_react.default.createElement(StyledEuiButtonEmpty, {
    ...
    onClick: onClick
  }, _translations.UX_MESSAGES.filterClearAll);
});
