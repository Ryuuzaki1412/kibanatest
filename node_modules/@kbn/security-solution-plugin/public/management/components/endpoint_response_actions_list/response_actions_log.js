...
const ResponseActionsLog = /*#__PURE__*/(0, _react.memo)(({
  agentIds,
  showHostNames = false,
  isFlyout = true,
  setIsDataInResponse,
  ...
  (0, _react.useEffect)(() => {
    if (!isFlyout) {
      setQueryParams(prevState => ({
        ...prevState,
        commands: commandsFromUrl !== null && commandsFromUrl !== void 0 && commandsFromUrl.length ? commandsFromUrl.map(commandFromUrl => (0, _hooks2.getCommandKey)(commandFromUrl)) : prevState.commands,
        ...
        types: typesFromUrl !== null && typesFromUrl !== void 0 && typesFromUrl.length ? typesFromUrl : prevState.types
      }));
    }
  }, [commandsFromUrl, agentIdsFromUrl, isFlyout, statusesFromUrl, setQueryParams, usersFromUrl, withOutputsFromUrl, typesFromUrl]);
...
exports.ResponseActionsLog = ResponseActionsLog;
