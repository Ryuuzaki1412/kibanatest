...
exports.INGEST_API_PACKAGE_POLICIES = INGEST_API_PACKAGE_POLICIES;
const INGEST_API_AGENT_POLICIES = `${INGEST_API_ROOT}/agent_policies`;
exports.INGEST_API_AGENT_POLICIES = INGEST_API_AGENT_POLICIES;
const INGEST_API_FLEET_AGENT_STATUS = `${INGEST_API_ROOT}/agent_status`;
const INGEST_API_FLEET_AGENTS = `${INGEST_API_ROOT}/agents`;
exports.INGEST_API_FLEET_AGENTS = INGEST_API_FLEET_AGENTS;
 ...
 * @param options
 */
exports.INGEST_API_EPM_PACKAGES = INGEST_API_EPM_PACKAGES;
