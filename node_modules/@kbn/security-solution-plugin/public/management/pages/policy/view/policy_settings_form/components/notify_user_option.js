...
const NOTIFY_USER_SECTION_TITLE = _i18n.i18n.translate('xpack.securitySolution.endpoint.policyDetailsConfig.userNotification', {
  defaultMessage: 'User notification'
});
exports.NOTIFY_USER_SECTION_TITLE = NOTIFY_USER_SECTION_TITLE;
const NOTIFY_USER_CHECKBOX_LABEL = _i18n.i18n.translate('xpack.securitySolution.endpoint.policyDetail.notifyUser', {
  defaultMessage: 'Notify user'
});
exports.NOTIFY_USER_CHECKBOX_LABEL = NOTIFY_USER_CHECKBOX_LABEL;
...
const CUSTOMIZE_NOTIFICATION_MESSAGE_LABEL = _i18n.i18n.translate('xpack.securitySolution.endpoint.policyDetailsConfig.customizeUserNotification', {
  defaultMessage: 'Customize notification message'
});
exports.CUSTOMIZE_NOTIFICATION_MESSAGE_LABEL = CUSTOMIZE_NOTIFICATION_MESSAGE_LABEL;
const NotifyUserOption = /*#__PURE__*/_react.default.memo(({
  policy,
  onChange,
  mode,
  protection,
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    size: "s"
  }), isEditMode ? /*#__PURE__*/_react.default.createElement(_eui.EuiCheckbox, {
  ...
  }) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, NOTIFY_USER_CHECKBOX_LABEL), userNotificationSelected && (isEditMode ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, {
    size: "m"
...
exports.NotifyUserOption = NotifyUserOption;
NotifyUserOption.displayName = 'NotifyUserOption';
const SupportedVersionForProtectionNotice = /*#__PURE__*/_react.default.memo(({
  protection,
  'data-test-subj': dataTestSubj
}) => {
...
exports.SupportedVersionForProtectionNotice = SupportedVersionForProtectionNotice;
