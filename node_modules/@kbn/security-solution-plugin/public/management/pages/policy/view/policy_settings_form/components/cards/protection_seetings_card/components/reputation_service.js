...
const USE_REPUTATION_SERVICE_CHECKBOX_LABEL = _i18n.i18n.translate('xpack.securitySolution.endpoint.policyDetail.useReputationService', {
  defaultMessage: 'Use reputation service'
});
const DO_NOT_USE_REPUTATION_SERVICE_CHECKBOX_LABEL = _i18n.i18n.translate('xpack.securitySolution.endpoint.policyDetail.doNotUseReputationService', {
  defaultMessage: "Don't use reputation service"
});
const ReputationService = /*#__PURE__*/_react.default.memo(({
  policy,
  onChange,
  mode,
  protection,
  ...
  const checkboxLabel = checkboxChecked ? USE_REPUTATION_SERVICE_CHECKBOX_LABEL : DO_NOT_USE_REPUTATION_SERVICE_CHECKBOX_LABEL;
  if (!isCloud) {
    return null;
  }
  ...
  }) : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, checkboxLabel));
});
