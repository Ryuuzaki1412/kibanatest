...
const PolicyArtifactsList = /*#__PURE__*/_react.default.memo(({
  policy,
  apiClient,
  searchableFields,
  getArtifactPath,
  ...
  const provideCardProps = (0, _react.useCallback)(artifact => {
    ...
    const item = artifact;
    const isGlobal = (0, _utils.isGlobalPolicyEffected)(item.tags);
    const deleteAction = {
      icon: 'trash',
...
exports.PolicyArtifactsList = PolicyArtifactsList;
