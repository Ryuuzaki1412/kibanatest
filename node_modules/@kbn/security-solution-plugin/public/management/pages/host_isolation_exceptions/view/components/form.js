...
const testIdPrefix = 'hostIsolationExceptions-form';
exports.testIdPrefix = testIdPrefix;
const HostIsolationExceptionsForm = /*#__PURE__*/(0, _react.memo)(({
  item: exception,
  onChange,
  policies,
  disabled,
  ...
  const [selectedPolicies, setSelectedPolicies] = (0, _react.useState)({
    isGlobal: (0, _utils.isGlobalPolicyEffected)(exception.tags),
    selected: []
  });
  ...
  const handlePolicySelectChange = (0, _react.useCallback)(selection => {
    ...
    notifyOfChange({
      tags: (0, _utils.getArtifactTagsByEffectedPolicySelection)(selection, (0, _utils.getArtifactTagsWithoutPolicies)(exception.tags))
    });
  ...
  (0, _react.useEffect)(() => {
    if (selectedPolicies.selected.length === 0 && exception.tags) {
      setSelectedPolicies((0, _utils.getEffectedPolicySelectionByTags)(exception.tags, policies));
    }
...
exports.HostIsolationExceptionsForm = HostIsolationExceptionsForm;
