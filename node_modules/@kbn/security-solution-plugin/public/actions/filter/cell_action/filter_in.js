...
exports.createFilterInCellActionFactory = void 0;
...
const createFilterInCellActionFactory = ({
  store,
  services
}) => {
  ...
  const genericFilterInActionFactory = (0, _cellActions.createFilterInActionFactory)({
    filterManager,
    notifications
  });
  return genericFilterInActionFactory.combine({
    ...
    execute: async ({
      ...
      const addFilter = (metadata === null || metadata === void 0 ? void 0 : metadata.negateFilters) === true ? _cellActions.addFilterOut : _cellActions.addFilterIn;
...
exports.createFilterInCellActionFactory = createFilterInCellActionFactory;