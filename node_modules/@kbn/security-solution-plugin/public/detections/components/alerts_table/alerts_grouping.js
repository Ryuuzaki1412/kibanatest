...
const GroupedAlertsTableComponent = props => {
  ...
  const groupInRedux = (0, _use_selector.useDeepEqualSelector)(state => (0, _selectors.groupIdSelector)()(state, props.tableId));
  (0, _react.useEffect)(() => {
...
const GroupedAlertsTable = /*#__PURE__*/_react.default.memo(GroupedAlertsTableComponent);
exports.GroupedAlertsTable = GroupedAlertsTable;