...
const AlertsTableComponent = ({
  ...
  }), [triggersActionsUi.alertsTableConfigurationRegistry, configId, tableView, finalBoolQuery, gridStyle, rowHeightsOptions, finalColumns, finalBrowserFields, onAlertTableUpdate, runtimeMappings, isEventRenderedView]);
  (0, _react.useEffect)(() => {
