...
const GroupedSubLevelComponent = ({
  ...
  const {
    ...
    skip: (0, _securitysolutionGrouping.isNoneGroup)([selectedGroup])
  });
  ...
  (0, _react.useEffect)(() => {
    if (!(0, _securitysolutionGrouping.isNoneGroup)([selectedGroup])) {
...
const GroupedSubLevel = /*#__PURE__*/_react.default.memo(GroupedSubLevelComponent);
exports.GroupedSubLevel = GroupedSubLevel;