...
const useAddBulkToTimelineAction = ({
  ...
  const clearActiveTimeline = (0, _use_create_timeline.useCreateTimeline)({
    ...
    timelineType: _timeline3.TimelineType.default
  });
  const updateTimelineIsLoading = (0, _react.useCallback)(payload => dispatch(_timeline.timelineActions.updateIsLoading(payload)), [dispatch]);
  const createTimeline = (0, _react.useCallback)(({
    ...
    (0, _helpers.dispatchUpdateTimeline)(dispatch)({
      duplicate: true,
      from,
      id: _timeline2.TimelineId.active,
      notes: [],
