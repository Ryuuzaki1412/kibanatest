...
exports.severityAggregations = severityAggregations;
const alertTypeAggregations = {
  alertsByType: {
    terms: {
...
exports.alertTypeAggregations = alertTypeAggregations;
const alertRuleAggregations = {
  alertsByRule: {
    terms: {
      field: _ruleDataUtils.ALERT_RULE_NAME,
      size: DEFAULT_QUERY_SIZE
...
exports.alertRuleAggregations = alertRuleAggregations;
