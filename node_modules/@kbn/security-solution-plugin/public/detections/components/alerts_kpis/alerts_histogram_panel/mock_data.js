...
exports.textResult = exports.stackedByTextField = exports.stackedByBooleanField = exports.result = exports.mockAlertSearchResponse = void 0;
/*
  ...
  hits: {
    ...
    hits: [{
      ...
      _source: {
        ...
        'kibana.alert.reason': 'malware event with process malware writer, file fake_malware.exe, on Host-xh6qyoiujf created low alert matches everything.',
        ...
        'kibana.alert.rule.indices': ['apm-*-transaction*', 'traces-apm*', 'auditbeat-*', 'endgame-*', 'filebeat-*', 'logs-*', 'packetbeat-*', 'winlogbeat-*'],
...
exports.mockAlertSearchResponse = mockAlertSearchResponse;