...
const DETECTIONS_TABLE_IDS = [_securitysolutionDataTable.TableId.alertsOnRuleDetailsPage, _securitysolutionDataTable.TableId.alertsOnAlertsPage];
exports.DETECTIONS_TABLE_IDS = DETECTIONS_TABLE_IDS;
class Detections {
  setup() {}
  start(storage) {
    return {
