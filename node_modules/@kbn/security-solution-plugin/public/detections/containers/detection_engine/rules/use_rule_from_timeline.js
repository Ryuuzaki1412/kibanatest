...
var _sourcerer2 = require("../../../../common/store/sourcerer");
...
const RULE_FROM_TIMELINE_URL_PARAM = 'createRuleFromTimeline';
exports.RULE_FROM_TIMELINE_URL_PARAM = RULE_FROM_TIMELINE_URL_PARAM;
const RULE_FROM_EQL_URL_PARAM = 'createRuleFromEql';
exports.RULE_FROM_EQL_URL_PARAM = RULE_FROM_EQL_URL_PARAM;
const useRuleFromTimeline = setRuleQuery => {
  ...
  const onOpenTimeline = (0, _react.useCallback)(timeline => {
    ...
    if (timeline.dataViewId !== dataViewId && !(0, _fp.isEmpty)(timeline.indexNames)) {
      ...
      dispatch(_sourcerer2.sourcererActions.setSelectedDataView({
    ...
    if (selectedTimeline == null || timelineId !== selectedTimeline.id) {
      (0, _helpers.queryTimelineById)({
        ...
        updateIsLoading: ({
          ...
          isLoading
        }) => dispatch((0, _actions.updateIsLoading)({
          id: currentTimelineId,
          isLoading
        })),
