...
const DEFAULT_TABLE_COLUMN_MIN_WIDTH = 180; // px

/** The default minimum width of a column of type `date` */
exports.DEFAULT_TABLE_COLUMN_MIN_WIDTH = DEFAULT_TABLE_COLUMN_MIN_WIDTH;
const DEFAULT_TABLE_DATE_COLUMN_MIN_WIDTH = 190; // px
exports.DEFAULT_TABLE_DATE_COLUMN_MIN_WIDTH = DEFAULT_TABLE_DATE_COLUMN_MIN_WIDTH;