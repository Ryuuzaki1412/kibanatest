...
exports.useNetworkOverview = exports.ID = void 0;
...
const ID = 'overviewNetworkQuery';
exports.ID = ID;
const useNetworkOverview = ({
  filterQuery,
  endDate,
  indexNames,
  skip = false,
  ...
  const {
    ...
    factoryQueryType: _security_solution.NetworkQueries.overview,
    initialResult: {
      overviewNetwork: {}
    },
  ...
  const overviewNetworkResponse = (0, _react.useMemo)(() => ({
    endDate,
  ...
  const overviewNetworkRequest = (0, _react.useMemo)(() => ({
...
exports.useNetworkOverview = useNetworkOverview;