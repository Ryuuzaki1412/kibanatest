...
exports.useHostOverview = exports.ID = void 0;
...
const useHostOverview = ({
  ...
  const {
    ...
    factoryQueryType: _security_solution.HostsQueries.overview,
    initialResult: {
      overviewHost: {}
    },
  ...
  const overviewHostResponse = (0, _react.useMemo)(() => ({
    endDate,
  ...
  const overviewHostRequest = (0, _react.useMemo)(() => ({
...
exports.useHostOverview = useHostOverview;