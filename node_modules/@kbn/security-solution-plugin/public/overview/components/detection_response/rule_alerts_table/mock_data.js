...
exports.severityRuleAlertsQuery = severityRuleAlertsQuery;
const mockSeverityRuleAlertsResponse = {
  aggregations: {
    alertsByRule: {
      buckets: [{
        key: 'RULE_1',
...
exports.mockSeverityRuleAlertsResponse = mockSeverityRuleAlertsResponse;
const severityRuleAlertsResponseParsed = [{
  alert_count: 54,
...
exports.severityRuleAlertsResponseParsed = severityRuleAlertsResponseParsed;