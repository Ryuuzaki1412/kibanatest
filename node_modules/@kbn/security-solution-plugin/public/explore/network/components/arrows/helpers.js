...
const DEFAULT_ARROW_HEIGHT = 1;
exports.DEFAULT_ARROW_HEIGHT = DEFAULT_ARROW_HEIGHT;
const MAX_ARROW_HEIGHT = 4;

/** Returns the height of an arrow in pixels based on the specified percent (0-100) */
exports.MAX_ARROW_HEIGHT = MAX_ARROW_HEIGHT;
const getArrowHeightFromPercent = (0, _d3Scale.scaleLinear)().domain([0, 100]).range([DEFAULT_ARROW_HEIGHT, MAX_ARROW_HEIGHT]).clamp(true);
