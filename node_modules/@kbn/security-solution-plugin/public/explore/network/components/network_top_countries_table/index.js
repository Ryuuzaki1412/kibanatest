...
const NetworkTopCountriesTableId = 'networkTopCountries-top-talkers';
...
const NetworkTopCountriesTableComponent = ({
  ...
  const columns = (0, _react.useMemo)(() => (0, _columns.getCountriesColumnsCurated)(indexPattern, flowTargeted, type, NetworkTopCountriesTableId), [indexPattern, flowTargeted, type]);
...
const NetworkTopCountriesTable = /*#__PURE__*/_react.default.memo(NetworkTopCountriesTableComponent);
