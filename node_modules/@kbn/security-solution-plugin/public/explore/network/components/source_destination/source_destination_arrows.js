...
const SOURCE_BYTES_FIELD_NAME = 'source.bytes';
exports.SOURCE_BYTES_FIELD_NAME = SOURCE_BYTES_FIELD_NAME;
const SOURCE_PACKETS_FIELD_NAME = 'source.packets';
exports.SOURCE_PACKETS_FIELD_NAME = SOURCE_PACKETS_FIELD_NAME;
const DESTINATION_BYTES_FIELD_NAME = 'destination.bytes';
exports.DESTINATION_BYTES_FIELD_NAME = DESTINATION_BYTES_FIELD_NAME;
const DESTINATION_PACKETS_FIELD_NAME = 'destination.packets';
 ...
 */
const SourceDestinationArrows = /*#__PURE__*/_react.default.memo(({
  contextId,
  destinationBytes,
  destinationPackets,
  eventId,
