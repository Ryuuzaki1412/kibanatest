...
const sourceDestinationFieldMappings = {
  ...sourceFieldMappings,
...
const SUM_OF_CLIENT_BYTES = 'sum_of_client.bytes';
exports.SUM_OF_CLIENT_BYTES = SUM_OF_CLIENT_BYTES;
const SUM_OF_SERVER_BYTES = 'sum_of_server.bytes';
...
const getLayerList = indexPatternIds => {
  return [{
    sourceDescriptor: {
      type: _common.SOURCE_TYPES.EMS_TMS,
      isAutoSelect: true
    },
    id: (0, _uuid.v4)(),
    label: null,
    ...
    visible: true,
    style: null,
    type: _common.LAYER_TYPE.EMS_VECTOR_TILE
  }, ...indexPatternIds.reduce((acc, {
    title,
    id
  }) => {
