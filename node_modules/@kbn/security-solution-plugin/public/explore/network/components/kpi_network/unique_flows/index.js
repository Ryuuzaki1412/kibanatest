...
exports.fieldsMapping = exports.NetworkKpiUniqueFlows = void 0;
var _react = _interopRequireWildcard(require("react"));
var _kpi_unique_flow_ids = require("../../../../../common/components/visualization_actions/lens_attributes/network/kpi_unique_flow_ids");
var _unique_flows = require("../../../containers/kpi_network/unique_flows");
...
const fieldsMapping = [{
  ...
  fields: [{
    key: 'uniqueFlowId',
    value: null,
    lensAttributes: _kpi_unique_flow_ids.kpiUniqueFlowIdsLensAttributes
  }],
...
const NetworkKpiUniqueFlowsComponent = ({
  ...
  const {
    toggleStatus
  } = (0, _query_toggle.useQueryToggle)(_unique_flows.ID);
  ...
  const [loading, {
    ...
    inspect,
    ...data
  }] = (0, _unique_flows.useNetworkKpiUniqueFlows)({
    filterQuery,
    endDate: to,
    indexNames,
    startDate: from,
...
const NetworkKpiUniqueFlows = /*#__PURE__*/_react.default.memo(NetworkKpiUniqueFlowsComponent);
