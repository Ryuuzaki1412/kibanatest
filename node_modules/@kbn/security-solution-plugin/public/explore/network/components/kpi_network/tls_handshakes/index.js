...
exports.fieldsMapping = exports.NetworkKpiTlsHandshakes = void 0;
var _react = _interopRequireWildcard(require("react"));
var _kpi_tls_handshakes = require("../../../../../common/components/visualization_actions/lens_attributes/network/kpi_tls_handshakes");
var _tls_handshakes = require("../../../containers/kpi_network/tls_handshakes");
...
const fieldsMapping = [{
  ...
  fields: [{
    key: 'tlsHandshakes',
    value: null,
    lensAttributes: _kpi_tls_handshakes.kpiTlsHandshakesLensAttributes
  }],
...
const NetworkKpiTlsHandshakesComponent = ({
  ...
  const {
    toggleStatus
  } = (0, _query_toggle.useQueryToggle)(_tls_handshakes.ID);
  ...
  const [loading, {
    ...
    inspect,
    ...data
  }] = (0, _tls_handshakes.useNetworkKpiTlsHandshakes)({
    filterQuery,
    endDate: to,
    indexNames,
    startDate: from,
...
const NetworkKpiTlsHandshakes = /*#__PURE__*/_react.default.memo(NetworkKpiTlsHandshakesComponent);
