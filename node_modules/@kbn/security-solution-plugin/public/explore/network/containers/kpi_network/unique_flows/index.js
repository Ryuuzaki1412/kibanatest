...
exports.useNetworkKpiUniqueFlows = exports.ID = void 0;
...
exports.ID = ID;
const useNetworkKpiUniqueFlows = ({
  filterQuery,
  endDate,
  indexNames,
  skip = false,
  ...
  const [networkKpiUniqueFlowsRequest, setNetworkKpiUniqueFlowsRequest] = (0, _react.useState)(null);
  const [networkKpiUniqueFlowsResponse, setNetworkKpiUniqueFlowsResponse] = (0, _react.useState)({
    uniqueFlowId: 0,
    id: ID,
    inspect: {
      dsl: [],
  ...
  const networkKpiUniqueFlowsSearch = (0, _react.useCallback)(request => {
  ...
  (0, _react.useEffect)(() => {
    setNetworkKpiUniqueFlowsRequest(prevRequest => {
      const myRequest = {
        ...
        factoryQueryType: _search_strategy.NetworkKpiQueries.uniqueFlows,
...
exports.useNetworkKpiUniqueFlows = useNetworkKpiUniqueFlows;