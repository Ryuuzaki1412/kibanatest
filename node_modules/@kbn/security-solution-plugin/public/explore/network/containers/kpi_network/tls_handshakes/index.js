...
exports.useNetworkKpiTlsHandshakes = exports.ID = void 0;
...
exports.ID = ID;
const useNetworkKpiTlsHandshakes = ({
  filterQuery,
  endDate,
  indexNames,
  skip = false,
  ...
  const [networkKpiTlsHandshakesRequest, setNetworkKpiTlsHandshakesRequest] = (0, _react.useState)(null);
  const [networkKpiTlsHandshakesResponse, setNetworkKpiTlsHandshakesResponse] = (0, _react.useState)({
    tlsHandshakes: 0,
    id: ID,
    inspect: {
      dsl: [],
  ...
  const networkKpiTlsHandshakesSearch = (0, _react.useCallback)(request => {
  ...
  (0, _react.useEffect)(() => {
    setNetworkKpiTlsHandshakesRequest(prevRequest => {
      const myRequest = {
        ...
        factoryQueryType: _search_strategy.NetworkKpiQueries.tlsHandshakes,
...
exports.useNetworkKpiTlsHandshakes = useNetworkKpiTlsHandshakes;