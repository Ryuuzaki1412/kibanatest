...
exports.useNetworkKpiUniquePrivateIps = exports.ID = void 0;
...
exports.ID = ID;
const useNetworkKpiUniquePrivateIps = ({
  filterQuery,
  endDate,
  indexNames,
  skip = false,
  ...
  const [networkKpiUniquePrivateIpsRequest, setNetworkKpiUniquePrivateIpsRequest] = (0, _react.useState)(null);
  const [networkKpiUniquePrivateIpsResponse, setNetworkKpiUniquePrivateIpsResponse] = (0, _react.useState)({
  ...
  const networkKpiUniquePrivateIpsSearch = (0, _react.useCallback)(request => {
        ...
        next: response => {
          if (!(0, _common.isRunningResponse)(response)) {
            ...
            setNetworkKpiUniquePrivateIpsResponse(prevResponse => ({
              ...
              uniqueDestinationPrivateIpsHistogram: response.uniqueDestinationPrivateIpsHistogram,
  ...
  (0, _react.useEffect)(() => {
    setNetworkKpiUniquePrivateIpsRequest(prevRequest => {
      const myRequest = {
        ...
        factoryQueryType: _search_strategy.NetworkKpiQueries.uniquePrivateIps,
...
exports.useNetworkKpiUniquePrivateIps = useNetworkKpiUniquePrivateIps;