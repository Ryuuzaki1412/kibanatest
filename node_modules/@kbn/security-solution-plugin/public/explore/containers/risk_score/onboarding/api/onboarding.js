...
const installRiskScore = ({
  ...
  return http.post(_constants.INTERNAL_RISK_SCORE_URL, {
    ...
    if (resp.error.length > 0) {
      ...
      notifications === null || notifications === void 0 ? void 0 : (_notifications$toasts = notifications.toasts) === null || _notifications$toasts === void 0 ? void 0 : _notifications$toasts.addError(new Error(errorMessage !== null && errorMessage !== void 0 ? errorMessage : _translations.INSTALLATION_ERROR), {
    ...
    notifications === null || notifications === void 0 ? void 0 : (_notifications$toasts3 = notifications.toasts) === null || _notifications$toasts3 === void 0 ? void 0 : _notifications$toasts3.addError(new Error(errorMessage !== null && errorMessage !== void 0 ? errorMessage : _translations.INSTALLATION_ERROR), {
      title: errorMessage !== null && errorMessage !== void 0 ? errorMessage : _translations.INSTALLATION_ERROR,
