...
exports.useHostsKpiHosts = exports.ID = void 0;
...
const useHostsKpiHosts = ({
  ...
  const [hostsKpiHostsRequest, setHostsKpiHostsRequest] = (0, _react.useState)(null);
  const [hostsKpiHostsResponse, setHostsKpiHostsResponse] = (0, _react.useState)({
    hosts: 0,
    hostsHistogram: [],
    id: ID,
    inspect: {
  ...
  const hostsKpiHostsSearch = (0, _react.useCallback)(request => {
  ...
  (0, _react.useEffect)(() => {
    setHostsKpiHostsRequest(prevRequest => {
      const myRequest = {
        ...
        factoryQueryType: _search_strategy.HostsKpiQueries.kpiHosts,
...
exports.useHostsKpiHosts = useHostsKpiHosts;