...
exports.useUsersKpiAuthentications = exports.ID = void 0;
...
const ID = 'usersKpiAuthenticationsQuery';
exports.ID = ID;
const useUsersKpiAuthentications = ({
  filterQuery,
  endDate,
  indexNames,
  skip = false,
  ...
  const [usersKpiAuthenticationsRequest, setUsersKpiAuthenticationsRequest] = (0, _react.useState)(null);
  const [usersKpiAuthenticationsResponse, setUsersKpiAuthenticationsResponse] = (0, _react.useState)({
  ...
  const usersKpiAuthenticationsSearch = (0, _react.useCallback)(request => {
  ...
  (0, _react.useEffect)(() => {
    setUsersKpiAuthenticationsRequest(prevRequest => {
      const myRequest = {
        ...
        factoryQueryType: _search_strategy.UsersQueries.kpiAuthentications,
...
exports.useUsersKpiAuthentications = useUsersKpiAuthentications;