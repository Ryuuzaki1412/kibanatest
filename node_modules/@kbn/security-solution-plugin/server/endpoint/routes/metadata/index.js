...
exports.endpointFilters = void 0;
...
function registerEndpointRoutes(router, endpointAppContext) {
  ...
  router.versioned.get({
    ...
    version: '2023-10-31',
    validate: {
      request: _endpoint.GetMetadataListRequestSchema
    }
  ...
  router.versioned.get({
    ...
    version: '2023-10-31',
    validate: {
      request: _endpoint.GetMetadataRequestSchema
    }
  }, (0, _with_endpoint_authz.withEndpointAuthz)({
  ...
  router.versioned.get({
    ...
    all: ['canReadSecuritySolution']
  }, logger, (0, _handlers.getMetadataTransformStatsHandler)(endpointAppContext, logger)));
}