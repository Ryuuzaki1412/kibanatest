...
var _routes4 = require("../lib/entity_analytics/risk_engine/routes");
var _routes5 = require("../lib/timeline/routes");
var _calculation = require("../lib/entity_analytics/risk_score/routes/calculation");
var _preview = require("../lib/entity_analytics/risk_score/routes/preview");
var _routes6 = require("../lib/entity_analytics/asset_criticality/routes");
/*
...
const initRoutes = (router, config, hasEncryptionKey, security, telemetrySender, ml, ruleDataService, logger, ruleDataClient, ruleOptions, getStartServices, securityRuleTypeOptions, previewRuleDataClient, previewTelemetryReceiver) => {
  ...
  (0, _routes5.registerTimelineRoutes)(router, config, security);
  ...
  if (config.experimentalFeatures.riskScoringRoutesEnabled) {
    (0, _preview.riskScorePreviewRoute)(router, logger);
    (0, _calculation.riskScoreCalculationRoute)(router, logger);
    (0, _routes4.riskEngineStatusRoute)(router);
    (0, _routes4.riskEngineInitRoute)(router, getStartServices);
    (0, _routes4.riskEngineEnableRoute)(router, getStartServices);
    (0, _routes4.riskEngineDisableRoute)(router, getStartServices);
    if (config.experimentalFeatures.riskEnginePrivilegesRouteEnabled) {
      (0, _routes4.riskEnginePrivilegesRoute)(router, getStartServices);
    }
  }
  if (config.experimentalFeatures.entityAnalyticsAssetCriticalityEnabled) {
    (0, _routes6.assetCriticalityStatusRoute)(router, logger);
    (0, _routes6.assetCriticalityUpsertRoute)(router, logger);
    (0, _routes6.assetCriticalityGetRoute)(router, logger);
    (0, _routes6.assetCriticalityDeleteRoute)(router, logger);
    (0, _routes6.assetCriticalityPrivilegesRoute)(router, getStartServices, logger);
  }
};
