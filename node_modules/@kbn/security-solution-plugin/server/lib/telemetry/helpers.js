...
exports.trustedApplicationToTelemetryEntry = exports.tlog = exports.templateExceptionList = exports.setIsElasticCloudDeployment = exports.ruleExceptionListItemToTelemetryEvent = exports.ranges = exports.processK8sUsernames = void 0;
...
class TelemetryTimelineFetcher {
  ...
  async fetchTimeline(event) {
    ...
    // Build Tree
    const tree = await this.receiver.buildProcessTree(entities[0].id, entities[0].schema, this.timeFrame.startOfDay, this.timeFrame.endOfDay);
