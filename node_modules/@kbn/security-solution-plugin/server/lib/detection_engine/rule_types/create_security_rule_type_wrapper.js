...
const securityRuleTypeFieldMap = {
...
exports.securityRuleTypeFieldMap = securityRuleTypeFieldMap;
  ...
  return persistenceRuleType({
    ...
    async executor(options) {
      ...
      return (0, _with_security_span.withSecuritySpan)('securityRuleTypeExecutor', async () => {
        ...
        if (!(0, _utils.isMachineLearningParams)(params) && !(0, _utils.isEsqlParams)(params)) {
        ...
        try {
          ...
          const bulkCreate = (0, _factories.bulkCreateFactory)(alertWithPersistence, refresh, ruleExecutionLogger, experimentalFeatures);
