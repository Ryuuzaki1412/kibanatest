...
exports.getSignalValueMap = exports.getMatchedFields = exports.extractNamedQueries = exports.encodeThreatMatchNamedQuery = exports.decodeThreatMatchNamedQuery = exports.combineResults = exports.combineConcurrentResults = exports.calculateMaxLookBack = exports.calculateMax = exports.calculateAdditiveMax = exports.buildExecutionIntervalValidator = void 0;
...
const decodeThreatMatchNamedQuery = encoded => {
  ...
  if (queryType === _types.ThreatMatchQueryType.match) {
    isValidQuery = queryValues.length === 5 && queryValues.every(Boolean);
  }
  if (queryType === _types.ThreatMatchQueryType.term) {
...
exports.getSignalValueMap = getSignalValueMap;