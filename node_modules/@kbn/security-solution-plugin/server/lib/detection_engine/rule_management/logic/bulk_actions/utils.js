 ...
 * @returns {boolean}
 */
const isIndexPatternsBulkEditAction = editAction => [_rule_management.BulkActionEditTypeEnum.add_index_patterns, _rule_management.BulkActionEditTypeEnum.delete_index_patterns, _rule_management.BulkActionEditTypeEnum.set_index_patterns].includes(editAction);
