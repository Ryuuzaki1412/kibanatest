...
const exportRulesRoute = (router, config, logger) => {
  router.versioned.post({
    ...
    validate: {
      request: {
        query: (0, _route_validation.buildRouteValidationWithZod)(_rule_management.ExportRulesRequestQuery),
        body: (0, _route_validation.buildRouteValidationWithZod)(_rule_management.ExportRulesRequestBody)
      }
    }
  }, async (context, request, response) => {
    var _await$context$lists, _await$context$action;
