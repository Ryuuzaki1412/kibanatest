...
const LegacyInvestigationFields = z.array(z.string());
 ...
 * See PR 169061
 */
exports.LegacyInvestigationFields = LegacyInvestigationFields;
const InvestigationFieldsCombined = z.union([_rule_schema.InvestigationFields, LegacyInvestigationFields]);
...
exports.InvestigationFieldsCombined = InvestigationFieldsCombined;
const BaseRuleParams = z.object({
...
const EqlSpecificRuleParams = z.object({
  type: z.literal('eql'),
...
exports.EqlSpecificRuleParams = EqlSpecificRuleParams;
const EqlRuleParams = z.intersection(BaseRuleParams, EqlSpecificRuleParams);
exports.EqlRuleParams = EqlRuleParams;
const EsqlSpecificRuleParams = z.object({
  type: z.literal('esql'),
  language: z.literal('esql'),
  query: _rule_schema.RuleQuery
});
exports.EsqlSpecificRuleParams = EsqlSpecificRuleParams;
const EsqlRuleParams = z.intersection(BaseRuleParams, EsqlSpecificRuleParams);
exports.EsqlRuleParams = EsqlRuleParams;
const ThreatSpecificRuleParams = z.object({
...
exports.ThreatSpecificRuleParams = ThreatSpecificRuleParams;
const ThreatRuleParams = z.intersection(BaseRuleParams, ThreatSpecificRuleParams);
exports.ThreatRuleParams = ThreatRuleParams;
const QuerySpecificRuleParams = z.object({
...
exports.QuerySpecificRuleParams = QuerySpecificRuleParams;
const QueryRuleParams = z.intersection(BaseRuleParams, QuerySpecificRuleParams);
exports.QueryRuleParams = QueryRuleParams;
const SavedQuerySpecificRuleParams = z.object({
...
exports.SavedQuerySpecificRuleParams = SavedQuerySpecificRuleParams;
const SavedQueryRuleParams = z.intersection(BaseRuleParams, SavedQuerySpecificRuleParams);
exports.SavedQueryRuleParams = SavedQueryRuleParams;
const UnifiedQueryRuleParams = z.intersection(BaseRuleParams, z.union([QuerySpecificRuleParams, SavedQuerySpecificRuleParams]));
exports.UnifiedQueryRuleParams = UnifiedQueryRuleParams;
const ThresholdSpecificRuleParams = z.object({
...
exports.ThresholdSpecificRuleParams = ThresholdSpecificRuleParams;
const ThresholdRuleParams = z.intersection(BaseRuleParams, ThresholdSpecificRuleParams);
exports.ThresholdRuleParams = ThresholdRuleParams;
const MachineLearningSpecificRuleParams = z.object({
  type: z.literal('machine_learning'),
  anomalyThreshold: _rule_schema.AnomalyThreshold,
  machineLearningJobId: z.array(z.string())
});
exports.MachineLearningSpecificRuleParams = MachineLearningSpecificRuleParams;
const MachineLearningRuleParams = z.intersection(BaseRuleParams, MachineLearningSpecificRuleParams);
exports.MachineLearningRuleParams = MachineLearningRuleParams;
const NewTermsSpecificRuleParams = z.object({
...
exports.NewTermsSpecificRuleParams = NewTermsSpecificRuleParams;
const NewTermsRuleParams = z.intersection(BaseRuleParams, NewTermsSpecificRuleParams);
exports.NewTermsRuleParams = NewTermsRuleParams;
const TypeSpecificRuleParams = z.union([EqlSpecificRuleParams, EsqlSpecificRuleParams, ThreatSpecificRuleParams, QuerySpecificRuleParams, SavedQuerySpecificRuleParams, ThresholdSpecificRuleParams, MachineLearningSpecificRuleParams, NewTermsSpecificRuleParams]);
exports.TypeSpecificRuleParams = TypeSpecificRuleParams;
const RuleParams = z.union([EqlRuleParams, EsqlRuleParams, ThreatRuleParams, QueryRuleParams, SavedQueryRuleParams, ThresholdRuleParams, MachineLearningRuleParams, NewTermsRuleParams]);
