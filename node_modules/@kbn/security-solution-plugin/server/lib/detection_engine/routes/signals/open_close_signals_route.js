...
const setSignalsStatusRoute = (router, logger, sender, startServices) => {
  router.versioned.post({
    ...
    validate: {
      request: {
        body: (0, _route_validation.buildRouteValidation)(_signals.setSignalsStatusSchema)
      }
    }
    ...
    const validationErrors = (0, _signals.setSignalStatusValidateTypeDependents)(request.body);
