...
const extractDiffableCommonFields = rule => {
  var _rule$meta, _rule$tags, _rule$severity_mappin, _rule$risk_score_mapp, _rule$risk_score_mapp2, _rule$references, _rule$false_positives, _rule$threat, _rule$note, _rule$setup, _rule$related_integra, _rule$required_fields, _rule$author, _rule$license, _rule$actions, _rule$throttle, _rule$exceptions_list, _rule$max_signals;
  return {
    // --------------------- REQUIRED FIELDS
    // Technical fields
