...
const convertSavedObjectToSavedPinnedEvent = (savedObject, timelineVersion) => (0, _pipeable.pipe)(_saved_object.SavedObjectPinnedEventRuntimeType.decode(savedObject), (0, _Either.map)(savedPinnedEvent => {
  return {
