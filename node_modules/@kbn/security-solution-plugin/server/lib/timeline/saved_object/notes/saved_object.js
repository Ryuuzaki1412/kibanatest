...
exports.pickSavedNote = exports.persistNote = exports.getNotesByTimelineId = exports.getNote = exports.deleteNoteByTimelineId = exports.deleteNote = exports.convertSavedObjectToSavedNote = void 0;
...
const convertSavedObjectToSavedNote = (savedObject, timelineVersion) => (0, _pipeable.pipe)(_saved_object.SavedObjectNoteRuntimeType.decode(savedObject), (0, _Either.map)(savedNote => {
  return {
    noteId: savedNote.id,
