...
const NO_MATCH_VERSION_ERROR_MESSAGE = 'Timeline version conflict. The provided timelineVersion does not match the current timeline.';
exports.NO_MATCH_VERSION_ERROR_MESSAGE = NO_MATCH_VERSION_ERROR_MESSAGE;
const NO_MATCH_TEMPLATE_VERSION_ERROR_MESSAGE = 'Timeline template version conflict. The provided templateTimelineVersion does not match the current template.';
exports.NO_MATCH_TEMPLATE_VERSION_ERROR_MESSAGE = NO_MATCH_TEMPLATE_VERSION_ERROR_MESSAGE;
