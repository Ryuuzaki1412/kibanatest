...
const setTimeline = (parsedTimelineObject, parsedTimeline, isTemplateTimeline) => {
  ...
  return {
    ...
    templateTimelineId: isTemplateTimeline ? (_parsedTimeline$templ2 = parsedTimeline.templateTimelineId) !== null && _parsedTimeline$templ2 !== void 0 ? _parsedTimeline$templ2 : (0, _uuid.v4)() : null
  };
};
