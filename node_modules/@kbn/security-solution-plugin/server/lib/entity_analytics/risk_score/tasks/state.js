...
exports.stateSchemaByVersion = exports.defaultState = void 0;
...
const stateSchemaByVersion = {
  1: {
    ...
    schema: _configSchema.schema.object({
      lastExecutionTimestamp: _configSchema.schema.maybe(_configSchema.schema.string()),
      namespace: _configSchema.schema.string(),
      runs: _configSchema.schema.number(),
      scoresWritten: _configSchema.schema.maybe(_configSchema.schema.number())
    })
  }
};
