...
var _asset_criticality_data_client = require("./lib/entity_analytics/asset_criticality/asset_criticality_data_client");
/*
...
class RequestContextFactory {
  ...
  async create(context, request) {
    ...
    return {
      ...
      getAssetCriticalityDataClient: (0, _lodash.memoize)(() => new _asset_criticality_data_client.AssetCriticalityDataClient({
        logger: options.logger,
        esClient: coreContext.elasticsearch.client.asCurrentUser,
        namespace: getSpaceId()
      }))
