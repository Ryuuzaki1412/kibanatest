...
var _actions2 = require("./endpoint/services/actions");
...
var _app_features_service = require("./lib/app_features_service/app_features_service");
...
class Plugin {
  ...
  constructor(context) {
    ...
    (0, _defineProperty2.default)(this, "appFeaturesService", void 0);
    ...
    this.appFeaturesService = new _app_features_service.AppFeaturesService(this.logger, this.config.experimentalFeatures);
  ...
  setup(core, plugins) {
    ...
    return {
      setAppFeaturesConfigurator: appFeaturesService.setAppFeaturesConfigurator.bind(appFeaturesService),
      experimentalFeatures: {
  ...
  start(core, plugins) {
    ...
    if (this.lists && plugins.taskManager && plugins.fleet) {
      ...
      plugins.fleet.fleetSetupCompleted().then(() => {
        ...
        (0, _turn_off_policy_protections.turnOffPolicyProtectionsIfNotSupported)(core.elasticsearch.client.asInternalUser, endpointFleetServicesFactory.asInternalUser(), appFeaturesService, logger);
      });
    ...
    this.endpointAppContextService.start({
      ...
      actionCreateService: (0, _actions2.actionCreateService)(core.elasticsearch.client.asInternalUser, this.endpointContext),
      createFleetActionsClient,
      esClient: core.elasticsearch.client.asInternalUser,
      appFeaturesService,
      savedObjectsClient
