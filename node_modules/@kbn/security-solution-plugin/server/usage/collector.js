...
var _get_dashboards_metrics = require("./dashboards/get_dashboards_metrics");
var _schema = require("./risk_engine/schema");
var _get_risk_engine_metrics = require("./risk_engine/get_risk_engine_metrics");
/*
      ...
      dashboardMetrics: {
        dashboard_tag: {
          created_at: {
            type: 'keyword',
            _meta: {
              description: 'The time the tab was created'
            }
          },
          linked_dashboards_count: {
            type: 'long',
            _meta: {
              description: 'Number of associated dashboards'
            }
          }
        },
        dashboards: {
          ...
          items: {
            created_at: {
              type: 'keyword',
              _meta: {
                description: 'The time the dashboard was created'
              }
            },
            dashboard_id: {
              type: 'keyword',
              _meta: {
                description: 'The dashboard saved object id'
              }
            },
            error_message: {
              type: 'keyword',
              _meta: {
                description: 'The relevant error message'
              }
            },
            error_status_code: {
              type: 'long',
              _meta: {
                description: 'The relevant error status code'
              }
            }
          }
        }
      },
      riskEngineMetrics: _schema.riskEngineMetricsSchema
    },
    isReady: () => true,
    fetch: async ({
      esClient
      ...
      const [detectionMetrics, endpointMetrics, dashboardMetrics, riskEngineMetrics] = await Promise.allSettled([(0, _get_metrics.getDetectionsMetrics)({
        eventLogIndex,
        signalsIndex,
        esClient,
        savedObjectsClient,
        ...
        esClient,
        logger
      }), (0, _get_dashboards_metrics.getDashboardMetrics)({
        savedObjectsClient,
        logger
      }), (0, _get_risk_engine_metrics.getRiskEngineMetrics)({
        esClient,
        logger,
        riskEngineIndexPatterns
      })]);
