...
const initUiSettings = (uiSettings, experimentalFeatures, validationsEnabled) => {
  ...
  "to": "${_constants.DEFAULT_TO}"
    ...
    [_constants.ENABLE_EXPANDABLE_FLYOUT_SETTING]: {
      name: _i18n.i18n.translate('xpack.securitySolution.uiSettings.enableExpandableFlyoutLabel', {
        defaultMessage: 'Expandable flyout'
      }),
      value: true,
      description: _i18n.i18n.translate('xpack.securitySolution.uiSettings.enableExpandableFlyoutDescription', {
