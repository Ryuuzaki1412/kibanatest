...
exports.EnterpriseSearchAISearchPageTemplate = void 0;
...
const EnterpriseSearchAISearchPageTemplate = ({
  children,
  pageChrome,
  pageViewTelemetry,
  ...pageTemplateProps
  ...
  return /*#__PURE__*/_react.default.createElement(_layout.EnterpriseSearchPageTemplateWrapper, (0, _extends2.default)({}, pageTemplateProps, {
    solutionNav: {
      name: _constants.AI_SEARCH_PLUGIN.NAME,
      items: (0, _layout.useEnterpriseSearchNav)()
    },
    setPageChrome: pageChrome && /*#__PURE__*/_react.default.createElement(_kibana_chrome.SetAiSearchChrome, {
      trail: pageChrome
    })
...
exports.EnterpriseSearchAISearchPageTemplate = EnterpriseSearchAISearchPageTemplate;