...
const emptyBlockedWindow = {
  jobType: 'full',
  day: 'monday',
  start: '11:00:00Z',
  end: '13:00:00Z'
};
exports.emptyBlockedWindow = emptyBlockedWindow;
const isIncludeRule = rule => {
  return !!rule.include;
};
const SynchronizationLogic = (0, _kea.kea)({
...
exports.SynchronizationLogic = SynchronizationLogic;
