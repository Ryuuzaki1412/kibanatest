...
exports.pythonDefinition = void 0;
...
client = Elasticsearch(
  ...
  docLink: _doc_links.docLinks.clientsPythonOverview,
  github: {
    label: _i18n.i18n.translate('xpack.enterpriseSearch.languages.python.githubLink', {
...
# python -m pip install elasticsearch[async]
  `,
  name: _i18n.i18n.translate('xpack.enterpriseSearch.languages.python', {
    defaultMessage: 'Python'
  }),
  testConnection: `# API key should have cluster monitor rights
client.info()`
};
exports.pythonDefinition = pythonDefinition;