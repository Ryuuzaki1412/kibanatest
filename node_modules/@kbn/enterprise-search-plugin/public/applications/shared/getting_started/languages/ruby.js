...
`,
  docLink: _doc_links.docLinks.clientsRubyOverview,
  github: {
    label: _i18n.i18n.translate('xpack.enterpriseSearch.languages.ruby.githubLink', {
  ...
  ingestData: ({
    ...
    const ingestDocumentKeys = ingestPipeline ? (0, _helpers.ingestKeysToRuby)(extraIngestDocumentValues) : '';
    return `documents = [
...
client.bulk(body: documents${ingestPipeline ? `, pipeline: "${ingestPipeline}"` : ''})`;
  ...
  name: _i18n.i18n.translate('xpack.enterpriseSearch.languages.ruby', {
    defaultMessage: 'Ruby'
  }),
  testConnection: `# API Key should have cluster monitoring rights.
client.info`
};
exports.rubyDefinition = rubyDefinition;