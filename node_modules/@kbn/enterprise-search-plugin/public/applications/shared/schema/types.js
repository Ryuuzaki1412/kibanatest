 ...
 * Schema types
 */
let SchemaType; // Certain Schema types may have to be ignored from showing up, these types could be added to this list
...
const IgnoreSchemaTypes = [SchemaType.Nested];
// Certain API endpoints will use these internal type names, which map to the external names above
exports.IgnoreSchemaTypes = IgnoreSchemaTypes;
let InternalSchemaType;
exports.InternalSchemaType = InternalSchemaType;
(function (InternalSchemaType) {
...
})(InternalSchemaType || (exports.InternalSchemaType = InternalSchemaType = {}));
/**
