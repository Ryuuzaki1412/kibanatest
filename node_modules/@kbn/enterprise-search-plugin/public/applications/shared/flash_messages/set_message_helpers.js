...
const flashSuccessToast = (message, toastOptions = {}) => {
  _flash_messages_logic.FlashMessagesLogic.actions.addToastMessage({
    ..._constants.FLASH_MESSAGE_TYPES.success,
    ...toastOptions,
    title: message,
    id: (toastOptions === null || toastOptions === void 0 ? void 0 : toastOptions.id) || `successToast-${Date.now()}`
  });
};
...
const flashErrorToast = (message, toastOptions = {}) => {
  _flash_messages_logic.FlashMessagesLogic.actions.addToastMessage({
    ...
    ...toastOptions,
    title: message,
    id: (toastOptions === null || toastOptions === void 0 ? void 0 : toastOptions.id) || `errorToast-${Date.now()}`
  });
};
