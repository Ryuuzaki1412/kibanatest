...
exports.cronExpressionToParts = cronExpressionToParts;
exports.cronPartsToExpression = cronPartsToExpression;
/*
...
function cronExpressionToParts(expression) {
  const parsedCron = {
    second: undefined,
    minute: undefined,
    hour: undefined,
...
function cronPartsToExpression({
  second,
  minute,
  hour,
  day,
