...
const CronMonthly = ({
  ...
  fullWidth: true,
  prepend: _i18n.i18n.translate('xpack.enterpriseSearch.cronEditor.cronMonthly.textOnTheLabel', {
  ...
  options: hourOptions,
  value: hour,
  "aria-label": _i18n.i18n.translate('xpack.enterpriseSearch.cronEditor.cronMonthly.hourSelectLabel', {
    defaultMessage: 'Hour'
  }),
  onChange: e => onChange({
    hour: e.target.value
  ...
  fullWidth: true,
  prepend: _i18n.i18n.translate('xpack.enterpriseSearch.cronEditor.cronMonthly.fieldHour.textAtLabel', {
    defaultMessage: 'At'
  }),
  ...
  value: minute,
  "aria-label": _i18n.i18n.translate('xpack.enterpriseSearch.cronEditor.cronMonthly.minuteSelectLabel', {
