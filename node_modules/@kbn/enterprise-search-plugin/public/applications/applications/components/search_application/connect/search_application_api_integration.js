...
const SearchApplicationApiIntegrationStage = () => {
  ...
  const consolePreviewLink = canShowDevtools ? (_url$locators$get = url.locators.get('CONSOLE_APP_LOCATOR')) === null || _url$locators$get === void 0 ? void 0 : _url$locators$get.useUrl({
