...
const CachedFetchIndexApiLogic = (0, _kea.kea)({
  actions: {
  ...
  connect: {
    ...
    values: [_fetch_index_api_logic.FetchIndexApiLogic, ['data as fetchIndexApiData', 'status']]
  },
  events: ({
    values
  }) => ({
...
exports.CachedFetchIndexApiLogic = CachedFetchIndexApiLogic;