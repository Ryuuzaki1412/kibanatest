...
const fetchIndexExists = async ({
  ...
  const {
    exists
  } = await _http.HttpLogic.values.http.get(route);
  return {
    exists,
    indexName
  };
...
const IndexExistsApiLogic = (0, _create_api_logic.createApiLogic)(['index_exists_api_logic'], fetchIndexExists);
exports.IndexExistsApiLogic = IndexExistsApiLogic;