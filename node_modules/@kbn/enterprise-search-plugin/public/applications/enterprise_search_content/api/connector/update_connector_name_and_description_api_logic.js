...
const ConnectorNameAndDescriptionApiLogic = (0, _create_api_logic.createApiLogic)(['content', 'connector_name_and_description_api_logic'], putConnectorNameAndDescription, {
  showSuccessFlashFn: () => _i18n.i18n.translate('xpack.enterpriseSearch.content.indices.configurationConnector.nameAndDescription.successToast.title', {
    defaultMessage: 'Connector name and description updated'
  })
});
exports.ConnectorNameAndDescriptionApiLogic = ConnectorNameAndDescriptionApiLogic;