...
const ConnectorFilteringLogic = (0, _kea.kea)({
  actions: {
  ...
  listeners: ({
    ...
    saveDraftFilteringRules: () => {
      if ((0, _indices.isConnectorIndex)(values.index)) {
        var _values$localAdvanced2, _values$localFilterin2;
        actions.draftMakeRequest({
          advancedSnippet: (_values$localAdvanced2 = values.localAdvancedSnippet) !== null && _values$localAdvanced2 !== void 0 ? _values$localAdvanced2 : '',
          connectorId: values.index.connector.id,
          filteringRules: (_values$localFilterin2 = values.localFilteringRules) !== null && _values$localFilterin2 !== void 0 ? _values$localFilterin2 : []
        });
      }
    },
    setIsEditing: isEditing => {
...
exports.ConnectorFilteringLogic = ConnectorFilteringLogic;