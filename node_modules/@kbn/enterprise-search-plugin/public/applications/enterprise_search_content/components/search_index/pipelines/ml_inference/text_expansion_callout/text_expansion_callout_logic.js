...
const TextExpansionCalloutLogic = (0, _kea.kea)({
  ...
  events: ({
    ...
    afterMount: async () => {
      var _KibanaLogic$values$m;
      const elserModel = await ((_KibanaLogic$values$m = _kibana.KibanaLogic.values.ml.elasticModels) === null || _KibanaLogic$values$m === void 0 ? void 0 : _KibanaLogic$values$m.getELSER({
        version: 2
      }));
      if (elserModel != null) {
