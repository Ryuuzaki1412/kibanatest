...
const MLInferenceLogic = (0, _kea.kea)({
  ...
  selectors: ({
    ...
    existingInferencePipelines: [() => [selectors.mlInferencePipelinesData, selectors.sourceFields, selectors.supportedMLModels, selectors.mlInferencePipelineProcessors], (mlInferencePipelinesData, indexFields, supportedMLModels, mlInferencePipelineProcessors) => {
