...
const PipelinesLogic = (0, _kea.kea)({
  actions: {
  ...
  listeners: ({
    ...
    closePipelineSettings: () => {
      var _values$index$connect3, _values$index$connect4;
      return actions.setPipelineState((0, _indices.isConnectorIndex)(values.index) || (0, _indices.isCrawlerIndex)(values.index) ? (_values$index$connect3 = (_values$index$connect4 = values.index.connector) === null || _values$index$connect4 === void 0 ? void 0 : _values$index$connect4.pipeline) !== null && _values$index$connect3 !== void 0 ? _values$index$connect3 : values.defaultPipelineValues : values.defaultPipelineValues);
    },
    ...
    openPipelineSettings: () => {
      var _values$index$connect5;
      const pipeline = (0, _indices.isCrawlerIndex)(values.index) || (0, _indices.isConnectorIndex)(values.index) ? (_values$index$connect5 = values.index.connector) === null || _values$index$connect5 === void 0 ? void 0 : _values$index$connect5.pipeline : values.defaultPipelineValues;
      actions.setPipelineState(pipeline !== null && pipeline !== void 0 ? pipeline : values.defaultPipelineValues);
    },
    ...
    savePipeline: () => {
      if ((0, _indices.isConnectorIndex)(values.index) || (0, _indices.isCrawlerIndex)(values.index)) {
        if (values.index.connector) {
          var _values$index$connect6;
          actions.makeRequest({
            connectorId: (_values$index$connect6 = values.index.connector) === null || _values$index$connect6 === void 0 ? void 0 : _values$index$connect6.id,
...
exports.PipelinesLogic = PipelinesLogic;