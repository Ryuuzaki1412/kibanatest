...
const AddConnectorLogic = (0, _kea.kea)({
  actions: {
  ...
  connect: {
    actions: [_add_connector_api_logic.AddConnectorApiLogic, ['apiError', 'apiSuccess']]
  },
  listeners: {
    apiSuccess: async ({
      indexName
...
exports.AddConnectorLogic = AddConnectorLogic;