...
const CrawlRequestsTable = () => {
  ...
  const columns = [{
    field: 'id',
    name: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.crawler.crawlRequestsTable.column.domainURL', {
    ...
    field: 'createdAt',
    name: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.crawler.crawlRequestsTable.column.created', {
    ...
    field: 'type',
    name: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.crawler.crawlRequestsTable.column.crawlType', {
    ...
    name: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.crawler.crawlRequestsTable.column.domains', {
      defaultMessage: 'Domains'
    }),
    render: event => /*#__PURE__*/_react.default.createElement(_eui.EuiBadge, null, event.crawlConfig.domainAllowlist.length)
  }, {
    field: 'status',
    name: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.crawler.crawlRequestsTable.column.status', {
      defaultMessage: 'Status'
    }),
    render: status => _types.readableCrawlerStatuses[status]
  }];
  return /*#__PURE__*/_react.default.createElement(_eui.EuiBasicTable, {
    ...
    noItemsMessage: /*#__PURE__*/_react.default.createElement(_eui.EuiEmptyPrompt, {
      ...
      title: /*#__PURE__*/_react.default.createElement("h3", null, _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.crawler.crawlRequestsTable.emptyPrompt.title', {
        defaultMessage: 'No recent crawl requests'
      })),
      body: /*#__PURE__*/_react.default.createElement("p", null, _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.crawler.crawlRequestsTable.emptyPrompt.body', {
