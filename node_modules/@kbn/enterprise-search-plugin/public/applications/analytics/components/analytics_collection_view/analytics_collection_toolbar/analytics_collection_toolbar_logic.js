...
const AnalyticsCollectionToolbarLogic = (0, _kea.kea)({
  actions: {
    onTimeRefresh: true,
    setRefreshInterval: ({
      pause,
  ...
  listeners: ({
    ...
    onTimeRefresh() {
      actions.setSearchSessionId(_kibana_logic.KibanaLogic.values.data.search.session.start());
    },
...
exports.AnalyticsCollectionToolbarLogic = AnalyticsCollectionToolbarLogic;