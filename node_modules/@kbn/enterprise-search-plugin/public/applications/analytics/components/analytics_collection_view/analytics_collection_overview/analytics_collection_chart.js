...
const AnalyticsCollectionChart = ({
  ...
  return isLoading && Object.keys(currentData).length === 0 ? /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
    ...
    headerFormatter: tooltipData => (0, _moment.default)(tooltipData.value).format(uiSettings.get('dateFormat')),
    maxTooltipItems: 1,
...
const AnalyticsCollectionChartWithLens = (0, _with_lens_data.withLensData)(AnalyticsCollectionChart, {
...
exports.AnalyticsCollectionChartWithLens = AnalyticsCollectionChartWithLens;