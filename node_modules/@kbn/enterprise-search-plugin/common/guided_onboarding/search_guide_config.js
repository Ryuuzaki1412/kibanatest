...
const appSearchGuideId = 'appSearch';
exports.appSearchGuideId = appSearchGuideId;
const websiteSearchGuideId = 'websiteSearch';
exports.websiteSearchGuideId = websiteSearchGuideId;
const databaseSearchGuideId = 'databaseSearch';
exports.databaseSearchGuideId = databaseSearchGuideId;
const apiRoutes = {
...
const appSearchGuideConfig = getGuideConfig(appSearchGuideId);
exports.appSearchGuideConfig = appSearchGuideConfig;
const websiteSearchGuideConfig = getGuideConfig(websiteSearchGuideId);
exports.websiteSearchGuideConfig = websiteSearchGuideConfig;
const databaseSearchGuideConfig = getGuideConfig(databaseSearchGuideId);
exports.databaseSearchGuideConfig = databaseSearchGuideConfig;