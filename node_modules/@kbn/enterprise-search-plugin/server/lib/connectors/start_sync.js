...
const startSync = async (client, connectorId, jobType, nextSyncConfig) => {
  ...
  if (connector) {
    ...
    const targetIndexName = jobType === _searchConnectors.SyncJobType.ACCESS_CONTROL ? `${_constants.CONNECTORS_ACCESS_CONTROL_INDEX_PREFIX}${index_name}` : index_name !== null && index_name !== void 0 ? index_name : undefined;
