...
class EnterpriseSearchPlugin {
  ...
  setup({
    ...
    if (customIntegrations) {
      (0, _integrations.registerEnterpriseSearchIntegrations)(config, http, customIntegrations, isCloud);
    }
    ...
    getStartServices().then(([coreStart]) => {
      ...
      if (usageCollection) {
        ...
        (0, _telemetry2.registerTelemetryUsageCollector)(usageCollection);
        if (config.canDeployEntSearch) {
    ...
    if (globalSearch) {
      globalSearch.registerResultProvider((0, _search_result_provider.getSearchResultProvider)(http.basePath, config));
    }
  }
  start() {}
  stop() {}
