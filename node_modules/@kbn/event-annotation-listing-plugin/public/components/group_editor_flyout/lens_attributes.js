...
exports.DATA_LAYER_ID = DATA_LAYER_ID;
const DATE_HISTOGRAM_COLUMN_ID = 'date-histogram-column-id';
exports.DATE_HISTOGRAM_COLUMN_ID = DATE_HISTOGRAM_COLUMN_ID;
...
const getCurrentTimeField = attributes => {
  return attributes.state.datasourceStates.formBased.layers[DATA_LAYER_ID].columns[DATE_HISTOGRAM_COLUMN_ID].sourceField;
};
