...
class CloudPlugin {
  ...
  setup(core, {
    ...
    var _this$config$serverle, _this$config$serverle2, _decodedId, _decodedId2, _decodedId3, _decodedId4, _this$config$apm, _this$config$apm2, _this$config$serverle3;
