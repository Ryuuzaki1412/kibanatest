...
const useChartActions = ({
  ...
  const [showChartOptionsPopover, setShowChartOptionsPopover] = (0, _react.useState)(false);
  const toggleChartOptions = (0, _react.useCallback)(() => {
    setShowChartOptionsPopover(!showChartOptionsPopover);
  }, [showChartOptionsPopover]);
  const closeChartOptions = (0, _react.useCallback)(() => {
