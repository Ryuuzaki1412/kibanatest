...
function servicesRoutes({
  ...
  const validate = (0, _ioTsUtils.createRouteValidationFunction)(_types_api.getServiceAssetsQueryOptionsRT);
  // GET /assets/services
  router.get({
    ...
    try {
      ...
      (0, _debug_log.debug)('Error while looking up SERVICE asset records', error);
      ...
      return res.customError({
        statusCode: 500,
        body: {
          message: 'Error while looking up service asset records - ' + `${error}`
        }
      });
    }
  });
