...
const fetchSyntheticsMonitor = async ({
  monitorId
}) => _api_service.apiService.get(_constants.SYNTHETICS_API_URLS.GET_SYNTHETICS_MONITOR.replace('{monitorId}', monitorId), undefined, _runtime_types.EncryptedSyntheticsMonitorCodec);
