...
const selectIsMonitorStatusesLoading = (0, _reselect.createSelector)(getState, state => state.loading);
exports.selectIsMonitorStatusesLoading = selectIsMonitorStatusesLoading;
