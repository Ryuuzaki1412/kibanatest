...
exports.StepRunDate = exports.StepPageNavigation = exports.PREVIOUS_CHECK_BUTTON_TEXT = exports.NEXT_CHECK_BUTTON_TEXT = void 0;
...
const StepPageNavigation = ({
  ...
  let startedAt = formatter(data === null || data === void 0 ? void 0 : (_data$details = data.details) === null || _data$details === void 0 ? void 0 : _data$details.timestamp);
  const {
    stepIndex,
    monitorId
  ...
  }, startedAt)), /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, {
    grow: false
  }, /*#__PURE__*/_react.default.createElement(_eui.EuiButtonEmpty, {
    "data-test-subj": "syntheticsStepPageNavigationButton",
    href: nextHref,
...
const PREVIOUS_CHECK_BUTTON_TEXT = _i18n.i18n.translate('xpack.synthetics.synthetics.stepDetail.previousCheckButtonText', {
  defaultMessage: 'Previous check'
});
exports.PREVIOUS_CHECK_BUTTON_TEXT = PREVIOUS_CHECK_BUTTON_TEXT;
const NEXT_CHECK_BUTTON_TEXT = _i18n.i18n.translate('xpack.synthetics.synthetics.stepDetail.nextCheckButtonText', {
  defaultMessage: 'Next check'
});
exports.NEXT_CHECK_BUTTON_TEXT = NEXT_CHECK_BUTTON_TEXT;