...
const SYNTHETICS_ONLOAD_EVENT = 'browser.experience.load.us';
exports.SYNTHETICS_ONLOAD_EVENT = SYNTHETICS_ONLOAD_EVENT;
...
const LCP_LABEL = _i18n.i18n.translate('xpack.synthetics.lcp.label', {
  defaultMessage: 'LCP'
});
exports.LCP_LABEL = LCP_LABEL;
const FCP_LABEL = _i18n.i18n.translate('xpack.synthetics.fcp.label', {
  defaultMessage: 'FCP'
});
exports.FCP_LABEL = FCP_LABEL;
const CLS_LABEL = _i18n.i18n.translate('xpack.synthetics.cls.label', {
  defaultMessage: 'CLS'
});
exports.CLS_LABEL = CLS_LABEL;
const DCL_LABEL = _i18n.i18n.translate('xpack.synthetics.dcl.label', {
  defaultMessage: 'DCL'
});
exports.DCL_LABEL = DCL_LABEL;
const STEP_DURATION_LABEL = _i18n.i18n.translate('xpack.synthetics.totalDuration.metrics', {
  defaultMessage: 'Step duration'
});
exports.STEP_DURATION_LABEL = STEP_DURATION_LABEL;
const TRANSFER_SIZE = _i18n.i18n.translate('xpack.synthetics.totalDuration.transferSize', {
  defaultMessage: 'Transfer size'
});
exports.TRANSFER_SIZE = TRANSFER_SIZE;