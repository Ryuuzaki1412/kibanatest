...
const showSyncErrors = (errors, locations, toasts) => {
  Object.values(errors).forEach(location => {
    ...
    toasts.addWarning({
      ...
      text: (0, _public.toMountPoint)( /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("p", null, _i18n.i18n.translate('xpack.synthetics.monitorManagement.service.error.message', {
