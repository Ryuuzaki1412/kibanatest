...
const getScheduleContent = value => {
  if (value > 60) {
...
const SCHEDULES = _constants.ALLOWED_SCHEDULES_IN_MINUTES.map(value => ({
  value,
...
exports.MONITOR_TYPE_CONFIG = MONITOR_TYPE_CONFIG;
const FIELD = readOnly => {
  ...
  return {
    ...
    ['schedule.number']: {
      fieldKey: `${_types.ConfigKey.SCHEDULE}.number`,
      required: true,
    ...
    [_types.ConfigKey.ENABLED]: {
      ...
      props: ({
        ...
        const isProjectMonitor = ((_formState$defaultVal = formState.defaultValues) === null || _formState$defaultVal === void 0 ? void 0 : _formState$defaultVal[_types.ConfigKey.MONITOR_SOURCE_TYPE]) === _types.SourceType.PROJECT;
        return {
    ...
    [_types.ConfigKey.THROTTLING_CONFIG]: {
      ...
      props: ({
        ...
        return {
          ...
          readOnly,
          disabled: false,
          initialValue: (_formState$defaultVal4 = formState.defaultValues) === null || _formState$defaultVal4 === void 0 ? void 0 : _formState$defaultVal4[_types.ConfigKey.THROTTLING_CONFIG]
        };
      },
      validation: () => ({
        required: true
