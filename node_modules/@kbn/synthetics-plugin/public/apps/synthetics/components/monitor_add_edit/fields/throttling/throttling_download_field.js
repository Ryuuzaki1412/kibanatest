...
const DOWNLOAD_LABEL = _i18n.i18n.translate('xpack.synthetics.createPackagePolicy.stepConfigure.browserAdvancedSettings.throttling.download.label', {
  defaultMessage: 'Download Speed'
});
exports.DOWNLOAD_LABEL = DOWNLOAD_LABEL;
const DOWNLOAD_SPEED_ERROR = _i18n.i18n.translate('xpack.synthetics.createPackagePolicy.stepConfigure.browserAdvancedSettings.throttling.download.error', {
  defaultMessage: 'Download speed must be greater than zero.'
});
exports.DOWNLOAD_SPEED_ERROR = DOWNLOAD_SPEED_ERROR;