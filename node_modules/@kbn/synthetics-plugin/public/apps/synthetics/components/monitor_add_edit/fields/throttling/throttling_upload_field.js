...
const UPLOAD_LABEL = _i18n.i18n.translate('xpack.synthetics.createPackagePolicy.stepConfigure.browserAdvancedSettings.throttling.upload.label', {
  defaultMessage: 'Upload Speed'
});
exports.UPLOAD_LABEL = UPLOAD_LABEL;
const UPLOAD_SPEED_ERROR = _i18n.i18n.translate('xpack.synthetics.createPackagePolicy.stepConfigure.browserAdvancedSettings.throttling.upload.error', {
  defaultMessage: 'Upload speed must be greater than zero.'
});
exports.UPLOAD_SPEED_ERROR = UPLOAD_SPEED_ERROR;