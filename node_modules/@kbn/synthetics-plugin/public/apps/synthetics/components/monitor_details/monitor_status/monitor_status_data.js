...
const SUCCESS_VIZ_COLOR = _eui.VISUALIZATION_COLORS[0];
exports.SUCCESS_VIZ_COLOR = SUCCESS_VIZ_COLOR;
const DANGER_VIZ_COLOR = _eui.VISUALIZATION_COLORS[_eui.VISUALIZATION_COLORS.length - 1];
exports.DANGER_VIZ_COLOR = DANGER_VIZ_COLOR;
const CHART_CELL_WIDTH = 17;
exports.CHART_CELL_WIDTH = CHART_CELL_WIDTH;
