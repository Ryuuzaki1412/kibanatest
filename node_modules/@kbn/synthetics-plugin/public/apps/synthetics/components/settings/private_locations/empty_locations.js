...
const EmptyLocations = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiEmptyPrompt, {
    hasBorder: true,
    title: /*#__PURE__*/_react.default.createElement("h2", null, ADD_FIRST_LOCATION),
    titleSize: "s",
    ...
    actions: /*#__PURE__*/_react.default.createElement(_permissions.NoPermissionsTooltip, {
      ...
      href: history.createHref({
        pathname: _constants.PRIVATE_LOCATIOSN_ROUTE
      })
      ...
      fill: true,
      onClick: () => {
        setIsAddingNew === null || setIsAddingNew === void 0 ? void 0 : setIsAddingNew(true);
        dispatch((0, _private_locations.setManageFlyoutOpen)(true));
        dispatch((0, _private_locations.setAddingNewPrivateLocation)(true));
      }
    }, ADD_LOCATION)),
    footer: /*#__PURE__*/_react.default.createElement(_eui.EuiText, {
      size: "s"
    }, LEARN_MORE, " ", /*#__PURE__*/_react.default.createElement(PrivateLocationDocsLink, null))
  });
};
...
const START_ADDING_LOCATIONS_DESCRIPTION = _i18n.i18n.translate('xpack.synthetics.monitorManagement.startAddingLocationsDescription', {
...
exports.START_ADDING_LOCATIONS_DESCRIPTION = START_ADDING_LOCATIONS_DESCRIPTION;
const ADD_LOCATION = _i18n.i18n.translate('xpack.synthetics.monitorManagement.createLocation', {
  defaultMessage: 'Create location'
});
const READ_DOCS = _i18n.i18n.translate('xpack.synthetics.monitorManagement.readDocs', {
  defaultMessage: 'read the docs'
});
exports.READ_DOCS = READ_DOCS;
const LEARN_MORE = _i18n.i18n.translate('xpack.synthetics.monitorManagement.learnMore', {
