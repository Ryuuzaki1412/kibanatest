...
const AGENT_CALLOUT_TITLE = _i18n.i18n.translate('xpack.synthetics.monitorManagement.agentCallout.title', {
  defaultMessage: 'Requirement'
});
exports.AGENT_CALLOUT_TITLE = AGENT_CALLOUT_TITLE;
const AGENT_MISSING_CALLOUT_TITLE = _i18n.i18n.translate('xpack.synthetics.monitorManagement.agentMissingCallout.title', {
  defaultMessage: 'Selected agent policy has no agents'
});
exports.AGENT_MISSING_CALLOUT_TITLE = AGENT_MISSING_CALLOUT_TITLE;
const LOCATION_NAME_LABEL = _i18n.i18n.translate('xpack.synthetics.monitorManagement.locationName', {
  defaultMessage: 'Location name'
});
exports.LOCATION_NAME_LABEL = LOCATION_NAME_LABEL;
