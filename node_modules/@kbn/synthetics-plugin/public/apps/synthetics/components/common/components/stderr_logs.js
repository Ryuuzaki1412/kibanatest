...
const TIMESTAMP_LABEL = _i18n.i18n.translate('xpack.synthetics.monitorList.timestamp', {
  defaultMessage: 'Timestamp'
});
exports.TIMESTAMP_LABEL = TIMESTAMP_LABEL;
const TYPE_LABEL = _i18n.i18n.translate('xpack.synthetics.monitorList.type', {
  defaultMessage: 'Type'
});
exports.TYPE_LABEL = TYPE_LABEL;
const ERROR_SUMMARY_LABEL = _i18n.i18n.translate('xpack.synthetics.monitorList.errorSummary', {
  defaultMessage: 'Error summary'
});
exports.ERROR_SUMMARY_LABEL = ERROR_SUMMARY_LABEL;
const VIEW_IN_DISCOVER_LABEL = _i18n.i18n.translate('xpack.synthetics.monitorList.viewInDiscover', {
  defaultMessage: 'View in discover'
});
exports.VIEW_IN_DISCOVER_LABEL = VIEW_IN_DISCOVER_LABEL;
const TEST_RUN_LOGS_LABEL = _i18n.i18n.translate('xpack.synthetics.monitorList.testRunLogs', {
  defaultMessage: 'Test run logs'
});
exports.TEST_RUN_LOGS_LABEL = TEST_RUN_LOGS_LABEL;