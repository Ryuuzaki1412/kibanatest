...
const inspectSyntheticsMonitorRoute = () => ({
  ...
  handler: async routeContext => {
    ...
    const privateLocations = await (0, _add_monitor.getPrivateLocationsForMonitor)(savedObjectsClient, normalizedMonitor);
    ...
    try {
      ...
      const monitorWithNamespace = (0, _add_monitor.hydrateMonitorFields)({
        normalizedMonitor,
        routeContext,
        newMonitorId
      });
