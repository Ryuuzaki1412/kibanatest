...
const getAgentPoliciesRoute = (router, osqueryContext) => {
  router.versioned.get({
    ...
    validate: {
      request: {
        params: (0, _route_validation.buildRouteValidation)(_api.getAgentPoliciesRequestParamsSchema),
        query: (0, _route_validation.buildRouteValidation)(_api.getAgentPoliciesRequestQuerySchema)
      }
    }
