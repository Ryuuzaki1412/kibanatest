...
const ECSComboboxField = /*#__PURE__*/_react.default.memo(ECSComboboxFieldComponent, _fastDeepEqual.default);
exports.ECSComboboxField = ECSComboboxField;
...
const OsqueryColumnField = /*#__PURE__*/_react.default.memo(OsqueryColumnFieldComponent, _fastDeepEqual.default);
exports.OsqueryColumnField = OsqueryColumnField;
const defaultEcsFormData = {
  key: '',
  result: {
    type: 'field',
    value: ''
...
exports.defaultEcsFormData = defaultEcsFormData;
...
const ECSMappingEditorField = /*#__PURE__*/_react.default.memo(({
  euiFieldProps
}) => {
  const {
    setError,
...
exports.ECSMappingEditorField = ECSMappingEditorField;
var _default = ECSMappingEditorField;
