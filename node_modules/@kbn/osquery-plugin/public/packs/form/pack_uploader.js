...
exports.OsqueryPackUploader = void 0;
...
const ExamplePackLink = /*#__PURE__*/_react.default.memo(() => /*#__PURE__*/_react.default.createElement(_eui.EuiLink, {
...
const OsqueryPackUploaderComponent = ({
  ...
  const handleFileRead = () => {
    ...
    if (!((_parsedContent = parsedContent) !== null && _parsedContent !== void 0 && _parsedContent.queries)) {
      return;
    }
  ...
  const handleInputChange = (0, _react.useCallback)(inputFiles => {
    ...
    if (inputFiles.length && ((_ref = !!inputFiles[0].type.length && !SUPPORTED_PACK_EXTENSIONS.includes(inputFiles[0].type)) !== null && _ref !== void 0 ? _ref : !inputFiles[0].name.endsWith('.conf'))) {
      var _filePickerRef$curren3;
      packName.current = '';
      setIsInvalid(_i18n.i18n.translate('xpack.osquery.packUploader.unsupportedFileTypeText', {
    ...
    packName.current = (0, _lodash.kebabCase)(inputFiles[0].name.split('.')[0]);
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, {
    ...
    fullWidth: true,
    labelAppend: /*#__PURE__*/_react.default.createElement(ExamplePackLink, null),
    isInvalid: !!isInvalid,
    ...
    initialPromptText: _i18n.i18n.translate('xpack.osquery.packUploader.initialPromptTextLabel', {
...
const OsqueryPackUploader = /*#__PURE__*/_react.default.memo(OsqueryPackUploaderComponent);
exports.OsqueryPackUploader = OsqueryPackUploader;