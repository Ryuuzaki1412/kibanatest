...
const ERROR_ALL_RESULTS = _i18n.i18n.translate('xpack.osquery.results.errorSearchDescription', {
  defaultMessage: `An error has occurred on all results search`
});
exports.ERROR_ALL_RESULTS = ERROR_ALL_RESULTS;
const FAIL_ALL_RESULTS = _i18n.i18n.translate('xpack.osquery.results.failSearchDescription', {
  defaultMessage: `Failed to fetch results`
});
exports.FAIL_ALL_RESULTS = FAIL_ALL_RESULTS;