...
const OsqueryManagedPolicyCreateImportExtension = /*#__PURE__*/_react.default.memo(({
  onChange,
  policy,
  newPolicy
}) => {
  ...
  (0, _react.useEffect)(() => {
    ...
    /*
      ...
      in the next step
    */
    if (newPolicy !== null && newPolicy !== void 0 && (_newPolicy$package = newPolicy.package) !== null && _newPolicy$package !== void 0 && _newPolicy$package.version) {
      var _newPolicy$package2, _newPolicy$package3;
      if (!editMode && (0, _satisfies.default)(newPolicy === null || newPolicy === void 0 ? void 0 : (_newPolicy$package2 = newPolicy.package) === null || _newPolicy$package2 === void 0 ? void 0 : _newPolicy$package2.version, '<0.6.0')) {
        const updatedPolicy = (0, _immer.produce)(newPolicy, draft => {
      ...
      if ((0, _satisfies.default)(newPolicy === null || newPolicy === void 0 ? void 0 : (_newPolicy$package3 = newPolicy.package) === null || _newPolicy$package3 === void 0 ? void 0 : _newPolicy$package3.version, '>=0.6.0')) {
        const updatedPolicy = (0, _immer.produce)(newPolicy, draft => {
...
exports.OsqueryManagedPolicyCreateImportExtension = OsqueryManagedPolicyCreateImportExtension;
