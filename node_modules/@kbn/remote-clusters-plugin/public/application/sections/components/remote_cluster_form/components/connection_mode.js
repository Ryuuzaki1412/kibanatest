...
const ConnectionMode = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiDescribedFormGroup, {
    ...
    description: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, isCloudEnabled ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
      id: "xpack.remoteClusters.remoteClusterForm.sectionModeCloudDescription",
      defaultMessage: "Automatically configure the remote cluster by using the Elasticsearch endpoint URL of the remote deployment or enter the proxy address and server name manually."
      ...
      onChange: e => onFieldsChange({
        cloudUrlEnabled: !e.target.checked
      })
