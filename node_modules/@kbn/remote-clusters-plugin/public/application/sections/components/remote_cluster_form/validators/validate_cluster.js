...
var _validate_server_name = require("./validate_server_name");
...
const validateCluster = (fields, isCloudEnabled) => {
  ...
  return {
    ...
    proxyAddress: !cloudUrlEnabled && mode === _constants.PROXY_MODE ? (0, _validate_proxy.validateProxy)(proxyAddress) : null,
    // server name is only required in cloud when proxy mode is enabled
    serverName: !cloudUrlEnabled && isCloudEnabled && mode === _constants.PROXY_MODE ? (0, _validate_server_name.validateServerName)(serverName) : null,
    cloudUrl: cloudUrlEnabled ? (0, _validate_cloud_url.validateCloudUrl)(cloudUrl) : null
  };
};
