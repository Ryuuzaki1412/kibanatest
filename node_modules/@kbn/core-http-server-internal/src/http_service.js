...
class HttpService {
  constructor(coreContext) {
    ...
    }), configService.atPath(_csp.cspConfig.path), configService.atPath(_external_url.externalUrlConfig.path)]).pipe((0, _operators.map)(([http, csp, externalUrl]) => new _http_config.HttpConfig(http, csp, externalUrl)));
