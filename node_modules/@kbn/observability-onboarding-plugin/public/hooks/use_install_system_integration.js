...
exports.useInstallSystemIntegration = void 0;
...
// Errors
const UNAUTHORIZED_ERROR = _i18n.i18n.translate('xpack.observability_onboarding.installSystemIntegration.error.unauthorized', {
...
const useInstallSystemIntegration = ({
  ...
  const [requestState, callPerformRequest] = (0, _useTrackedPromise.useTrackedPromise)({
    ...
    createPromise: async () => {
      ...
      } = await http.get('/api/fleet/epm/packages/system', options);
...
exports.useInstallSystemIntegration = useInstallSystemIntegration;