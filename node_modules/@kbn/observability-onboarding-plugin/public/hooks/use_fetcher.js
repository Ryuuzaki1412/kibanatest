...
function getDetailsFromErrorResponse(error) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, message, " (", (_error$response2 = error.response) === null || _error$response2 === void 0 ? void 0 : _error$response2.status, ")", /*#__PURE__*/_react.default.createElement("h5", null, _i18n.i18n.translate('xpack.observability_onboarding.fetcher.error.url', {
    defaultMessage: `URL`
        ...
        if (!signal.aborted) {
          ...
          if (showToastOnError) {
            notifications.toasts.danger({
              ...
              body: /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h5", null, _i18n.i18n.translate('xpack.observability_onboarding.fetcher.error.status', {
