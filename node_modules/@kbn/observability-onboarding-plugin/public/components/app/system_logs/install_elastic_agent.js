...
var _system_integration_banner = require("./system_integration_banner");
...
function InstallElasticAgent() {
  var _progressData$progres, _progressData$progres2, _progressData$progres3, _progressData$progres4, _progressData$progres5;
  const {
    services: {
      share
    }
  ...
  const [systemIntegrationStatus, setSystemIntegrationStatus] = (0, _react.useState)('pending');
  const onIntegrationStatusChange = (0, _react.useCallback)(status => {
  ...
  const {
    ...
    if (monitoringRole !== null && monitoringRole !== void 0 && monitoringRole.hasPrivileges) {
  ...
  }, [apiKeyEncoded, onboardingId, installShipperSetupStatus === _use_fetcher.FETCH_STATUS.SUCCESS]);
  (0, _react.useEffect)(() => {
    setState(state => ({
      ...state,
      onboardingId,
  ...
  const autoDownloadConfigStatus = progressData === null || progressData === void 0 ? void 0 : (_progressData$progres3 = progressData.progress) === null || _progressData$progres3 === void 0 ? void 0 : (_progressData$progres4 = _progressData$progres3['ea-config']) === null || _progressData$progres4 === void 0 ? void 0 : _progressData$progres4.status;
  return /*#__PURE__*/_react.default.createElement(_step_panel.StepPanel, {
    ...
    color: "subdued"
  }, /*#__PURE__*/_react.default.createElement("p", null, _i18n.i18n.translate('xpack.observability_onboarding.systemLogs.installElasticAgent.description', {
    ...
    size: "m"
  }), /*#__PURE__*/_react.default.createElement(_system_integration_banner.SystemIntegrationBanner, {
    ...
    installAgentPlatformOptions: [{
      ...
      children: /*#__PURE__*/_react.default.createElement(_windows_install_step.WindowsInstallStep, {
        docsLink: "https://www.elastic.co/guide/en/welcome-to-elastic/current/getting-started-observability.html"
      })
    }],
    ...
    installProgressSteps: (_progressData$progres5 = progressData === null || progressData === void 0 ? void 0 : progressData.progress) !== null && _progressData$progres5 !== void 0 ? _progressData$progres5 : {},
...
const CHECK_LOGS_LABELS = {
  incomplete: _i18n.i18n.translate('xpack.observability_onboarding.systemLogs.installElasticAgent.progress.logsIngest.incompleteTitle', {
    defaultMessage: 'Ship logs to Elastic Observability'
  }),
  loading: _i18n.i18n.translate('xpack.observability_onboarding.systemLogs.installElasticAgent.progress.logsIngest.loadingTitle', {
    defaultMessage: 'Waiting for logs to be shipped...'
  }),
  completed: _i18n.i18n.translate('xpack.observability_onboarding.systemLogs.installElasticAgent.progress.logsIngest.completedTitle', {
