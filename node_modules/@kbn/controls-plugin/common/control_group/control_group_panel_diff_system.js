...
const ControlPanelDiffSystems = {
  [_types2.RANGE_SLIDER_CONTROL]: {
    getPanelIsEqual: (initialInput, newInput) => {
      ...
      return (0, _lodash.isEqual)(valueA, valueB) && (0, _fastDeepEqual.default)(inputA, inputB);
    }
  },
  [_types.OPTIONS_LIST_CONTROL]: {
    getPanelIsEqual: (initialInput, newInput) => {
      ...
      return Boolean(excludeA) === Boolean(excludeB) && Boolean(hideSortA) === Boolean(hideSortB) && Boolean(hideExistsA) === Boolean(hideExistsB) && Boolean(hideExcludeA) === Boolean(hideExcludeB) && Boolean(singleSelectA) === Boolean(singleSelectB) && Boolean(existsSelectedA) === Boolean(existsSelectedB) && Boolean(runPastTimeoutA) === Boolean(runPastTimeoutB) && (0, _lodash.isEqual)(searchTechniqueA !== null && searchTechniqueA !== void 0 ? searchTechniqueA : 'prefix', searchTechniqueB !== null && searchTechniqueB !== void 0 ? searchTechniqueB : 'prefix') && (0, _fastDeepEqual.default)(sortA !== null && sortA !== void 0 ? sortA : _suggestions_sorting.OPTIONS_LIST_DEFAULT_SORT, sortB !== null && sortB !== void 0 ? sortB : _suggestions_sorting.OPTIONS_LIST_DEFAULT_SORT) && (0, _lodash.isEqual)(selectedA !== null && selectedA !== void 0 ? selectedA : [], selectedB !== null && selectedB !== void 0 ? selectedB : []) && (0, _fastDeepEqual.default)(inputA, inputB);
    }
  },
  [_types3.TIME_SLIDER_CONTROL]: {
    getPanelIsEqual: (initialInput, newInput) => {
      ...
      return Boolean(isAnchoredA) === Boolean(isAnchoredB) && Boolean(startA) === Boolean(startB) && startA === startB && Boolean(endA) === Boolean(endB) && endA === endB;
    }
  }
};
