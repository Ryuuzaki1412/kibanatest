...
const TimeSliderControlContext = /*#__PURE__*/(0, _react.createContext)(null);
exports.TimeSliderControlContext = TimeSliderControlContext;
const useTimeSlider = () => {
...
class TimeSliderControlEmbeddable extends _public.Embeddable {
  ...
  constructor(reduxToolsPackage, input, output, parent) {
    ...
    const _timeRangeBounds = this.timeRangeToBounds(input.timeRange ? input.timeRange : getDefaultTimeRange());
    ...
    this.waitForControlOutputConsumersToLoad$ = parent && 'anyControlOutputConsumerLoading$' in parent ? parent.anyControlOutputConsumerLoading$.pipe((0, _operators.debounceTime)(300), (0, _operators.first)(isAnyControlOutputConsumerLoading => {
  ...
  syncWithTimeRange() {
    ...
    if (timesliceStartAsPercentageOfTimeRange !== undefined && timesliceEndAsPercentageOfTimeRange !== undefined) {
      ...
      this.onRangeChange(value[_time_utils.TO_INDEX] - value[_time_utils.FROM_INDEX]);
    }
  }
