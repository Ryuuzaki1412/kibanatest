...
async function updateRelatedSavedObject(soClient, esClient, fleetServerHosts, outputs, downloadSources) {
  await (0, _pMap.default)(fleetServerHosts, fleetServerHost => {
    (0, _fleet_server_host.updateFleetServerHost)(soClient, fleetServerHost.id, {
  ...
  await (0, _pMap.default)(outputs, output => {
    _output.outputService.update(soClient, esClient, output.id, {
  ...
  await (0, _pMap.default)(downloadSources, downloadSource => {
    _download_source.downloadSourceService.update(soClient, downloadSource.id, {
