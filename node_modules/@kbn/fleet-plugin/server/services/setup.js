...
async function createSetupSideEffects(soClient, esClient) {
  var _appContextService$ge, _stepSpan, _stepSpan2, _stepSpan3, _stepSpan4, _appContextService$ge2, _appContextService$ge4, _appContextService$ge5, _appContextService$ge6, _appContextService$ge8, _stepSpan5, _stepSpan6, _stepSpan7;
  ...
  if (!((_appContextService$ge4 = _app_context.appContextService.getEncryptedSavedObjectsSetup()) !== null && _appContextService$ge4 !== void 0 && _appContextService$ge4.canEncrypt)) {
  ...
  await ((_appContextService$ge5 = _app_context.appContextService.getUninstallTokenService()) === null || _appContextService$ge5 === void 0 ? void 0 : _appContextService$ge5.generateTokensForAllPolicies());
  if ((_appContextService$ge6 = _app_context.appContextService.getEncryptedSavedObjectsSetup()) !== null && _appContextService$ge6 !== void 0 && _appContextService$ge6.canEncrypt) {
    var _appContextService$ge7;
    logger.debug('Checking for and encrypting plain text uninstall tokens');
    await ((_appContextService$ge7 = _app_context.appContextService.getUninstallTokenService()) === null || _appContextService$ge7 === void 0 ? void 0 : _appContextService$ge7.encryptTokens());
  }
  logger.debug('Checking validity of Uninstall Tokens');
  const uninstallTokenError = await ((_appContextService$ge8 = _app_context.appContextService.getUninstallTokenService()) === null || _appContextService$ge8 === void 0 ? void 0 : _appContextService$ge8.checkTokenValidityForAllPolicies());
  ...
  const nonFatalErrors = [...preconfiguredPackagesNonFatalErrors, ...packagePolicyUpgradeErrors, ...(messageSigningServiceNonFatalError ? [messageSigningServiceNonFatalError] : []), ...(uninstallTokenError ? [uninstallTokenError] : [])];
