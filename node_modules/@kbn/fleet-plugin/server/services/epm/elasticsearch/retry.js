...
const isRetryableError = (e, additionalResponseStatuses = []) => retryMessages.some(msg => e.message.includes(msg)) || e instanceof _elasticsearch.errors.NoLivingConnectionsError || e instanceof _elasticsearch.errors.ConnectionError || e instanceof _elasticsearch.errors.TimeoutError || e instanceof _elasticsearch.errors.ResponseError && [...retryResponseStatuses, ...additionalResponseStatuses].includes(e === null || e === void 0 ? void 0 : e.statusCode);
