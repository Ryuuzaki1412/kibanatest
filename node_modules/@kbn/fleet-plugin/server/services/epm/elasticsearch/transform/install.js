...
const processTransformAssetsPerModule = (installablePackage, installNameSuffix, transformPaths, previousInstalledTransformEsAssets = [], force, username) => {
  ...
  transformPaths.forEach(path => {
    ...
    if (fileName === TRANSFORM_SPECS_TYPES.FIELDS || (0, _field.isFields)(path)) {
      var _transformsSpecificat, _transformsSpecificat2, _transformsSpecificat3;
      ...
      const previousMappings = (_transformsSpecificat = (_transformsSpecificat2 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat2 === void 0 ? void 0 : _transformsSpecificat2.get('mappings')) !== null && _transformsSpecificat !== void 0 ? _transformsSpecificat : {};
      (_transformsSpecificat3 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat3 === void 0 ? void 0 : _transformsSpecificat3.set('mappings', {
        properties: {
    ...
    if (fileName === TRANSFORM_SPECS_TYPES.TRANSFORM) {
      var _content$_meta, _content$_meta2, _content$_meta3, _content$_meta$fleet_, _content$_meta4, _transformsSpecificat4, _content$_meta5, _transformsSpecificat5, _transformsSpecificat6, _transformsSpecificat7, _transformsSpecificat8, _content$_meta6;
      ...
      (_transformsSpecificat4 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat4 === void 0 ? void 0 : _transformsSpecificat4.set('originalDestinationIndexName', content.dest.index);
      ...
      (_transformsSpecificat5 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat5 === void 0 ? void 0 : _transformsSpecificat5.set('destinationIndex', content.dest);
      (_transformsSpecificat6 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat6 === void 0 ? void 0 : _transformsSpecificat6.set('destinationIndexAlias', aliases);
      (_transformsSpecificat7 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat7 === void 0 ? void 0 : _transformsSpecificat7.set('transform', content);
      (_transformsSpecificat8 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat8 === void 0 ? void 0 : _transformsSpecificat8.set('transformVersion', transformVersion);
      content._meta = {
      ...
      if (previousInstalledTransformEsAssets.length === 0) {
        ...
        (_transformsSpecificat9 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat9 === void 0 ? void 0 : _transformsSpecificat9.set('transformVersionChanged', true);
      } else {
        if (force || !currentTransformSameAsPrev) {
          ...
          (_transformsSpecificat10 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat10 === void 0 ? void 0 : _transformsSpecificat10.set('transformVersionChanged', true);
          if (aliasNames.length > 0) {
            aliasesRefs.push(...aliasNames);
          }
        } else {
          var _transformsSpecificat11;
          (_transformsSpecificat11 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat11 === void 0 ? void 0 : _transformsSpecificat11.set('transformVersionChanged', false);
        }
      }
    }
    ...
    if (fileName === TRANSFORM_SPECS_TYPES.MANIFEST) {
      if ((0, _mlIsPopulatedObject.isPopulatedObject)(content, ['start']) && content.start === false) {
        ...
        (_transformsSpecificat12 = transformsSpecifications.get(transformModuleId)) === null || _transformsSpecificat12 === void 0 ? void 0 : _transformsSpecificat12.set('start', false);
      }
  ...
  const indexTemplatesRefs = destinationIndexTemplates.map(template => {
    ...
    return {
      ...
      version: (_transformsSpecificat13 = transformsSpecifications.get(template.transformModuleId)) === null || _transformsSpecificat13 === void 0 ? void 0 : _transformsSpecificat13.get('transformVersion')
    };
  });
  const componentTemplatesRefs = [...destinationIndexTemplates.map(template => {
    ...
    return {
      ...
      version: (_transformsSpecificat14 = transformsSpecifications.get(template.transformModuleId)) === null || _transformsSpecificat14 === void 0 ? void 0 : _transformsSpecificat14.get('transformVersion')
    };
    ...
    return {
      ...
      type: _models.ElasticsearchAssetType.componentTemplate,
      version: (_transformsSpecificat15 = transformsSpecifications.get(template.transformModuleId)) === null || _transformsSpecificat15 === void 0 ? void 0 : _transformsSpecificat15.get('transformVersion')
    };
  })];
...
const installTransformsAssets = async (installablePackage, installNameSuffix, transformPaths, esClient, savedObjectsClient, logger, esReferences = [], previousInstalledTransformEsAssets = [], force, authorizationHeader) => {
  let installedTransforms = [];
  ...
  if (transformPaths.length > 0) {
    const {
      ...
      transformsToRemove,
      transformsToRemoveWithDestIndex
    } = processTransformAssetsPerModule(installablePackage, installNameSuffix, transformPaths, previousInstalledTransformEsAssets, force, username);
        ...
        return (0, _install.installComponentAndIndexTemplateForDataStream)({
          ...
          indexTemplate: {
            ...
            indexTemplate: {
              ...
              index_patterns: [(_transformsSpecificat16 = transformsSpecifications.get(destinationIndexTemplate.transformModuleId)) === null || _transformsSpecificat16 === void 0 ? void 0 : _transformsSpecificat16.get('destinationIndex').index],
    ...
    if (shouldInstallSequentially) {
      for (const transform of transforms) {
        var _transformsSpecificat17;
        const installTransform = await handleTransformInstall({
          esClient,
          logger,
          transform,
          startTransform: (_transformsSpecificat17 = transformsSpecifications.get(transform.transformModuleId)) === null || _transformsSpecificat17 === void 0 ? void 0 : _transformsSpecificat17.get('start'),
      ...
      const transformsPromises = transforms.map(async transform => {
        var _transformsSpecificat18;
        return handleTransformInstall({
          esClient,
          logger,
          transform,
          startTransform: (_transformsSpecificat18 = transformsSpecifications.get(transform.transformModuleId)) === null || _transformsSpecificat18 === void 0 ? void 0 : _transformsSpecificat18.get('start'),
          secondaryAuth: transform.runAsKibanaSystem !== false ? undefined : secondaryAuth
        });
      });
...
const installTransforms = async ({
  ...
  return await installTransformsAssets(installablePackage, installNameSuffix, transformPaths, esClient, savedObjectsClient, logger, esReferences, previousInstalledTransformEsAssets, force, authorizationHeader);
};
...
async function handleTransformInstall({
  ...
  try {
    ...
    var _err$body, _err$body$error, _err$body2, _err$body2$error, _err$body2$error$reas, _err$body3, _err$body3$error;
    ...
    const isAlreadyExistError = isResponseError && (err === null || err === void 0 ? void 0 : (_err$body3 = err.body) === null || _err$body3 === void 0 ? void 0 : (_err$body3$error = _err$body3.error) === null || _err$body3$error === void 0 ? void 0 : _err$body3$error.type) === 'resource_already_exists_exception';
  ...
  if (startTransform === undefined || startTransform === true) {
    try {
      ...
      var _err$body4, _err$body4$error, _err$body5, _err$body5$error, _err$body5$error$reas;
      const isResponseError = err instanceof _elasticsearch.errors.ResponseError;
      isUnauthorizedAPIKey = isResponseError &&
      // if transform was created with insufficient permission,
      // _start will yield an error
      (err === null || err === void 0 ? void 0 : (_err$body4 = err.body) === null || _err$body4 === void 0 ? void 0 : (_err$body4$error = _err$body4.error) === null || _err$body4$error === void 0 ? void 0 : _err$body4$error.type) === 'security_exception' && (err === null || err === void 0 ? void 0 : (_err$body5 = err.body) === null || _err$body5 === void 0 ? void 0 : (_err$body5$error = _err$body5.error) === null || _err$body5$error === void 0 ? void 0 : (_err$body5$error$reas = _err$body5$error.reason) === null || _err$body5$error$reas === void 0 ? void 0 : _err$body5$error$reas.includes('lacks the required permissions'));
