...
const DATASTREAM_MANIFEST_NAME = 'manifest.yml';
exports.DATASTREAM_MANIFEST_NAME = DATASTREAM_MANIFEST_NAME;
const DATASTREAM_ROUTING_RULES_NAME = 'routing_rules.yml';
exports.DATASTREAM_ROUTING_RULES_NAME = DATASTREAM_ROUTING_RULES_NAME;
const DATASTREAM_LIFECYCLE_NAME = 'lifecycle.yml';
exports.DATASTREAM_LIFECYCLE_NAME = DATASTREAM_LIFECYCLE_NAME;
const KIBANA_FOLDER_NAME = 'kibana';
exports.KIBANA_FOLDER_NAME = KIBANA_FOLDER_NAME;
const TAGS_NAME = 'tags.yml';
exports.TAGS_NAME = TAGS_NAME;
...
const optionalArchivePackageProps = ['readme', 'assets', 'data_streams', 'license', 'type', 'categories', 'conditions', 'screenshots', 'icons', 'policy_templates', 'release', 'elasticsearch'];
...
function parseAndVerifyArchive(paths, assetsMap, topLevelDirOverride) {
  ...
  if (!paths.includes(manifestFile) || !manifestBuffer) {
    throw new _errors.PackageInvalidArchiveError(`Package at top-level directory ${toplevelDir} must contain a top-level ${MANIFEST_NAME} file.`);
  }
