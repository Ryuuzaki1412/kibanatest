...
const FLEET_INSTALL_FORMAT_VERSION = '1.1.0';
exports.FLEET_INSTALL_FORMAT_VERSION = FLEET_INSTALL_FORMAT_VERSION;
const FLEET_AGENT_POLICIES_SCHEMA_VERSION = '1.1.1';
...
const STACK_COMPONENT_TEMPLATE_LOGS_SETTINGS = `logs@settings`;
exports.STACK_COMPONENT_TEMPLATE_LOGS_SETTINGS = STACK_COMPONENT_TEMPLATE_LOGS_SETTINGS;
const STACK_COMPONENT_TEMPLATE_METRICS_SETTINGS = `metrics@settings`;
exports.STACK_COMPONENT_TEMPLATE_METRICS_SETTINGS = STACK_COMPONENT_TEMPLATE_METRICS_SETTINGS;
const STACK_COMPONENT_TEMPLATE_METRICS_TSDB_SETTINGS = `metrics@tsdb-settings`;
exports.STACK_COMPONENT_TEMPLATE_METRICS_TSDB_SETTINGS = STACK_COMPONENT_TEMPLATE_METRICS_TSDB_SETTINGS;
const STACK_COMPONENT_TEMPLATES = [STACK_COMPONENT_TEMPLATE_LOGS_SETTINGS, STACK_COMPONENT_TEMPLATE_METRICS_SETTINGS, STACK_COMPONENT_TEMPLATE_METRICS_TSDB_SETTINGS];
exports.STACK_COMPONENT_TEMPLATES = STACK_COMPONENT_TEMPLATES;
const FLEET_FINAL_PIPELINE_VERSION = 4;
