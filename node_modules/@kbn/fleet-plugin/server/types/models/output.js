...
exports.ElasticSearchSchema = ElasticSearchSchema;
...
const RemoteElasticSearchSchema = {
  ...ElasticSearchSchema,
...
exports.RemoteElasticSearchSchema = RemoteElasticSearchSchema;
...
exports.LogstashSchema = LogstashSchema;
...
const OutputSchema = _configSchema.schema.oneOf([_configSchema.schema.object({
  ...ElasticSearchSchema
...
const UpdateOutputSchema = _configSchema.schema.oneOf([_configSchema.schema.object({
  ...ElasticSearchUpdateSchema
}), _configSchema.schema.object({
