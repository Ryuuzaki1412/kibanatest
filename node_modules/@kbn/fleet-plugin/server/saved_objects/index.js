...
function registerSavedObjects(savedObjects) {
...
function registerEncryptedSavedObjects(encryptedSavedObjects) {
  encryptedSavedObjects.registerType({
    ...
    attributesToExcludeFromAAD: new Set(['output_id', 'name', 'type', 'is_default', 'is_default_monitoring', 'hosts', 'ca_sha256', 'ca_trusted_fingerprint', 'config', 'config_yaml', 'is_preconfigured', 'proxy_id', 'version', 'key', 'compression', 'compression_level', 'client_id', 'auth_type', 'connection_type', 'username', 'sasl', 'partition', 'random', 'round_robin', 'hash', 'topics', 'headers', 'timeout', 'broker_timeout', 'required_acks', 'preset', 'secrets'])
  });
