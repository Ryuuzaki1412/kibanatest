...
function getAllowedOutputTypeForPolicy(agentPolicy) {
  const isRestrictedToSameClusterES = agentPolicy.package_policies && agentPolicy.package_policies.some(p => {
    var _p$package, _p$package2, _p$package3;
    return ((_p$package = p.package) === null || _p$package === void 0 ? void 0 : _p$package.name) === _constants.FLEET_SERVER_PACKAGE || ((_p$package2 = p.package) === null || _p$package2 === void 0 ? void 0 : _p$package2.name) === _constants.FLEET_SYNTHETICS_PACKAGE || ((_p$package3 = p.package) === null || _p$package3 === void 0 ? void 0 : _p$package3.name) === _constants.FLEET_APM_PACKAGE;
  });
