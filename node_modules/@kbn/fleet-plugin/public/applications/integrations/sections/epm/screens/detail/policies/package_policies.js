...
const PackagePoliciesPage = ({
  ...
  const showAddAgentHelpForPackagePolicyId = (_packageAndAgentPolic = packageAndAgentPolicies.find(({
    agentPolicy
  }) => (agentPolicy === null || agentPolicy === void 0 ? void 0 : agentPolicy.id) === showAddAgentHelpForPolicyId)) === null || _packageAndAgentPolic === void 0 ? void 0 : (_packageAndAgentPolic2 = _packageAndAgentPolic.packagePolicy) === null || _packageAndAgentPolic2 === void 0 ? void 0 : _packageAndAgentPolic2.id;
  ...
  const columns = (0, _react.useMemo)(() => [{
    ...
    render(_version, {
      ...
      }))), agentPolicy && packagePolicy.hasUpgrade && /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, {
        grow: false
    ...
    render(id, {
      ...
      return agentPolicy ? /*#__PURE__*/_react.default.createElement(_components.AgentPolicySummaryLine, {
        policy: agentPolicy
  ...
  const selectedPolicies = packageAndAgentPolicies.find(({
    agentPolicy: policy
  }) => (policy === null || policy === void 0 ? void 0 : policy.id) === flyoutOpenForPolicyId);
  const agentPolicy = selectedPolicies === null || selectedPolicies === void 0 ? void 0 : selectedPolicies.agentPolicy;
  ...
  }))), flyoutOpenForPolicyId && agentPolicy && !isLoading && /*#__PURE__*/_react.default.createElement(_components.AgentEnrollmentFlyout, {
    onClose: () => {
