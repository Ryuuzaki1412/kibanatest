...
})), /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, null, /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_eui.EuiLink, {
...
const SettingsPage = /*#__PURE__*/(0, _react.memo)(({
  packageInfo,
  theme$
}) => {
  ...
  const agentPolicyIds = (0, _react.useMemo)(() => {
    ...
    return (_packagePoliciesData$ = packagePoliciesData === null || packagePoliciesData === void 0 ? void 0 : packagePoliciesData.items.map(({
      policy_id: agentPolicyId
    }) => agentPolicyId)) !== null && _packagePoliciesData$ !== void 0 ? _packagePoliciesData$ : [];
  }, [packagePoliciesData]);
  const {
    data: dryRunData
