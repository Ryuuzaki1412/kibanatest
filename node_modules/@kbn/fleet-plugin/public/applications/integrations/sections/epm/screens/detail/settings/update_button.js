...
const UpdateButton = ({
  ...
  const handleClickUpgradePolicies = (0, _react.useCallback)(async () => {
    ...
    upgradePackagePoliciesMutation.mutate({
      ...
      packagePolicyIds: packagePolicyIds.filter(id => {
  ...
  }, [isUpgradingPackagePolicies, setIsUpgradingPackagePolicies, installPackage, name, version, title, upgradePackagePoliciesMutation, packagePolicyIds, dryRunData, notifications.toasts, theme$, navigateToNewSettingsPage]);
