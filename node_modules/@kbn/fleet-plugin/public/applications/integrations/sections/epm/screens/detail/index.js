...
function Detail() {
  ...
  const canReadPackageSettings = (0, _hooks.useAuthz)().integrations.readPackageSettings;
  ...
  const {
    ...
    enabled: !isSettingsInitialLoading,
  ...
  }, /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, null, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_eui.EuiButtonEmpty, {
    iconType: "arrowLeft",
    size: "xs",
    flush: "left",
    href: href
  ...
  })) : null))))))), [integrationInfo, isLoading, packageInfo, href]);
  ...
  const headerTabs = (0, _react.useMemo)(() => {
    ...
    if (!_constants.HIDDEN_API_REFERENCE_PACKAGES.includes(packageInfo.name)) {
      tabs.push({
        id: 'api-reference',
        name: /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
    ...
    return tabs;
  }, [packageInfo, panel, getHref, integration, canReadIntegrationPolicies, numOfDeferredInstallations, isInstalled, CustomAssets, canReadPackageSettings, showCustomTab]);
