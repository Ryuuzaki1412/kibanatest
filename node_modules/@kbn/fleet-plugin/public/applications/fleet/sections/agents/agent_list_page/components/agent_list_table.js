...
const AgentListTable = props => {
  ...
  const columns = [{
    ...
    render: (version, agent) => /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, {
      ...
      isAgentUpgradable: !!(isAgentSelectable(agent) && latestAgentVersion && (0, _services.isAgentUpgradeable)(agent, latestAgentVersion)),
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiBasicTable, {
    ...
    items: totalAgents ? showUpgradeable ? agents.filter(agent => isAgentSelectable(agent) && latestAgentVersion && (0, _services.isAgentUpgradeable)(agent, latestAgentVersion)) : agents : [],
    itemId: "id",
    columns: columns,
    pagination: {
