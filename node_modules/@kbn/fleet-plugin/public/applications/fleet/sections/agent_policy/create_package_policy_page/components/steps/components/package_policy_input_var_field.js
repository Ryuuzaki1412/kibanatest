...
const PackagePolicyInputVarField = /*#__PURE__*/(0, _react.memo)(({
  ...
  const formRow = /*#__PURE__*/_react.default.createElement(FormRow, {
    isInvalid: isInvalid,
    error: errors,
    label: varDef.secret ? /*#__PURE__*/_react.default.createElement(SecretFieldLabel, {
      fieldLabel: fieldLabel
    }) : fieldLabel,
  ...
  return varDef.secret ? /*#__PURE__*/_react.default.createElement(SecretFieldWrapper, null, formRow) : formRow;
});
