...
const validateKafkaPasswordSecret = toSecretValidator(validateKafkaPassword);
exports.validateKafkaPasswordSecret = validateKafkaPasswordSecret;
...
const validateServiceTokenSecret = toSecretValidator(validateServiceToken);
exports.validateServiceTokenSecret = validateServiceTokenSecret;
...
const validateSSLKeySecret = toSecretValidator(validateSSLKey);
exports.validateSSLKeySecret = validateSSLKeySecret;
