...
const EditOutputFlyout = ({
  ...
  const {
    outputSecretsStorage: isOutputSecretsStorageEnabled
  } = _services.ExperimentalFeaturesService.get();
  const [useSecretsStorage, setUseSecretsStorage] = _react.default.useState(isOutputSecretsStorageEnabled);
  ...
  const renderTypeSpecificWarning = () => {
    const isKafkaOutput = inputs.typeInput.value === _constants.outputType.Kafka;
    ...
    const generateWarningMessage = () => {
      switch (inputs.typeInput.value) {
        case _constants.outputType.Kafka:
          return _i18n.i18n.translate('xpack.fleet.settings.editOutputFlyout.kafkaOutputTypeCallout', {
            defaultMessage: 'Kafka output is currently not supported on Agents using the Elastic Defend integration.'
          });
        default:
        case _constants.outputType.Elasticsearch:
  ...
  return /*#__PURE__*/_react.default.createElement(_eui.EuiFlyout, {
    maxWidth: _constants2.FLYOUT_MAX_WIDTH,
    onClose: onClose
    ...
    label: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
      ...
      defaultMessage: "Type"
    }), inputs.typeInput.value === _constants.outputType.Kafka && /*#__PURE__*/_react.default.createElement(_eui.EuiBetaBadge, {
      label: _i18n.i18n.translate('xpack.fleet.settings.betaBadgeLabel', {
        defaultMessage: 'Beta'
      }),
      size: "s",
      css: (0, _react2.css)`
