...
function useOutputForm(onSucess, output) {
  ...
  */
  ...
  const extractKafkaTopics = topics => {
  ...
  const kafkaHostsInput = (0, _hooks.useComboInput)('kafkaHostsComboBox', (_output$hosts3 = output === null || output === void 0 ? void 0 : output.hosts) !== null && _output$hosts3 !== void 0 ? _output$hosts3 : [], _output_form_validators.validateKafkaHosts, isDisabled('hosts'));
  ...
  const kafkaTopicsInput = (0, _hooks.useTopicsInput)('kafkaTopicsComboBox', extractKafkaTopics(kafkaOutput === null || kafkaOutput === void 0 ? void 0 : kafkaOutput.topics), _output_form_validators.validateKafkaTopics, isDisabled('topics'));
  ...
  const validate = (0, _react.useCallback)(() => {
    ...
    if (isKafka) {
      // validate kafka
      return nameInputValid && kafkaHostsValid && kafkaSslCertificateValid && kafkaSslKeyValid && kafkaUsernameValid && kafkaPasswordValid && kafkaHeadersValid && kafkaDefaultTopicValid && kafkaTopicsValid && additionalYamlConfigValid && kafkaClientIDValid && partitioningRandomGroupEventsValid && partitioningRoundRobinGroupEventsValid;
    }
