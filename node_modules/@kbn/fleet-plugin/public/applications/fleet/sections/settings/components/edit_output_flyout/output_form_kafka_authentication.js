...
const OutputFormKafkaAuthentication = props => {
  ...
  }, [useSecretsStorage, inputs.kafkaAuthPasswordInput, inputs.kafkaAuthPasswordSecretInput, inputs.kafkaSslKeyInput, inputs.kafkaSslKeySecretInput, isFirstLoad, setIsFirstLoad]);
