...
const fetchSavedObjects = async (type, name) => {
  ...
  return (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.hits;
};
const SavedObjectDebugger = () => {
  const types = [{
    value: `${_constants.AGENT_POLICY_SAVED_OBJECT_TYPE}`,
    text: _i18n.i18n.translate('xpack.fleet.debug.savedObjectDebugger.agentPolicyLabel', {
      defaultMessage: 'Agent policy'
    })
  }, {
    value: `${_constants.PACKAGE_POLICY_SAVED_OBJECT_TYPE}`,
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiText, {
    ...
    css: `
            min-width: 400px;
          `
  }, /*#__PURE__*/_react.default.createElement(_eui.EuiFormRow, null, /*#__PURE__*/_react.default.createElement(_saved_object_names_combo.SavedObjectNamesCombo, {
    name: name,
    setName: setName,
    type: type,
