...
const useFleetServerHost = () => {
  ...
  const saveFleetServerHost = (0, _react.useCallback)(async newFleetServerHost => {
    setIsFleetServerHostSubmitted(false);
    const res = await (0, _hooks.sendPostFleetServerHost)({
      name: newFleetServerHost === null || newFleetServerHost === void 0 ? void 0 : newFleetServerHost.name,
      host_urls: newFleetServerHost === null || newFleetServerHost === void 0 ? void 0 : newFleetServerHost.host_urls,
      is_default: newFleetServerHost === null || newFleetServerHost === void 0 ? void 0 : newFleetServerHost.is_default
    });
    if (res.error) {
      throw res.error;
    }
