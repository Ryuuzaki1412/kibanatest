...
const getSeriesProps = ({
  ...
  const scaleType = (yAxis === null || yAxis === void 0 ? void 0 : yAxis.scaleType) || _charts.ScaleType.Linear;
  ...
  return {
    ...
    yScaleType: (formatter === null || formatter === void 0 ? void 0 : formatter.id) === 'bytes' && scaleType === _charts.ScaleType.Linear ? _charts.ScaleType.LinearBinary : scaleType,
