...
const XYChartReportable = /*#__PURE__*/_react.default.memo(XYChart);
...
function XYChart({
  ...
  const getYAxisDomain = axis => {
    ...
    if (extent.mode === 'custom') {
      const {
        inclusiveZeroError,
        boundaryError
      } = (0, _helpers2.validateExtent)(hasBarOrArea, extent);
  ...
  const xAxisStyle = shouldUseNewTimeAxis ? {
    ..._common.MULTILAYER_TIME_AXIS_STYLE,
    tickLabel: {
    ...
    tickLine: {
      ..._common.MULTILAYER_TIME_AXIS_STYLE.tickLine,
      visible: Boolean(xAxisConfig === null || xAxisConfig === void 0 ? void 0 : xAxisConfig.showLabels)
    },
    axisTitle: {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    actions: (0, _tooltip_actions.getTooltipActions)(dataLayers, onClickMultiValue, fieldFormats, formattedDatatables, xAxisFormatter, formatFactory, interactive && !args.detailedTooltip),
