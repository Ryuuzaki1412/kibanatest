...
const colorMappingSlice = (0, _toolkit.createSlice)({
  name: 'colorMapping',
  initialState,
  reducers: {
...
exports.colorMappingSlice = colorMappingSlice;
const {
  updatePalette,
  assignStatically,
  assignAutomatically,
...
const colorMappingReducer = colorMappingSlice.reducer;
exports.colorMappingReducer = colorMappingReducer;