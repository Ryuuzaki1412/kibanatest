...
function PaletteColors({
  ...
  const neutralColors = Array.from({
    ...
    return _neutral.NeutralPalette.getColor(i, isDarkMode);
  });
  const originalColor = color.type === 'categorical' ? color.paletteId === _neutral.NeutralPalette.id ? _neutral.NeutralPalette.getColor(color.colorIndex, isDarkMode) : getPaletteFn(color.paletteId).getColor(color.colorIndex, isDarkMode) : color.colorCode;
