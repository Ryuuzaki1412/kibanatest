...
const DataVisualizerFieldNamesFilter = ({
  ...
  const fieldNameTitle = (0, _react.useMemo)(() => _i18n.i18n.translate('xpack.dataVisualizer.fieldNameSelect', {
    defaultMessage: 'Field name'
  }), []);
  const options = (0, _react.useMemo)(() => fields.filter(d => d.fieldName !== undefined).map(d => ({
    value: d.fieldName
  })), [fields]);
