...
const useData = (initialSettings, selectedDataView, contextId, searchString, searchQueryLanguage, randomSampler, randomSamplerProd, onUpdate, barTarget = DEFAULT_BAR_TARGET, timeRange) => {
  ...
  const docCountRequestParams = (0, _react.useMemo)(() => {
    ...
    if (timefilterActiveBounds !== undefined) {
      ...
      const refQuery = (0, _saved_search_utils.createMergedEsQuery)(searchQuery, (0, _public2.mapAndFlattenFilters)([...queryManager.filterManager.getFilters(), ...((_referenceStateManage = referenceStateManager.filters) !== null && _referenceStateManage !== void 0 ? _referenceStateManage : [])]), selectedDataView, uiSettings);
      const compQuery = (0, _saved_search_utils.createMergedEsQuery)(searchQuery, (0, _public2.mapAndFlattenFilters)([...queryManager.filterManager.getFilters(), ...((_comparisonStateManag = comparisonStateManager.filters) !== null && _comparisonStateManag !== void 0 ? _comparisonStateManag : [])]), selectedDataView, uiSettings);
      return {
        reference: {
          ...query,
