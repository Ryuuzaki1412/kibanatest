...
class ImportView extends _react.Component {
      ...
      this.setState({
        ...
        this.setState({
          ...
          setTimeout(async () => {
            ...
            if ((0, _mlIsPopulatedObject.isPopulatedObject)(mappings.properties, [DEFAULT_TIME_FIELD])) {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_eui.EuiPageBody, {
      ...
      size: "m"
    }), (initialized === false || importing === true) && /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, null, /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, {
      grow: false
    ...
    })))), initialized === true && importing === false && /*#__PURE__*/_react.default.createElement(_eui.EuiFlexGroup, null, /*#__PURE__*/_react.default.createElement(_eui.EuiFlexItem, {
      grow: false
    }, /*#__PURE__*/_react.default.createElement(_eui.EuiButton, {
    ...
    }))))), initialized === true && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_eui.EuiSpacer, {
      size: "m"
    }), /*#__PURE__*/_react.default.createElement(_eui.EuiPanel, null, /*#__PURE__*/_react.default.createElement(_import_progress.ImportProgress, {
      statuses: statuses
