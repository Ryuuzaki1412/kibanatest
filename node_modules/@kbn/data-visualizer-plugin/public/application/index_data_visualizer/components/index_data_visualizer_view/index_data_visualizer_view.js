...
exports.getDefaultPageState = getDefaultPageState;
...
const IndexDataVisualizerView = dataVisualizerProps => {
  ...
  const onAddFilter = (0, _react2.useCallback)((field, values, operation) => {
    ...
    const combinedQuery = (0, _saved_search_utils.createMergedEsQuery)({
      query: searchString || '',
      language: searchQueryLanguage
    }, (_data$query$filterMan = data.query.filterManager.getFilters()) !== null && _data$query$filterMan !== void 0 ? _data$query$filterMan : [], currentDataView, uiSettings);
    setSearchParams({
