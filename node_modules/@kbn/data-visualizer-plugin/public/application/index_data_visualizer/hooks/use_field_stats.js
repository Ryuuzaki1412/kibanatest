...
function useFieldStatsSearchStrategy(searchStrategyParams, fieldStatsParams, dataVisualizerListState, samplingProbability) {
  ...
  const startFetch = (0, _react.useCallback)(() => {
    ...
    searchSubscription$.current = (0, _rxjs.from)(fieldStatsToFetch).pipe((0, _operators.mergeMap)(observable => observable, _index_data_visualizer_viewer.MAX_CONCURRENT_REQUESTS)).subscribe({
      next: batchResponse => {
        setFetchState({
          ...(0, _progress_utils.getInitialProgress)(),
          error: undefined
    ...
    retries$.current = (0, _rxjs.combineLatest)([statsMap$, fieldsToRetry$.pipe((0, _operators.switchMap)(failedFields => {
