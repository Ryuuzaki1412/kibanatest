...
exports.DocumentCountWithDualBrush = void 0;
...
const DocumentCountWithDualBrush = ({
  id,
  randomSampler,
  reload,
  ...
  const approximate = (0, _useObservable.default)(randomSampler.getProbability$().pipe((0, _operators.map)(samplingProbability => (0, _mlIsDefined.isDefined)(samplingProbability) ? samplingProbability < 1 : false)), false);
...
exports.DocumentCountWithDualBrush = DocumentCountWithDualBrush;