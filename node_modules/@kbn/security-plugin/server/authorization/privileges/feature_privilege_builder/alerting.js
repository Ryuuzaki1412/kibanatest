...
const readOperations = {
  rule: ['get', 'getRuleState', 'getAlertSummary', 'getExecutionLog', 'getActionErrorLog', 'find', 'getRuleExecutionKPI', 'runSoon'],
  alert: ['get', 'find', 'getAuthorizedAlertsIndices', 'getAlertSummary']
};
const writeOperations = {
  rule: ['create', 'delete', 'update', 'updateApiKey', 'enable', 'disable', 'muteAll', 'unmuteAll', 'muteAlert', 'unmuteAlert', 'snooze', 'bulkEdit', 'bulkDelete', 'bulkEnable', 'bulkDisable', 'unsnooze'],
  alert: ['update']
};
const allOperations = {
