...
var _user_profile_settings_client = require("./user_profile/user_profile_settings_client");
var _user_setting_service = require("./user_profile/user_setting_service");
...
class SecurityPlugin {
  constructor(initializerContext) {
    ...
    (0, _defineProperty2.default)(this, "userSettingService", void 0);
    (0, _defineProperty2.default)(this, "userSettingServiceStart", void 0);
    (0, _defineProperty2.default)(this, "userProfileSettingsClient", void 0);
    ...
    this.userSettingService = new _user_setting_service.UserSettingService(this.initializerContext.logger.get('user-settings'));
    this.analyticsService = new _analytics.AnalyticsService(this.initializerContext.logger.get('analytics'));
    this.userProfileSettingsClient = new _user_profile_settings_client.UserProfileSettingsClient(this.initializerContext.logger.get('user-settings-client'));
  }
  setup(core, {
    features,
    licensing,
