...
const SessionExpirationToast = ({
  ...
  const expirationWarning = /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedMessage, {
    ...
    values: {
      timeout: /*#__PURE__*/_react.default.createElement(_i18nReact.FormattedRelative, {
        value: Math.max(state.expiresInMs - _constants.SESSION_GRACE_PERIOD_MS, 0) + Date.now(),
        updateInterval: 1000
      })
    }
  });
...
const createSessionExpirationToast = (sessionState$, onExtend, onClose) => {
  return {
    color: 'warning',
    iconType: 'clock',
    ...
    text: (0, _public.toMountPoint)( /*#__PURE__*/_react.default.createElement(SessionExpirationToast, {
