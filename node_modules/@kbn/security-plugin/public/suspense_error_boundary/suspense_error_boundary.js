...
class SuspenseErrorBoundary extends _react.Component {
  ...
  componentDidCatch(error) {
    ...
    if (notifications) {
      const title = _i18n.i18n.translate('xpack.security.uiApi.errorBoundaryToastTitle', {
        defaultMessage: 'Failed to load Kibana asset'
      });
      const toastMessage = _i18n.i18n.translate('xpack.security.uiApi.errorBoundaryToastMessage', {
