...
class SecurityNavControlService {
  ...
  start({
    ...
    return {
      getUserMenuLinks$: () => this.userMenuLinks$.pipe((0, _operators.map)(this.sortUserMenuLinks), (0, _operators.takeUntil)(this.stop$)),
...
const Providers = ({
  ...
  authc: authc
}, /*#__PURE__*/_react.default.createElement(_components.SecurityApiClientsProvider, securityApiClients, /*#__PURE__*/_react.default.createElement(_i18nReact.I18nProvider, null, /*#__PURE__*/_react.default.createElement(_public.KibanaThemeProvider, {
  theme$: theme$
