...
exports.VALID_HEX_COLOR = exports.MAX_IMAGE_SIZE = exports.IMAGE_FILE_TYPES = void 0;
...
const IMAGE_FILE_TYPES = ['image/svg+xml', 'image/jpeg', 'image/png', 'image/gif'];
...
const VALID_HEX_COLOR = /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i;
exports.VALID_HEX_COLOR = VALID_HEX_COLOR;