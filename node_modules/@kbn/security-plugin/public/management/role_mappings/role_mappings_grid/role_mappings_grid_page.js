  ...
  constructor(props) {
    ...
    (0, _defineProperty2.default)(this, "renderTable", () => {
      ...
      const search = {
        toolsLeft: selectedItems.length ? /*#__PURE__*/_react.default.createElement(_components.DeleteProvider, {
          ...
          return /*#__PURE__*/_react.default.createElement(_eui.EuiButton, {
            onClick: () => deleteRoleMappingsPrompt(selectedItems, this.onRoleMappingsDeleted, this.onRoleMappingsDeleteCancel),
            color: "danger",
      ...
      return /*#__PURE__*/_react.default.createElement(_components.DeleteProvider, {
        ...
        return /*#__PURE__*/_react.default.createElement(_table_utils.ActionsEuiTableFormatting, null, /*#__PURE__*/_react.default.createElement(_eui.EuiInMemoryTable, {
          items: roleMappings,
          itemId: "name",
      ...
      if (!this.props.readOnly) {
        config.push({
          ...
          actions: [{
            isPrimary: true,
            render: record => {
              const title = _i18n.i18n.translate('xpack.security.management.roleMappings.actionCloneTooltip', {
                defaultMessage: 'Clone'
              });
              const label = _i18n.i18n.translate('xpack.security.management.roleMappings.actionCloneAriaLabel', {
              ...
              }, (0, _public.reactRouterNavigate)(this.props.history, (0, _management_urls.getCloneRoleMappingHref)(record.name))), title));
            }
          }, {
            render: record => {
              const title = _i18n.i18n.translate('xpack.security.management.roleMappings.actionDeleteTooltip', {
                defaultMessage: 'Delete'
              });
              const label = _i18n.i18n.translate('xpack.security.management.roleMappings.actionDeleteAriaLabel', {
            ...
            isPrimary: true,
            render: record => {
              const label = _i18n.i18n.translate('xpack.security.management.roleMappings.actionEditAriaLabel', {
                defaultMessage: `Edit '{name}'`,
                values: {
                  name: record.name
                }
              });
              const title = _i18n.i18n.translate('xpack.security.management.roleMappings.actionEditTooltip', {
                defaultMessage: 'Edit'
              });
              return /*#__PURE__*/_react.default.createElement(_eui.EuiToolTip, {
                content: title
                ...
                disabled: this.state.selectedItems.length >= 1
              }, (0, _public.reactRouterNavigate)(this.props.history, (0, _management_urls.getEditRoleMappingHref)(record.name))), title));
            }
          }]
        });
      }
    ...
    (0, _defineProperty2.default)(this, "onRoleMappingsDeleteCancel", () => {
