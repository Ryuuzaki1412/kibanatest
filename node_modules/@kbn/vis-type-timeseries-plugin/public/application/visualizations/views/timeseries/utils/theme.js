...
function getBaseTheme(baseTheme, bgColor) {
  ...
  const mainTheme = bgLuminosity <= 0.179 ? _charts.DARK_THEME : _charts.LIGHT_THEME;
  const color = findBestContrastColor(bgColor, _charts.LIGHT_THEME.axes.axisTitle.fill, _charts.DARK_THEME.axes.axisTitle.fill);
  return {
    ...mainTheme,
    axes: {
      ...mainTheme.axes,
