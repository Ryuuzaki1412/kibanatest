...
class VisEditorVisualizationUI extends _react.Component {
  ...
  async _loadVisualization() {
    ...
    this._subscription = this._handler.handler.data$.pipe((0, _operators.pluck)('result')).subscribe(data => onDataChange(data.value));
  }
...
const VisEditorVisualization = (0, _i18nReact.injectI18n)(VisEditorVisualizationUI);
exports.VisEditorVisualization = VisEditorVisualization;