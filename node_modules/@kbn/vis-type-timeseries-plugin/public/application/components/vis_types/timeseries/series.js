...
exports.TimeseriesSeries = void 0;
...
const TimeseriesSeriesUI = (0, _i18nReact.injectI18n)(function (props) {
  const {
    panel,
    fields,
    onAdd,
  ...
  if (visible) {
    ...
    if (selectedTab === 'metrics') {
      ...
      seriesBody = /*#__PURE__*/_react.default.createElement(_config.TimeseriesConfig, {
        fields: props.fields,
        panel: panel,
        model: model,
        onChange: props.onChange,
  ...
  const colorPicker = /*#__PURE__*/_react.default.createElement(_color_picker.ColorPicker, {
    disableTrash: true,
    onChange: props.onChange,
    name: "color",
    value: model.color
...
const TimeseriesSeries = (0, _i18nReact.injectI18n)(TimeseriesSeriesUI);
exports.TimeseriesSeries = TimeseriesSeries;