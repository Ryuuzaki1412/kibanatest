...
(0, _vega.scheme)('elastic', (0, _eui.euiPaletteColorBlind)());
...
class VegaBaseView {
  constructor(opts) {
    this._$parentEl = (0, _jquery.default)(opts.parentEl);
  ...
  async init() {
    ...
    try {
      ...
      this._$container = (0, _jquery.default)('<div class="vgaVis__view">').appendTo(this._$parentEl);
      this._$controls = (0, _jquery.default)(`<div class="vgaVis__controls vgaVis__controls--${this._parser.controlsDir}">`).appendTo(this._$parentEl);
  ...
  _addMessage(type, text) {
    if (!this._$messages) {
      this._$messages = (0, _jquery.default)(`<ul class="vgaVis__messages">`).appendTo(this._$parentEl);
    }
    const isMessageAlreadyDisplayed = this._$messages.find(`pre.vgaVis__messageCode`).filter((index, element) => element.textContent === text).length;
    if (!isMessageAlreadyDisplayed) {
      this._$messages.append((0, _jquery.default)(`<li class="vgaVis__message vgaVis__message--${type}">`).append((0, _jquery.default)(`<pre class="vgaVis__messageCode">`).text(text)));
    }
  }
  async resize() {
  ...
  updateVegaSize(view, dimensions) {
    ...
    const width = Math.floor(Math.max(0, (_dimensions$width = dimensions === null || dimensions === void 0 ? void 0 : dimensions.width) !== null && _dimensions$width !== void 0 ? _dimensions$width : this._$container.width()));
    const height = Math.floor(Math.max(0, (_dimensions$height = dimensions === null || dimensions === void 0 ? void 0 : dimensions.height) !== null && _dimensions$height !== void 0 ? _dimensions$height : this._$container.height()));
  ...
  setView(view) {
    ...
    if (view) {
      ...
      if (this._parser.tooltips) {
        ...
        const tthandler = new _vega_tooltip.TooltipHandler(this._$container[0], view, this._parser.tooltips);
