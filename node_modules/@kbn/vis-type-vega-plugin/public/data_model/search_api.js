...
class SearchAPI {
  ...
  search(searchRequests) {
    ...
    return (0, _rxjs.combineLatest)(searchRequests.map(request => {
      ...
      return (0, _rxjs.from)(extendSearchParamsWithRuntimeFields(indexPatterns, requestParams, request.index)).pipe((0, _operators.tap)(params => {
      ...
      }), (0, _operators.switchMap)(params => search.search({
        params
      }, {
        abortSignal: this.abortSignal,
        sessionId: this.searchSessionId,
        executionContext: this.executionContext
      }).pipe((0, _operators.tap)(data => this.inspectSearchResult(data, requestResponders[requestId]), err => this.inspectSearchResult({
        rawResponse: err === null || err === void 0 ? void 0 : err.err
      }, requestResponders[requestId])), (0, _operators.map)(data => ({
        name: requestId,
