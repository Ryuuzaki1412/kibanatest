...
function getTextColors(fillDefinition, geometryColor, { color: backgroundColor, fallbackColor: fallbackBGColor }) {
    ...
    const fillColor = (0, fill_text_color_1.fillTextColor)(fallbackBGColor, geometryColor, backgroundColor);
    const shadowColor = (0, fill_text_color_1.fillTextColor)(fallbackBGColor, fillColor, backgroundColor);
    return {
        fillColor,
        shadowColor,
    };
